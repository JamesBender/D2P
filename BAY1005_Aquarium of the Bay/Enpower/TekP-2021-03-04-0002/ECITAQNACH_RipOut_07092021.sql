...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ECITAQNACH_20210709.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Testing Purposes Only','202106251','EMPEXPORT','TEST','Jun 23 2021  4:47PM','ECITAQNACH',NULL,NULL,NULL,'202106251','Jun 25 2021 12:00AM','Jun 20 2021 12:00AM','202106251','50','','','202106251',dbo.fn_GetTimedKey(),NULL,'us3rVaBAY1005',NULL);
