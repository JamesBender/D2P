...
GO
IF OBJECT_ID('U_EHFXCENTE2_Audit') IS NOT NULL DROP TABLE [dbo].[U_EHFXCENTE2_Audit];
GO
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvStatueChangeDate"','33','(''UA''=''T'')','EHFXCENTE2Z0','35','D','02','1087',NULL,'Hourly Rate',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EHFXCENTE2_20210412.txt';
/*09*/ DECLARE @FILEPATH varchar(1000) = '\\' + @COUNTRY + '.saas\' + @SERVER + '\' + @ENVIRONMENT + '\Downloads\V10\Exports\' + @COCODE + '\EmployeeHistoryExport\';
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N','IAGFG',NULL,NULL,NULL,'EHFXCENTE2 export','201601069','EMPEXPORT','EHFXCENTE2',NULL,'EHFXCENTE2',NULL,NULL,NULL,'202104079',NULL,NULL,'202103311',NULL,'','','201512301',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'TEST','201612021','EMPEXPORT','TEST','Dec  2 2016  7:31PM','EHFXCENTE2',NULL,NULL,NULL,'201612021','Dec  2 2016 12:00AM','Nov 27 2016 12:00AM','201601011','1388','','','201601011',dbo.fn_GetTimedKey(),NULL,'ULTI_WPTEN',NULL);
...
CREATE TABLE [dbo].[U_dsi_EHFXCENTE2_drvTbl] (
    ...
    [drvStatueChangeDate] varchar(10) NULL
);
...
IF OBJECT_ID('U_EHFXCENTE2_Audit') IS NULL
CREATE TABLE [dbo].[U_EHFXCENTE2_Audit] (
...
--        drvPeriodEndDate = CONVERT(varchar(10), PgpPeriodEndDate, 112)--case when eecemplstatus <> 'T' then CONVERT(varchar(10), PgpPeriodEndDate, 112) end
    ,drvStatueChangeDate = CASE WHEN AudNewValue IS NOT NULL THEN CONVERT(VARCHAR(10), audDateTime, 112) END
