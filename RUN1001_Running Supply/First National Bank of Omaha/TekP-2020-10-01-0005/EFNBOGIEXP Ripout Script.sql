...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EFNBOGIEXP_20210113.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N',',VELO7',NULL,NULL,NULL,'FNB of Omaha Gen Int Exp-Sched','202101119','EMPEXPORT','SCH_EFNBOG','Nov 10 2020  1:34PM','EFNBOGIEXP',NULL,NULL,NULL,'202101119','Nov  9 2020  4:41PM','Nov  9 2020  4:41PM','202101111','38','','','202101111',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
