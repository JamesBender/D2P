...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvEmpEffectiveDate"','15','(''UD112''=''F'')','EMUTOMAEXPZ0','76','D','10','317',NULL,'Employee Effective Date',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EMUTOMAEXP_20200717.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Mutual of Omaha Benefit Export','202001149','EMPEXPORT','ONDEMAND',NULL,'EMUTOMAEXP',NULL,NULL,NULL,'202001149','Jan 14 2020  4:23PM','Jan 14 2020  4:23PM','202001141',NULL,'','','202001141',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EMUTOMAEXP_20200717.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','202001149','EMPEXPORT','SCHEDULED',NULL,'EMUTOMAEXP',NULL,NULL,NULL,'202001149','Jan 14 2020  4:23PM','Jan 14 2020  4:23PM','202001141',NULL,'','','202001141',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EMUTOMAEXP_20200717.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','202001149','EMPEXPORT','OEACTIVE',NULL,'EMUTOMAEXP',NULL,NULL,NULL,'202001149','Jan 14 2020  4:23PM','Jan 14 2020  4:23PM','202001141',NULL,'','','202001141',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EMUTOMAEXP_20200717.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','202001149','EMPEXPORT','OEPASSIVE',NULL,'EMUTOMAEXP',NULL,NULL,NULL,'202001149','Jan 14 2020  4:23PM','Jan 14 2020  4:23PM','202001141',NULL,'','','202001141',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EMUTOMAEXP_20200717.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202007149','EMPEXPORT','TEST','Jul 14 2020  8:48AM','EMUTOMAEXP',NULL,NULL,NULL,'202007149','Jul 14 2020 12:00AM','Dec 30 1899 12:00AM','202006221','782','','','202006221',dbo.fn_GetTimedKey(),NULL,'us3lKiANG1002',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EMUTOMAEXP_20200717.txt' END WHERE expFormatCode = 'EMUTOMAEXP';
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EMUTOMAEXP','Subsort','C','drvSubSort');
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvBasicSalMode = 'A'
        ,drvBasicSalAmt = dbo.dsi_fnPadZero(eecannsalary*100,16,0) --Format decimal 16 character pad zero
        ...
        ,drvClassBlifeEligEvent =  CASE WHEN GLIFM IS NOT NULL or GLIFD IS NOT NULL or GLIFE is not null THEN
                                        CASE WHEN ISNULL(GLIFD_BenStatus,'') IN ('T','') and  ISNULL(GLIFM_BenStatus,'') IN ('T','') and ISNULL(GLIFE_BenStatus,'') IN ('T','') then 'TM'
                                               ELSE 'EN'
                                        END 
                                  END
        ...
        ,drvBasicADDEligEvent = CASE WHEN ERADD IS NOT NULL OR ERADE IS NOT NULL OR ERADM IS NOT NULL THEN
                                        CASE WHEN  ISNULL(ERADD_BenStatus,'') IN ('T','')  and ISNULL(ERADE_BenStatus,'') IN ('T','') and ISNULL(ERADM_BenStatus,'') IN ('T','') then 'TM'
                                               ELSE 'EN'
                                        END 
                                  END
        ...
        ,drvVolAccEligEvent = CASE WHEN MVACE IS NOT NULL THEN
                                CASE WHEN bdmRecType = 'EMP' and  MVACE_BenStatus = 'T' THEN 'TM'
    ...
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    JOIN (Select  eedEEID as bdmeeid,eedcoid as bdmcoid,'EMP' as BdmRecType,null as bdmdeprecid
            ,GLIFM  = MAX((CASE WHEN eedDedCode = 'GLIFM' then 'GLIFM' END))
            ,GLIFM_BenefitDate = MAX((CASE WHEN eedDedCode = 'GLIFM'  then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,GLIFM_BenStatus = MAX((CASE WHEN eedDedCode = 'GLIFM' then  eedBenStatus END))
            ,GLIFM_BenStopDate = MAX((CASE WHEN eedDedCode = 'GLIFM' then  eedBenStopDate END))
            ,GLIFD  = MAX((CASE WHEN eedDedCode = 'GLIFD ' then 'GLIFD' END))
            ,GLIFD_BenefitDate =   MAX((CASE WHEN eedDedCode = 'GLIFD'   then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,GLIFD_BenStatus = MAX((CASE WHEN eedDedCode = 'GLIFD' then  eedBenStatus END))
            ,GLIFD_BenStopDate = MAX((CASE WHEN eedDedCode = 'GLIFD' then  eedBenStopDate END))
            ,GLIFE  = MAX((CASE WHEN eedDedCode = 'GLIFE ' then 'GLIFE' END))
            ,GLIFE_BenefitDate =   MAX((CASE WHEN eedDedCode = 'GLIFE' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,GLIFE_BenStatus = MAX((CASE WHEN eedDedCode = 'GLIFE' then  eedBenStatus END))
            ,GLIFE_BenStopDate = MAX((CASE WHEN eedDedCode = 'GLIFE' then  eedBenStopDate END))
            ,ERADD  = MAX((CASE WHEN eedDedCode = 'ERADD ' then 'ERADD' END))
            ,ERADD_BenefitDate =   MAX((CASE WHEN eedDedCode = 'ERADD' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,ERADD_BenStatus = MAX((CASE WHEN eedDedCode = 'ERADD' then  eedBenStatus END))
            ,ERADD_BenStopDate = MAX((CASE WHEN eedDedCode = 'ERADD' then  eedBenStopDate END))
            ,ERADE  = MAX((CASE WHEN eedDedCode = 'ERADE' then 'ERADE' END))
            ,ERADE_BenefitDate =   MAX((CASE WHEN eedDedCode = 'ERADE' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,ERADE_BenStatus = MAX((CASE WHEN eedDedCode = 'ERADE' then  eedBenStatus END))
            ,ERADE_BenStopDate = MAX((CASE WHEN eedDedCode = 'ERADE' then  eedBenStopDate END))
            ,ERADM  = MAX((CASE WHEN eedDedCode = 'ERADM' then 'ERADM' END))
            ,ERADM_BenefitDate =   MAX((CASE WHEN eedDedCode = 'ERADM' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,ERADM_BenStatus = MAX((CASE WHEN eedDedCode = 'ERADM' then  eedBenStatus END))
            ,ERADM_BenStopDate = MAX((CASE WHEN eedDedCode = 'ERADM' then  eedBenStopDate END))
            ,ERSTD  = MAX((CASE WHEN eedDedCode = 'ERSTD' then 'ERSTD' END))
            ,ERSTD_BenefitDate =   MAX((CASE WHEN eedDedCode = 'ERSTD' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,ERSTD_BenStatus = MAX((CASE WHEN eedDedCode = 'ERSTD' then  eedBenStatus END))
            ,ERSTD_BenStopDate = MAX((CASE WHEN eedDedCode = 'ERSTD' then  eedBenStopDate END))
            ,ERLTD  = MAX((CASE WHEN eedDedCode = 'ERLTD' then 'ERLTD' END))
            ,ERLTD_BenefitDate =   MAX((CASE WHEN eedDedCode = 'ERLTD' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,ERLTD_BenStatus = MAX((CASE WHEN eedDedCode = 'ERLTD' then  eedBenStatus END))
            ,ERLTD_BenStopDate = MAX((CASE WHEN eedDedCode = 'ERLTD' then  eedBenStopDate END))
            ,LIFEE  = MAX((CASE WHEN eedDedCode = 'LIFEE' then 'LIFEE' END))
            ,LIFEE_BenefitDate =   MAX((CASE WHEN eedDedCode = 'LIFEE' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,LIFEE_BenStatus = MAX((CASE WHEN eedDedCode = 'LIFEE' then  eedBenStatus END))
            ,LIFEE_BenStopDate = MAX((CASE WHEN eedDedCode = 'LIFEE' then  eedBenStopDate END))
            ,LIFEE_BenAmt = SUM((CASE WHEN eedDedCode = 'LIFEE' then  CAST(eedBenAmt as money)END)) 
            ,LIFES  = MAX((CASE WHEN eedDedCode = 'LIFES' then 'LIFES' END))
            ,LIFES_BenefitDate =   MAX((CASE WHEN eedDedCode = 'LIFES' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,LIFES_BenStatus = MAX((CASE WHEN eedDedCode = 'LIFES' then  eedBenStatus END))
            ,LIFES_BenStopDate = MAX((CASE WHEN eedDedCode = 'LIFES' then  eedBenStopDate END))
            ,LIFES_BenAmt = SUM((CASE WHEN eedDedCode = 'LIFES' then  CAST(eedBenAmt as money)END)) 
            ,LIFEC  = MAX((CASE WHEN eedDedCode = 'LIFEC' then 'LIFEC' END))
            ,LIFEC_BenefitDate =   MAX((CASE WHEN eedDedCode = 'LIFEC' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,LIFEC_BenStatus = MAX((CASE WHEN eedDedCode = 'LIFEC' then  eedBenStatus END))
            ,LIFEC_BenStopDate = MAX((CASE WHEN eedDedCode = 'LIFEC' then  eedBenStopDate END))
            ,LIFEC_BenAmt = SUM((CASE WHEN eedDedCode = 'LIFEC' then  CAST(eedBenAmt as money)END)) 
            ,ADDE = MAX((CASE WHEN eedDedCode = 'ADDE' then 'ADDE' END))
            ,ADDE_BenefitDate =   MAX((CASE WHEN eedDedCode = 'ADDE' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,ADDE_BenStatus = MAX((CASE WHEN eedDedCode = 'ADDE' then  eedBenStatus END))
            ,ADDE_BenStopDate = MAX((CASE WHEN eedDedCode = 'ADDE' then  eedBenStopDate END))
            ,ADDE_BenAmt = SUM((CASE WHEN eedDedCode = 'ADDE' then  CAST(eedBenAmt as money)END)) 
            ,ADDS = MAX((CASE WHEN eedDedCode = 'ADDS' then 'ADDS' END))
            ,ADDS_BenefitDate =   MAX((CASE WHEN eedDedCode = 'ADDS' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,ADDS_BenStatus = MAX((CASE WHEN eedDedCode = 'ADDS' then  eedBenStatus END))
            ,ADDS_BenStopDate = MAX((CASE WHEN eedDedCode = 'ADDS' then  eedBenStopDate END))
            ,ADDS_BenAmt = SUM((CASE WHEN eedDedCode = 'ADDS' then  CAST(eedBenAmt as money)END)) 

            ,ADDC = MAX((CASE WHEN eedDedCode = 'ADDC' then 'ADDS' END))
            ,ADDC_BenefitDate =   MAX((CASE WHEN eedDedCode = 'ADDC' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,ADDC_BenStatus = MAX((CASE WHEN eedDedCode = 'ADDC' then  eedBenStatus END))
            ,ADDC_BenStopDate = MAX((CASE WHEN eedDedCode = 'ADDC' then  eedBenStopDate END))
            ,ADDC_BenAmt = SUM((CASE WHEN eedDedCode = 'ADDC'  then  CAST(eedBenAmt as money)END)) 

            ,MVACE = MAX((CASE WHEN eedDedCode = 'MVACE' then 'MVACE' END))
            ,MVACE_BenefitDate =   MAX((CASE WHEN eedDedCode = 'MVACE' then  CASE WHEN eedbenstatus in ('T','C') THEN dateadd(day,1,eedBenStopdate) ELSE eedBenStartDate  END END))
            ,MVACE_BenStatus = MAX((CASE WHEN eedDedCode = 'MVACE' then  eedBenStatus END))
            ,MVACE_BenStopDate = MAX((CASE WHEN eedDedCode = 'MVACE' then  eedBenStopDate END))
            ,MVACE_BenAmt = SUM((CASE WHEN eedDedCode = 'MVACE' then  CAST(eedBenAmt as money)END)) 
            ,MVACE_BenOption =   MAX((CASE WHEN eedDedCode = 'MVACE' then  eedBenOption END))
            from dbo.U_dsi_bdm_EmpDeductions where eedformatcode = 'EMUTOMAEXP' and eedbenstatus not in ('W','C')

            group by eedEEID,eedcoid

            UNION ALL 

            Select  dbnEEID as bdmeeid,dbncoid as bdmcoid,'DEP' as BdmRecType,dbndeprecid as bdmdeprecid
            ,GLIFM  = MAX((CASE WHEN dbnDedCode = 'GLIFM' then 'GLIFM' END))
            ,GLIFM_BenefitDate = MAX((CASE WHEN dbnDedCode = 'GLIFM' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,GLIFM_BenStatus = MAX((CASE WHEN dbnDedCode = 'GLIFM' then  dbnBenStatus END))
            ,GLIFM_BenStopDate = MAX((CASE WHEN dbnDedCode = 'GLIFM' then  dbnBenStopDate END))
            ,GLIFD  = MAX((CASE WHEN dbnDedCode = 'GLIFD ' then 'GLIFD' END))
            ,GLIFD_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'GLIFD' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,GLIFD_BenStatus = MAX((CASE WHEN dbnDedCode = 'GLIFD' then  dbnBenStatus END))
            ,GLIFD_BenStopDate = MAX((CASE WHEN dbnDedCode = 'GLIFD' then  dbnBenStopDate END))
            ,GLIFE  = MAX((CASE WHEN dbnDedCode = 'GLIFE ' then 'GLIFE' END))
            ,GLIFE_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'GLIFE' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,GLIFE_BenStatus = MAX((CASE WHEN dbnDedCode = 'GLIFE' then  dbnBenStatus END))
            ,GLIFE_BenStopDate = MAX((CASE WHEN dbnDedCode = 'GLIFE' then  dbnBenStopDate END))
            ,ERADD  = MAX((CASE WHEN dbnDedCode = 'ERADD ' then 'ERADD' END))
            ,ERADD_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'ERADD' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,ERADD_BenStatus = MAX((CASE WHEN dbnDedCode = 'ERADD' then  dbnBenStatus END))
            ,ERADD_BenStopDate = MAX((CASE WHEN dbnDedCode = 'ERADD' then  dbnBenStopDate END))
            ,ERADE  = MAX((CASE WHEN dbnDedCode = 'ERADE' then 'ERADE' END))
            ,ERADE_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'ERADE' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,ERADE_BenStatus = MAX((CASE WHEN dbnDedCode = 'ERADE' then  dbnBenStatus END))
            ,ERADE_BenStopDate = MAX((CASE WHEN dbnDedCode = 'ERADE' then  dbnBenStopDate END))
            ,ERADM  = MAX((CASE WHEN dbnDedCode = 'ERADM' then 'ERADM' END))
            ,ERADM_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'ERADM' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,ERADM_BenStatus = MAX((CASE WHEN dbnDedCode = 'ERADM' then  dbnBenStatus END))
            ,ERADM_BenStopDate = MAX((CASE WHEN dbnDedCode = 'ERADM' then  dbnBenStopDate END))
            ,ERSTD  = MAX((CASE WHEN dbnDedCode = 'ERSTD' then 'ERSTD' END))
            ,ERSTD_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'ERSTD' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,ERSTD_BenStatus = MAX((CASE WHEN dbnDedCode = 'ERSTD' then  dbnBenStatus END))
            ,ERSTD_BenStopDate = MAX((CASE WHEN dbnDedCode = 'ERSTD' then  dbnBenStopDate END))
            ,ERLTD  = MAX((CASE WHEN dbnDedCode = 'ERLTD' then 'ERLTD' END))
            ,ERLTD_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'ERLTD' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,ERLTD_BenStatus = MAX((CASE WHEN dbnDedCode = 'ERLTD' then  dbnBenStatus END))
            ,ERLTD_BenStopDate = MAX((CASE WHEN dbnDedCode = 'ERLTD' then  dbnBenStopDate END))
            ,LIFEE  = MAX((CASE WHEN dbnDedCode = 'LIFEE' then 'LIFEE' END))
            ,LIFEE_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'LIFEE' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,LIFEE_BenStatus = MAX((CASE WHEN dbnDedCode = 'LIFEE' then  dbnBenStatus END))
            ,LIFEE_BenStopDate = MAX((CASE WHEN dbnDedCode = 'LIFEE' then  dbnBenStopDate END))
            ,LIFEE_BenAmt = SUM((CASE WHEN dbnDedCode = 'LIFEE' then  CAST(dedeebenamt as money)END)) 
            ,LIFES  = MAX((CASE WHEN dbnDedCode = 'LIFES' then 'LIFES' END))
            ,LIFES_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'LIFES' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,LIFES_BenStatus = MAX((CASE WHEN dbnDedCode = 'LIFES' then  dbnBenStatus END))
            ,LIFES_BenStopDate = MAX((CASE WHEN dbnDedCode = 'LIFES' then  dbnBenStopDate END))
            ,LIFES_BenAmt = SUM((CASE WHEN dbnDedCode = 'LIFES' then  CAST(dedeebenamt as money)END)) 
            ,LIFEC  = MAX((CASE WHEN dbnDedCode = 'LIFEC' then 'LIFEC' END))
            ,LIFEC_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'LIFEC' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,LIFEC_BenStatus = MAX((CASE WHEN dbnDedCode = 'LIFEC' then  dbnBenStatus END))
            ,LIFEC_BenStopDate = MAX((CASE WHEN dbnDedCode = 'LIFEC' then  dbnBenStopDate END))
            ,LIFEC_BenAmt = SUM((CASE WHEN dbnDedCode = 'LIFEC' then  CAST(dedeebenamt as money)END)) 
            ,ADDE = MAX((CASE WHEN dbnDedCode = 'ADDE' then 'ADDE' END))
            ,ADDE_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'ADDE' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,ADDE_BenStatus = MAX((CASE WHEN dbnDedCode = 'ADDE' then  dbnBenStatus END))
            ,ADDE_BenStopDate = MAX((CASE WHEN dbnDedCode = 'ADDE' then  dbnBenStopDate END))
            ,ADDE_BenAmt = SUM((CASE WHEN dbnDedCode = 'ADDE' then  CAST(dedeebenamt as money)END)) 
            ,ADDS = MAX((CASE WHEN dbnDedCode = 'ADDS' then 'ADDS' END))
            ,ADDS_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'ADDS' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,ADDS_BenStatus = MAX((CASE WHEN dbnDedCode = 'ADDS' then  dbnBenStatus END))
            ,ADDS_BenStopDate = MAX((CASE WHEN dbnDedCode = 'ADDS' then  dbnBenStopDate END))
            ,ADDS_BenAmt = SUM((CASE WHEN dbnDedCode = 'ADDS' then  CAST(dedeebenamt as money)END)) 

            ,ADDC = MAX((CASE WHEN dbnDedCode = 'ADDC' then 'ADDS' END))
            ,ADDC_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'ADDC' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,ADDC_BenStatus = MAX((CASE WHEN dbnDedCode = 'ADDC' then  dbnBenStatus END))
            ,ADDC_BenStopDate = MAX((CASE WHEN dbnDedCode = 'ADDC' then  dbnBenStopDate END))
            ,ADDC_BenAmt = SUM((CASE WHEN dbnDedCode = 'ADDC'  then  CAST(dedeebenamt as money)END)) 

            ,MVACE = MAX((CASE WHEN dbnDedCode = 'MVACE' then 'MVACE' END))
            ,MVACE_BenefitDate =   MAX((CASE WHEN dbnDedCode = 'MVACE' then  CASE WHEN dbnbenstatus in ('T','C') THEN dateadd(day,1,dbnBenStopdate) ELSE dbnBenStartDate  END END))
            ,MVACE_BenStatus = MAX((CASE WHEN dbnDedCode = 'MVACE' then  dbnBenStatus END))
            ,MVACE_BenStopDate = MAX((CASE WHEN dbnDedCode = 'MVACE' then  dbnBenStopDate END))
            ,MVACE_BenAmt = SUM((CASE WHEN dbnDedCode = 'MVACE' then  CAST(dedeebenamt as money)END)) 
            ,MVACE_BenOption =   MAX((CASE WHEN dbnDedCode = 'MVACE' then  dbnBenOption END))
            from dbo.U_dsi_bdm_DepDeductions where dbnformatcode = 'EMUTOMAEXP' and dbnbenstatus not in ('W','C')
            group by dbnEEID,dbncoid,dbndeprecid) as BdmConsolidated
        ON BdmEEID = xEEID 
        AND BdmCoID = xCoID
