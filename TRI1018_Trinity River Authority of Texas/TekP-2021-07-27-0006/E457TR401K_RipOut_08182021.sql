...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCreateTClockBatches,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhPreProcessSQL,AdhRecordSize,AdhRespectZeroPayRate,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhThirdPartyPay) VALUES ('N','C','Y','0','',NULL,'','N','','N','','013010','EMPEXPORT','CDE','E457TR401K','Mission Square 457 Payroll Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','dbo.dsi_sp_Switchbox_v2','1000','N','S','N','E457TR401KZ0','N','Jan  1 1900 12:00AM','C','N');
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPayDate"','10','(''UA''=''F'')','E457TR401KZ0','8','D','20','10',NULL,'Payroll Date',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'E457TR401K_20210818.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','',NULL,NULL,NULL,NULL,'Mission Square 457 Payro-Test','202108189','EMPEXPORT','TEST_XOE',NULL,'E457TR401K',NULL,NULL,NULL,'202108189','Aug 18 2021  3:53PM','Aug 18 2021  3:53PM','202108181',NULL,'','','202108181',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvFiller1 = ''
        ,drvIRSNum = (SELECT CmmFedTaxId FROM dbo.CompMast WITH(NOLOCK))
        ,drvTotRemit = CAST(CAST(PdhSource1 AS DECIMAL(10,2)) AS VARCHAR)
        ,drvFiller2 = ''
        ,drvFormatCode = '03'
        ,drvFiller3 = ''
    ...
    SELECT DISTINCT
        ...
        ,drvSourceCode = 'EE'
        ,drvPartSSN = EepSSN
        ,drvContAmt = CAST(CAST(PdhSource1 AS DECIMAL(10,2)) AS VARCHAR)
        ,drvTaxYear = ''
        ,drvFundId = ''
        ,drvFiller1 = ''
        ,drvLocId = ''
    ...
    SELECT DISTINCT
        ...
        ,drvPartSSN = EepSSN
        ,drvLoanRepAmt = CAST(CAST(PdhEECurAmt AS DECIMAL(10,2)) AS VARCHAR)
        ,drvFiller2 = ''
