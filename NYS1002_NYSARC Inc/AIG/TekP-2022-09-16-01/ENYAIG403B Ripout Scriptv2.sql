...
Client ID:      NYS1002
Date/time:      2023-01-19 09:30:23.010
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    E42
...
/*08*/ DECLARE @FileName varchar(1000) = 'ENYAIG403B_20230119.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,',5KG86,5KF7N,5KGB3,5KFTS,5KGEW',NULL,NULL,NULL,'AIG 403b Combined Export','202212029','EMPEXPORT','ONDEM_XOE',NULL,'ENYAIG403B',NULL,NULL,NULL,'202212029','Oct 24 2022  1:44PM','Oct 24 2022  1:44PM','202211261',NULL,'','','202211261',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','5KG86,5KF7N,5KGB3,5KFTS,5KGEW',NULL,NULL,NULL,'Test Purposes Only','202301069','EMPEXPORT','TEST_XOE','Nov 11 2022 12:17PM','ENYAIG403B',NULL,NULL,NULL,'202301069','Nov 10 2022 12:00AM','Dec 30 1899 12:00AM','202212311','4182','','','202212311',dbo.fn_GetTimedKey(),NULL,'us3lKiNYS1002',NULL);
...
CREATE TABLE [dbo].[U_ENYAIG403B_drvTbl] (
    ...
    [drvExcludedClassType] varchar(1) NOT NULL,
    [drvHRArea] varchar(4) NOT NULL,
    [drvJobTitle] varchar(8000) NULL,
    [drvOriginalHireDate] datetime NULL,
    [drvSubGroup] varchar(3) NOT NULL,
    [drvUnionID] varchar(4) NOT NULL,
    ...
    [drvPlanExcludedCompensation] varchar(1) NOT NULL
);
...
Marie Waters        1/19/2023       TekP-2022-09-16-01    Removed the BDM and Audit sections from the procedure as it is not being used and causing web exections to time out
...
BEGIN
    ...
    (SELECT EecEEID FROM dbo.EmpComp WITH (NOLOCK) WHERE EecEEType IN ('TES','INT','VOL','BOD'));
     ...
     -- Cleans EE List where ssn starts with 999
    DELETE FROM dbo.U_ENYAIG403B_EEList 
    WHERE xEEID IN
    (SELECT EepEEID FROM dbo.EmpPers WITH (NOLOCK) WHERE eepssn LIKE '999%');
 ...
 SELECT DISTINCT
        ...
        ,drvParticipantFirstName = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(EepNameFirst, 'á', 'a'), 'é','e'), 'í', 'i'), 'ó', 'o'), 'ú','u'), 'n','n'),'¢','o')  --EepNameFirst
        ,drvParticipantMiddleName = EepNameMiddle-- LEFT(EepNameMiddle,1)
        ,drvParticipantLastName = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(EepNameLast, 'á', 'a'), 'é','e'), 'í', 'i'), 'ó', 'o'), 'ú','u'), 'n','n'),'.',''),',',''),'¢','o')   --EepNameLast
        ,drvAddress1 = REPLACE(EepAddressLine1, ',', '')
        ,drvAddress2 = REPLACE(EepAddressLine2, ',', '')
        ,drvCity = LEFT(REPLACE(EepAddressCity, ',', ''),20)
        ,drvStateCountryCode = EepAddressState
        --,EepAddressZipCode
        ,drvZip = EepAddressZipCode + '0000'  --FORMAT(CAST(EepAddressZipCode AS INT), '000000000')
        ,drvPayrollFrequencycode = CASE WHEN PrgPayFrequency = 'B' THEN 'BW' ELSE 'WE' END
        ,drvPayrolDate = CASE WHEN PrgPayDate IS NOT NULL THEN
                        ...
                        --CASE WHEN Prgpaydate BETWEEN @StartDate AND @EndDate THEN Prgpaydate
                        --      ELSE (SELECT PgrPayDate FROM PayGroup WITH (NOLOCK) WHERE PgrPayGroup = EecPayGroup)  -- AND PgrPayDate BETWEEN @StartPerControl AND @EndPerControl)    
                        -- END
        ...
        ,drvMaritalstatus = CASE WHEN eepMaritalStatus = 'Z' THEN 'U' ELSE eepMaritalStatus END
        ...
        ,drvEmploymentStatusChangDate = CASE WHEN eecemplstatus = 'T' THEN FORMAT(eecdateoftermination, 'MMddyyyy')
                                             ...
                                             ELSE ''
                                        END
        ,drvLocationCode = CASE WHEN EecUnionLocal IS NOT NULL OR EecUnionNational IS NOT NULL THEN '0001' ELSE '0002' END
        ...
        ,drvHRArea = CASE WHEN EecUnionLocal IS NOT NULL OR EecUnionNational IS NOT NULL THEN '0001' ELSE '0002' END
        ,drvJobTitle = REPLACE((SELECT JbcDesc FROM dbo.JobCode WITH (NOLOCK)  WHERE JbcJobCode = EecJobCode), ',', '')
        ,drvOriginalHireDate = EecDateOfOriginalHire
        ,drvSubGroup = CASE WHEN EecUnionLocal IS NOT NULL OR EecUnionNational IS NOT NULL THEN '001' ELSE '002' END
        ,drvUnionID = CASE WHEN  EecUnionLocal IS NOT NULL OR EecUnionNational IS NOT NULL THEN '1707' ELSE '' END
          --CASE WHEN  EecUnionLocal IS NOT NULL THEN EecUnionLocal WHEN EecUnionNational IS NOT NULL THEN EecUnionNational ELSE '' END
        ...
        ,drvPlanCompensation = CONVERT(VARCHAR,dbo.dsi_fnPadZero(CAST (PehInclInDefComp as money)*100,10,0))
    ...
    WHERE EecEmplStatus <> 'T' 
          ...
          OR ISNULL(pdtEETotals,0.00) <> 0.00 
          OR ISNULL(PdtERTtotals,0.00) <> 0.00 
          OR ISNULL(PehInclInDefComp,0.00) <> 0.00 
          OR ISNULL(PehCurAmt,0.00) <> 0.00
          OR ISNULL(PehCurHrs,0.00) <> 0.00)  -- Do not exclude if terms with Deductions
    ;
