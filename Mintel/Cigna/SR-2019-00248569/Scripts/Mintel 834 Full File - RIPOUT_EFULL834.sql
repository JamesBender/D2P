...
@CustomFormatCode - Replace with Format Code (i.e., ESUNLIF834) -- EMINTEL834
...
GO
IF OBJECT_ID('U_EMINTEL834_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_EMINTEL834_AuditFields];
GO
IF OBJECT_ID('U_EMINTEL834_Audit') IS NOT NULL DROP TABLE [dbo].[U_EMINTEL834_Audit];
GO
...
SET @AdhSystemID = LEFT('EMINTEL834' + REPLICATE('0',10),10) + 'Z0';
SET @FixedFormatName1 = LEFT('Cigna 834 Export',50);
SET @FixedFormatName2 = LEFT('Cigna 834 Export',30);

INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) SELECT 'N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','EMINTEL834','Cigna 834 Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','2000','S','N',@AdhSystemID,'N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N';
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '17',@AdhSystemID,'1','H','01','17',NULL,'Component Element Separator',NULL,NULL,'":"','(''DA''=''F*'')'; -- JCB
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Changes Only File',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','CHANGES','Oct  1 2018 12:00AM','EMINTEL834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Full File Only',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','FULLFILE','Oct  1 2018 12:00AM','EMINTEL834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEACTIVE','Oct  1 2018 12:00AM','EMINTEL834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEPASSIVE','Oct  1 2018 12:00AM','EMINTEL834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,@FixedFormatName2,CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','SCHEDULED','Oct  1 2018 12:00AM','EMINTEL834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EMINTEL834','ExportPath','V','@FileExportPath');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EMINTEL834','UseFileName','V','N');
...
DECLARE @ForrmatCode VARCHAR(10) = 'EMINTEL834';
...
BEGIN
    ...
    UPDATE dbo.AscExp SET expAscFileName = @FilePath + @FileName WHERE expFormatCode = 'EMINTEL834';

    DELETE FROM dbo.U_dsi_Configuration WHERE FormatCode = 'EMINTEL834' AND CfgName IN ('TestPath','UDESPath');
END
GO
...
EXEC dbo._dsi_usp_ExportRipOut @FormatCode = 'EMINTEL834', @AllObjects = 'Y', @IsWeb = 'N';
**********************************************************************************/
BEGIN
    ...
    ***************************************************************************************************************/
    ...
    SELECT DISTINCT drvISA05_SenderIDQual = '30'
        ...
        ,drvISA16_ComponentElementSeparator = ':' -- added
        ,drvGS02_SenderID = '364204612'
        ,drvGS03_ReceiverID = '029053964'
        ,drvGS04_Date = @RunDate
        ,drvGS05_Time = @RunTime
        ,drvGS07_ResponsibleAgencyCode = 'X',
        ,drvGS08_VersionReleaseIndustryIdentifierCode = '005010X220A1'
        -- added these based on doc
        ,drvST01_TransactionSetIdentifierCode = '834'
        ,drvST03_ImplementationConventionReference = '005010X220A1'
        -- stop added
        ...
        ,drvQTY02_Quantity3 = ''
        ,drvN101_EntityIDCodeSponsor1 = 'P1'
    ...
    SELECT DISTINCT
        ...
        ,drvPER03_CommNumberQualifier = CASE WHEN BdmRecType = 'EMP' THEN 
                                            CASE WHEN ISNULL(EepPhoneHomeNumber,'') = '' THEN 'EM'
                                                WHEN THEN ISNULL(eepAddressEMail, '') THEN 'HP'
                                                ELSE ''
                                            END
                                        END
        ...
        ,drvPER05_CommNumberQualifier = CASE WHEN BdmRecType = 'EMP' THEN 
                                            CASE WHEN ISNULL(EepPhoneHomeNumber,'') = '' THEN ''
                                                WHEN THEN ISNULL(eepAddressEMail, '') = '' then ''
                                                ELSE 'EM'
                                            END
                                        END
        ...
        ,drvDMG02_DateTimePeriod1 = CASE WHEN BdmRecType = 'EMP' THEN CONVERT(VARCHAR(8),EepDateOfBirth,112)
                                    ...
                                    END
        ,drvDMG03_GenderCode1 = CASE WHEN (BdmRecType = 'EMP' && ISNULL(EepGender, '') <> '') THEN EepGender 
                                     WHEN (BdmRecType = 'DEP' && ISNULL(ConGender, '') <> '') THEN ConGender
                                     ELSE 'U'
                                END
        ,drvDMG04_MaritalStatusCode1 = CASE WHEN BdmRecType = 'EMP' THEN
                                            CASE WHEN (EepMaritalStatus = 'M' || EepMaritalStatus = 'S') THEN EepMaritalStatus ELSE '' END
                                       END
...
*/                                    
        ,drvHD04_PlanCoverageDesc = CASE    WHEN BdmDedCode IN ('MED') THEN
                                                ...
                                                CASE WHEN eepAddressState in ('MO', 'TX') THEN 'OAPCF'
                                                ELSE 'OAPC'
                                            WHEN BdmDedCode in ('MED2') THEN
                                                CASE WHEN eepAddressState = 'CA' THEN 'OAPCC'
                                                CASE WHEN eepAddressState in ('MO', 'TX') THEN 'OAPFF'
                                                ELSE 'OAPP'
                                            WHEN BdmDedCode in ('MED3') THEN
                                                CASE WHEN eepAddressState = 'CA' THEN 'OAPVC'
                                                CASE WHEN eepAddressState in ('MO', 'TX') THEN 'OAPVF'
                                                ELSE 'OAPV'
                                            WHEN BdmDedCode IN ('DEN') THEN 
                                                CASE WHEN eepAddressState = 'MS' THEN 'DPPOM' 
                                                CASE WHEN eepAddressState = 'TX' THEN 'TXDEN' 
                                                ELSE 'DPPO'
                                                END
        ...
        ,drvREF02_RefNumberDesc =   WHEN cmpcompanycode NOT IN ('RSI', 'COM') THEN
                                        CASE BdmDedType 
                                            WHEN 'MED' THEN 
                                            ...
                                            WHEN 'DEN' THEN 
                                                CASE WHEN eepAddressState = 'MS' THEN LEFT('3342965A002 DPPOM' + SPACE(18), 18)
                                                    ...
                                                    ELSE THEN LEFT('3342965A001 DPPO' + SPACE(18), 18)
                                                END
                                            WHEN 'VIS' THEN LEFT('3342965A001 VISP' + SPACE(18), 18)
                                        END
                                    CASE WHEN cmpcompanycode = 'RSI' THEN
                                        CASE BdmDedType 
                                            WHEN 'MED' THEN 
                                            ...
                                            WHEN 'DEN' THEN
                                                CASE WHEN eepAddressState = 'MS' THEN LEFT('3342965A002 DPPOM' + SPACE(18), 18)
                                                    WHEN eepAddressState = 'TX' THEN LEFT('3342965A001 TXDEN' + SPACE(18), 18)
                                                    ELSE THEN LEFT('3342965A002 DPPO' + SPACE(18), 18)
                                                END
                                        ...
                                        CASE BdmDedType 
                                            ...
                                            WHEN 'DEN' THEN 
                                                CASE WHEN eepAddressState = 'MS' THEN LEFT('3342965A003 DPPOM' + SPACE(18), 18)
                                                    WHEN eepAddressState = 'TX' THEN LEFT('3342965A001 TXDEN' + SPACE(18), 18)
                                                    ELSE THEN LEFT('3342965A003 DPPO' + SPACE(18), 18)
                                                END
