...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ECUNA4012_20210830.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'CUNA - 401k V2-Test','202108209','EMPEXPORT','TEST_XOE','Aug 30 2021  5:26AM','ECUNA4012',NULL,NULL,NULL,'202108209','Aug 20 2021 12:00AM','Dec 30 1899 12:00AM','202108201','158','eecPayGroup','BWQFCU','202108201',dbo.fn_GetTimedKey(),NULL,'us3cPeQUO1000',NULL);
