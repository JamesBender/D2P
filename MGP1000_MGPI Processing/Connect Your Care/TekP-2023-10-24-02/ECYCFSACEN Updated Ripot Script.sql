...
Client ID:      MGP1000
Date/time:      2024-01-29 07:08:08.227
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECYCFSACEN_20240129.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'CYC FSA HSA Census-OnDemand','202201211','EMPEXPORT','ONDEM_XOE','Feb 19 2022  4:34PM','ECYCFSACEN',NULL,NULL,NULL,'202201211','Jan 21 2022 12:00AM','Jan 16 2022 12:00AM','202201151','599','','','202201151',dbo.fn_GetTimedKey(),NULL,'us3cPeMGP1000',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N',',M0UP1,M0U4Y,WA3OC',NULL,NULL,NULL,'CYC FSA HSA Census-Scheduled','202012019','EMPEXPORT','SCH_ECYCFS',NULL,'ECYCFSACEN',NULL,NULL,NULL,'202401269','Dec  1 2020  9:04AM','Dec  1 2020  9:04AM','202401191',NULL,'','','202012011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',',WA3OC,M0UP1,M0U4Y,Y5019',NULL,NULL,NULL,'CYC FSA HSA Census-Test','202401269','EMPEXPORT','TEST_XOE',NULL,'ECYCFSACEN',NULL,NULL,NULL,'202401269','Dec  1 2020  9:04AM','Dec  1 2020  9:04AM','202401261',NULL,'','','202401261',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
Marie Waters        01/29/2024     TekP-2023-10-24-02    added additional group and added Test session
...
Execute Export
--------------
EXEC dbo.dsi_sp_TestSwitchbox_v2 'ECYCFSACEN', 'TEST_XOE'; -- MW added
    ...
    SELECT DISTINCT
       ...
       -- ,drvDepRecID = CONVERT(varchar(12),'1') --DELETE IF NOT USING DEPENDENT DATA
        ...
        ,drvBillingGroupID = CASE WHEN EecOrgLvl3 IN ('1000', '2000', '7000') THEN 'ATCH'
                                  ...
                                  WHEN EecOrgLvl3 IN ('44001') THEN 'PNLPE' -- MW updated 
                                  ELSE '' 
                             END
