...
Client ID:      CLI1003
Date/time:      2022-01-10 05:57:42.510
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECUTRAMPEX_20220110.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','IAGFG,Y5USD,XI0GS,HG0SP,VLYMR,368IV,B57L5',NULL,NULL,NULL,'Culture Amp Demographic -Sched','202104229','EMPEXPORT','SCH_ECUTRA','Apr 22 2021 12:46PM','ECUTRAMPEX',NULL,NULL,NULL,'202201099','Apr 22 2021 12:00AM','Dec 30 1899 12:00AM','202201081','124','','','202104011',dbo.fn_GetTimedKey(),NULL,'us3rVaCLI1003',NULL);
...
CREATE TABLE [dbo].[U_ECUTRAMPEX_drvTbl] (
    ...
    [drvRateEthnicity] varchar(46) NULL,
