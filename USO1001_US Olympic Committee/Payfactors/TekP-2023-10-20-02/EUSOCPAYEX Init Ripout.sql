...
EUSOCPAYEX: USOC Payfactor Jobs Export

FormatCode:     EUSOCPAYEX
Project:        USOC Payfactor Jobs Export
Client ID:      USG1000
Date/time:      2023-11-28 14:40:05.893
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EZ24
...
Web Filename:   USG1000_79690_EEHISTORY_EUSOCPAYEX_ExportCode_YYYYMMDD_HHMMSS.txt
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','EUSOCPAYEX','USOC Payfactor Jobs Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','1000','S','N','EUSOCPAYEXZ0','N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUSOCPAYEX_20231128.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'USOC Payfactor Jobs Export','202311289','EMPEXPORT','ONDEM_XOE',NULL,'EUSOCPAYEX',NULL,NULL,NULL,'202311289','Nov 28 2023 11:42AM','Nov 28 2023 11:42AM','202311281',NULL,'','','202311281',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'USOC Payfactor Jobs Expo-Sched','202311289','EMPEXPORT','SCH_EUSOCP',NULL,'EUSOCPAYEX',NULL,NULL,NULL,'202311289','Nov 28 2023 11:42AM','Nov 28 2023 11:42AM','202311281',NULL,'','','202311281',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'USOC Payfactor Jobs Expo-Test','202311289','EMPEXPORT','TEST_XOE',NULL,'EUSOCPAYEX',NULL,NULL,NULL,'202311289','Nov 28 2023 11:42AM','Nov 28 2023 11:42AM','202311281',NULL,'','','202311281',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSOCPAYEX','ExportPath','V','\\ez2sup4db01\ultiprodata\[Name]\Exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSOCPAYEX','UseFileName','V','N');
...
Purpose: USOC Payfactor Jobs Export

Revision History
----------------
Update By           Date           Request Num          Desc
Spencer Kerch       11/28/2023     TekP-2023-10-20-02   Build Jobs export File
...
BEGIN
  ...
  /*   --==========================================
    ...
    IF OBJECT_ID('U_EUSOCPAYEX_AuditFields','U') IS NOT NULL
        DROP TABLE dbo.U_EUSOCPAYEX_AuditFields;
    CREATE TABLE dbo.U_EUSOCPAYEX_AuditFields (aTableName varchar(30),aFieldName varchar(30));

    -- Create audit table based on fields defined above
    IF OBJECT_ID('U_EUSOCPAYEX_Audit','U') IS NOT NULL
        DROP TABLE dbo.U_EUSOCPAYEX_Audit;
    SELECT 
    ...
    INTO dbo.U_EUSOCPAYEX_Audit
    FROM dbo.vw_AuditData WITH (NOLOCK) 
    JOIN dbo.U_EUSOCPAYEX_AuditFields WITH (NOLOCK) 
    ...
    -- Create Index
    CREATE CLUSTERED INDEX CDX_U_EUSOCPAYEX_Audit ON dbo.U_EUSOCPAYEX_Audit (audEEID,audKey2);

    --================
    -- Changes Only
    --================
    --DELETE FROM dbo.U_EUSOCPAYEX_EEList
    --WHERE NOT EXISTS (SELECT 1 FROM dbo.U_EUSOCPAYEX_Audit WHERE audEEID = xEEID AND audRowNo = 1);
    ...
    IF OBJECT_ID('U_EUSOCPAYEX_DedList','U') IS NOT NULL
        DROP TABLE dbo.U_EUSOCPAYEX_DedList;
    SELECT DISTINCT
         DedCode = DedDedCode
        ,DedType = DedDedType
    INTO dbo.U_EUSOCPAYEX_DedList
 ...
 */
    ...
    --JOIN dbo.U_dsi_BDM_EUSOCPAYEX WITH (NOLOCK)
        --ON BdmEEID = xEEID 
        --AND BdmCoID = xCoID
    ;
