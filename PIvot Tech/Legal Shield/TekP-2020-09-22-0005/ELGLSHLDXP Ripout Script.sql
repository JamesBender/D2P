...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ELGLSHLDXP_20201012.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Legal Shield Export-Test','202010101','EMPEXPORT','TEST_XOE','Oct 10 2020  6:11PM','ELGLSHLDXP',NULL,NULL,NULL,'202010101','Oct 10 2020 12:00AM','Dec 30 1899 12:00AM','202009261','468','','','202009261',dbo.fn_GetTimedKey(),NULL,'us3cPeACS1003',NULL);
