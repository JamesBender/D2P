...
GO
IF OBJECT_ID('U_EDISENRFS2_drvTbl_DP') IS NOT NULL DROP TABLE [dbo].[U_EDISENRFS2_drvTbl_DP];
GO
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvContribLevel"','7','(''UA''=''T|'')','EDISENRFS2Z0','10','D','20','7',NULL,'Employer Contribution Level',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvRelationship"','4','(''UA''=''T|'')','EDISENRFS2Z0','9','D','50','4',NULL,'Relationship',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvDependentNumber"','5','(''UA''=''T|'')','EDISENRFS2Z0','10','D','50','5',NULL,'Dependent Number',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISENRFS2_20210513.txt';
/*09*/ DECLARE @FILEPATH varchar(1000) = '\\' + @COUNTRY + '.saas\' + @SERVER + '\' + @ENVIRONMENT + '\Downloads\V10\Exports\' + @COCODE + '\EmployeeHistoryExport\';
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N','SPXBO,SPXK9',NULL,NULL,NULL,'1st of Month Discovery Enroll','202104289','EMPEXPORT','1stofMonth','Apr 19 2021 12:13PM','EDISENRFS2',NULL,NULL,NULL,'202104289','Mar  1 2021 12:00AM','Dec 30 1899 12:00AM','202101011','1915','','','202101011',dbo.fn_GetTimedKey(),NULL,'us3rVaCRO1006',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','202104289','EMPEXPORT','OEACTIVE',NULL,'EDISENRFS2',NULL,NULL,NULL,'202104289','Nov  2 2018 12:38PM','Nov  2 2018 12:38PM','202101011',NULL,'','','202101011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','202104289','EMPEXPORT','OEPASSIVE',NULL,'EDISENRFS2',NULL,NULL,NULL,'202104289','Nov  2 2018 12:38PM','Nov  2 2018 12:38PM','202101011',NULL,'','','202101011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','',NULL,NULL,NULL,NULL,'Discovery FSA PT/EN File 3.5','202104289','EMPEXPORT','ONDEMAND',NULL,'EDISENRFS2',NULL,NULL,NULL,'202104289','Nov  2 2018 12:38PM','Nov  2 2018 12:38PM','202101011',NULL,'','','202101011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,'SPXBO,SPXK9',NULL,NULL,NULL,'Discovery FSA Enrollment Week','202104289','EMPEXPORT','SCHEDULED',NULL,'EDISENRFS2',NULL,NULL,NULL,'202104289','Nov  2 2018 12:38PM','Nov  2 2018 12:38PM','202101011',NULL,'','','202101011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','SPXBO,SPXK9',NULL,NULL,NULL,'Test Purposes Only','202104289','EMPEXPORT','TEST','May 11 2021  3:37PM','EDISENRFS2',NULL,NULL,NULL,'202104289','Feb 22 2021 12:00AM','Feb 15 2021 12:00AM','202101011','2001','','','202101011',dbo.fn_GetTimedKey(),NULL,'us3rVaCRO1006',NULL);
...
IF OBJECT_ID('U_EDISENRFS2_drvTbl_DP') IS NULL
CREATE TABLE [dbo].[U_EDISENRFS2_drvTbl_DP] (
    [drvEEID] char(12) NULL,
    [drvCoID] char(5) NULL,
    [drvDepRecID] varchar(12) NULL,
    [drvInitialSort] varchar(11) NULL,
    [drvParticipantFileImportID] varchar(11) NULL,
    [drvDependentFileImportId] char(11) NULL,
    [drvRelationship] varchar(9) NOT NULL,
    [drvDependentNumber] varchar(1) NOT NULL,
    ...
    [drvIssueCard] varchar(1) NOT NULL,
    [drvExternalDependentID] varchar(1) NOT NULL
);
...
CREATE TABLE [dbo].[U_EDISENRFS2_drvTbl_EN] (
    ...
    [drvContribLevel] varchar(9) NULL,
...
    WHERE t.tdate not between @Enddate-7 and @Enddate
  ...
  --==========================================  
    ...
    SELECT DISTINCT  
         drvEEID = xEEID  
        ,drvCoID = xCoID  
        ,drvInitialSort = EecEmplStatus -- RTRIM(EepSSN)  
   ...
   ----------------------------------------  
    ...
    SELECT DISTINCT  
        ...
        ,drvPlanName = CASE WHEN BdmDedCode IN ('FSA','FSAPT')  THEN 'Medical FSA'  
                       ...
                       END  
        ,drvContribLevel =        CASE  WHEN BdmDedCode IN ('XOMFT','XOMPT') THEN 
                                    CASE 
        ...
        ,drvElectionAmountIndicator = 
                                      ...
                                      END  
        ,drvHDHPCoverageLevel = CASE  WHEN BdmDedCode IN ('MEDFT','MEDPT') THEN 
                                    CASE 
                                     WHEN NULLIF(BdmBenOption,'') = 'EE' THEN 'Single'
                                     WHEN NULLIF(BdmBenOption,'') = 'ES' THEN 'IndSpouse'
                                     WHEN NULLIF(BdmBenOption,'') = 'EEC' THEN 'Single'
                                     WHEN NULLIF(BdmBenOption,'') IS NOT NULL THEN 'Family'
                                    END
                                END
  ...
  IF OBJECT_ID('U_EDISENRFS2_drvTbl_DP','U') IS NOT NULL
   ...
   SELECT DISTINCT
    ...
    ,drvRelationship = CASE WHEN BdmRelationship = 'SPS' THEN 'Spouse'
                            WHEN BdmRelationship = 'CHL' THEN 'Dependent'
                            ELSE 'Dependent'
                       END 
    ,drvDependentNumber = ''
