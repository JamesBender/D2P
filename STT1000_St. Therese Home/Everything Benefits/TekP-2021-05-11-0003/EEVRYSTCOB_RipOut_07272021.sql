...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EEVRYSTCOB_20210727.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Everything Benefits COBR-Test','202107241','EMPEXPORT','TEST_XOE','Jul 24 2021  2:17PM','EEVRYSTCOB',NULL,NULL,NULL,'202107241','Jul 24 2021 12:00AM','Dec 30 1899 12:00AM','202107101','2735','','','202107101',dbo.fn_GetTimedKey(),NULL,'us3cPeSTT1000',NULL);
...
07/27/2021 by AP:
        ...
        - Added "Employee Assitance Program" to benefit type when plan name = "Employee Assitance Program".
...
BEGIN
   ...
   IF OBJECT_ID('U_EEVRYSTCOB_drvTbl','U') IS NOT NULL
    ...
    SELECT DISTINCT
        ...
        ,drvBenPlanName = 'Employee Assitance Program'
