...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EEMP403EXP_20191202.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201909069','EMPEXPORT','SCHEDULED',NULL,'EEMP403EXP',NULL,NULL,NULL,'201909069','Sep  6 2019  1:35PM','Sep  6 2019  1:35PM','201909061',NULL,'','','201909061',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EEMP403EXP_20191202.txt',NULL,'','','',NULL,NULL,NULL,'Empower 401k','201909069','EMPEXPORT','ONDEMAND','Sep  6 2019  3:23PM','EEMP403EXP',NULL,NULL,NULL,'201909069','Sep  6 2019 12:00AM','Dec 30 1899 12:00AM','201908111','193','','','201908111',dbo.fn_GetTimedKey(),NULL,'us3mLaHEN1004',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EEMP403EXP_20191202.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','201909209','EMPEXPORT','TEST','Sep 20 2019  1:45PM','EEMP403EXP',NULL,NULL,NULL,'201909209','Sep 20 2019 12:00AM','Dec 30 1899 12:00AM','201909201','190','','','201909201',dbo.fn_GetTimedKey(),NULL,'us3lKiHEN1004',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EEMP403EXP_20191202.txt' END WHERE expFormatCode = 'EEMP403EXP';
...
BEGIN
   ...
   IF OBJECT_ID('U_EEMP403EXP_DedList','U') IS NOT NULL
    ...
    INNER JOIN dbo.U_EEMP403EXP_PEarHist WITH (NOLOCK)
            ON PehEEID = xEEID
    JOIN dbo.U_EEMP403EXP_PDedHist 
       on PdhEEID =  xEEID
    ON SourceEEId =  xEEID;
