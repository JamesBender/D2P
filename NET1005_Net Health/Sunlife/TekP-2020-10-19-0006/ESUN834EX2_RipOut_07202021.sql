...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ESUN834EX2_20210720.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Full File Only','202107139','EMPEXPORT','FULLFILE','Jul 13 2021  3:22PM','ESUN834EX2',NULL,NULL,NULL,'202107139','Jul 13 2021 12:00AM','Dec 30 1899 12:00AM','202106291','25439','','','202106291',dbo.fn_GetTimedKey(),NULL,'us3lKiNET1005',NULL);
    ...
    ***************************************************************************************************************/
    ...
    SELECT DISTINCT
        ...
        */
        ...
        ,drvAMT01_AmountQualifierCode1 = 'IO'
        ,drvAMT02_MonetaryAmount1 = (SELECT TOP 1 EedBenAmt from dbo.EmpDed WITH (NOLOCK) WHERE EedEEID = drvEEID AND EedDedCode = 'LIFEC') 
