...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ECIGDTO834_20210630.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Full File Only','202107011','EMPEXPORT','FULLFILE','Jun 30 2021  4:12PM','ECIGDTO834',NULL,NULL,NULL,'202107011','Jul  1 2021 12:00AM','Jun 30 2021 12:00AM','202106171','4287','','','202106171',dbo.fn_GetTimedKey(),NULL,'us3cPeTOP1004',NULL);
...
CREATE TABLE [dbo].[U_ECIGDTO834_DrvTbl_2300] (
    ...
    [drvREF01_RefNumberQual1] varchar(2) NOT NULL,
    [drvREF02_RefNumberQual1] varchar(19) NULL,
...
06/30/2021 by AP:
		- Updated Ref02 value fix.
		- Updated congender value fix.
...
BEGIN
    ...
    ***************************************************************************************************************/
    ...
    SELECT DISTINCT
        ...
        ,drvREF01_RefNumberQual1 = '1L' 
        ,drvREF02_RefNumberQual1 = CASE WHEN BdmDedCode = 'DENTE' AND EepAddressState <> 'TX' THEN '0624893ACTIVEDPPO'
