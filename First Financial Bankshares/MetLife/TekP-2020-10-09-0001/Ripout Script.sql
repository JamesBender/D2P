...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCreateTClockBatches,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhPreProcessSQL,AdhRecordSize,AdhRespectZeroPayRate,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhThirdPartyPay) VALUES ('N','C','Y','0','',NULL,'','N','','N','','013010','EMPEXPORT','SDF','EMETLDNVIS','MetLife Den and Vis Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','dbo.dsi_sp_Switchbox_v2','1000','N','S','N','EMETLDNVISZ0','N','Jan  1 1900 12:00AM','C','N');
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvEmployeeEmploymentDate"','13','(''UA''=''F'')','EMETLDNVISZ0','8','D','10','84',NULL,'[Employee''s] Employment Date',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EMETLDNVIS_20201110.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'MetLife Den and Vis Expo-Test','202011109','EMPEXPORT','TEST_XOE',NULL,'EMETLDNVIS',NULL,NULL,NULL,'202011109','Nov 10 2020  4:49PM','Nov 10 2020  4:49PM','202011101',NULL,'','','202011101',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EMETLDNVIS','EEList','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EMETLDNVIS','ExportPath','V','\\ez2sup4db01\ultiprodata\[Name]\Exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EMETLDNVIS','UseFileName','V','N');
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvDentalCoverage = ''
        ,drvDentalCoverageStartDate = ''
        ,drvDentalCoveragteStopDate = ''
        ,drvDentalReportNumber = ''
        ,drvDentalSubCode = ''
        ,drvDentalSubPoint = ''
        ,drvDentalStatusCode = ''
        ,drvDentalMembersCovered = ''
        ,drvVisionCoverage = ''
        ,drvVisionCoverageStartDate = ''
        ,drvVisionCoverageStopDate = ''
        ,drvVisionReportNumber = ''
        ,drvVisionSubCode = ''
        ,drvVisionSubPoint = ''
        ,drvVisionMembersCovered = ''
