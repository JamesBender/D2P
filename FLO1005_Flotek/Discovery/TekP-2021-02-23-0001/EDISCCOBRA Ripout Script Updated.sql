...
Client ID:      FLO1005
Date/time:      2023-01-06 08:23:04.763
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EDISCCOBRA_20230106.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,',IAGFG,D66LG',NULL,NULL,NULL,'Discovery Cobra Export','202202019','EMPEXPORT','ONDEM_XOE',NULL,'EDISCCOBRA',NULL,NULL,NULL,'202202019','Jan 24 2021  1:23PM','Jan 24 2021  1:23PM','202201011',NULL,'','','202201011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','IAGFG',NULL,NULL,NULL,'WEX Cobra and NPM E-Sched','202102019','EMPEXPORT','SCH_EDISCC',NULL,'EDISCCOBRA',NULL,NULL,NULL,'202301049','Jan 24 2021  1:23PM','Jan 24 2021  1:23PM','202212281',NULL,'','','202012011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',',IAGFG,D66LG',NULL,NULL,NULL,'Discover Cobra and NPM E-Test','202301049','EMPEXPORT','TEST_XOE','Nov 28 2022 12:00AM','EDISCCOBRA',NULL,NULL,NULL,'202301049','Nov 28 2022 12:00AM','Dec 30 1899 12:00AM','202212281','3482','','','202212281',dbo.fn_GetTimedKey(),NULL,'us3cBeFLO1005',NULL);
...
Marie Waters        1/6/2023     TekP-2021-02-23-0001  Updated the logic inserts for scenarios
...
BEGIN
    ...
    SET @DedList = 'DEN,MED,MEDHD,VIS,FSA,FSALP,DFSA,M3,EAP'; 
...
-- from dbo.U_dsi_BDM_EDISCCOBRA X where BdmDedRowStatus IN ('Data Inserted for 204 Chg reason','Data Inserted for 201 Chg reason','Data Inserted for 210 Chg reason')
    ...
    JOIN (
            ...
            FROM (
                    ...
                    WHERE EdhDedCode IN ('DEN', 'MED', 'MEDHD', 'VIS', 'EAP') --Added EAP
    ...
    SELECT DISTINCT
        ...
        ,drvEventDate =       CASE WHEN eecEmplStatus = 'T' AND EecTermReason NOT IN ('202','203') THEN EecDateOfTermination
                            ...
                            WHEN BdmChangeReason IN ('LEVNT3','LEVNT4','204','210','201','302') THEN BdmBenStopDate
...
/*    JOIN dbo.U_dsi_BDM_EDISCCOBRA WITH (NOLOCK)
        ...
        AND BdmRunId = 'QB'*/
    JOIN (
           SELECT BdmEEID, BdmCOID, MAX(BdmBenStartDate) AS BdmBenStartDate, MAX(BdmDateOfCobraEvent) AS BdmDateOfCobraEvent , MAX(BdmBenStopDate) as BdmBenStopDate, MAX(BdmChangeReason) AS BdmChangeReason
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName =    CASE  WHEN BdmDedCode IN ('DEN')THEN 'Aetna Dental'
                                ...
                                WHEN BdmDedCode = 'DFSA' THEN 'WEX FSA'
                                WHEN BdmDedCode = 'EAP' THEN 'Magellan EAP'
                                WHEN BdmDedCode = 'VIS' THEN 'Ameritas Vision'    
                                WHEN BdmDedCode = 'M3' THEN 'WEX FSA'
                                --WHEN BdmDedCode = 'EAP' THEN 'Magellan EAP'  In twice
                        END
        ,drvCoverageLevel =    CASE 
                                WHEN BdmDedCode = 'EAP' THEN 'EE'
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName =    CASE WHEN BdmDedCode = 'M3' THEN 'WEX FSA'
                        --WHEN BdmDedCode = 'EAP' THEN 'Magellan EAP'
                        END
                        --CASE WHEN BdmDedCode = 'FSA' THEN 'DBI FSA'
                        --END
        ,drvRate = CASE WHEN BdmDedCode IN ('M3') THEN FORMAT(ISNULL(BdmEEAmt, 0.00), '#0.00') END  --'FSA', Removed
