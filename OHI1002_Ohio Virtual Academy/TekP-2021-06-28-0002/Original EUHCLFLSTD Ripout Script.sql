...
EUHCLFLSTD: UHC Life LTD STD GenNotic Exp

FormatCode:     EUHCLFLSTD
Project:        UHC Life LTD STD GenNotic Exp
Client ID:      OHI1002
Date/time:      2021-12-30 10:50:21.727
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    E32
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','SDF','EUHCLFLSTD','UHC Life LTD STD GenNotic Exp','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','434','S','N','EUHCLFLSTDZ0','N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUHCLFLSTD_20211230.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,'ODQ5S',NULL,NULL,NULL,'UHC Life LTD STD GenNotic Exp','202111259','EMPEXPORT','ONDEMAND','Dec  1 2021 12:00AM','EUHCLFLSTD',NULL,NULL,NULL,'202111259','Nov 25 2021 12:00AM','Dec 30 1899 12:00AM','202111191','2691','','','202111191',dbo.fn_GetTimedKey(),NULL,'JWANG',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,'ODQ5S',NULL,NULL,NULL,'Scheduled Session','201509259','EMPEXPORT','SCHEDULED','Dec 24 2021  7:00AM','EUHCLFLSTD',NULL,NULL,NULL,'202112239','Sep 25 2015 12:00AM','Dec 30 1899 12:00AM','202112171','2327','','','201509251',dbo.fn_GetTimedKey(),NULL,'MGROM01',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,'ODQ5S',NULL,NULL,NULL,'Test Purposes Only','202111229','EMPEXPORT','TEST','Dec  1 2021  1:11PM','EUHCLFLSTD',NULL,NULL,NULL,'202111229','Nov 22 2021 12:00AM','Dec 30 1899 12:00AM','202111221','4253','','','202111221',dbo.fn_GetTimedKey(),NULL,'JWANG',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUHCLFLSTD','ExportPath','V','\\us.saas\e0\data_exchange\OHI1002\Exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUHCLFLSTD','TestPath','V','\\us.saas\e3\Public\OHI1002\exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUHCLFLSTD','UseFileName','V','N');
...
Purpose: UHC Life LTD STD GenNotic Exp
...
BEGIN
    ...
    -- Required parameters
    INSERT INTO U_dsi_bdm_Configuration VALUES (@FormatCode, 'DedCodes', 'ERSTD,LIFEB,ADD,VLIF,LIFSP,LIFCH')    
    ...
    SELECT DISTINCT
        ...
        ,drvEedDedCode  = CASE WHEN EedDedCode = 'ERSTD' then 'C'
                        ...
                        END
        ,drvBenStrtDate = CASE
                                WHEN EedDedCode in ('ERSTD','LIFEB','ADD','VLIF','LIFSP','LIFCH') THEN EedBenStartDate ELSE NULL END
        ,drvBenStopDate = CASE WHEN EedDedCode in ('ERSTD','LIFEB','ADD','VLIF','LIFSP','LIFCH') THEN EedBenStopDate ELSE NULL END
        ,drvDateOfLastHire = EecDateOfLastHire
        ,drvDateStart = CASE WHEN EedDedCode in ('ERSTD','LIFEB','ADD','VLIF','LIFSP','LIFCH') THEN EedBenStartDate ELSE NULL END
        ...
        ,drvBeginDate = CASE WHEN EedDedCode in ('ERSTD','LIFEB','ADD','VLIF','LIFSP','LIFCH') THEN EedBenStartDate ELSE NULL END
        ,drvEEID = xEEID
        ,drvCoID = xCoID
        ,drvDepID = ''
--select * from U_dsi_bdm_EmpDeductions  where eedformatcode = 'EUHCLFLSTD'
    ...
    ConSystemID,ConGender,ConDateOfBirth,EedBenStartDate,EedBenStopDate,EedDedCode,EedBenAmt,DedEEBenAmt,EecDateOfLastHire,EecAnnSalary,EjhIsRateChange,xEEID,xCOID
