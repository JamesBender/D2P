...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EEVRYSTCOB_20210817.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Everything Benefits COBR-Test','202107241','EMPEXPORT','TEST_XOE','Jul 27 2021  6:50PM','EEVRYSTCOB',NULL,NULL,NULL,'202107241','Jul 24 2021 12:00AM','Dec 30 1899 12:00AM','202107101','2749','','','202107101',dbo.fn_GetTimedKey(),NULL,'us3cPeSTT1000',NULL);
...
BEGIN
   ...
   IF OBJECT_ID('U_EEVRYSTCOB_drvTbl','U') IS NOT NULL
    ...
    SELECT DISTINCT
        ...
        ,drvBenIsWaived = ''
        ,drvBenBaseCovAmt = 	CAST(CAST(CASE WHEN EedDedCode = 'BLD' AND EecAnnSalary < 100000 THEN ROUND(EecAnnSalary, 0)
