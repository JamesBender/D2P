...
GO
IF OBJECT_ID('U_EVOY401WDP_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_EVOY401WDP_AuditFields];
GO
IF OBJECT_ID('U_EVOY401WDP_Audit') IS NOT NULL DROP TABLE [dbo].[U_EVOY401WDP_Audit];
GO
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'XXXive Open Enrollment Export','201902049','EMPEXPORT','OEACTIVE',NULL,'EVOY401WDP',NULL,NULL,NULL,'201902049','Feb  4 2019 12:27PM','Feb  4 2019 12:27PM','201902041',NULL,'','','201902041',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'XXXsive Open Enrollment Export','201902049','EMPEXPORT','OEPASSIVE',NULL,'EVOY401WDP',NULL,NULL,NULL,'201902049','Feb  4 2019 12:27PM','Feb  4 2019 12:27PM','201902041',NULL,'','','201902041',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','LMJ6T',NULL,NULL,NULL,'XXXa Deferred Comp Census and','202102162','EMPEXPORT','ONDEMAND','Mar  3 2021 11:22AM','EVOY401WDP',NULL,NULL,NULL,'202102162','Feb 16 2021 12:00AM','Feb 10 2021 12:00AM','202102162','119','eecPayGroup','W','202102162',dbo.fn_GetTimedKey(),NULL,'ULTI_WPWDP',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'XXXt Purposes Only','202109219','EMPEXPORT','TEST','Sep 17 2021 12:35PM','EVOY401WDP',NULL,NULL,NULL,'202109219','Sep 21 2021 12:00AM','Dec 30 1899 12:00AM','202109151','1606','eecPayGroup','W','202109151',dbo.fn_GetTimedKey(),NULL,'us3jReWAS1010',NULL);
...
IF OBJECT_ID('U_EVOY401WDP_Audit') IS NULL
CREATE TABLE [dbo].[U_EVOY401WDP_Audit] (
...
IF OBJECT_ID('U_EVOY401WDP_AuditFields') IS NULL
CREATE TABLE [dbo].[U_EVOY401WDP_AuditFields] (
...
BEGIN
    ...
    DELETE EE
    FROM dbo.U_EVOY401WDP_EEList EE
    ...
    IF OBJECT_ID('U_EVOY401WDP_AuditFields','U') IS NOT NULL
        DROP TABLE dbo.U_EVOY401WDP_AuditFields;
    CREATE TABLE dbo.U_EVOY401WDP_AuditFields (aTableName VARCHAR(30),aFieldName VARCHAR(30));
    -- Employee Information
    INSERT INTO dbo.U_EVOY401WDP_AuditFields VALUES ('EmpComp','EecDateOfTermination');
    -- Create audit table based on fields defined above
    IF OBJECT_ID('U_EVOY401WDP_Audit','U') IS NOT NULL
        DROP TABLE dbo.U_EVOY401WDP_Audit;
    ...
    INTO dbo.U_EVOY401WDP_Audit
    FROM dbo.U_EVOY401WDP_EEList WITH (NOLOCK)
    JOIN dbo.vw_AuditData WITH (NOLOCK)
        ON xEEID = audKey1Value
    JOIN dbo.U_EVOY401WDP_AuditFields WITH (NOLOCK)
    ...
    -- Create Index
    CREATE CLUSTERED INDEX CDX_U_EVOY401WDP_Audit ON dbo.U_EVOY401WDP_Audit (audCOID, audEEID);
...
;
    ...
    SELECT DISTINCT
        ...
        ,drvPayrollCycle = CASE EecPayPeriod
                               ...
                               WHEN 'M' THEN '4'
                           END
        ,drvPayDate = (SELECT MAX(PdhPayDate) FROM dbo.U_EVOY401WDP_PDedHist WITH (NOLOCK))
        ,drvIRSCode = '401K'
        ,drvSSN = EepSSN
    ...
    WHERE (EecEmplStatus <> 'T' 
           OR PehAnniversaryHrs > 0
            OR (EecEmplStatus = 'T' AND EXISTS(SELECT 1 FROM dbo.U_EVOY401WDP_Audit WITH (NOLOCK) WHERE audEEID = xEEID AND audCOID = xcoid ) )) --Added 8/10/2010 KJM
...
WHERE expFormatCode = 'EVOY401WDP' AND EXPExportcode = 'TEST';
