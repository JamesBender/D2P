...
Client ID:      VEN1005
Date/time:      2022-03-14 13:28:11.213
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    NWP
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('22','EVENCOBPARZ0','50','D','10','22',NULL,'Current Date',NULL,NULL,'"drvCurrentDate"','(''UD112''=''T'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EVENCOBPAR_20220314.txt';
