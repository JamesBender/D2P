...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EFIDHSANUC_20210601.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','GQ166,IAGFG',NULL,NULL,NULL,'Fidelity 401K Part Exp - TEST','202106019','EMPEXPORT','TEST','Jun  1 2021  3:05PM','EFIDHSANUC',NULL,NULL,NULL,'202106019','Jun  1 2021 12:00AM','Dec 30 1899 12:00AM','202101011','1','','','202101011',dbo.fn_GetTimedKey(),NULL,'us3aPiNUC1003',NULL);
