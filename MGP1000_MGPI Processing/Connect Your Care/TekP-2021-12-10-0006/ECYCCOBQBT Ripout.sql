...
Client ID:      MGP1000
Date/time:      2022-01-20 14:56:46.823
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
BEGIN
    ...
    --==========================================
        ...
        SELECT DISTINCT
            ...
            ,drvPlanName      = CASE WHEN BdmDedCode IN ('MEDA1', 'MEDLB') THEN 'Medical HDHP'
                                     WHEN BdmDedCode IN ('MEDAT', 'MEDL2') THEN 'Medical PPO'
