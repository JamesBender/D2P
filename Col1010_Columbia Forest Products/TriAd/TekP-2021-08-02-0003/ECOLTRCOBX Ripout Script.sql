...
Client ID:      COL1010
Date/time:      2021-12-30 10:07:14.703
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    E11
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECOLTRCOBX_20211230.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',',60DZM,603MK,60DVD,60DPK,P34RH',NULL,NULL,NULL,'TriAD Flex Expor-Sched','202112279','EMPEXPORT','SCH_ECOLTR','Oct  8 2021  3:18PM','ECOLTRCOBX',NULL,NULL,NULL,'202112279','Oct  3 2021  2:13PM','Oct  3 2021  2:13PM','202112271','11','','','202112271',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','60DZM,603MK,60DVD,60DPK,P34RH',NULL,NULL,NULL,'TriAD Flex Expor-Test','202112071','EMPEXPORT','TEST_XOE','Dec 30 2021 10:06AM','ECOLTRCOBX',NULL,NULL,NULL,'202112071','Dec  7 2021 12:00AM','Nov 27 2021 12:00AM','202111011','93','','','202111011',dbo.fn_GetTimedKey(),NULL,'us3cPeCOL1010',NULL);
...
INSERT INTO [dbo].[U_dsi_BDM_ECOLTRCOBX]
    ...
    */
            ...
            Update dbo.U_dsi_BDM_ECOLTRCOBX  
            set bdmNumSpouses = (select count(*) from U_dsi_BDM_ECOLTRCOBX A where A.bdmeeid = X.bdmeeid and bdmRelationship = 'SPS' and A.bdmcoid = X.bdmcoid)
            ,bdmNumChildren = (select count(*) from U_dsi_BDM_ECOLTRCOBX A where A.bdmeeid = X.bdmeeid and bdmRelationship = 'CHL' and A.bdmcoid = X.bdmcoid)
