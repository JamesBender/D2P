...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EVOYAACIHE_20210112.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N',',JO25E',NULL,NULL,NULL,'Voya Acc/Crit-Ill/Hosp E-Sched','202012199','EMPEXPORT','SCH_EVOYAA','Nov 11 2020  5:29PM','EVOYAACIHE',NULL,NULL,NULL,'202101089','Nov 11 2020  4:08PM','Nov 11 2020  4:08PM','202101011','1800','','','202012191',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Voya Acc/Crit-Ill/Hosp E-Test','202101081','EMPEXPORT','TEST_XOE','Jan  8 2021  9:52AM','EVOYAACIHE',NULL,NULL,NULL,'202101081','Jan  8 2021 12:00AM','Dec 30 1899 12:00AM','202101021','2067','','','202101021',dbo.fn_GetTimedKey(),NULL,'us3cPePOW1008',NULL);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvInsuredSSN =    CASE WHEN BdmRecType = 'EMP' THEN eepSSN 
                                ELSE CASE WHEN ConSSN IN ('000000000','999999999','888888888','123456789', '111111111') OR LEFT(ConSSN, 3) IN ('999','998') THEN '' ELSE ConSSN END
                            END
