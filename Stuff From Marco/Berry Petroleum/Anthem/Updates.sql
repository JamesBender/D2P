...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EANTLIFEXP_20200416.txt',NULL,'','',NULL,NULL,NULL,NULL,'Anthem VOL Plans Export','202003129','EMPEXPORT','ONDEMAND',NULL,'EANTLIFEXP',NULL,NULL,NULL,'202003129','Mar 12 2020  3:24PM','Mar 12 2020  3:24PM','202003121',NULL,'','','202003121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EANTLIFEXP_20200416.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','202003129','EMPEXPORT','SCH_ANTXP','Mar 16 2020  4:47PM','EANTLIFEXP',NULL,NULL,NULL,'202003129','Mar 12 2020  3:24PM','Mar 12 2020  3:24PM','202003121','8362','','','202003121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EANTLIFEXP_20200416.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','202003129','EMPEXPORT','OEACTIVE',NULL,'EANTLIFEXP',NULL,NULL,NULL,'202003129','Mar 12 2020  3:24PM','Mar 12 2020  3:24PM','202003121',NULL,'','','202003121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EANTLIFEXP_20200416.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','202003129','EMPEXPORT','OEPASSIVE',NULL,'EANTLIFEXP',NULL,NULL,NULL,'202003129','Mar 12 2020  3:24PM','Mar 12 2020  3:24PM','202003121',NULL,'','','202003121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EANTLIFEXP_20200416.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202004099','EMPEXPORT','TEST','Apr  9 2020  1:00PM','EANTLIFEXP',NULL,NULL,NULL,'202004099','Apr  9 2020 12:00AM','Dec 30 1899 12:00AM','202003261','6578','','','202003261',dbo.fn_GetTimedKey(),NULL,'us3lKiBER1020',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EANTLIFEXP_20200416.txt' END WHERE expFormatCode = 'EANTLIFEXP';
...
CREATE TABLE [dbo].[U_EANTLIFEXP_drvMember] (
    ...
    [drvMemDeptNumber] varchar(1) NOT NULL,
    ...
    [drvMemSubsCvgAmt] varchar(30) NULL,
...
BEGIN
    ...
    SET @DedList = 'ACCD,CILLC,CILLF,CILLD,CILLE,GLIFE,HOSP,LTD,STD,VCL,VOL,VSL';
    ...
    SELECT DISTINCT
        ...
        ,drvMemRelCode = dbo.dsi_fnRemoveChars('.,/-',
                              CASE WHEN BdmRecType = 'EMP' THEN 'SUB'
                                   ...
                                   CASE WHEN ConRelationship in ('SPS', 'DP') THEN 'SPS'
                                         WHEN ConRelationship in ('CHL', 'DPC','STC' ) THEN 'CHD'
                                         WHEN ConRelationship in ('DIS' ) THEN 'HCH'
                                    END
                              END)
        ,drvMemFiller1 = ''
        ,drvMemCovEffDat = bdmBenStartDate
        ...
        ,drvMemZipCode = LEFT(5,EepAddressZipCode)
        ,drvMemZipCodePlus4 = ''
        ,drvMemZipCodePlus2 = ''
        ...
        ,drvMemSalMulti = CONVERT(VARCHAR,dbo.dsi_fnPadZero((CASE WHEN BdmdedCode in ('GLIFE') THEN 2
                          ...
                          END                          ) *100,5,0))
        ,drvMemSubsCvgAmt = CASE WHEN bdmdedcode in ('VOL','VSL','VCL') THEN  CONVERT(VARCHAR,dbo.dsi_fnPadZero(CAST (BdmUSGField1 as money) *100,11,0))
                           END  
        ,drvMemFiller9 = ''
        ,drvMemFiller10 = ''
        ...
        ,drvMemPreExEffDate = ''
        ,drvMemCoordBenefits = ''
        ,drvMemDisableInd = CASE WHEN ConRelationship in ('CHL','DPC','CHD','STC') and ConIsDisabled = 'Y' THEN 'Y' ELSE  'N' END
        ,drvMemCobraInd = ''
    ...
    SELECT DISTINCT
        ...
        ,drvSPEGRPNbrSfx =  '' /*(CASE WHEN bdmDedcode in ('ACCD') THEN '282032X001'
                           ...
                           END*/
        ,drvSPEActionCd = ''
        ,drvSPERelInd =  CASE WHEN bdmDedcode in ('ACCD') THEN '282032X001'
                                WHEN bdmDedcode in ('CILLC', 'CILLF', 'CILLD', 'CILLE') THEN '282032Y001'
                                WHEN bdmDedcode in ('HOSP') THEN '282032Z001'
                                WHEN bdmDedcode in ('STD') THEN '282032W001'
                                WHEN bdmDedcode in ('LTD') THEN '282032L001'
        ...
        ,drvSPEGender = dbo.dsi_fnRemoveChars('.,/-',
                              CASE WHEN BdmRecType = 'EMP' THEN EepGender
                                   WHEN BdmRecType = 'DEP' THEN ConGender
                              END)
        ,drvSPEBenChangeEffDate = dbo.dsi_fnGetMinMaxDates('MAX',BdmBenStartDate, dbo.dsi_fnlib_GetAnnSalary_EffDate_WithStartDate(EecEEID, EecCOID, bdmbenstartdate,EecDateOfLastHire)) 
        ,drvSPESalMultiSps = ''
        ,drvSPESPSCovAmt = CASE WHEN BdmDedcode in ('VSL') then CONVERT(VARCHAR,dbo.dsi_fnPadZero(CAST (BdmUSGField1 as money) *100,11,0))   end
        ,drvSPEChlCovAmt = CASE WHEN BdmDedcode in ('VCL') then  CONVERT(VARCHAR,dbo.dsi_fnPadZero(CAST (BdmUSGField1 as money) *100,11,0)) end
        ,drvSPEFiller1 = ''
    ...
    set drvSPEGrpNbr =  CASE WHEN VCL = '1' and VSL = '0' THEN '282032S002'
                                ...
                                WHEN VCL = '0' and VSL = '0' THEN '282032S001'
                            END
        ,drvSPESPSCovAmt = CASE WHEN VSL = '1' THEN  CONVERT(VARCHAR,dbo.dsi_fnPadZero(CAST (BdmUSGField1 as money) *100,11,0)) END
        ,drvSPEChlCovAmt = CASE WHEN VCL = '1' THEN  CONVERT(VARCHAR,dbo.dsi_fnPadZero(CAST (BdmUSGField1 as money) *100,11,0)) END
...
SELECT DISTINCT
        ...
        ,drvSPEFiller1 
    FROM dbo.U_EANTLIFEXP_drvSpecialty
        Where drvSPEGrpNbr In ('282032B001','282032S001','282032S002','282032SF01')
