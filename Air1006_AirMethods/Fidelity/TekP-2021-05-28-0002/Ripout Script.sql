...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EFIDCON2_20210909.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,'FR95C,N7GY3,WO2AC,RIOOJ,H4VKS,0Y1AJ',NULL,NULL,NULL,'Fidelity 401k Payroll - TEST','202109031','EMPEXPORT','TEST','Sep  1 2021  5:29PM','EFIDCON2',NULL,NULL,NULL,'202109031','Sep  3 2021 12:00AM','Aug 28 2021 12:00AM','202109031','4218','eecPayGroup','PLTHH,BLUEHI,BWXMPT,BWMECH,BWMED,BWNXMT,BWPLT,SUNDNC,BWUR','202109031',dbo.fn_GetTimedKey(),NULL,'us3lKiAIR1006',NULL);
...
END
GO
CREATE PROCEDURE [dbo].[dsi_sp_BuildDriverTables_EFIDCON2] @SystemID VARCHAR(15) = NULL
AS
/************************************************************
...
dsi_sp_testswitchbox 'EFIDCON2', 'ON_DEMAND'
dsi_sp_testswitchbox 'EFIDCON2', 'ZAP'
dsi_sp_testswitchbox 'EFIDCON2', 'TEST'
