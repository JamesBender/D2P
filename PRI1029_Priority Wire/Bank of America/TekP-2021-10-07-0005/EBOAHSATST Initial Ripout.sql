...
>>>>>> NOTE: this ripout is cloned from EBOAHSA


EBOAHSATST: Bank of America HSA

FormatCode:     EBOAHSATST
Project:        Bank of America HSA
Client ID:      PRI1029
Date/time:      2021-12-18 16:45:51.990
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    NWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EBOAHSATST_20211218.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,NULL,'Test Purposes Only','202101159','EMPEXPORT','TEST','Jan 19 2021 11:10AM','EBOAHSATST',NULL,NULL,NULL,'202101159','Jan 15 2021 12:00AM','Dec 30 1899 12:00AM','202101151','1858',NULL,NULL,'202101151',dbo.fn_GetTimedKey(),NULL,'ULTI_WPPWC',NULL);
...
EXEC dbo._dsi_usp_ExportRipOut @FormatCode = 'EBOAHSATST', @AllObjects = 'Y', @IsWeb = 'Y'
**********************************************************************************/
BEGIN
...
WHERE AdfHeaderSystemID LIKE 'EBOAHSATST%'
