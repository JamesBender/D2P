USE [ULTIPRO_LUIGI]
GO
/****** Object:  StoredProcedure [dbo].[dsi_sp_BuildDriverTables_EMILTEN834]    Script Date: 11/9/2023 12:13:45 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    ***************************************************************************************************************/
    ...
    SELECT DISTINCT
        ...
        ,drvREF02_RefNumberQual1 = CASE WHEN xCoid = 'MNA1' and eepAddressState = 'LA' THEN '0636891001   DPP02'
                                            WHEN xCoid = 'MNA1' and EepAddressState = 'TX' THEN '0636891001   DENT'
                                            WHEN xCoid = 'MNA1' and EepAddressState not in ('LA','TX') THEN '0636891001   DPP01'
                                            WHEN xCoid = 'OUS1' and EepAddressState = 'LA' THEN '0636891002   DPP02'
                                            WHEN xCoid = 'OUS1' and EepAddressState = 'TX' THEN '0636891002   DENT'
                                            WHEN xCoid = 'OUS1' and EepAddressState not in ('LA','TX') THEN '0636891002   DPP01'
                                            WHEN xCoid = 'BUS1' and EepAddressState = 'LA' THEN '0636891003   DPP02'
                                            WHEN xCoid = 'BUS1' and EepAddressState = 'TX' THEN '0636891003   DENT'
                                            WHEN xCoid = 'BUS1' and EepAddressState not in ('LA','TX') THEN '0636891003   DPP01'
                                            WHEN xCoid = 'LUS1' and EepAddressState = 'LA' THEN '0636891004   DPP02'
                                            WHEN xCoid = 'LUS1' and EepAddressState = 'TX' THEN '0636891004   DENT'
                                            WHEN xCoid = 'LUS1' and EepAddressState not in ('LA','TX') THEN '0636891004   DPP01'
                                        END
        -- If drvREF01_RefNumberQual2 is Populated, then send REF Segment
