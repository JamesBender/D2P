...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELINFINEXP_20191112.txt',NULL,'','',NULL,NULL,NULL,NULL,'Lincoln Financial Export','201911089','EMPEXPORT','ONDEMAND',NULL,'ELINFINEXP',NULL,NULL,NULL,'201911089','Nov  8 2019 11:11AM','Nov  8 2019 11:11AM','201911081',NULL,'','','201911081',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELINFINEXP_20191112.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','201911089','EMPEXPORT','TEST',NULL,'ELINFINEXP',NULL,NULL,NULL,'201911089','Nov  8 2019 11:11AM','Nov  8 2019 11:11AM','201911081',NULL,'','','201911081',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELINFINEXP_20191112.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','201911089','EMPEXPORT','OEPASSIVE',NULL,'ELINFINEXP',NULL,NULL,NULL,'201911089','Nov  8 2019 11:11AM','Nov  8 2019 11:11AM','201911081',NULL,'','','201911081',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELINFINEXP_20191112.txt',NULL,'','','',NULL,NULL,NULL,'Active Open Enrollment Export','201911089','EMPEXPORT','OEACTIVE','Nov 11 2019 12:00AM','ELINFINEXP',NULL,NULL,NULL,'201911089','Nov  8 2019 12:00AM','Dec 30 1899 12:00AM','201911081',NULL,'','','201911081',dbo.fn_GetTimedKey(),NULL,'us3jBeDIA1002',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELINFINEXP_20191112.txt',NULL,'','',NULL,NULL,NULL,NULL,'Scheduled Session','201911089','EMPEXPORT','SCHEDULED','Nov 11 2019 12:00AM','ELINFINEXP',NULL,NULL,NULL,'201911089','Nov  8 2019 12:00AM','Dec 30 1899 12:00AM','201911081',NULL,'','','201911081',dbo.fn_GetTimedKey(),NULL,'us3jBeDIA1002',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_ELINFINEXP_20191112.txt' END WHERE expFormatCode = 'ELINFINEXP';
...
CREATE TABLE [dbo].[U_ELINFINEXP_drvTbl] (
    ...
    [drvLiCvgs] money NULL,
    [drvLiTerminationDate] datetime NULL,
    [drvAdCvgs] money NULL,
    ...
    [drvWiPlanCode] int NULL,
    [drvWiClassCode] int NULL,
    [drvWiCvgs] money NULL,
    ...
    [drvLtdPlanCode] int NULL,
    [drvLtdClassCode] int NULL,
    [drvLtdCvgs] money NULL,
    ...
    [drvDepRelationshipCode1] char(1) NULL,
    [drvDepStudentCode1] varchar(1) NULL,
    [drvDepDisabledYN1] char(1) NULL,
    [drvDepCvgIndicator1] varchar(1) NOT NULL,
    ...
    [drvDepRelationshipCode2] char(1) NULL,
    ...
    [drvDepRelationshipCode3] char(1) NULL,
    ...
    [drvDepRelationshipCode4] char(1) NULL,
    ...
    [drvDepRelationshipCode5] char(1) NULL,
    ...
    [drvDepRelationshipCode6] char(1) NULL,
    ...
    [drvDepRelationshipCode7] char(1) NULL,
    ...
    [drvDepRelationshipCode8] char(1) NULL,
    ...
    [drvDepRelationshipCode9] char(1) NULL,
    ...
    [drvDepRelationshipCode10] char(1) NULL,
    ...
    [drvDepRelationshipCode11] char(1) NULL,
    [drvDepStudentCode11] varchar(1) NULL,
    [drvDepDisabledYN11] char(1) NULL,
    [drvDepCvgIndicator11] varchar(1) NOT NULL,
    ...
    [drvDepRelationshipCode12] char(1) NULL,
    [drvDepStudentCode12] varchar(1) NULL,
    [drvDepDisabledYN12] char(1) NULL,
    [drvDepCvgIndicator12] varchar(1) NOT NULL,
    ...
    [drvDepRelationshipCode13] char(1) NULL,
    [drvDepStudentCode13] varchar(1) NULL,
    [drvDepDisabledYN13] char(1) NULL,
    [drvDepCvgIndicator13] varchar(1) NOT NULL,
    ...
    [drvDepRelationshipCode14] char(1) NULL,
    [drvDepStudentCode14] varchar(1) NULL,
    [drvDepDisabledYN14] char(1) NULL,
    [drvDepCvgIndicator14] varchar(1) NOT NULL,
    ...
    [drvDepRelationshipCode15] char(1) NULL,
    [drvDepStudentCode15] varchar(1) NULL,
    [drvDepDisabledYN15] char(1) NULL,
    [drvDepCvgIndicator15] varchar(1) NOT NULL,
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvDepChangeDate = bdmBenStartDate
        ,drvTerminationDate = CASE WHEN EecEmplStatus = 'T' THEN bdmBenStopDate END -- EecDateOfTermination END ???
        ...
        ,drvLiCvgs = CASE WHEN BdmDedCode = 'BLIFE' THEN  BdmEEAmt  ELSE '' END -- ??? Is this the right Amount field?       
        ,drvLiTerminationDate = CASE WHEN BdmDedCode = 'BLIFE' THEN BdmBenStopDate END       
        ,drvAdCvgs = CASE WHEN BdmDedCode = 'BLIFE' THEN BdmEEAmt END -- ??? Is this the right Amount field?
        ,drvAdTerminationDate = CASE WHEN BdmDedCode = 'BLIFE' THEN BdmBenStopDate END
        ,drvDliCvgs = ''
        ...
        ,drvWiTerminationDate = CASE WHEN BdmDedCode = 'STD' THEN BdmBenStopDate END
        ,drvOwiCvgs = ''
        ...
        ,drvLtdTerminationDate = CASE WHEN BdmDedCode = 'LTD' THEN BdmBenStopDate END
        ,drvOltdCvgs = ''
        ...
        ,drvDentCoverageCode =    CASE WHEN BdmDedCode IN ('DEN1', 'DEN2') THEN -- ??? This should be coverage tier
                                ...
                                END
        ,drvDentOtherIns = 'U'
        ,drvDentTerminationDate = CASE WHEN BdmDedCode IN ('DEN1', 'DEN2') THEN FORMAT(BdmBenStopDate, 'MM/dd/YYYY') END
        ,drvDhmoPolicyNumber = ''
        ...
        -- Dependatnt Start
        ,drvDepFirstName1 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName1 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial1 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender1 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth1 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode1 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode1 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN1 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator1 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp1 = ''  
-- Dep Start
        ,drvDepFirstName2 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName2 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial2 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender2 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth2 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode2 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode2 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN2 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator2 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp2 = ''   
        ,drvDepFirstName3 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName3 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial3 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender3 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth3 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode3 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode3 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN3 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator3 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp3 = ''   
        ,drvDepFirstName4 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName4 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial4 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender4 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth4 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode4 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode4 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN4 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator4 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp4 = ''   
        ,drvDepFirstName5 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName5 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial5 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender5 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth5 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode5 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode5 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN5 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator5 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp5 = ''   
        ,drvDepFirstName6 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName6 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial6 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender6 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth6 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode6 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode6 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN6 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator6 = '' -- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp6 = ''   
        ,drvDepFirstName7 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName7 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial7 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender7 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth7 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode7 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode7 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN7 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator7 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp7 = ''   
        ,drvDepFirstName8 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName8 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial8 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender8 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth8 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode8 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode8 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN8 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator8 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp8 = ''   
        ,drvDepFirstName9 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName9 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial9 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender9 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth9 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode9 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode9 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN9 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator9 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp9 = ''   
        ,drvDepFirstName10 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName10 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial10 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender10 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth10 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode10 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode10 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN10 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator10 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp10 = ''   
        ,drvDepFirstName11 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName11 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial11 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender11 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth11 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode11 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode11 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN11 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator11 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp11 = ''   
        ,drvDepFirstName12 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName12 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial12 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender12 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth12 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode12 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode12 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN12 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator12 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp12 = ''   
        ,drvDepFirstName13 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName13 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial13 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender13 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth13 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode13 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode13 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN13 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator13 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp13 = ''   
        ,drvDepFirstName14 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName14 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial14 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender14 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth14 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode14 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode14 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN14 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator14 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp14 = ''   
        ,drvDepFirstName15 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepLastName15 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConNameLast from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepMiddleInitial15 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ISNULL(LEFT(ConNameMiddle, 1), '') from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepGender15 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDateOfBirth15 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode15 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConGender from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepStudentCode15 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN15 = CASE WHEN BdmDedCode in (Select Code from @DedBenCodes) THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator15 = '' ----- ??? Need Maros help w/ spec   
        ,drvDedDhmoPcp15 = ''   
-- Dep End
        -- Dependant End
    ...
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    JOIN dbo.U_dsi_BDM_ELINFINEXP WITH (NOLOCK) -- ??? no table
        ON BdmEEID = xEEID 
        AND BdmCoID = xCoID
