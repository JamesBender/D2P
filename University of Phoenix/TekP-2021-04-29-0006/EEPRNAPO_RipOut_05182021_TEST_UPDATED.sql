...
Date/time:     2021-05-18 12:03:51.237
Client ID:     APO1003
FormatCode:    EEPRNAPO
...
ExportPath:    \\us.saas\n0\data_exchange\APO1003\Export\
TestPath:      \\US.SAAS\n2\APO1003\APO1003\Exports\Empyrean\
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Empyrean Export','201909059','EMPEXPORT','TEST','Sep  5 2019  7:40PM','EEPRNAPO',NULL,NULL,NULL,'201909059','Sep  5 2019 12:00AM','Dec 30 1899 12:00AM','201905301','12980','','','201905301',dbo.fn_GetTimedKey(),NULL,'PAMBROSE',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EEPRNAPO','ExportPath','V','\\us.saas\n0\data_exchange\APO1003\Export\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EEPRNAPO','TestPath','V','\\US.SAAS\n2\APO1003\APO1003\Exports\Empyrean\');
...
CREATE TABLE [dbo].[U_EEPRNAPO_drvTblD10] (
	...
	drvReasonCodeAttr varchar(50) NULL,
...
--ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ drvFTPTATTREFFDATE Field 37
        ,drvFTPTATTREFFDATE = CASE WHEN FTPTEffDate > lstFTPTINDICATOREFFDATE THEN FTPTEffDate
                                   ...
                                   ELSE GETDATE() 
                                   END
		,drvReasonCodeAttr = CASE WHEN EecEmplStatus = 'T' THEN EecTermReason 
									WHEN EecEmplStatus = 'A' AND em.EejIsPrimaryJob = 'N' AND em.EejJobCode NOT IN ('999999', 'AA088') AND sj.Employment_UPSecondaryJobTerminationDate <> '' THEN sj.Employment_UPSecondaryJobActionReason 
									END
		,drvReasonEffDate = CASE WHEN EecEmplStatus = 'T' THEN EecDateOfTermination 
									WHEN EecEmplStatus = 'A' AND em.EejIsPrimaryJob = 'N' AND em.EejJobCode NOT IN ('999999', 'AA088') AND sj.Employment_UPSecondaryJobTerminationDate <> '' THEN sj.Employment_UPSecondaryJobTerminationDate 
								END
