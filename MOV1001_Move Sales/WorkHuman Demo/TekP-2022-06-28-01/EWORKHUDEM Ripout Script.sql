...
Client ID:      MOV1001
Date/time:      2022-07-11 04:57:21.110
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    N33
...
/*08*/ DECLARE @FileName varchar(1000) = 'EWORKHUDEM_20220711.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','PPEYL,PJ6ZD,OG4IV,NR767,R4GFV',NULL,NULL,NULL,'Work Human Demo Export-Sched','202203049','EMPEXPORT','SCH_EWORKH',NULL,'EWORKHUDEM',NULL,NULL,NULL,'202207069','Mar  4 2022  2:32PM','Mar  4 2022  2:32PM','202206221',NULL,'','','202203041',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
