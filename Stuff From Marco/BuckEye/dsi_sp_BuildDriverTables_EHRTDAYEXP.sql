...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EMETPLALIF_20210326.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202103251','EMPEXPORT','TEST','Mar 25 2021 12:00AM','EMETPLALIF',NULL,NULL,NULL,'202103251','Mar 25 2021 12:00AM','Dec 30 1899 12:00AM','202103111','511','','','202103111',dbo.fn_GetTimedKey(),NULL,'us3cPePLA1016',NULL);
...
BEGIN
    ...
    */
    ...
    SELECT DISTINCT
        ...
        ,drvCustomerNumber = CASE WHEN BasicLife_Code is not null or SupSpouseADD_Code is not null or SupChildADD_Code is not null or SupBasicADD_Code is not null
        ...
        ,drvBenefitAmount19 = CASE WHEN CritIllness_Code IS NOT NULL  and BdmRecType = 'EMP' THEN dbo.dsi_fnpadzero((ISNULL((Select max(CritIllness_BdmBenAmount) from U_EMETPLALIF_Consolidated C  where C.bdmeeid = bdmeeid),0)),8,0)  END
        ...
        ,drvBenefitAmount20 = CASE WHEN CritIllnessDep_Code IS NOT NULL THEN dbo.dsi_fnpadzero((ISNULL((Select max(CritIllnessDep_BdmBenAmount) from U_EMETPLALIF_Consolidated C  where C.bdmeeid = bdmeeid),0)),8,0)  END
