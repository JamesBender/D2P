...
ESUNLIFE: Sunlife XML Export V2

FormatCode:     ESUNLIFE
Project:        Sunlife XML Export V2
Client ID:      REF1001
Date/time:      2022-08-19 08:52:16.310
Ripout version: 7.4
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','ESUNLIFE','Sunlife XML Export V2','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','3000','S','N','ESUNLIFE00Z0','N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N');
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','202208169','EMPEXPORT','SCHEDULED','Aug 17 2022 11:01AM','ESUNLIFE',NULL,NULL,NULL,'202208169','Apr 15 2019  5:15PM','Apr 15 2019  5:15PM','202208101',NULL,'','','202208101',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\E4\Public\REF1001\Exports\Sunlife\ESUNLIFE_20211019.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','202207129','EMPEXPORT','TEST','Aug 19 2022 12:00AM','ESUNLIFE',NULL,NULL,NULL,'202207129','Jul 12 2022 12:00AM','Dec 30 1899 12:00AM','202207061','4200','','','202207061',dbo.fn_GetTimedKey(),NULL,'JBENDER10',NULL);
...
UPDATE dbo.U_dsi_Configuration SET CfgValue = '\\us.saas\e4\Public\REF1001\Exports\Sunlife\' WHERE FormatCode='ESUNLIFE' AND CfgName='ExportPath';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'ESUNLIFE', 'TEST';
UPDATE dbo.U_dsi_Configuration SET CfgValue = '\\us.saas\E0\data_exchange\REF1001\Exports\' WHERE FormatCode='ESUNLIFE' AND CfgName='ExportPath';
...
EXEC dbo._dsi_usp_ExportRipOut_v7_4 @FormatCode = 'ESUNLIFE', @AllObjects = 'Y', @IsWeb = 'N'
**********************************************************************************/
BEGIN
...
*/
        ...
        'ApplyDate="' + ISNULL(CASE WHEN EXISTS(SELECT * FROM dbo.U_ESUNLIFE_Audit WITH (NOLOCK) WHERE AudEEID = xEEID AND AudFieldName = 'EecEmplStatus' AND AudOldValue IS NULL AND AudNewValue = 'A' AND AudEEID = xEEID) THEN 
                                    LEFT(CONVERT(VARCHAR(8),EecDateOfLastHire, 112), 4) + '-' + SUBSTRING(CONVERT(VARCHAR(8),EecDateOfLastHire, 112), 5, 2) + '-' + SUBSTRING(CONVERT(VARCHAR(8),EecDateOfLastHire, 112), 7, 2)  --Add
                                        ...
                                        WHEN EXISTS(SELECT * FROM dbo.U_ESUNLIFE_Audit WITH (NOLOCK) WHERE AudEEID = xEEID AND AudFieldName = 'EecEmplStatus' AND ISNULL(AudOldValue, '') IN ('T') AND ISNULL(AudNewValue, '') = 'A') THEN 
                                        ...
                                        WHEN EXISTS(SELECT * FROM dbo.U_ESUNLIFE_Audit WITH (NOLOCK) WHERE AudEEID = xEEID AND AudFieldName = 'EecEmplStatus' AND ISNULL(AudOldValue, '') IN ('R') AND ISNULL(AudNewValue, '') = 'A') THEN 
