...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISCCOBRA_20210406.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N','V5C6H,V5C45',NULL,NULL,NULL,'Discovery COBRA','202011139','EMPEXPORT','SCH_DISC','Nov 19 2020 12:00AM','EDISCCOBRA',NULL,NULL,NULL,'202104029','Nov 13 2020 12:00AM','Dec 30 1899 12:00AM','202103261',NULL,'','','202011061',dbo.fn_GetTimedKey(),NULL,'us3lKiUSO1001A',NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','V5C6H,V5C45',NULL,NULL,NULL,'Test NPM/Cobra Export','202102219','EMPEXPORT','TEST','Feb 21 2021  5:53PM','EDISCCOBRA',NULL,NULL,NULL,'202102219','Feb 21 2021 12:00AM','Dec 30 1899 12:00AM','202102011','56','','','202102011',dbo.fn_GetTimedKey(),NULL,'us3lKiUSO1001A',NULL);
 ...
 ---------------------------------
    ...
    SELECT DISTINCT
        ...
        ,drvSPMBillEndDate = CASE 
                                    WHEN EecEmplStatus = 'T' THEN DateAdd(Day,30,bdmBenStopDate )
                                    WHEN EecEmplStatus = 'A' and  EmpStatus = 'L' then (select Max(EshStatusStopDate) from EmpHStat where esheeid = xeeid) 
                            END
