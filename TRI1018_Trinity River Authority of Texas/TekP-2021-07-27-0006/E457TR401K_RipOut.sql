...
/*08*/ DECLARE @FILENAME varchar(1000) = 'E457TR401K_20210827.txt';
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvPartSSN = EepSSN
        ,drvLoanRepAmt = CASE WHEN PdhDedCode IN ('BDC1', 'BDC2', 'BDC3', 'BDC4',
									'BDC5', 'BDC6', 'BDC7', 'BDC8', 'BDC9', 'BDC10', 'BDC11',
									'BDC12', 'BDC13', 'BDC14', 'BDC15', 'BDC16', 'BDC17', 'BDC18',
									'BDC19', 'BDC20', 'BDC21', 'BDC22', 'BDC23', 'BDC24', 'BDC25',
									'BDC26', 'BDC27', 'BDC28', 'BDC29', 'BDC30') THEN RIGHT('0000000000' + REPLACE(CAST(PdhEECurAmt AS VARCHAR), '.', ''), 10) END
        ,drvFiller2 = ''
