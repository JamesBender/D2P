...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCreateTClockBatches,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhPreProcessSQL,AdhRecordSize,AdhRespectZeroPayRate,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhThirdPartyPay) VALUES ('N','C','Y','0','',NULL,'','N','','N','','013010','EMPEXPORT','CDE','EUNUMDREXP','UNUM LTD STD Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','dbo.dsi_sp_Switchbox_v2','5000','N','S','N','EUNUMDREXPZ0','N','Jan  1 1900 12:00AM','C','N');
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EUNUMDREXP_20210727.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'UNUM LTD STD Export-Test','202107269','EMPEXPORT','TEST_XOE',NULL,'EUNUMDREXP',NULL,NULL,NULL,'202107269','Jul 26 2021  4:24PM','Jul 26 2021  4:24PM','202107261',NULL,'','','202107261',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUNUMDREXP','EEList','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUNUMDREXP','ExportPath','V','\\ez2sup4db01\ultiprodata\[Name]\Exports\');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUNUMDREXP','Testing','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUNUMDREXP','UseFileName','V','N');
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvSickPayHrs = '0'
        ,drvDtLastSalChg = dbo.dsi_fnlib_GetAnnSalary_EffDate_WithStartDate(EecEEID, EecCOID, '01/01/2010',EecDateOfLastHire) 
        ...
        ,drvWrkSat = 'N'
        ,drvOfficeNm = 'Drift'
        ,drvEmpWorkMailStreetAdd1 = (SELECT TOP 1 LocAddressline2 FROM dbo.Location WITH(NOLOCK) WHERE LocCode = EecLocation)
        ,drvEmpWorkMailStreetAdd2 = (SELECT TOP 1 LocAddressline1 FROM dbo.Location WITH(NOLOCK) WHERE LocCode = EecLocation)
        ...
        ,drvEarnings1 = CASE WHEN YEAR(EecDateOfLastHire) < YEAR(GETDATE()) THEN  
                                CASE WHEN STD IS NOT NULL THEN CAST(CONVERT(DECIMAL(10,2), Peh.PehCurAmt / 52) AS VARCHAR) END 
                            WHEN YEAR(EecDateOfLastHire) = YEAR(GETDATE()) THEN
                                CASE WHEN STD IS NOT NULL THEN CAST(CONVERT(DECIMAL(10,2), ((EecAnnSalary + EecUDField09 + EecUDField10) / 52)) AS VARCHAR) END
                            END
        ,drvEarningsPrd1 = CASE WHEN STD IS NOT NULL THEN 'WK' END
        ,drvEffDtOfEmpCov1 = CASE WHEN STD IS NOT NULL THEN STD_BenStartDate END
        ...
        ,drvEarnings2 = CASE WHEN YEAR(EecDateOfLastHire) < YEAR(GETDATE()) THEN
                                CASE WHEN STD IS NOT NULL AND EepAddressState = 'MA' THEN CAST(CONVERT(DECIMAL(10,2), ((EecAnnSalary + PehB.PehCurAmt) / 52)) AS VARCHAR) END
                            WHEN YEAR(EecDateOFLastHire) = YEAR(GETDATE()) THEN 
                                CASE WHEN STD IS NOT NULL AND EepAddressState = 'MA' THEN CAST(CONVERT(DECIMAL(10,2), ((EecAnnSalary + PehB.PehCurAmt) / 52)) AS VARCHAR) END
                            END
        ,drvEarningsPrd2 = CASE WHEN STD IS NOT NULL AND EepAddressState = 'MA' THEN 'WK' END
        ,drvEffDtOfEmpCov2 = CASE WHEN STD IS NOT NULL AND EepAddressState = 'MA' THEN STD_BenStartDate END
        ...
        ,drvEarnings3 = CASE WHEN YEAR(EecDateOfLastHire) < YEAR(GETDATE()) THEN
                                CASE WHEN LTD IS NOT NULL AND EepAddressState = 'MA' THEN CAST(CONVERT(DECIMAL(10,2), ((EecAnnSalary + PehB.PehCurAmt) / 52)) AS VARCHAR) END
                            WHEN YEAR(EecDateOFLastHire) = YEAR(GETDATE()) THEN 
                                CASE WHEN LTD IS NOT NULL AND EepAddressState = 'MA' THEN CAST(CONVERT(DECIMAL(10,2), ((EecAnnSalary + PehB.PehCurAmt) / 52)) AS VARCHAR) END
                            END
        ,drvEarningsPrd3 = CASE WHEN LTD IS NOT NULL THEN 'MO' END
        ,drvEffDtOfEmpCov3 = CASE WHEN LTD IS NOT NULL THEN LTD_BenStartDate END
    ...
    LEFT JOIN (SELECT PehEEID, PehEarnCode, PehCurAmt
                ...
                WHERE PehEarnCode IN ('BONUS', 'BONSP', 'BONSR', 'COMM', 'HOL', 'BONSL', 'OT', 'PTO', 'REF',
