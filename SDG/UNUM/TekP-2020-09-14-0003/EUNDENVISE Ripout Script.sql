...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EUNDENVISE_20201104.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'UNUM Dental Vision Elg Export','202010279','EMPEXPORT','FULLFILE','Oct 28 2020  8:41PM','EUNDENVISE',NULL,NULL,NULL,'202010279','Oct 27 2020 12:00AM','Dec 30 1899 12:00AM','202009251','333','','','202009251',dbo.fn_GetTimedKey(),NULL,'us3cPeSDG1000',NULL);
