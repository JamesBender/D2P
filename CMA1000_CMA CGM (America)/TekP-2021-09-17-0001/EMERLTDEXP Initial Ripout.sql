...
Client ID:      CMA1000
Date/time:      2021-12-08 21:34:27.207
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('34','EMERLTDEXPZ0','50','H','01','1633',NULL,'MEBA',NULL,NULL,'"MEBA"','(''DA''=''T'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('34','EMERLTDEXPZ0','50','D','10','1633',NULL,'MEBA',NULL,NULL,'"drvMEBA"','(''UA''=''T'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EMERLTDEXP_20211208.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','MLMTS,MLWSW,Y0SOB,MLWA8',NULL,NULL,NULL,'Mercer Data File Monthly 15th','202002269','EMPEXPORT','SCH_MERS','Feb 26 2020  3:42PM','EMERLTDEXP',NULL,NULL,NULL,'202110319','Feb 26 2020 12:00AM','Dec 30 1899 12:00AM','202110011','1206','','','201912311',dbo.fn_GetTimedKey(),NULL,'us3mLaCMA1000',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','MLMTS,MLWSW,Y0SOB,MLWA8',NULL,NULL,NULL,'Test Purposes Only','202004309','EMPEXPORT','TEST','May 29 2020  9:26AM','EMERLTDEXP',NULL,NULL,NULL,'202004309','Apr 30 2020 12:00AM','Dec 30 1899 12:00AM','202004011','815','','','202004011',dbo.fn_GetTimedKey(),NULL,'us3lKiCMA1000',NULL);
