...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','99','(''DA''=''T|'')','EHRTSLFEXPZ0','50','D','10','99',NULL,'Client-Specific Field #3 Name',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','100','(''DA''=''T|'')','EHRTSLFEXPZ0','50','D','10','100',NULL,'Client-Specific Field #3 Value',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','178','(''DA''=''T|'')','EHRTSLFEXPZ0','50','D','10','178',NULL,'Reporting Level 2',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','217','(''DA''=''T|'')','EHRTSLFEXPZ0','50','D','10','217',NULL,'Supplemental Life Requested Amount',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','228','(''DA''=''T|'')','EHRTSLFEXPZ0','50','D','10','228',NULL,'Supplemental AD&D Requested Amount',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','270','(''DA''=''T|'')','EHRTSLFEXPZ0','50','D','10','270',NULL,'Spouse Supplemental Life Requested Amount',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20191213.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Hartford LTD STD and FMLA Expo','201910159','EMPEXPORT','ONDEMAND',NULL,'EHRTSLFEXP',NULL,NULL,NULL,'201910159','Oct 15 2019  5:41PM','Oct 15 2019  5:41PM','201910151',NULL,'','','201910151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20191213.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201910159','EMPEXPORT','SCHEDULED',NULL,'EHRTSLFEXP',NULL,NULL,NULL,'201910159','Oct 15 2019  5:41PM','Oct 15 2019  5:41PM','201910151',NULL,'','','201910151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20191213.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202001019','EMPEXPORT','TEST','Dec 13 2019 11:57AM','EHRTSLFEXP',NULL,NULL,NULL,'202001019','Jan  1 2020 12:00AM','Dec 30 1899 12:00AM','201912131','1497','','','201912131',dbo.fn_GetTimedKey(),NULL,'us3lKiAPP1004',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EHRTSLFEXP_20191213.txt' END WHERE expFormatCode = 'EHRTSLFEXP';
...
CREATE TABLE [dbo].[U_EHRTSLFEXP_drvTbl] (
    ...
    [drvProvinceCode] varchar(3) NOT NULL,
    ...
    [drvLastFourWeekPayroll] varchar(6000) NULL,
    [drvEEHolidaySchedule] varchar(25) NOT NULL,
    [drvClientFiend2Value] varchar(1) NOT NULL,
...
BEGIN
    ...
    SET @DedList = 'STD,LTD,LIFES,GLIFE,LIFEC,LIFEE';
    ...
    IF @ExportCode LIKE '%TEST' or @ExportCode LIKE '%SCHEDULED'
    BEGIN
    ...
    SELECT DISTINCT
        ...
        ,PehCurHrsYTD           = SUM(CASE WHEN PehEarnCode NOT IN ('HOL', 'HOLWK', 'PTO', 'SIC' , 'VAC') THEN PehCurHrs ELSE 0.00 END)
    ...
    SELECT DISTINCT
        ...
        ,drvSubSort  =  Case WHEN BdmRecType = 'EMP' THEN '1' ELSE '2' END
        ...
        ,drvEmployeeStatus =  CASE WHEN EecEmplStatus = 'T' THEN 'T' ELSE 'A' END
        ...
        ,drvLastFourWeekPayroll =  dbo.dsi_fnRemoveChars('.,',CAST(PehCurAmtOthers as varchar(12)))
        ,drvEEHolidaySchedule = 'FEDERAL CALENDAR EMPLOYEE' --To be set to PahAccrOption
        ,drvClientFiend2Value = '' --Set to blank
        ...
        ,drvNSTPlanSummary = CASE WHEN STD = 'STD' THEN
                                CASE WHEN EecSalaryOrHourly = 'H' THEN '1A1' ELSE  '1A2' End
                            END
        ...
        */
        ...
        ,drvSTACoverageEffectiveDate = CASE WHEN STD = 'STD' AND (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'HI' THEN STD_BenefitDate END
        ,drvSTACoverageTerminationDate = CASE WHEN STD = 'STD' AND (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'HI' THEN STD_BenefitStopDate END
        ,drvSTAPlanCoverageOption = CASE WHEN STD = 'STD' AND (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'HI' THEN 'HI' END

        ,drvSTAPlanSummary = CASE WHEN STD IS NOT NULL and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'HI' and EecSalaryOrHourly = 'S' THEN '2A1'
                                   WHEN STD IS NOT NULL and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'HI' and EecSalaryOrHourly <> 'S' THEN '1A1'
                                 END
        ,drvSTAEmployeeGroupId = ''
        ,drvSTAEmployeeClassCode = CASE WHEN STD = 'STD' AND (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'HI' THEN '1' END
        ...
        ,drvLTDPlanSummary = CASE WHEN LTD IS NOT NULL THEN 
                                  CASE WHEN  (Select Top 1 JbcEEOCategory from JobCode where JbcJobCode  in (EecJobCode) ) = '11' THEN '1B1'
                                  WHEN  (Select Top 1 JbcEEOCategory from JobCode where JbcJobCode  in (EecJobCode) ) IN ( '12', '21', '22', '23' , '4') THEN '1B2'
                                  ELSE  '1B3'
                                END
                             END
        ...
        ,drvLTDEmployeeClassCode = CASE WHEN LTD IS NOT NULL THEN 
                                    CASE WHEN  (Select Top 1 JbcEEOCategory from JobCode where JbcJobCode  in (EecJobCode) ) = '11' THEN '1'
                                      WHEN  (Select Top 1 JbcEEOCategory from JobCode where JbcJobCode  in (EecJobCode) ) IN ( '12', '21', '22', '23' , '4') THEN '2'
                                      ELSE  '3'
                                END
                             END
        ...
        ,drvSPLEffectiveDate = CASE WHEN LIFES IS NOT NULL and BdmRecType = 'DEP' THEN LIFES_BenefitDate END
        ,drvSPLTerminationDate = CASE WHEN LIFES IS NOT NULL and BdmRecType = 'DEP' THEN LIFES_BenefitStopDate END
        ,drvSPLAmount  = CASE WHEN LIFES IS NOT NULL and BdmRecType = 'DEP' THEN  CAST( (CONVERT(DECIMAL(12,0),(CAST( (select TOP 1 BdmUSGField1 from U_dsi_BDM_EHRTSLFEXP A  where A.bdmeeid = bdmeeid and bdmDedcode = 'LIFES' and bdmrectype = 'EMP') as MONEY)))) as varchar(12)) END
        ,drvSPLGroupId = CASE WHEN LIFES IS NOT NULL and EecCoID = 'TJFST' AND BdmRecType = 'DEP' THEN '10'
                              WHEN LIFES IS NOT NULL and EecCoID = 'A97O7' AND BdmRecType = 'DEP' THEN '12'
                              WHEN LIFES IS NOT NULL AND BdmRecType = 'DEP' THEN '7'
                         END
        ,drvSPLClassCode = CASE WHEN LIFES IS NOT NULL and BdmRecType = 'DEP' THEN '1' END
        ...
        ,drvDPLAmount  = CASE WHEN LIFEC IS NOT NULL and BdmRecType = 'DEP' THEN CAST( (CONVERT(DECIMAL(12,0),(CAST( (select TOP 1 BdmUSGField1 from U_dsi_BDM_EHRTSLFEXP A  where A.bdmeeid = bdmeeid and bdmDedcode = 'LIFEC' and bdmrectype = 'EMP') as MONEY)))) as varchar(12)) END
    ...
    JOIN     (select  bdmEEID,bdmcoid,bdmrectype,bdmdeprecid
            ,LTD = MAX((CASE WHEN bdmDedCode = 'LTD' then bdmDedCode END))
            ,STD = MAX((CASE WHEN bdmDedCode = 'STD' then bdmDedCode END))
            ...
            ,STD_BenefitDate = MAX((CASE WHEN bdmDedCode = 'STD' then  bdmBenStartDate END))
            ...
            ,STD_BenefitStopDate = MAX((CASE WHEN bdmDedCode = 'STD' then  bdmBenStopDate END))
