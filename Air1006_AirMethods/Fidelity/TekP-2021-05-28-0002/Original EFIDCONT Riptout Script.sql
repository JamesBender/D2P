...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,'FR95C',NULL,NULL,NULL,'On Demand Export','202108202','EMPEXPORT','ON_DEMAND','Aug 20 2021  8:03PM','EFIDCONT',NULL,NULL,NULL,'202108202','Aug 20 2021 12:00AM','Aug 20 2021 12:00AM','202108202','297','eecPayGroup','BWPLT','202108202',dbo.fn_GetTimedKey(),NULL,'ULTI_AIRMC',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,'FR95C,N7GY3,WO2AC,RIOOJ,H4VKS,0Y1AJ',NULL,NULL,NULL,'Fidelity 401kPayroll-BW Fri 6a','202108209','EMPEXPORT','SCH_EFID40','Sep 30 2021 12:00AM','EFIDCONT',NULL,NULL,NULL,'202110159','Aug 20 2021 12:00AM','Dec 30 1899 12:00AM','202110021',NULL,'eecPaygroup','PLTHH,BLUEHI,BWXMPT,BWMECH,BWMED,BWNXMT,BWPLT,SUNDNC,BWUR','202108201',dbo.fn_GetTimedKey(),NULL,'us3lKiAIR1006',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,'FR95C,N7GY3,WO2AC,RIOOJ,H4VKS,0Y1AJ',NULL,NULL,NULL,'Fidelity 401k Payroll - TEST','202110019','EMPEXPORT','TEST','Sep 30 2021  8:49AM','EFIDCONT',NULL,NULL,NULL,'202110019','Oct  1 2021 12:00AM','Dec 30 1899 12:00AM','202110011','4223','eecPayGroup','PLTHH,BLUEHI,BWXMPT,BWMECH,BWMED,BWNXMT,BWPLT,SUNDNC,BWUR','202110011',dbo.fn_GetTimedKey(),NULL,'us3lKiAIR1006',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unlock Export Session','201306099','EMPEXPORT','ZAP','Aug 23 2021 12:00AM','EFIDCONT',NULL,NULL,NULL,'201306099','Jun  9 2013 12:00AM','Dec 30 1899 12:00AM','201306091','-99','','PLTHH,BLUEHI,XMPTBH,NXMTBH,PLTBH,BWXMPT,XMPTHH,NXMTHH,BWMECH,BWMED,BWNXMT,BWPLT,SUNDNC,XMPTSD,NXMTSD,PLTSD,TRACK,XMPTTS,MECHTS,MEDTS,NXMTTS,PLTTS,BWUR','201306091',dbo.fn_GetTimedKey(),NULL,'us3lKiAIR1006',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFIDCONT','Testing','V','Y');
...
IF dbo.dsi_fnVariable('EFIDCONT','TEST') = 'Y' BEGIN

    INSERT INTO dbo.U_EFIDCONT_File VALUES ('H00','0','1','TESTEDT' + SPACE(73))

END
GO
CREATE PROCEDURE [dbo].[dsi_sp_BuildDriverTables_EFIDCONT] @SystemID VARCHAR(15)
AS
SET NOCOUNT ON;
/************************************************************
...
SELECT ExpFormatCode, ExpExportCode, ExpStartPerControl, ExpEndPerControl,* FROM dbo.AscExp WHERE expFormatCode = 'EFIDCONT';
SELECT * FROM dbo.U_dsi_InterfaceActivityLog WHERE FormatCode = 'EFIDCONT' ORDER BY RunID DESC;
...
dsi_sp_testswitchbox 'EFIDCONT', 'TEST'
dsi_sp_testswitchbox 'EFIDCONT', 'SCH_EFID40'
...
CREATE View [dbo].[dsi_vwEFIDCONT_Export] as
        select top 2000000 UPPER(Data) AS UPPERDATA from dbo.U_EFIDCONT_File with (nolock)
