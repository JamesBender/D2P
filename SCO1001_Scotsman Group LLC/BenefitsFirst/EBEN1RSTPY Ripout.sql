...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('40','EBEN1RSTPYZ0','50','H','01','40',NULL,'Excempt Status',NULL,NULL,'"Excempt Status"','(''DA''=''T'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('40','EBEN1RSTPYZ0','50','D','10','40',NULL,'Excempt Status',NULL,NULL,'"drvExcemptStat"','(''UA''=''T'')');
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EBEN1RSTPY_20210910.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','',NULL,NULL,NULL,'Benefitfirst Payroll Exp-Test','202108139','EMPEXPORT','TEST_XOE','Sep 10 2021 11:01AM','EBEN1RSTPY',NULL,NULL,NULL,'202108139','Aug 13 2021 12:00AM','Dec 30 1899 12:00AM','202107301','528','','','202107301',dbo.fn_GetTimedKey(),NULL,'us3lKiSCO1001','',NULL);
