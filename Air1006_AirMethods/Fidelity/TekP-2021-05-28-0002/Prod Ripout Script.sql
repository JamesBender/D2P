...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EFIDCONT_20210809.txt';
/*09*/ DECLARE @FILEPATH varchar(1000) = '\\' + @COUNTRY + '.saas\' + @SERVER + '\' + @ENVIRONMENT + '\Downloads\V10\Exports\' + @COCODE + '\EmployeeHistoryExport\';
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,'FR95C,WO2AC,RIOOJ,H4VKS',NULL,NULL,NULL,'On Demand Export','202107239','EMPEXPORT','ON_DEMAND','Aug  5 2021 12:00AM','EFIDCONT',NULL,NULL,NULL,'202107239','Jul 23 2021 12:00AM','Dec 30 1899 12:00AM','202107231','4284','','PLTHH,BLUEHI,XMPTBH,NXMTBH,PLTBH,BWXMPT,XMPTHH,NXMTHH,BWMECH,BWMED,BWNXMT,BWPLT,SUNDNC,XMPTSD,NXMTSD,PLTSD,TRACK,XMPTTS,MECHTS,MEDTS,NXMTTS,PLTTS,BWUR','202107231',dbo.fn_GetTimedKey(),NULL,'us3lKiAIR1006',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,'FR95C,N7GY3,WO2AC,RIOOJ,H4VKS,0Y1AJ',NULL,NULL,NULL,'Fidelity 401k Payroll - TEST','202108069','EMPEXPORT','TEST','Aug  5 2021  1:51PM','EFIDCONT',NULL,NULL,NULL,'202108069','Aug  6 2021 12:00AM','Dec 30 1899 12:00AM','202108061','4243','eecPayGroup','PLTHH,BLUEHI,BWXMPT,BWMECH,BWMED,BWNXMT,BWPLT,SUNDNC,BWUR','202108061',dbo.fn_GetTimedKey(),NULL,'us3lKiAIR1006',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unlock Export Session','201306099','EMPEXPORT','ZAP','Aug  5 2021 12:00AM','EFIDCONT',NULL,NULL,NULL,'201306099','Jun  9 2013 12:00AM','Dec 30 1899 12:00AM','201306091','-99','','','201306091',dbo.fn_GetTimedKey(),NULL,'us3lKiAIR1006',NULL);
