...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EHJOYDEMEX_20210930.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','NE59R',NULL,NULL,NULL,'HealthJoy Demographic Ex-Test','202109231','EMPEXPORT','TEST_XOE','Sep 28 2021 12:24AM','EHJOYDEMEX',NULL,NULL,NULL,'202109231','Sep 23 2021 12:00AM','Dec 30 1899 12:00AM','202109091','1169','','','202109091',dbo.fn_GetTimedKey(),NULL,'us3cPeACH1001',NULL);
