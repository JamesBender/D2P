...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHCMEMPEXP_20200608.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Health Comp FSA Employee Expor','202006019','EMPEXPORT','ONDEMAND',NULL,'EHCMEMPEXP',NULL,NULL,NULL,'202006019','Jun  1 2020  3:26PM','Jun  1 2020  3:26PM','202006011',NULL,'','','202006011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHCMEMPEXP_20200608.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','202006019','EMPEXPORT','SCH_HCFEE','Jun  1 2020  5:45PM','EHCMEMPEXP',NULL,NULL,NULL,'202006019','Jun  1 2020  3:26PM','Jun  1 2020  3:26PM','202006011','143','','','202006011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHCMEMPEXP_20200608.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'ACTIVE Session','202006019','EMPEXPORT','OEACTIVE',NULL,'EHCMEMPEXP',NULL,NULL,NULL,'202006019','Jun  1 2020  3:26PM','Jun  1 2020  3:26PM','202006011',NULL,'','','202006011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHCMEMPEXP_20200608.txt',NULL,'','','',NULL,NULL,NULL,'PASSIVE Session','202006019','EMPEXPORT','OEPASSIVE','Jun  1 2020  5:45PM','EHCMEMPEXP',NULL,NULL,NULL,'202006019','Jun  1 2020  3:26PM','Jun  1 2020  3:26PM','202006011','178','','','202006011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHCMEMPEXP_20200608.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202006019','EMPEXPORT','TEST','Jun  4 2020 10:53AM','EHCMEMPEXP',NULL,NULL,NULL,'202006019','Jun  1 2020 12:00AM','Dec 30 1899 12:00AM','202005181','145','','','202005181',dbo.fn_GetTimedKey(),NULL,'us3cPeTUR1007',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EHCMEMPEXP_20200608.txt' END WHERE expFormatCode = 'EHCMEMPEXP';
...
CREATE TABLE [dbo].[U_EHCMEMPEXP_drvTbl] (
    ...
    [drvDepSocialSecurityNumber] varchar(1) NOT NULL,
    [drvDependentLastName] varchar(1) NOT NULL,
    [drvDependentFirstName] varchar(1) NOT NULL,
    [drvImportOption] varchar(1) NOT NULL,
    [drvDebitCardOption] varchar(2) NOT NULL,
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvFlexEffectivePeriodStDate = dbo.dsi_fnGetMinMaxDates('MAX',BdmBenStartDate, CAST('1/1/2020' as DateTIME) )
        ,drvAlternateEmployeeID = EecEmpNo
        ,drvHiredDate = EecDateOfOriginalHire
        ,drvDepSocialSecurityNumber = ''
        ,drvDependentLastName = ''
        ,drvDependentFirstName = ''
        ,drvImportOption = 'N'
        ,drvDebitCardOption = 'ED'
        ,drvDepartment = ''
