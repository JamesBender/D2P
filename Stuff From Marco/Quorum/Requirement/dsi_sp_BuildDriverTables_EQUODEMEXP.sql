...
Client ID:      QUO1000
Date/time:      2021-12-21 20:15:26.347
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EQUODEMEXP_20211221.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,NULL,'One Digital Employee Exp-Test','202112199','EMPEXPORT','TEST_XOE',NULL,'EQUODEMEXP',NULL,NULL,NULL,'202112199','Dec 19 2021  1:41AM','Dec 19 2021  1:41AM','202112191',NULL,'','','202112191',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
CREATE TABLE [dbo].[U_EQUODEMEXP_drvTbl] (
    ...
    [drvTotalHoursPilstmonth] varchar(1) NOT NULL
);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvPTFTStatus = CASE WHEN EecFullTimeOrPartTime = 'F' THEN '1'
                         ...
                         END
        ,drvManagerEmployeeNumber = dbo.dsi_fnlib_GetSupervisorField('', EecSupervisorID, 'EmpNo')    
        ,drvManagerLastName = dbo.dsi_fnlib_GetSupervisorField('', EecSupervisorID, 'NameLast')
        ,drvManagerFirstName = dbo.dsi_fnlib_GetSupervisorField('', EecSupervisorID, 'NameFirst')
        ,drvManagerPhone = CASE WHEN  dbo.dsi_fnlib_GetSupervisorField('', EecSupervisorID, 'BusinessPhoneNumber') <> '' THEN FORMAT(CAST(dbo.dsi_fnlib_GetSupervisorField('', EecSupervisorID, 'BusinessPhoneNumber') as numeric),'###-##-####')  END
        ...
        ,drvPayRate = CAST( CASE WHEN eecSalaryOrHourly = 'S' THEN EecAnnSalary ELSE EecAnnSalary END as varchar)
        ...
        ,drvAverageWeeklyMinutes = CAST( CONVERT( DECIMAL(10,2),( (PehCurHrsAll / 52) * 60)) as varchar)
        ,drvWorkCounty = ''
        ,drvResidenceCounty = ''
        ,drvWorkCity = ''
        ,drvEmptyColumn4 = ''
        ,drvFTEPercentage = ''
        ,drvTotalHoursPilstmonth = ''
