...
GO
IF OBJECT_ID('U_EHENEMP401_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_EHENEMP401_AuditFields];
GO
IF OBJECT_ID('U_EHENEMP401_Audit') IS NOT NULL DROP TABLE [dbo].[U_EHENEMP401_Audit];
GO
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHENEMP401_20200602.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201909069','EMPEXPORT','SCHEDULED',NULL,'EHENEMP401',NULL,NULL,NULL,'201909069','Sep  6 2019  1:35PM','Sep  6 2019  1:35PM','201909061',NULL,'','','201909061',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHENEMP401_20200602.txt',NULL,'','','',NULL,NULL,NULL,'Empower 401k','201909069','EMPEXPORT','ONDEMAND','Sep  6 2019  3:23PM','EHENEMP401',NULL,NULL,NULL,'201909069','Sep  6 2019 12:00AM','Dec 30 1899 12:00AM','201908111','193','','','201908111',dbo.fn_GetTimedKey(),NULL,'us3mLaHEN1004',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHENEMP401_20200602.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202005051','EMPEXPORT','TEST','May 15 2020  4:01PM','EHENEMP401',NULL,NULL,NULL,'202005051','May  5 2020 12:00AM','Apr 30 2020 12:00AM','202005051','222','','','202005051',dbo.fn_GetTimedKey(),NULL,'us3lKiHEN1004A',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EHENEMP401_20200602.txt' END WHERE expFormatCode = 'EHENEMP401';
...
IF OBJECT_ID('U_EHENEMP401_Audit') IS NULL
CREATE TABLE [dbo].[U_EHENEMP401_Audit] (
...
IF OBJECT_ID('U_EHENEMP401_AuditFields') IS NULL
CREATE TABLE [dbo].[U_EHENEMP401_AuditFields] (
...
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EHENEMP401', 'TEST';
...
BEGIN
    ...
    IF OBJECT_ID('U_EHENEMP401_AuditFields','U') IS NOT NULL
        DROP TABLE dbo.U_EHENEMP401_AuditFields;
    CREATE TABLE dbo.U_EHENEMP401_AuditFields (aTableName varchar(128),aFieldName varchar(128));
    
    -- Insert tables/fields to be audited
    INSERT INTO dbo.U_EHENEMP401_AuditFields VALUES ('empcomp','EecEmplStatus');    
    
    -- Create audit table
    IF OBJECT_ID('U_EHENEMP401_Audit','U') IS NOT NULL
        DROP TABLE dbo.U_EHENEMP401_Audit;
    SELECT
    ...
    INTO dbo.U_EHENEMP401_Audit
    FROM (SELECT *
          FROM dbo.AuditRecords WITH (NOLOCK)
          WHERE adrTableName IN (SELECT aTableName FROM dbo.U_EHENEMP401_AuditFields WITH (NOLOCK))) ADR
    JOIN (SELECT *
          FROM dbo.AuditFields WITH (NOLOCK)
          WHERE adfFieldName IN (SELECT aFieldName FROM dbo.U_EHENEMP401_AuditFields WITH (NOLOCK))) ADF
        ON adrSystemID = adfSystemID
       AND adrKey = adfKey
    WHERE adrType IN (1,2,5,6) -- Insert/Update; remove this to include Deletes and Viewed
      AND adrProcessedDateTime BETWEEN @StartDate -60 AND @EndDate;
    
    -- Create Index
    CREATE CLUSTERED INDEX CDX_U_EHENEMP401_Audit ON dbo.U_EHENEMP401_Audit (audKey1Value, audKey2Value);
    ...
    SELECT DISTINCT
        ...
        ,drvDateOfTermination = CASE WHEN EecEmplStatus = 'T' THEN EecDateOfTermination 
                                     WHEN EecDateOfOriginalHire <> EecDateOfLastHire and EecEmplStatus = 'A' THEN (Select top 1 EhcDateOfTermination from EmpHComp where ehceeid = xeeid and ehcemplstatus = 'T' order by ehcdateTimeCreated desc)
                                     END
        ,drvDateOfLastHire = CASE WHEN EecEmplStatus = 'A'  and EecDateOfOriginalHire <> EecDateOfLastHire THEN EecDateOfLastHire END
        ,drvPayDate = dbo.dsi_fnGetMinMaxDates('MAX',PrgPayDate, PayDate) 
        ,drvEmpBeforeTax = dbo.dsi_fnpadzero((ISNULL(DSSoure,0)),10,2)
        ,drvEmpRoth = dbo.dsi_fnpadzero((ISNULL(SMATCH,0)),10,2)
        ,drvERMatching = dbo.dsi_fnpadzero((ISNULL(ROTH,0)),10,2)
    ...
    JOIN dbo.EmpComp WITH (NOLOCK)
        ...
        AND EecCoID = xCoID
         and (eecemplstatus <> 'T' OR (eecemplstatus= 'T' and eectermreason <>'TRO' 
                                      and EXISTS(select 1 from dbo.U_EHENEMP401_Audit where  audKey1Value = xEEID AND audKey2Value = xcoid and audfieldname = 'eecemplstatus' and audNewValue = 'T')))
        
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    JOIN dbo.U_EHENEMP401_PEarHist WITH (NOLOCK)
            ON PehEEID = xEEID
    LEFT JOIN (
    ...
    Delete from dbo.U_EHENEMP401_drvTbl  where drvDateOfTermination < @StartDate -60 and drvDateOfLastHire is null;
