...
Client ID:      COA1009
Date/time:      2022-06-21 15:36:54.703
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    NWP
...
GO
IF OBJECT_ID('U_EWEXCTREXP_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_EWEXCTREXP_AuditFields];
GO
IF OBJECT_ID('U_EWEXCTREXP_Audit') IS NOT NULL DROP TABLE [dbo].[U_EWEXCTREXP_Audit];
GO
...
/*08*/ DECLARE @FileName varchar(1000) = 'EWEXCTREXP_20220621.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'Active Open Enrollment Export','202202289','EMPEXPORT','OEACTIVE','Mar  2 2022  6:10AM','EWEXCTREXP',NULL,NULL,NULL,'202202289','Mar  1 2022  9:35AM','Mar  1 2022  9:35AM','202202281','2','','','202202281',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'WEX FSA/DepCare/HAS/T & -Test','202206151','EMPEXPORT','TEST_XOE','Jun 20 2022 12:00AM','EWEXCTREXP',NULL,NULL,NULL,'202206151','Jun 15 2022 12:00AM','Jun 15 2022 12:00AM','202206151','1734','eecPayGroup','CFSAL,CFHRLY,FEDSAL','202206151',dbo.fn_GetTimedKey(),NULL,'us3mWaCOA1009',NULL);
...
-----------
-- Create table U_EWEXCTREXP_Audit
-----------

IF OBJECT_ID('U_EWEXCTREXP_Audit') IS NULL
CREATE TABLE [dbo].[U_EWEXCTREXP_Audit] (
...
-----------
-- Create table U_EWEXCTREXP_AuditFields
-----------

IF OBJECT_ID('U_EWEXCTREXP_AuditFields') IS NULL
CREATE TABLE [dbo].[U_EWEXCTREXP_AuditFields] (
...
CREATE TABLE [dbo].[U_EWEXCTREXP_PDedHist] (
    ...
    [PdhSourceHSACF] numeric NULL,
    [PdhSourceHSACI] numeric NULL,
    [PdhSourceHSAF] numeric NULL,
    [PdhSourceHSAI] numeric NULL,
    [PdhSourceHSRF] numeric NULL,
    [PdhSourceHSAER] numeric NULL,
    [PdhSourceHSERF] numeric NULL,
    [PdhSourceHSERI] numeric NULL,
...
Marie Waters     06/17/2022     TekP-2021-10-26-0007   Added Audit table and where clauses to remove older terms
...
BEGIN
    ...
    --==========================================
     ...
     --Test user
    DELETE FROM dbo.U_EWEXCTREXP_EEList WHERE xEEID = 'DOTJ4L000030';
    ...
    -- Get data from audit fields table. Add fields here if auditing
     IF OBJECT_ID('U_EWEXCTREXP_AuditFields','U') IS NOT NULL
        DROP TABLE dbo.U_EWEXCTREXP_AuditFields;
    CREATE TABLE dbo.U_EWEXCTREXP_AuditFields (aTableName varchar(30),aFieldName varchar(30));

    INSERT INTO dbo.U_EWEXCTREXP_AuditFields VALUES ('EmpComp','EecDateofTermination');
    INSERT INTO dbo.U_EWEXCTREXP_AuditFields VALUES ('EmpComp','EecEmplStatus');
    INSERT INTO dbo.U_EWEXCTREXP_AuditFields VALUES ('EmpComp','EecTermReason');
    INSERT INTO dbo.U_EWEXCTREXP_AuditFields VALUES ('EmpDed','eedBenStopDate');
    INSERT INTO dbo.U_EWEXCTREXP_AuditFields VALUES ('EmpDed','eedBenOption');
    INSERT INTO dbo.U_EWEXCTREXP_AuditFields VALUES ('EmpDed','eedDedCode');

     --Create audit table based on fields defined above
    IF OBJECT_ID('U_EWEXCTREXP_Audit','U') IS NOT NULL
        DROP TABLE dbo.U_EWEXCTREXP_Audit;
    SELECT 
    ...
    INTO dbo.U_EWEXCTREXP_Audit
    FROM dbo.vw_AuditData WITH (NOLOCK) 
    JOIN dbo.U_EWEXCTREXP_AuditFields WITH (NOLOCK) 
    ...
    -- Create Index
    CREATE CLUSTERED INDEX CDX_U_EWEXCTREXP_Audit ON dbo.U_EWEXCTREXP_Audit (audEEID,audKey2)
    ...
    --SET @DedList = 'FSA,FSAD,FSAL,HSACF,HSACI,HSAF,HSAI,TRANS,PARK,PARKP,HSERF,HSERI';
    SET @DedList = 'FSA,FSAL,HSACF,HSACI,HSAF,HSAI,TRANS,PARK,PARKP,HSERF,HSERI,FSAD';
  ...
  --  INSERT INTO dbo.U_dsi_bdm_Configuration VALUES (@FormatCode, 'UpdDedType', 'FSA')
    ...
    -- ================================================
     ...
     INSERT INTO [dbo].[U_dsi_BDM_EWEXCTREXP]
	...
	JOIN dbo.EmpPers WITH (NOLOCK)
         ON EepEEID =EedEEID
    Where  EedFormatCode =  'EWEXCTREXP'
		and eeddedcode in ('FSA','FSAL','HSACF','HSACI','HSAF','HSAI','TRANS','PARK','PARKP','HSERF','HSERI','FSAD')
    ...
    SELECT DISTINCT
        ...
        ,PdhSourceHSACF        = SUM(CASE WHEN PdhDedCode IN ('HSACF')  THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhSourceHSACI        = SUM(CASE WHEN PdhDedCode IN ('HSACI')  THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhSourceHSAF        = SUM(CASE WHEN PdhDedCode IN ('HSAF')  THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhSourceHSAI        = SUM(CASE WHEN PdhDedCode IN ('HSAI')  THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhSourceHSRF        = SUM(CASE WHEN PdhDedCode IN ('HSRF')  THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhSourceHSAER        = SUM(CASE WHEN PdhDedCode IN ('HSAER')  THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhSourceHSERF        = SUM(CASE WHEN PdhDedCode IN ('HSERF')  THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhSourceHSERI        = SUM(CASE WHEN PdhDedCode IN ('HSERI')  THEN PdhEECurAmt ELSE 0.00 END)            
    ...
    LEFT JOIN (
        ...
        ON EfoEEID = xEEID
    LEFT JOIN dbo.U_EWEXCTREXP_PDedHist WITH (NOLOCK)
        ON PdhEEID = xEEID
    LEFT Join dbo.U_EWEXCTREXP_Audit WITH (NOLOCK)
        ON audEEID = xEEID
        AND AudFieldName  = 'eecemplstatus' 
        AND AudNewValue = 'T'
    WHERE (eecemplstatus <> 'T' OR (eecemplstatus = 'T' and eectermreason <> 'TRO' AND AudDateTime IS NOT NULL))
                OR (ISNULL(PdhSourceFSA, 0.00) > 0.00
                OR ISNULL(PdhSourceFSAD, 0.00) > 0.00
                OR ISNULL(PdhSourceFSAL, 0.00) > 0.00
                OR ISNULL(PdhSourceHSACF, 0.00) > 0.00
                OR ISNULL(PdhSourceHSACI, 0.00) > 0.00
                OR ISNULL(PdhSourceHSAF, 0.00) > 0.00
                OR ISNULL(PdhSourceHSAI , 0.00) > 0.00
                OR ISNULL(PdhSourceHSRF, 0.00) > 0.00
                OR ISNULL(PdhSourceHSAER, 0.00) > 0.00
                OR ISNULL(PdhSourceHSERF, 0.00) > 0.00
                OR ISNULL(PdhSourceTRANS , 0.00) > 0.00
                OR ISNULL(PdhSourcePARK, 0.00) > 0.00
                OR ISNULL(PdhSourceHSERI, 0.00) > 0.00
                )
    ;
    ---------------------------------
    ...
    SELECT DISTINCT
        ...
        ,drvParticipantElectionAmount =    FORMAT(
                                            ...
                                            END
                                        , '#0.00')
        ,drvEnrollmentTerminationDate =    CASE WHEN BdmBenStatus = 'T' AND BdmDedCode IN ('FSA','FSAD','FSAL, TRANS, PARK, PARKP') THEN BdmBenStopDate 
                                        END
    ...
    SELECT DISTINCT
        ...
        ,drvContributionAmont =    FORMAT(
                                    ...
                                    WHEN BdmDedCode IN ('HSACF') THEN PdhSourceHSACF
                                    WHEN BdmDedCode IN ('HSACI') THEN PdhSourceHSACI
                                    WHEN BdmDedCode IN ('HSAF') THEN PdhSourceHSAF    
                                    WHEN BdmDedCode IN ('HSAI') THEN PdhSourceHSAI
                                    WHEN BdmDedCode IN ('HSRF') THEN PdhSourceHSRF
                                    WHEN BdmDedCode IN ('HSAER') THEN PdhSourceHSAER
                                    WHEN BdmDedCode IN ('HSERF') THEN PdhSourceHSERF
                                    WHEN BdmDedCode IN ('HSERI') THEN PdhSourceHSERI        
