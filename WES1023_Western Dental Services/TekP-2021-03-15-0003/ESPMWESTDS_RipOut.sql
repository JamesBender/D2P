...
GO
IF OBJECT_ID('U_ESPMWESTDS_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_ESPMWESTDS_AuditFields];
GO
IF OBJECT_ID('U_ESPMWESTDS_Audit') IS NOT NULL DROP TABLE [dbo].[U_ESPMWESTDS_Audit];
GO
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBillEndDate"','22','(''UA''=''T,'')','ESPMWESTDSZ0','50','D','10','22',NULL,'BillingEndDate',NULL,NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ESPMWESTDS','NoEmpty','V','N');
...
IF OBJECT_ID('U_ESPMWESTDS_Audit') IS NULL
CREATE TABLE [dbo].[U_ESPMWESTDS_Audit] (
    ...
    [audLOA] varchar(1) NOT NULL,
    [audReHire] varchar(1) NOT NULL,
    [audTerm] varchar(1) NOT NULL,
    [audSalaryChange] varchar(1) NOT NULL
);
IF OBJECT_ID('U_ESPMWESTDS_AuditFields') IS NULL
CREATE TABLE [dbo].[U_ESPMWESTDS_AuditFields] (
...
CREATE TABLE [dbo].[U_ESPMWESTDS_spmTbl] (
    ...
    [drvClientDivName] varchar(6000) NULL,
    ...
    [drvBillEndDate] varchar(1) NOT NULL,
