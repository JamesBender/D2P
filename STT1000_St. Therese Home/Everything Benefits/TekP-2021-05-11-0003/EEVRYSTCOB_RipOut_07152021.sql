...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EEVRYSTCOB_20210716.csv';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Everything Benefits COBR-Test','202107159','EMPEXPORT','TEST_XOE','Jul 16 2021 12:00AM','EEVRYSTCOB',NULL,NULL,NULL,'202107159','Jul 15 2021 12:00AM','Dec 30 1899 12:00AM','202106011',NULL,'','','202106011',dbo.fn_GetTimedKey(),NULL,'us3aPiSTT1000',NULL);
...
CREATE TABLE [dbo].[U_EEVRYSTCOB_drvTbl] (
    ...
    [drvEmpPrefi] varchar(1) NULL,
    [drvEmpDOB] varchar(30) NULL,
    [drvEmpDOD] varchar(30) NULL,
    [drvEmpEmail] varchar(50) NULL,
    [drvEmpAdd1] varchar(8000) NULL,
    [drvEmpAdd2] varchar(8000) NULL,
    [drvEmpAdd3] varchar(1) NULL,
    [drvEmpCity] varchar(255) NULL,
    [drvEmpCount] varchar(1) NULL,
    [drvEmpState] varchar(255) NULL,
    [drvEmpZip] varchar(50) NULL,
    [drvEmpHPh] varchar(12) NULL,
    [drvEmpWPh] varchar(12) NULL,
    [drvEmpGen] varchar(1) NULL,
    [drvEmpMarit] varchar(8) NULL,
    [drvEmpDtMar] varchar(1) NULL,
    [drvEmpRace] varchar(1) NULL,
    [drvEmpCitiz] varchar(1) NULL,
    [drvEmpHandi] varchar(1) NULL,
    [drvEmpHospi] varchar(1) NULL,
    [drvEmpSmoke] varchar(3) NULL,
    [drvEmpLangu] varchar(1) NULL,
    [drvEmptDtSt] varchar(30) NULL,
    [drvEmptDtTerm] varchar(30) NULL,
    [drvEmptTermReason] varchar(30) NULL,
    [drvEmptDtHire] varchar(1) NULL,
    [drvEmptDtOrigHire] varchar(30) NULL,
    [drvEmptDtBenEligh] varchar(1) NULL,
    [drvEmptDtRet] varchar(1) NULL,
    [drvEmptNum] varchar(1) NULL,
    [drvEmptStat] varchar(10) NULL,
    [drvEmptType] varchar(1) NULL,
    [drvEmptFull] varchar(1) NULL,
    [drvEmptExStat] varchar(1) NULL,
    [drvEmptRegion] varchar(1) NULL,
    [drvEmptDiv] varchar(1) NULL,
    [drvEmptDep] varchar(1) NULL,
    [drvEmptLoc] varchar(1) NULL,
    [drvEmptJobTitle] varchar(1) NULL,
    [drvEmptJobCode] char(8) NULL,
    [drvEmptPerc] varchar(1) NULL,
    [drvEmptIsCorpOf] varchar(1) NULL,
    [drvEmptIsKeyEmp] varchar(1) NULL,
    [drvEmptIsHighComp] varchar(1) NULL,
    [drvEmptUnion] varchar(1) NULL,
    [drvEmptMedElig] varchar(1) NULL,
    [drvEmptCompAnnAmt] varchar(1) NULL,
    [drvEmpCompNumPay] varchar(1) NULL,
    [drvEmpCompHrlyRate] varchar(1) NULL,
    [drvEmptCompEffFrom] varchar(1) NULL,
    [drvEmptWeeklyHrs] varchar(1) NULL,
    [drvConSysId] varchar(1) NULL,
    ...
    [drvConNamePref] varchar(1) NULL,
    [drvConDOB] varchar(50) NULL,
    [drvConDOD] varchar(1) NULL,
    [drvConEmail] varchar(1) NULL,
    [drvConAddr1] varchar(1) NULL,
    [drvConAddr2] varchar(1) NULL,
    [drvConAddr3] varchar(1) NULL,
    [drvConAddCity] varchar(1) NULL,
    [drvConAddCounty] varchar(1) NULL,
    [drvConAddState] varchar(1) NULL,
    [drvConAddZip] varchar(1) NULL,
    [drvConHPh] varchar(50) NULL,
    [drvConWPh] varchar(1) NULL,
    [drvConGen] varchar(50) NULL,
    [drvConMaritalStat] varchar(1) NULL,
    [drvConRace] varchar(1) NULL,
    [drvConCitiz] varchar(1) NULL,
    [drvConHandi] varchar(1) NULL,
    [drvConHospi] varchar(1) NULL,
    [drvConSmoke] varchar(1) NULL,
    [drvConLangu] varchar(1) NULL,
    [drvConIRSQual] varchar(1) NULL,
    [drvConFullTimeStuddent] varchar(1) NULL,
    [drvBenCarName] varchar(18) NULL,
    [drvBenCarEIN] varchar(1) NULL,
    [drvBenType] varchar(27) NULL,
    [drvBenPlanName] varchar(8) NULL,
    [drvBenPolNum1] varchar(1) NULL,
    [drvBenPolNum2] varchar(1) NULL,
    [drvBenPolNum3] varchar(1) NULL,
    [drvBenPolNum4] varchar(1) NULL,
    [drvBenPolNum5] varchar(1) NULL,
    [drvBenEffFrom] varchar(30) NULL,
    [drvBenEffLastDt] varchar(30) NULL,
    [drvBenOrigEffFrom] varchar(1) NULL,
    [drvBenCovLevel] varchar(3) NULL,
    [drvBenIsWaived] varchar(1) NULL,
    [drvBenBaseCovAmt] varchar(1) NULL,
    [drvBenAppCovAmt] varchar(1) NULL,
    [drvBenReqCovAmt] varchar(1) NULL,
    [drvBenEmpPrem] varchar(1) NULL,
    [drvBenEmployerPrem] varchar(1) NULL,
    [drvBenNumDedPerYear] varchar(1) NULL,
    [drvBenSalary] varchar(1) NULL,
    [drvBenMedOfficeNum] varchar(1) NULL,
    [drvBenMedOfficeProvName] varchar(1) NULL,
    [drvBenMedOfficeProvAdd] varchar(1) NULL,
    [drvBenPercent] varchar(1) NULL,
    [drvInitialSort] varchar(20) NULL,
    [drvSubSort] varchar(5) NULL
);
...
BEGIN
   ...
   IF OBJECT_ID('U_EEVRYSTCOB_drvTbl','U') IS NOT NULL
    ...
    SELECT DISTINCT
        ...
        ,drvEmpHPh = SUBSTRING(EepPhoneHomeNumber, 1, 3) + '-' + 
                     SUBSTRING(EepPhoneHomeNumber, 4, 3) + '-' + 
                     SUBSTRING(EepPhoneHomeNumber, 7, 4)
        ,drvEmpWPh = SUBSTRING(EecPhoneBusinessNumber, 1, 3) + '-' + 
                     SUBSTRING(EecPhoneBusinessNumber, 4, 3) + '-' + 
                     SUBSTRING(EecPhoneBusinessNumber, 7, 4)
        ...
        ,drvBenPlanName = CASE WHEN EedDedCode IN ('MDP1', 'MDP2', 'MDP3') THEN 'PKA20366'
...
-- Spouse Record
    INSERT INTO dbo.U_EEVRYSTCOB_drvTbl
     SELECT DISTINCT
        ...
        ,drvBenPlanName = CASE WHEN DbnDedCode IN ('MDP1', 'MDP2', 'MDP3') THEN 'PKA20366'
...
---- Child Record
    INSERT INTO dbo.U_EEVRYSTCOB_drvTbl
     SELECT DISTINCT
        ...
        ,drvEmptDtSt = LEFT(CONVERT(VARCHAR, EecDateOfLastHire, 126), 10)
        ,drvEmptDtTerm = LEFT(ISNULL(CONVERT(VARCHAR, EecDateOfTermination, 126), ''), 10)
        ,drvEmptTermReason = '' -- TscDesc WHERE TrmReasn = EecTermReason (send the description) 
        --CASE WHEN EecEmplStatus = 'T' THEN EecTermReason END
        ,drvEmptDtHire = ''
        ,drvEmptDtOrigHire = LEFT(CONVERT(VARCHAR, EecDateOfOriginalHire, 126), 10)
        ,drvEmptDtBenEligh = ''
    ...
    JOIN dbo.U_EEVRYSTCOB_Audit 
	   ...
	   LEFT JOIN dbo.TrmReasn WITH (NOLOCK)  
        ON EecTermReason =   TchCode 
    WHERE audNewHire = 'Y' OR audTerm = 'Y'
    AND DbnRelationship IN ('CHL', 'STC')
    AND EecEEType NOT IN ('AG', 'CON', 'INT', 'SUM', 'Z')
    ;
