...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('8','EMICWEXFSAZ0','50','D','30','8',NULL,'Tax Year',NULL,NULL,'"Current"','(''DA''=''T'')');
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','202112229','EMPEXPORT','OEACTIVE',NULL,'EMICWEXFSA',NULL,NULL,NULL,'202112229','Dec 22 2021 12:57PM','Dec 22 2021 12:57PM','202101131',NULL,'','','202101131',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
BEGIN
    ...
    -- Required parameters
    INSERT INTO dbo.U_dsi_BDM_Configuration VALUES(@FormatCode,'DedCodes','FSA, FSADC, HSA, HSACF, HSACI, HSAF, HSAI, HSAER');
    ...
    SELECT DISTINCT
        ...
        ,drvSubmittedTime = REPLACE(CONVERT(VARCHAR(6),@RunDate,108),':',SPACE(0))
        ,drvFileVersion = '3.5'
...
--          and EXISTS (Select 1 from dbo.U_EMICWEXFSA_Audit where audEEID = xEEID and audfieldname = 'eecemplstatus' and audNewValue = 'T')))
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName = CASE WHEN BdmDedCode = 'FSA' THEN 'Medical FSA'
                            ...
                            END
        ,drvEnrollEffDate = 
        CASE WHEN BdmDedCode in ('FSA', 'FSADC', 'HSA', 'HSACF', 'HSACI', 'HSAF', 'HSAI') 
                                    THEN 
                                    '0101'+ CONVERT(VARCHAR(4), CASE WHEN DATEPART(YEAR, GETDATE() ) < 2022 THEN '2022' ELSE DATEPART(YEAR, GETDATE()) END )
                                    END
        ,drvParticipantAmount = CASE WHEN BdmDedCode in ('FSADC', 'FSA') THEN BdmEEGoalAmt 
                                     WHEN BdmDedCode in ('HSA', 'HSACF', 'HSACI', 'HSAF', 'HSAI') THEN 0.00
                                     END
        ,drvEnrollTermDate = CASE WHEN eecemplstatus <> 'T' and BdmDedCode in ('FSADC', 'FSA') THEN BdmBenStopDate END
        ,drvElectionIndicator = CASE WHEN BdmDedCode in ('HSA', 'HSACF', 'HSACI', 'HSAF', 'HSAI') THEN 'PerPay' END
...
--Update Dates
UPDATE dbo.AscExp
    SET expLastStartPerControl = '202112131'
       ,expStartPerControl     = '202112131'
       ,expLastEndPerControl   = '202112229'
       ,expEndPerControl       = '202112229'
WHERE expFormatCode = 'EMICWEXFSA';
