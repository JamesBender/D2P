...
Client ID:      GRA1017
Date/time:      2022-07-18 15:34:52.237
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    E43
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('18','EDIRECTPATZ0','50','D','10','18',NULL,'Term Code',NULL,NULL,'"drvTermCode"','(''UA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('51','EDIRECTPATZ0','50','D','10','51',NULL,'Employment Field 2',NULL,NULL,'"drvEmploymentField2"','(''UA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('52','EDIRECTPATZ0','50','D','10','52',NULL,'Employment Field 2 Effective Date',NULL,NULL,'"drvEmploymentField2Date"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('53','EDIRECTPATZ0','50','D','10','53',NULL,'Employment Field 3',NULL,NULL,'"drvEmploymentField3"','(''UA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('55','EDIRECTPATZ0','50','D','10','55',NULL,'Employment Field 4',NULL,NULL,'"drvEmploymentField4"','(''UA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('63','EDIRECTPATZ0','50','D','10','63',NULL,'LOA End Date',NULL,NULL,'"drvLOAendDate"','(''UD101''=''T,'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EDIRECTPAT_20220718.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,',WSGTJ,14CGB,RW4WR,S92SH,S92PR,S92N5,K2WNB,6OBUQ',NULL,NULL,NULL,'Direct Path Census Export','202102249','EMPEXPORT','ONDEM_XOE','Oct 18 2021 12:00AM','EDIRECTPAT',NULL,NULL,NULL,'202102249','Feb 24 2021 12:00AM','Dec 30 1899 12:00AM','202102011',NULL,'','','202102011',dbo.fn_GetTimedKey(),NULL,'MBUTTIMER01',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','WSGTJ,14CGB,RW4WR,S92SH,6OBUQ,S92PR,S92N5',NULL,NULL,NULL,'Direct Path Census Scheduled','202102239','EMPEXPORT','SCH_EDIREC',NULL,'EDIRECTPAT',NULL,NULL,NULL,'202207139','Jan 27 2020  6:01PM','Jan 27 2020  6:01PM','202207061',NULL,'','','202102011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','WSGTJ,14CGB,RW4WR,S92SH,6OBUQ,S92PR,S92N5',NULL,NULL,NULL,'Direct Path Census Test','202207139','EMPEXPORT','TEST_XOE','Jul 18 2022 12:00AM','EDIRECTPAT',NULL,NULL,NULL,'202207139','Jul 13 2022 12:00AM','Dec 30 1899 12:00AM','202207061','10198','','','202207061',dbo.fn_GetTimedKey(),NULL,'us3jReGRA1017',NULL);
...
CREATE TABLE [dbo].[U_EDIRECTPAT_drvTbl] (
    ...
    [drvTerminationReason] varchar(2) NOT NULL,
    [drvTermCode] varchar(1) NOT NULL,
    ...
    [drvEmploymentField2Date] datetime NULL,
...
Darren Collard   02/06/2022        TekP-2021-10-25-0001   update to return "AFTRA"
Darren Collard   02/16/2022        TekP-2021-10-25-0001   Term reason send description, added TermCode (V,I)
Darren Collard   03/17/2022        TekP-2021-10-25-0001   Send Term Reason as integer
Marie Waters     07/18/2022        TekP-2021-10-25-0001   Added and EecEmplStatus <> 'T' to the Termination date and reason case statments Where eecJobChangeReason in ('TRI','TRO')
...
EXEC dbo._dsi_usp_ExportRipOut_v7_4 @FormatCode = 'EDIRECTPAT', @AllObjects = 'Y',@FilePath = '', @IsWeb = 'Y'
**********************************************************************************/
BEGIN
    ...
    INSERT INTO dbo.U_EDIRECTPAT_AuditFields 
    ...
    SELECT DISTINCT
        ...
        ,drvRehireDate = CASE WHEN eecJobChangeReason in ('TRI','TRO') and EecEmplStatus <> 'T' THEN NULL WHEN EecDateOfOriginalHire <> EecDateOfLastHire THEN EecDateOfLastHire END --DLC 12/18 ignore transfer out/in -- Updated 7/18/22 and EecEmplStatus <> 'T'
        ,drvTerminationDate = CASE WHEN eecJobChangeReason in ('TRI','TRO') and EecEmplStatus <> 'T' THEN NULL 
                                   WHEN EecEmplStatus = 'T' THEN EecDateOfTermination           --DLC 12/18 ignore transfer out/in
                                   WHEN EecDateOfOriginalHire <> EecDateOfLastHire THEN (SELECT MAX(EJHJobEffDate) FROM EmpHJob where EJHEEID = xEEID AND EjhEmplStatus = 'T' AND EjhReason NOT IN ('TRI','TRO'))
                                   END
        ,drvTerminationReason = CASE                                                            --Updated by Rishabh Verma SR-2021-00317414
                                    WHEN eecJobChangeReason in ('TRI','TRO') and EecEmplStatus <> 'T' THEN ''                                                                      --DLC 12/18 ignore transfer out/in -- Updated 7/18/22 and EecEmplStatus <> 'T'
                                    WHEN EecEmplStatus = 'T' AND TchCode IN ('N107','I110','N115')                       THEN '1'  --'Termination'  --'1'
                                    WHEN EecEmplStatus = 'T' AND TchCode IN ('V123','202')                               THEN '2'  --'Retirement'  --'2'
                                    WHEN EecEmplStatus = 'T' AND TchCode IN ('N105','203')                               THEN '4'  --'Death'  --'4'
                                    WHEN EecEmplStatus = 'T' AND TchCode IN ('N101','N102','N108')                       THEN '5'  --'Other'  --'5'
                                    WHEN EecEmplStatus = 'T' AND TchCode = 'I121'                                        THEN '6'  --'Layoff'  --'6'
                                    WHEN EecEmplStatus = 'T' AND TchCode = 'V112'                                        THEN '9'  --'Termination - Relocation'  --'9'
                                    WHEN EecEmplStatus = 'T' AND TchCode = 'V116'                                        THEN '10' --'Termination - Other Employment'  --'10'
                                    WHEN EecEmplStatus = 'T' AND TchCode IN ('I106','I109','I126','I127','V103','V120')  THEN '12' --'Termination - Involuntary Separation'  --'12'
                                    WHEN EecEmplStatus = 'T' AND TchCode IN ('V118','V122')                              THEN '14' --'Termination - Voluntary'  --'14'
                                    WHEN EecEmplStatus = 'T' AND TchCode IN ('I114', 'V113')                             THEN '15' --'Termination - Mutual'  --'15'
                                    WHEN EecEmplStatus = 'T' AND TchCode = 'V111'                                        THEN '17' --'Military Leave'  --'17'
                                    WHEN EecEmplStatus = 'T' AND TchCode = 'I119'                                        THEN '18' --'Termination - Position Eliminated'  --'18'
                                    WHEN EecEmplStatus = 'T' AND TchCode = 'I117'                                        THEN '19' --'Termination - Performance'  --'19'
                                    WHEN EecEmplStatus = 'T' AND TchCode IN ('I104','N124','N125')                       THEN '27' --'Contract Ended'  --'27'
                                    ELSE ''
                                END
        ,drvTermCode = IIF(EecEmplStatus = 'T', CASE TchType WHEN 'V' THEN '1' WHEN 'I' THEN '2' ELSE '' END, '')
        ,drvStatusChangeDate = (SELECT MAX(AudDateTime) FROM dbo.U_EDIRECTPAT_Audit WHERE AudEEID = xEEID AND AudFieldName = 'EecDedGroupCode' AND AudDateTime >= @StartDate) --Most recent effective date of audited EhcDedGroupCode record
        ,drvJobTitle = JbcDesc 
        ...
        ,drvLOAendDate = CASE WHEN EecEmplStatus = 'A' 
                              THEN (SELECT MAX(AudDateTime) FROM dbo.U_EDIRECTPAT_Audit WHERE AudEEID = xEEID AND AudFieldName = 'EecEmplStatus' AND audOldValue = 'L' AND audNewValue = 'A') END
...
--Update Dates
UPDATE dbo.AscExp
    SET expLastStartPerControl = '202204201'
       ,expStartPerControl     = '202204201'
       ,expLastEndPerControl   = '202204279'
       ,expEndPerControl       = '202204279'
       ,expCOIDList            = 'WSGTJ,14CGB,RW4WR,S92SH,6OBUQ,S92PR,S92N5'
       ,expAscFileName         = '\\us.saas\e4\Public\GRA1017\Exports\Direct Path\EDIRECTPAT_TEST_XOE_20220427.txt'
WHERE expFormatCode = 'EDIRECTPAT' AND expExportCode='TEST_XOE';
