...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvBenStartDate = dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate, '11/1/2022')
        ,drvPlanCode = CASE
        ...
        ,drvMemberOrigEffDate = ISNULL(CONVERT(VARCHAR, (CASE WHEN EedDedCode IN ('GTLEX', 'ADDCX', 'CIE20', 'CIS10', 'CIS5','ACC', 'HSPL', 'HSPH', 'STDER', 'LTDEX', 'GTLEE', 'ADDCE', 'LIFEE', 'LIFES', 'LIFEC', 'LTD', 'ACCL','CIC2','CIC5') THEN
                                    dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate, '11/1/2022') END), 112), '')
        ...
        ,drvSubscriberClassID = CASE WHEN EecDedGroupCode = 'EXEC' THEN '2001'
                                 ...
                                 END
        ,drvSubClassEffDate = dbo.dsi_fnGetMinMaxDates('MAX', EecDateOfLastHire,'11/1/2022') 
