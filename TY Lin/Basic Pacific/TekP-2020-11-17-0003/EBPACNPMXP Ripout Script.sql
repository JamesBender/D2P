...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EBPACNPMXP_20210407.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Basic Pacific NPM Export-Test','202104061','EMPEXPORT','TEST_XOE','Apr  6 2021  7:08PM','EBPACNPMXP',NULL,NULL,NULL,'202104061','Apr  6 2021 12:00AM','Dec 30 1899 12:00AM','202103011','12','','','202103011',dbo.fn_GetTimedKey(),NULL,'us3cPeTYL1001',NULL);
