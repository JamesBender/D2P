...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '3',@AdhSystemID,'1','D','58','3',NULL,NULL,NULL,NULL,'"Drv2310NM102"','(''UA''=''T*'')';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'On demand run',CONVERT(CHAR(8),GETDATE(),112) + '1','EMPEXPORT','ONDEMAND',NULL,'@CustomFormatCode',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '9',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '9',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled run',CONVERT(CHAR(8),GETDATE(),112) + '1','EMPEXPORT','SCHEDULED',NULL,'@CustomFormatCode',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '9',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '9',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Test run',CONVERT(CHAR(8),GETDATE(),112) + '1','EMPEXPORT','TEST',NULL,'@CustomFormatCode',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '9',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '9',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Open enrollment - passive',CONVERT(CHAR(8),GETDATE(),112) + '1','EMPEXPORT','OEPASSIVE',NULL,'@CustomFormatCode',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '9',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '9',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Open enrollment - active',CONVERT(CHAR(8),GETDATE(),112) + '1','EMPEXPORT','OEACTIVE',NULL,'@CustomFormatCode',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '9',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '9',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
...
BEGIN
    ...
    DrvLoop2000INS02RelationshipCode = CASE WHEN ConRelationship = 'SPS' THEN '01'  
    ...
    DrvSort                = DrvSort,
    drvSubSort             = '2100A',
    DrvNameLast            = CASE WHEN DrvRecType = 'EMP' THEN EepNameLast 
                                  WHEN DrvRecType = 'DEP' THEN ConNameLast 
                             END,
    DrvNameFirst           = CASE WHEN DrvRecType = 'EMP' THEN EepNameFirst 
                                  WHEN DrvRecType = 'DEP' THEN ConNameFirst 
                             END,
    DrvNameMiddle          = CASE WHEN DrvRecType = 'EMP' THEN EepNameMiddle
                                  WHEN DrvRecType = 'DEP' THEN ConNameMiddle
                             END,
    DrvNamePrefix          = CASE WHEN DrvRecType = 'EMP' THEN CASE WHEN EepNamePrefix = 'Z' THEN '' ELSE EepNamePrefix END
                                  ELSE ''
                             END,
    DrvNameSuffix          = CASE WHEN DrvRecType = 'EMP' THEN CASE WHEN EepNameSuffix = 'Z' THEN '' ELSE EepNameSuffix END
    ...
    DrvLoop2100ADMG04      = CASE WHEN DrvRecType = 'EMP' THEN CASE EepMaritalStatus WHEN 'M' THEN 'M' ELSE 'I' END 
