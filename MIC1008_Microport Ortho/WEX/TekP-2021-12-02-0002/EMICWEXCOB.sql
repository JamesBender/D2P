...
Project:        WEX COBRA
Client ID:      MIC1008
Date/time:      2022-06-06 10:50:14.123
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EMICWEXCOB_20220606.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','202205309','EMPEXPORT','OEACTIVE',NULL,'EMICWEXCOB',NULL,NULL,NULL,'202205309','Dec 22 2021 12:57PM','Dec 22 2021 12:57PM','202205011',NULL,'','','202205011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','202205309','EMPEXPORT','OEPASSIVE',NULL,'EMICWEXCOB',NULL,NULL,NULL,'202205309','Dec 22 2021 12:57PM','Dec 22 2021 12:57PM','202205011',NULL,'','','202205011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WEX COBRA','202205309','EMPEXPORT','ONDEM_XOE',NULL,'EMICWEXCOB',NULL,NULL,NULL,'202205309','Dec 22 2021 12:57PM','Dec 22 2021 12:57PM','202205011',NULL,'','','202205011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WEX COBRA-Sched','202205309','EMPEXPORT','SCH_EMICWE',NULL,'EMICWEXCOB',NULL,NULL,NULL,'202205309','Dec 22 2021 12:57PM','Dec 22 2021 12:57PM','202205011',NULL,'','','202205011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','73Y89,7S10A,M5E06,70IXB',NULL,NULL,NULL,'WEX COBRA-Test','202205309','EMPEXPORT','TEST_XOE','May 20 2022  1:30PM','EMICWEXCOB',NULL,NULL,NULL,'202205309','May 19 2022 12:00AM','Dec 30 1899 12:00AM','202205011','19','','','202205011',dbo.fn_GetTimedKey(),NULL,'us3cPeMIC1008',NULL);
...
UPDATE dbo.AscExp
    SET expLastStartPerControl = '202205011'
       ...
       ,expLastEndPerControl   = '202205309'
       ,expEndPerControl       = '202205309'
WHERE expFormatCode = 'EMICWEXCOB';
...
BEGIN
    ...
    --================
    DELETE FROM dbo.U_EMICWEXCOB_EEList
    WHERE xEEID in ( 'B8JR7V0020K0','B8IABE0010K0','BQX8JZ0000K0','BQX8JZ0000K0')

    --NOT EXISTS (SELECT 1 FROM dbo.U_EMICWEXCOB_Audit WHERE audEEID = xEEID AND audRowNo = 1);
    ...
    INSERT INTO dbo.U_dsi_BDM_Configuration VALUES (@FormatCode,'CobraReasonsDepPQB','204,210,LEVNT3,LEVNT4'); -- Add valid dependent edhchangereasons
    INSERT INTO dbo.U_dsi_BDM_Configuration VALUES (@FormatCode,'InvalidCobraReasonsEmp','204,210,LEVNT3,LEVNT4'); -- Invalidate employee when Cobra Reason is a dependent PQB reason – Add valid dependent edhchangereasons (should be same as previous line above)
...
----====================================================
    ...
    JOIN dbo.U_dsi_BDM_DepDeductions WITH (NOLOCK)
     ...
     --Delete from dbo.U_dsi_BDM_EMICWEXCOB where BdmRelationship = 'Emp' and BdmChangeReason = '201'
    ...
    --==========================================
        ...
        FROM dbo.U_EMICWEXCOB_EEList WITH (NOLOCK)
            ...
            JOIN dbo.U_dsi_BDM_EMICWEXCOB WITH (NOLOCK)
                ...
                AND bdmRunID = 'QB'
                AND BdmIsPQB ='Y'
				AND BdmCobraReason not in ('201','203','204','210','DEA','LEVNT3','LEVNT4') 
                AND BdmRecType = 'EMP'
                ;

		INSERT INTO dbo.U_EMICWEXCOB_QB_drvTbl (
			drvEEID
            ,drvCoID
            ,drvEmpNoSort
            ,drvClientDivName  
		...
		SELECT DISTINCT
            ...
            ,drvCoID = BdmCoID
            --,drvDepRecID = CONVERT(varchar(12),'1') --DELETE IF NOT USING DEPENDENT DATA
            ,drvEmpNoSort = '1 ' + BdmEEID + ' 1'
            -- standard fields above and additional driver fields below
            ,drvClientDivName = CASE WHEN BdmCoID IN ('73Y89')    THEN 'MPI'
                                     WHEN BdmCoID IN ('70IXB')    THEN 'MPO'
                                     WHEN BdmCoID IN ('M5E06')    THEN 'CRM'
                                END   
            ,drvFirstName =	ConNameFirst
            ,drvMiddleInitial =		LEFT(ConNameMiddle,1)
            ,drvLastName =			ConNameLast
            ,drvSSN =				ConSSN
            ,drvAddressLine1 =		 REPLACE(conaddressline1,'PO Box', 'Post Office Box') 
            ,drvAddressLine2 =		Conaddressline2
            ,drvCityCity =			ConAddressCity
            ,drvStateState =		 ConAddressState
        ...
        FROM dbo.U_dsi_BDM_EMICWEXCOB WITH (NOLOCK)
           JOIN dbo.Contacts WITH (NOLOCK)
                ...
                Where bdmRunID = 'QB'
				AND BdmRelationship <> 'Emp'
                AND BdmCobraReason in ('201','203','204','210','DEA','LEVNT3','LEVNT4')
                ;
        ...
        SELECT DISTINCT
            ...
            -- standard fields above and additional driver fields below
            ,drvEventType = CASE    WHEN EecEmplStatus = 'T' and EecTermReason not in ('202','203','DEA') and BdmCobraReason not in ('201', 'LEVNT3') AND EecTermType = 'V' THEN 'TERMINATION'
                                    WHEN EecEmplStatus = 'T' and EecTermReason not in ('202','203','DEA') and BdmCobraReason not in ('201', 'LEVNT3') AND EecTermType = '' THEN 'TERMINATION'
        ...
        SELECT DISTINCT
            ...
            -- standard fields above and additional driver fields below
            ,drvSSN = conSSN
            ,drvRelationship = CASE WHEN BdmRelationship in ('CHL', 'DIS', 'DPC', 'STC') THEN 'CHILD'
        ...
        FROM dbo.U_EMICWEXCOB_EEList WITH (NOLOCK)
           ...
           JOIN dbo.CONTACTS WITH (NOLOCK)
              ON consystemID = BdmDepRecID
                --AND ConEEID not in ( 'B8JR7V0020K0')
                ;
