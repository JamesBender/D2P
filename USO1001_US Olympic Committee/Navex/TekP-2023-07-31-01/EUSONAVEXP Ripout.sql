...
Client ID:      USO1001
Date/time:      2023-09-22 12:40:14.460
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUSONAVEXP_20230922.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,NULL,'Navex Demographic Export-Test','202309219','EMPEXPORT','TEST_XOE',NULL,'EUSONAVEXP',NULL,NULL,NULL,'202309219','Sep 21 2023  1:07PM','Sep 21 2023  1:07PM','202309211',NULL,'','','202309211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
