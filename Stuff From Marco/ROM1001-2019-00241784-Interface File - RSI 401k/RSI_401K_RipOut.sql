...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EROMRSI401_20190829.txt',NULL,'','','',NULL,NULL,NULL,'RSI401k','201907199','EMPEXPORT','ONDEMAND','Aug 15 2019 10:39AM','EROMRSI401',NULL,NULL,NULL,'201907199','Jul 19 2019 12:00AM','Dec 30 1899 12:00AM','201907121','205','','','201907121',dbo.fn_GetTimedKey(),NULL,'US3MLAROM1001',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EROMRSI401_20190829.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','201907229','EMPEXPORT','SCHEDULED','Jul 24 2019 12:49PM','EROMRSI401',NULL,NULL,NULL,'201907229','Jul 22 2019 12:00AM','Dec 30 1899 12:00AM','201907121','206','','','201907121',dbo.fn_GetTimedKey(),NULL,'US3MLAROM1001',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EROMRSI401_20190829.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','201908239','EMPEXPORT','TEST','Aug 29 2019 10:23AM','EROMRSI401',NULL,NULL,NULL,'201908239','Aug 23 2019 12:00AM','Dec 30 1899 12:00AM','201908231','174','eecPayGroup','BWP','201908231',dbo.fn_GetTimedKey(),NULL,'us3lKiROM1001',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EROMRSI401_20190829.txt' END WHERE expFormatCode = 'EROMRSI401';
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,PehCurAmt              = SUM(CASE WHEN PehPerControl >= @StartPerControl AND PehEarnCode NOT IN  ('HSAEB','HSAEW') THEN PehCurAmt ELSE 0.00 END)
    ...
    SELECT DISTINCT
        ...
        ,drvdateOfTermination = CASE WHEN EecEmplStatus = 'T' THEN EecDateOfTermination 
                                           WHEN EecEmplStatus IN ('A','S') AND EecDateOfOriginalHire <> EecDateOfLastHire AND (EecHireSource = 'REHIRE' OR EecJobChangeReason = '101') THEN 
                                           (select Max(EjhJobEffDate) from dbo.[EmpHJob] where EJhEEid = xEEID   and EjhEmplStatus = 'T')
                                           ELSE NULL END
        ,drvRehireDate = CASE WHEN EecEmplStatus IN ('A','S') AND EecDateOfOriginalHire <> EecDateOfLastHire AND (EecHireSource = 'REHIRE' OR EecJobChangeReason = '101') THEN EecDateOfLastHire ELSE NULL END
