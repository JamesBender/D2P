...
Client ID:      CLI1003
Date/time:      2022-02-03 04:55:45.997
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('17','ECUTRAMPEXZ0','200','D','10','17',NULL,'Job Title',NULL,NULL,'"drvJobTitle"','(''UA''=''T,'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECUTRAMPEX_20220203.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','IAGFG,Y5USD,XI0GS,HG0SP,VLYMR,368IV,B57L5',NULL,NULL,NULL,'Culture Amp Demographic -Sched','202104229','EMPEXPORT','SCH_ECUTRA','Apr 22 2021 12:46PM','ECUTRAMPEX',NULL,NULL,NULL,'202202029','Apr 22 2021 12:00AM','Dec 30 1899 12:00AM','202202011','124','','','202104011',dbo.fn_GetTimedKey(),NULL,'us3rVaCLI1003',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','IAGFG,Y5USD,XI0GS,HG0SP,VLYMR,368IV,B57L5',NULL,NULL,NULL,'Culture Amp Demographic -Test','202202019','EMPEXPORT','TEST_XOE','Jan  7 2022 10:53AM','ECUTRAMPEX',NULL,NULL,NULL,'202202019','Jan  7 2022 12:00AM','Jan  1 2022 12:00AM','202202011','122','','','202202011',dbo.fn_GetTimedKey(),NULL,'us3rVaCLI1003',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECUTRAMPEX','TestPath','V',NULL);
...
CREATE TABLE [dbo].[U_ECUTRAMPEX_drvTbl] (
    ...
    [drvPrefferedName] varchar(102) NULL,
    [drvEmployeeID] varchar(11) NULL,
    [drvAddressEmail] varchar(52) NULL,
    [drvDateOfBirth] varchar(12) NULL,
    [drvStartDate] varchar(12) NULL,
    [drvEndDate] varchar(12) NULL,
    [drvManager] varchar(8000) NULL,
    [drvManagerEmail] varchar(52) NULL,
    [drvGender] varchar(12) NOT NULL,
    [drvLocation] varchar(27) NULL,
    [drvBusinessUnit] varchar(27) NULL,
    [drvDepartment] varchar(47) NULL,
    [drvEmploymentType] varchar(11) NOT NULL,
    [drvJobTitle] varchar(152) NULL,
    [drvOrgLvl1Manager] varchar(203) NOT NULL,
    [drvOrgLvl3Description] varchar(27) NULL,
    [drvAge] varchar(32) NULL,
    [drvTimeInRole] varchar(32) NULL,
    [drvRateEthnicity] varchar(47) NULL,
    [drvOrvLvl2Description] varchar(257) NULL,
    [drvFSLAType] varchar(12) NOT NULL,
    [drvCompany] varchar(42) NULL,
    [drvEmploymentStatus] varchar(18) NOT NULL,
    [drvCountry] varchar(47) NULL,
    [drvManagerEEID] varchar(11) NULL
);
...
12/09/2021 by AP:
    ...
    - Removed hyphens from name and manager names.
...
BEGIN
   ...
   SELECT xEEID
    ...
    SELECT DISTINCT
        ...
        ,drvName =  '"' + dbo.dsi_fnRemoveChars('.,/',E.EepNameFirst + ' ' + E.EepNameLast) + '"'
        ,drvPrefferedName = '"' + CASE WHEN E.EepNamePreferred IS NOT NULL THEN E.EepNamePreferred ELSE E.EepNameFirst END + '"'
        ,drvEmployeeID = '"' + RTRIM(EC.EecEmpNo) + '"'
        ,drvAddressEmail = '"' + E.EepAddressEMail + '"'
        ,drvDateOfBirth = '"' + CONVERT(VARCHAR(10), E.EepDateOfBirth, 23) + '"'
        ,drvStartDate = '"' + CONVERT(VARCHAR(10), EC.EecDateOfLastHire, 23) + '"'
        ,drvEndDate = '"' + CONVERT(VARCHAR(10), EC.EecDateOfTermination, 23) + '"'
        ,drvManager = '"' + REPLACE(REPLACE(SUP.EepNameFirst + ' ' + SUP.EepNameLast, 'é', 'e'), '-', '') + '"'
        ...
        ,drvAge = '"' + CONVERT(VARCHAR,DATEDIFF(hour,E.EepDateOfBirth,GETDATE())/8766) + '"'
        ,drvTimeInRole =  '"' + CONVERT(VARCHAR,EjhMonthsInJobCode) + '"'
        ,drvRateEthnicity = '"' + RTRIM(EDesc) + '"' -- E.EepEthnicID
        ...
        ,drvManagerEEID = '"' + RTRIM((SELECT TOP 1 SUP.EecEmpNo FROM dbo.EmpComp SUP WITH (NOLOCK) WHERE SUP.EecEEID = EC.EecSupervisorId)) + '"'
