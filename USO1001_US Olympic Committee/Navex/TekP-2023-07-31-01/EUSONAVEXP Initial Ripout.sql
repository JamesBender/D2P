...
Client ID:      USG1000
Date/time:      2023-09-21 14:51:29.787
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EZ24
...
Web Filename:   USG1000_79690_EEHISTORY_EUSONAVEXP_ExportCode_YYYYMMDD_HHMMSS.txt
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUSONAVEXP_20230921.txt';
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSONAVEXP','ExportPath','V','\\ez2sup4db01\ultiprodata\[Name]\Exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSONAVEXP','UseFileName','V','N');
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvManager ='ManagerID'
        ,drvManagerName = 'ManagerName'
        ,drvManagerEmail = 'ManagerEmail'
        ,drvHireDate = 'HireDate'
        ,drvEmpType = 'EmpType'
