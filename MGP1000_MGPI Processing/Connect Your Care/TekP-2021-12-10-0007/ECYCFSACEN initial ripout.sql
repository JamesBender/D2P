...
Client ID:      MGP1000
Date/time:      2022-01-25 20:52:12.653
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECYCFSACEN_20220125.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','M0UP1,M0U4Y',NULL,NULL,NULL,'CYC FSA HSA Census-Scheduled','202012019','EMPEXPORT','SCH_ECYCFS',NULL,'ECYCFSACEN',NULL,NULL,NULL,'202201219','Dec  1 2020  9:04AM','Dec  1 2020  9:04AM','202201141',NULL,'','','202012011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
EXEC dbo._dsi_usp_ExportRipOut_v7 @FormatCode = 'ECYCFSACEN', @AllObjects = 'Y', @IsWeb = 'Y'
**********************************************************************************/
BEGIN
...
WHERE AdfHeaderSystemID LIKE 'ECYCFSACEN%'
