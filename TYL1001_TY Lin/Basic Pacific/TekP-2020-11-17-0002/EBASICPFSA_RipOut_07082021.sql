...
GO
IF OBJECT_ID('U_EBASICPFSA_drvTbl') IS NOT NULL DROP TABLE [dbo].[U_EBASICPFSA_drvTbl];
GO
...
GO
IF OBJECT_ID('U_EBASICPFSA_Audit_Final') IS NOT NULL DROP TABLE [dbo].[U_EBASICPFSA_Audit_Final];
GO
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EBASICPFSA_20210708.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Basic Pacific FSA Export-Test','202106299','EMPEXPORT','TEST_XOE','Jun 29 2021  1:47PM','EBASICPFSA',NULL,NULL,NULL,'202106299','Jun 29 2021 12:00AM','Dec 30 1899 12:00AM','202104191','165','','','202104191',dbo.fn_GetTimedKey(),NULL,'us3cPeTYL1001',NULL);
...
IF OBJECT_ID('U_EBASICPFSA_drvTbl') IS NULL
CREATE TABLE [dbo].[U_EBASICPFSA_drvTbl] (
    ...
    [drvIndividualSSN] char(11) NULL,
    [drvLastName] varchar(100) NULL,
    [drvFirstName] varchar(100) NULL,
    [drvBenefitPlanID] varchar(10) NULL,
    [drvEffectiveDate] datetime NULL,
    [drvElectionChangeDate] varchar(30) NOT NULL,
    [drvEligibilityEndDate] datetime NULL,
    [drvIndividualElectionAmount] varchar(30) NULL,
    [drvClientElectionAmount] varchar(1) NOT NULL,
    [drvDisbursableDate] varchar(1) NOT NULL,
    [drvTakeoverOverride] varchar(1) NOT NULL,
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvElectionChangeDate =  ISNULL(CONVERT(VARCHAR, (CASE WHEN EecDateOfOriginalHire BETWEEN @StartDate AND @EndDate THEN NULL
											WHEN EjhReason = '100' THEN NULL
											WHEN audKey3 IN ('FSA19', 'DCA19', 'LPF19', 'LPT19') AND CAST(BdmBenStartDate AS DATE) <> CAST(YEAR(GETDATE()) AS VARCHAR) + '-01-01' AND EjhReason <> '100' THEN NULL
