...
Client ID:      MGP1000
Date/time:      2022-02-04 12:29:02.527
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECYCCBNPM_20220204.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N',',M0UP1,M0U4Y',NULL,NULL,NULL,'CYC Cobra NPM Scheduled','202004229','EMPEXPORT','SCH_ECYCCB',NULL,'ECYCCBNPM',NULL,NULL,NULL,'202202049','Jan 13 2016  8:53AM','Jan 13 2016  8:53AM','202201281',NULL,'','','202001011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
EXEC dbo._dsi_usp_ExportRipOut_v7_4 @FormatCode = 'ECYCCBNPM', @AllObjects = 'Y', @IsWeb = 'Y';
