...
ECYCFSAHSA: ConnectYourCare Enrollment Export

FormatCode:     ECYCFSAHSA
Project:        ConnectYourCare Enrollment Export
Client ID:      MAR1025
Date/time:      2022-01-13 11:33:12.950
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
Server:         EW2WUP4DB01
Database:       ULTIPRO_WPMARAT
Web Filename:   MAR1025_2095F_EEHISTORY_ECYCFSAHSA_ExportCode_YYYYMMDD_HHMMSS.txt
ExportPath:    
...
DELETE FROM dbo.U_dsi_RipoutParms WHERE rpoFormatCode = 'ECYCFSAHSA'
...
DELETE [dbo].[AscDefF] WHERE EXISTS (SELECT 1 FROM dbo.AscDefH WHERE AdfHeaderSystemID = AdhSystemID AND AdhFormatCode = 'ECYCFSAHSA')
DELETE FROM [dbo].[AscExp]                 WHERE ExpFormatCode = 'ECYCFSAHSA'
DELETE FROM [dbo].[AscImp]                 WHERE ImpFormatCode = 'ECYCFSAHSA'
DELETE FROM [dbo].[AscDefH]                WHERE AdhFormatCode = 'ECYCFSAHSA'
DELETE FROM [dbo].[U_dsi_Configuration]    WHERE FormatCode    = 'ECYCFSAHSA'
DELETE FROM [dbo].[U_dsi_SQLClauses]       WHERE FormatCode    = 'ECYCFSAHSA'
DELETE FROM [dbo].[U_dsi_RecordSetDetails] WHERE FormatCode    = 'ECYCFSAHSA'

IF OBJECT_ID('dbo.U_dsi_Translations')    IS NOT NULL DELETE FROM [dbo].[U_dsi_Translations]    WHERE FormatCode = 'ECYCFSAHSA'
IF OBJECT_ID('dbo.U_dsi_Translations_v2') IS NOT NULL DELETE FROM [dbo].[U_dsi_Translations_v2] WHERE FormatCode = 'ECYCFSAHSA'
IF OBJECT_ID('dbo.U_dsi_Translations_v3') IS NOT NULL DELETE FROM [dbo].[U_dsi_Translations_v3] WHERE FormatCode = 'ECYCFSAHSA'
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','SDF','ECYCFSAHSA','ConnectYourCare Enrollment Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','300','S','N','ECYCFSAHSAZ0','N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N');

-----------
-- AscDefF inserts
-----------

INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('1','ECYCFSAHSAZ0','11','D','10','1',NULL,'Account SSN',NULL,NULL,'"drvSSN"','(''UA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('2','ECYCFSAHSAZ0','30','D','10','12',NULL,'Employee ID',NULL,NULL,'"drvEmpNo"','(''UA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('3','ECYCFSAHSAZ0','30','D','10','42',NULL,'Partner Account Number',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('4','ECYCFSAHSAZ0','30','D','10','72',NULL,'Policy Number',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('5','ECYCFSAHSAZ0','2','D','10','102',NULL,'Transaction Type',NULL,NULL,'"drvTransactionType"','(''UA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('6','ECYCFSAHSAZ0','8','D','10','104',NULL,'Transaction Effective Date',NULL,NULL,'"drvTransactionEffDate"','(''UA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('7','ECYCFSAHSAZ0','8','D','10','112',NULL,'Policy Effective Date',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('8','ECYCFSAHSAZ0','20','D','10','120',NULL,'Enrollment Submitter ID',NULL,NULL,'"MARATHONHEALTH"','(''DA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('9','ECYCFSAHSAZ0','30','D','10','140',NULL,'Employer ID',NULL,NULL,'"MARATHONHEALTH"','(''DA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('10','ECYCFSAHSAZ0','30','D','10','170',NULL,'Employer Offering ID',NULL,NULL,'"drvEmployerOfferingID"','(''UA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('11','ECYCFSAHSAZ0','10','D','10','200',NULL,'Option ID',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('12','ECYCFSAHSAZ0','10','D','10','210',NULL,'Tier Coverage Code',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('13','ECYCFSAHSAZ0','10','D','10','220',NULL,'Total Policy Amount',NULL,NULL,'"drvTotalPolicyAmt"','(''UA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('14','ECYCFSAHSAZ0','8','D','10','230',NULL,'HSA Disclosure Date',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('15','ECYCFSAHSAZ0','8','D','10','238',NULL,'HSA Disclosure Time',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('16','ECYCFSAHSAZ0','30','D','10','246',NULL,'Partner Employee ID',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('17','ECYCFSAHSAZ0','20','D','10','276',NULL,'HSA Account Number',NULL,NULL,'""','(''SS''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('18','ECYCFSAHSAZ0','5','D','10','296',NULL,'Filler',NULL,NULL,'""','(''SS''=''F'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECYCFSAHSA_20220113.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','UEQ5H,UEQBA,UEQ7C,UEQ8J,UEQ9V,UEQGB,UEQDT,UEQF7,UEQCJ,JOA2K,CVUC0',NULL,NULL,NULL,'Active Open Enrollment Export','202201159','EMPEXPORT','OEACTIVE','Dec 29 2021 12:00AM','ECYCFSAHSA',NULL,NULL,NULL,'202201159','Jan 15 2022 12:00AM','Dec 30 1899 12:00AM','202112011',NULL,'','','202112011',dbo.fn_GetTimedKey(),NULL,'us3lKiMAR1025',NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','UEQ5H,UEQBA,UEQ7C,UEQ8J,UEQ9V,UEQGB,UEQDT,UEQF7,UEQCJ,JOA2K,CVUC0',NULL,NULL,NULL,'ConnectYourCare Enroll. Wed@9a','202012319','EMPEXPORT','SCH_ECYCFS',NULL,'ECYCFSAHSA',NULL,NULL,NULL,'202201119','Nov 30 2020  6:30PM','Nov 30 2020  6:30PM','202201041',NULL,'','','202010011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',',UEQ5H,UEQBA,UEQ7C,UEQ8J,UEQ9V,UEQGB,UEQDT,UEQF7,UEQCJ,JOA2K,CVUC0',NULL,NULL,NULL,'Testing Purposes Only','202201119','EMPEXPORT','TEST_XOE','Jan 13 2022 12:00AM','ECYCFSAHSA',NULL,NULL,NULL,'202201119','Jan 11 2022 12:00AM','Dec 30 1899 12:00AM','202201041','963','','','202201041',dbo.fn_GetTimedKey(),NULL,'us3lKiMAR1025',NULL);
...
-----------
-- Create table U_dsi_BDM_ECYCFSAHSA
-----------
...
-----------
-- Create table U_dsi_BDM_ECYCFSAHSA_G10_BKP_2021_PROD
-----------
...
-----------
-- Create table U_ECYCFSAHSA_DedList
-----------
...
-----------
-- Create table U_ECYCFSAHSA_drvTbl
-----------
...
-----------
-- Create table U_ECYCFSAHSA_EEList
-----------
...
-----------
-- Create table U_ECYCFSAHSA_File
-----------
...
-----------
-- Create table U_ECYCFSAHSA_G10_BKP_2021_PROD_DedList
-----------
...
-----------
-- Create table U_ECYCFSAHSA_G10_BKP_2021_PROD_drvTbl
-----------
...
-----------
-- Create table U_ECYCFSAHSA_G10_BKP_2021_PROD_EEList
-----------
...
-----------
-- Create table U_ECYCFSAHSA_G10_BKP_2021_PROD_File
-----------
...
-----------
-- Create table U_ECYCFSAHSA_PEarHist
-----------
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvTotalPolicyAmt = CASE WHEN BdmDedCode IN ('FSADC','FSAMD') THEN CONVERT(VARCHAR,CONVERT(DECIMAL(18,0),(BdmEEAmt * 26 * 100))) ELSE '0' END
                                --CASE WHEN BdmDedCode IN ('FSADC','FSAMD') and BdmEEGoalAmt <> 0 THEN CONVERT(VARCHAR,CONVERT(DECIMAL(18,0),(BdmEEAmt * 26 * 100)))  
                                --WHEN BdmDedCode IN ('FSADC','FSAMD') AND ISNULL(PrgPayPerRemainInYr,0) <> 0 and BdmEEGoalAmt = 0 THEN CONVERT(VARCHAR,CONVERT(DECIMAL(18,0),(PrgPayPerRemainInYr * BdmEEAmt * 100))) 
                                --WHEN BdmDedCode IN ('FSADC','FSAMD') AND ISNULL(PrgPayPerRemainInYr,0) = 0 and BdmEEGoalAmt = 0 THEN CONVERT(VARCHAR,CONVERT(DECIMAL(18,0),(PrgPayPerRemainInYr * BdmEEAmt * 100))) 
                                --ELSE '0' END
        
                                --CASE WHEN BdmDedCode IN ('FSADC','FSAMD') AND ISNULL(PrgPayPerRemainInYr,0) <> 0 THEN REPLACE(PrgPayPerRemainInYr * BdmEEAmt,'.','') -- Updated 7/27/21 KJM CASE WHEN BdmDedCode IN ('FSADC','FSAMD') THEN CONVERT(VARCHAR,CONVERT(DECIMAL(18,0),(BdmEEAmt * 26 * 100))) ELSE '0' END
    ...
    --       WHERE ppeEarnCode IS NOT NULL  --IN ('REG','REG2','RGSLY')
...
SELECT Engine = AdhEngine, EngineCode = AdhFormatCode
 ...
 WHERE AdhFormatCode = 'ECYCFSAHSA' AND AdhEngine = 'EMPEXPORT'
...
UPDATE dbo.U_dsi_Configuration
 ...
 WHERE rpoFormatCode = 'ECYCFSAHSA'
...
EXEC dbo.dsi_sp_UpdateConfig 'ECYCFSAHSA', 'ExportPath', 'V', NULL
EXEC dbo.dsi_sp_UpdateConfig 'ECYCFSAHSA', 'TestPath', 'V', NULL
...
EXEC dbo.dsi_sp_UpdateConfig 'ECYCFSAHSA', 'UseFileName', 'V', 'Y'
