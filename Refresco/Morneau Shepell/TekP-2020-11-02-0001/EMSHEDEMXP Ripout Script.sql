...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EMSHEDEMXP_20210108.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','CMCOX',NULL,NULL,NULL,'Morneau Shepell Demo Exp-Test','202012169','EMPEXPORT','TEST_XOE','Jan  8 2021 12:00AM','EMSHEDEMXP',NULL,NULL,NULL,'202012169','Dec 16 2020 12:00AM','Dec 30 1899 12:00AM','202012021','401','','','202012021',dbo.fn_GetTimedKey(),NULL,'JBENDER10',NULL);
