...
        ,drvDepRelationshipCode1 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator1 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) = 1 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp1 = ''  
        ,drvDepFirstName2 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode2 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator2 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 2 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp2 = ''  
        ,drvDepFirstName3 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode3 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
        ,drvDepStudentCode3 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN3 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator3 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 3 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp3 = ''  
        ,drvDepFirstName4 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode4 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator4 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 4 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp4 = ''  
        ,drvDepFirstName5 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode5 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator5 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 5 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp5 = ''  
        ,drvDepFirstName6 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepDateOfBirth6 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConDateOfBirth from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepRelationshipCode6 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
        ,drvDepStudentCode6 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepCvgIndicator6 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 6 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp6 = ''  
        ,drvDepFirstName7 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode7 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator7 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 7 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp7 = ''  
        ,drvDepFirstName8 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode8 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator8 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 8 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp8 = ''  
        ,drvDepFirstName9 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode9 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
        ,drvDepStudentCode9 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepDisabledYN9 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator9 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 9 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp9 = ''  
        ,drvDepFirstName10 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode10 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
        ,drvDepStudentCode10 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT 'N' from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepCvgIndicator10 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 10 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp10 = ''  
        ,drvDepFirstName11 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode11 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 10 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator11 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 11 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp11 = ''  
        ,drvDepFirstName12 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode12 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 11 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator12 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 12 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp12 = ''  
        ,drvDepFirstName13 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode13 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepDisabledYN13 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConIsDisabled from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 12 ROWS FETCH NEXT 1 ROWS ONLY) END
        ,drvDepCvgIndicator13 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 13 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp13 = ''  
        ,drvDepFirstName14 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode14 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 13 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator14 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 14 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp14 = ''  
        ,drvDepFirstName15 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN (SELECT ConNameFirst from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) END
...
        ,drvDepRelationshipCode15 = CASE WHEN DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL OR VIS_DedCode IS NOT NULL OR VLIFC_DedCode IS NOT NULL OR VLIFS_DedCode IS NOT NULL THEN ( CASE WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) in ('SPS', 'DP') THEN 'S' WHEN (SELECT ConRelationship from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' and ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ORDER BY ConSSN OFFSET 14 ROWS FETCH NEXT 1 ROWS ONLY) in ('DIS','CHL', 'DPC', 'STC') THEN 'C' END) END
...
        ,drvDepCvgIndicator15 = CASE WHEN ( SELECT COUNT(*) from Contacts WHERE ConEEID = xEEID AND ConIsActive = 'Y' AND ConIsDependent = 'Y' AND ConSSN IS NOT NULL AND ConRelationship in (Select Code from @DepRelCodes) ) >= 15 THEN CASE WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NOT NULL THEN '"D,V"' WHEN (DEN1_DedCode IS NOT NULL OR DEN2_DedCode IS NOT NULL) AND VIS_DedCode IS NULL THEN 'D' WHEN (DEN1_DedCode IS NULL AND DEN2_DedCode IS NULL) AND VIS_DedCode IS NOT NULL THEN 'V' END END  
        ,drvDedDhmoPcp15 = ''  
        -- Dependant End
