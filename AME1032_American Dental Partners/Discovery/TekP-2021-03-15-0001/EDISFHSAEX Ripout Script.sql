...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISFHSAEX_20210607.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Discovery FSA/HSA Contrb-Test','202105219','EMPEXPORT','TEST_XOE','Jun  4 2021  2:36PM','EDISFHSAEX',NULL,NULL,NULL,'202105219','May 21 2021 12:00AM','Dec 30 1899 12:00AM','202105151','128','','B1,B1TEST,B2,B2TEST,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14,B15,B16,B17,B18,B19,B20,B21,B22,B23,B24,B25,B26,B27,B28,B29,B30,B31,B32,B33,B34,B35,B36,B37,B38,B39,B40,B41,B42,B43,B44,B45,B46,B47,B48,B49,B50,B51,B52,B53,B54,M1,M2,M3,M4,M5,M6,M7,M8,S1,S1TEST,','202105151',dbo.fn_GetTimedKey(),NULL,'CPETITTI17',NULL);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvContributionDescription = 'Payroll Deduction' --CASE WHEN PdhFSAIAmt > 0 THEN 'Payroll Deduction' END
