...
Client ID:      COA1009
Date/time:      2022-05-18 11:58:19.720
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    NWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EWEXCTREXP_20220518.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'WEX FSA/DepCare/HAS/T & -Test','202204151','EMPEXPORT','TEST_XOE','May 17 2022 11:48AM','EWEXCTREXP',NULL,NULL,NULL,'202204151','Apr 15 2022 12:00AM','Apr 15 2022 12:00AM','202204151','1999','eecPayGroup','CFSAL,CFHRLY,FEDSAL','202204151',dbo.fn_GetTimedKey(),NULL,'us3cPeCOA1009',NULL);
