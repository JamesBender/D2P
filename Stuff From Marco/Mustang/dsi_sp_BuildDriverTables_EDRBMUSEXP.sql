...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvMemberEffectiveDate"','7','(''UD112''=''F'')','EDRBMUSEXPZ0','8','D','10','7',NULL,'Member Effective Date',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvDateofHire"','25','(''UD112''=''F'')','EDRBMUSEXPZ0','8','D','10','25',NULL,'Date of Hire',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvLocationDate"','27','(''UD112''=''F'')','EDRBMUSEXPZ0','8','D','10','27',NULL,'Location Date',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvSalaryEffectiveDate"','30','(''UD112''=''F'')','EDRBMUSEXPZ0','8','D','10','30',NULL,'Salary Effective Date',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvTerminationDate"','33','(''UD112''=''F'')','EDRBMUSEXPZ0','8','D','10','33',NULL,'Termination Date',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvApplicationReceivedDate"','40','(''UD112''=''F'')','EDRBMUSEXPZ0','8','D','10','40',NULL,'Application Received Date',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDRBMUSEXP_20210413.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','',NULL,NULL,NULL,NULL,'Dearborn File Export-Test','202104099','EMPEXPORT','TEST_XOE',NULL,'EDRBMUSEXP',NULL,NULL,NULL,'202104099','Apr  9 2021 12:30PM','Apr  9 2021 12:30PM','202104091',NULL,'','','202104091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
CREATE TABLE [dbo].[U_EDRBMUSEXP_drvTbl] (
    ...
    [drvWeeklyHours] varchar(1) NOT NULL,
    ...
    [drvUnits] varchar(9) NULL,
    [drvProductSetId] varchar(5) NULL,
    [drvUnderwritingStatsInd] varchar(1) NULL,
    [drvApplicationReceivedDate] varchar(8) NULL,
    [drvCertificateNumber] varchar(10) NULL,
    [drvDependentSequence] varchar(2) NULL,
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvSubSort = CONVERT( VARCHAR(4) , (CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN '1'
        ...
        ,drvAccountNumber = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN '00001'
                         ...
                         END
        ,drvDependentSSN = eepSSN

        
        ,drvMemberEffectiveDate =  CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN dbo.dsi_fnGetMinMaxDates('MAX',BdmBenStartDate, @FileMinCovDate)
        ...
        ,drvGender = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN 
                              ...
                              WHEN bdmrectype = 'DEP' and bdmrelationship = 'SPS' and bdmdedcode in ('LIFES','CRILS') THEN 
                                CASE WHEN ConGender = 'M' THEN 'M'
                                    ...
                                    END
                         END 
        ,drvDateofBirth = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN EepDateOfBirth
        ...
        ,drvSmokerIndicator = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN 
                              ...
                              WHEN bdmrectype = 'DEP' and bdmrelationship = 'SPS' and bdmdedcode in ('LIFES','CRILS') THEN 
                                CASE WHEN ConIsSmoker  = 'N' THEN 'N'
                                    END
                         END 
        ,drvDateofHire = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN dbo.dsi_fnGetMinMaxDates('MAX',EecDateOfLastHire , @FileMinCovDate)
        ...
        ,drvLocationNumber = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN 
                         ...
                         END
        ,drvLocationDate = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN dbo.dsi_fnGetMinMaxDates('MAX',EecDateOfLastHire , @FileMinCovDate)
                              WHEN bdmrectype = 'DEP' and bdmrelationship = 'SPS' and bdmdedcode in ('LIFES','CRILS') THEN dbo.dsi_fnGetMinMaxDates('MAX',EecDateOfLastHire , @FileMinCovDate)
                         END --TODO Need Audit Table

        ,drvReportedSalary = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN CONVERT(VARCHAR,dbo.dsi_fnPadZero(EecAnnSalary*100,12,0))  
                              WHEN bdmrectype = 'DEP' and bdmrelationship = 'SPS' and bdmdedcode in ('LIFES','CRILS') THEN CONVERT(VARCHAR,dbo.dsi_fnPadZero(EecAnnSalary*100,12,0)) 
                         END
        ...
        ,drvSalaryEffectiveDate = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN   dbo.dsi_fnGetMinMaxDates('MAX', dbo.dsi_fnlib_GetAnnSalary_EffDate_WithStartDate(EecEEID, EecCOID, GETdate(),EecDateOfLastHire)   , @FileMinCovDate)                           
        ...
        ,drvTerminationDate = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN 
        ...
        ,drvApplicationReceivedDate = SPACE(8)
        ,drvCertificateNumber = SPACE(10)
        ,drvDependentSequence = SPACE(2)
 ...
 SELECT DISTINCT
        ...
        ,drvMemberEffectiveDate =  dbo.dsi_fnGetMinMaxDates('MAX',BdmBenStartDate, @FileMinCovDate)
        ,drvIDNumber = ''
        ...
        ,drvGender = CASE WHEN bdmdedcode in ('VIS') THEN 
                        ...
                        END 
                    END  
        ,drvDateofBirth = CASE WHEN bdmdedcode in ('VIS') THEN ConDateOfBirth END 
        ,drvSmokerIndicator = CASE WHEN bdmrectype = 'EMP' and bdmdedcode in ('GACC', 'GLIFE', 'GTLII', 'LIFEE', 'LIFEC', 'CRILE', 'CRILC', 'VIS') THEN 
                                    CASE WHEN EepIsSmoker  = 'N' THEN 'N'
                                    END
                              WHEN bdmrectype = 'DEP' and bdmrelationship = 'SPS' and bdmdedcode in ('LIFES','CRILS') THEN 
        ...
        ,drvWeeklyHours = SPACE(5)
        ,drvProductId =  SPACE(7)
        ,drvTerminationDate = CASE WHEN bdmdedcode in ('VIS') and bdmBenStatus ='T' THEN bdmbenstopdate END 
    ...
    INSERT INTO dbo.U_EDRBMUSEXP_drvTbl
        ...
        ,drvDepRecID 
        ,drvInitialSort 
        ,drvSubSort =  CASE WHEN drvProductId = 'LIFE' THEN '61'
