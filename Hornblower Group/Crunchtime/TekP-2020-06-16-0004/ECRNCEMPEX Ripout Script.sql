...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','44','(''DA''=''TT'')','ECRNCEMPEXZ0','50','D','10','44',NULL,'Position Code 1',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ECRNCEMPEX_20201103.txt';
