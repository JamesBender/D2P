...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDRBMUSEXP_20210630.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Dearborn File Export-Test','202106181','EMPEXPORT','TEST_XOE','Jun 25 2021  6:18PM','EDRBMUSEXP',NULL,NULL,NULL,'202106181','Jun 18 2021 12:00AM','Dec 30 1899 12:00AM','202106041','1203','','','202106041',dbo.fn_GetTimedKey(),NULL,'us3cPeMUS1005',NULL);
