...
US Olympic Committee - Replace with customer name
Marco Lagrosa - Replace with TC name
Cheryl Petitti - Replace with BA/IC name
08/20/2020 - Replace with date of creation
TekP-2020-07-21-0003 - Replace with SR number
EUSCCON834 - Replace with Format Code (i.e., ESUNLIF834)
United Concordia 834 Export - Replace with Name of Interface (AdfFormatName) (i.e., Sunlife 834 Export)
USOC - Replace with Company Code (i.e., GOOG)
...
-- Data parameters
USOC - Replace with Company Code for Customer
DEN - Replace with Deduction Code List in CSV format (i.e., DED1,DED2,DED3)
...
*/
IF OBJECT_ID('dsi_vwEUSCCON834_Export') IS NOT NULL DROP VIEW [dbo].[dsi_vwEUSCCON834_Export];
GO
IF OBJECT_ID('dsi_sp_BuildDriverTables_EUSCCON834') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_BuildDriverTables_EUSCCON834];
GO
IF OBJECT_ID('dsi_sp_AfterCollect_EUSCCON834') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_AfterCollect_EUSCCON834];
GO
IF OBJECT_ID('U_EUSCCON834_TrlTbl') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_TrlTbl];
GO
IF OBJECT_ID('U_EUSCCON834_HdrTbl') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_HdrTbl];
GO
IF OBJECT_ID('U_EUSCCON834_File') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_File];
GO
IF OBJECT_ID('U_EUSCCON834_EEList') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_EEList];
GO
IF OBJECT_ID('U_EUSCCON834_DrvTbl_2300') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_DrvTbl_2300];
GO
IF OBJECT_ID('U_EUSCCON834_DrvTbl') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_DrvTbl];
GO
IF OBJECT_ID('U_EUSCCON834_DedList') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_DedList];
GO
IF OBJECT_ID('U_EUSCCON834_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_AuditFields];
GO
IF OBJECT_ID('U_EUSCCON834_Audit') IS NOT NULL DROP TABLE [dbo].[U_EUSCCON834_Audit];
GO
IF OBJECT_ID('U_dsi_BDM_EUSCCON834') IS NOT NULL DROP TABLE [dbo].[U_dsi_BDM_EUSCCON834];
GO
DELETE [dbo].[U_dsi_SQLClauses] FROM [dbo].[U_dsi_SQLClauses] WHERE FormatCode = 'EUSCCON834';
DELETE [dbo].[U_dsi_Configuration] FROM [dbo].[U_dsi_Configuration] WHERE FormatCode = 'EUSCCON834';
DELETE [dbo].[AscExp] FROM [dbo].[AscExp] WHERE expFormatCode = 'EUSCCON834';
DELETE [dbo].[AscDefF] FROM [dbo].[AscDefF] JOIN AscDefH ON AdfHeaderSystemID = AdhSystemID WHERE AdhFormatCode = 'EUSCCON834';
DELETE [dbo].[AscDefH] FROM [dbo].[AscDefH] WHERE AdhFormatCode = 'EUSCCON834';
GO

DECLARE @AdhSystemID VARCHAR(12), @FixedFormatName1 VARCHAR(50), @FixedFormatName2 VARCHAR(50);
SET @AdhSystemID = LEFT('EUSCCON834' + REPLICATE('0',10),10) + 'Z0';
SET @FixedFormatName1 = LEFT('United Concordia 834 Export',50);
SET @FixedFormatName2 = LEFT('United Concordia 834 Export',30);

INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) SELECT 'N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','EUSCCON834',@FixedFormatName1,'N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','2000','S','N',@AdhSystemID,'N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N';
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '1',@AdhSystemID,'3','H','05','1',NULL,'DTP Segment ID (Loop 2000)',NULL,NULL,'"drvDTP00_DateTime007"','(''UA''=''T*'')';
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '2',@AdhSystemID,'3','H','05','2',NULL,'Date/Time Qualifier',NULL,NULL,'"drvDTP01_DateTimeQualifier007"','(''UA''=''T*'')';
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '3',@AdhSystemID,'3','H','05','3',NULL,'Date/Time Format',NULL,NULL,'"drvDTP02_DateTimeFormatQual007"','(''UA''=''T*'')';
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '4',@AdhSystemID,'35','H','05','4',NULL,'Date/Time Period',NULL,NULL,'"drvDTP03_DateTimePeriod007"','(''UD112''=''T*'')';
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '1',@AdhSystemID,'3','H','06','1',NULL,'REF Segment ID (Header)',NULL,NULL,'"REF"','(''DA''=''T*'')';
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '2',@AdhSystemID,'3','H','06','2',NULL,'Reference Number Qualifier',NULL,NULL,'"drvREF01_RefNumberQual"','(''UA''=''T*'')';
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) SELECT '3',@AdhSystemID,'50','H','06','3',NULL,'Reference Number Qualifier',NULL,NULL,'"drvREF02_RefNumberQual"','(''UA''=''T*'')';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Changes Only File',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','CHANGES','Oct  1 2018 12:00AM','EUSCCON834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Full File Only',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','FULLFILE','Oct  1 2018 12:00AM','EUSCCON834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEACTIVE','Oct  1 2018 12:00AM','EUSCCON834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEPASSIVE','Oct  1 2018 12:00AM','EUSCCON834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,@FixedFormatName2,CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','SCHEDULED','Oct  1 2018 12:00AM','EUSCCON834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSCCON834','834LineFeed','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSCCON834','EEList','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSCCON834','ExportPath','V','@FileExportPath');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSCCON834','InitialSort','C','LEFT(drvInitialSort,20)');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSCCON834','Is834','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSCCON834','SubSort','C','drvSubSort');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSCCON834','Testing','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUSCCON834','UseFileName','V','N');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H01','U_EUSCCON834_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H02','U_EUSCCON834_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H03','U_EUSCCON834_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H04','U_EUSCCON834_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H05','U_EUSCCON834_HdrTbl','ISNULL(drvREF01_RefNumberQual,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H07','U_EUSCCON834_HdrTbl','ISNULL(drvQTY01_QuantityQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H08','U_EUSCCON834_HdrTbl','ISNULL(drvQTY01_QuantityQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H08','U_EUSCCON834_HdrTbl','ISNULL(drvQTY01_QuantityQual3,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H10','U_EUSCCON834_HdrTbl','ISNULL(drvN101_EntityIDCodeSponsor1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','H11','U_EUSCCON834_HdrTbl','ISNULL(drvN101_EntityIDCodeSponsor2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D11','U_EUSCCON834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D12','U_EUSCCON834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D13','U_EUSCCON834_DrvTbl','ISNULL(drvREF01_RefNumberQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D14','U_EUSCCON834_DrvTbl','ISNULL(drvREF01_RefNumberQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D15','U_EUSCCON834_DrvTbl','ISNULL(drvDTP00_DateTime1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D16','U_EUSCCON834_DrvTbl','ISNULL(drvDTP00_DateTime2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D20','U_EUSCCON834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D21','U_EUSCCON834_DrvTbl','ISNULL(drvPER03_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER05_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER07_CommNumberQualifier,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D22','U_EUSCCON834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D23','U_EUSCCON834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D24','U_EUSCCON834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D25','U_EUSCCON834_DrvTbl','ISNULL(drvICM01_FrequencyCode,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D26','U_EUSCCON834_DrvTbl','ISNULL(drvAMT00_SegmentID1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D27','U_EUSCCON834_DrvTbl','ISNULL(drvAMT00_SegmentID2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D28','U_EUSCCON834_DrvTbl','ISNULL(drvHLH00_SegmentID,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D40','U_EUSCCON834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D41','U_EUSCCON834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_348,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D42','U_EUSCCON834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_349,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D43','U_EUSCCON834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_303,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D45','U_EUSCCON834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvREF00_RefNumberQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D46','U_EUSCCON834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvREF00_RefNumberQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D50','U_EUSCCON834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvAMT00_AmountQualifierCode1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D51','U_EUSCCON834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvAMT00_AmountQualifierCode2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D80','U_EUSCCON834_DrvTbl_2300','ISNULL(drvLS01_LoopIDCode,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D81','U_EUSCCON834_DrvTbl_2300','ISNULL(drvLX01_AssignedNumber,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D85','U_EUSCCON834_DrvTbl_2300','ISNULL(drvN101_EntityIDCodeSponsor,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D86','U_EUSCCON834_DrvTbl_2300','ISNULL(drvREF01_RefNumberQual,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','D87','U_EUSCCON834_DrvTbl_2300','ISNULL(drvLE01_LoopIDCode,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','T90','U_EUSCCON834_TrlTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','T91','U_EUSCCON834_TrlTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EUSCCON834','T92','U_EUSCCON834_TrlTbl',NULL);
GO
DECLARE @ISWEB CHAR(1) = 'Y';
DECLARE @FormatCode VARCHAR(10) = 'EUSCCON834';
...
BEGIN
    ...
    UPDATE dbo.AscExp SET expAscFileName = @FilePath + @FileName WHERE expFormatCode = 'EUSCCON834';

    DELETE FROM dbo.U_dsi_Configuration WHERE FormatCode = 'EUSCCON834' AND CfgName IN ('TestPath','UDESPath');
END
GO
IF OBJECT_ID('U_EUSCCON834_EEList') IS NULL
CREATE TABLE [dbo].[U_EUSCCON834_EEList] (
    [xCOID] char(5) NULL,
    [xEEID] char(12) NULL
);
IF OBJECT_ID('U_EUSCCON834_File') IS NULL
CREATE TABLE [dbo].[U_EUSCCON834_File] (
...
GO
CREATE PROCEDURE [dbo].[dsi_sp_AfterCollect_EUSCCON834]
AS
SET NOCOUNT ON;
/************************************************************
Client: US Olympic Committee

Created By: Marco Lagrosa
Create Date: 08/20/2020
ChangePoint Request Number: TekP-2020-07-21-0003
...
BEGIN
    ...
    --==================================================
    WHILE (SELECT COUNT(*) FROM dbo.U_EUSCCON834_File WHERE RIGHT(DATA,2) = '*~') > 0
    BEGIN
        UPDATE dbo.U_EUSCCON834_File SET DATA = REPLACE(DATA,'*~','~') WHERE RIGHT(RTRIM(DATA),2) = '*~';
    END;

    --========================================
    -- Remove Extra Records from PER Segment
    --========================================
    UPDATE dbo.U_EUSCCON834_File SET DATA = REPLACE(DATA,'HP**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%HP**%';
    UPDATE dbo.U_EUSCCON834_File SET DATA = REPLACE(DATA,'WP**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%WP**%';
    UPDATE dbo.U_EUSCCON834_File SET DATA = REPLACE(DATA,'EM**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%EM**%';

    --====================================
    -- Update Record Count in SE Segment
    --====================================
    DECLARE @RecordCount INT;
    SET @RecordCount = (SELECT COUNT(*) FROM dbo.U_EUSCCON834_File WHERE LEFT(Data, CHARINDEX('*',Data) - 1) NOT IN ('ISA','GS','IEA','GE'));

    UPDATE dbo.U_EUSCCON834_File
    SET Data = REPLACE(Data,'9999',@RecordCount)
    WHERE LEFT(Data,2) = 'SE';

END
GO
CREATE PROCEDURE [dbo].[dsi_sp_BuildDriverTables_EUSCCON834]
    @systemid CHAR(12)
AS
SET NOCOUNT ON;
/**********************************************************************************
...
Create Date: 08/20/2020
Service Request Number: TekP-2020-07-21-0003

Purpose: United Concordia 834 Export
...
SELECT * FROM dbo.U_dsi_Configuration WHERE FormatCode = 'EUSCCON834';
SELECT * FROM dbo.U_dsi_SqlClauses WHERE FormatCode = 'EUSCCON834';
SELECT * FROM dbo.U_dsi_Parameters WHERE FormatCode = 'EUSCCON834';
SELECT * FROM dbo.AscExp WHERE expFormatCode = 'EUSCCON834';
SELECT * FROM dbo.U_dsi_InterfaceActivityLog WHERE FormatCode = 'EUSCCON834' ORDER BY RunID DESC;

Execute Export
--------------
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EUSCCON834', 'FULLFILE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EUSCCON834', 'CHANGES';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EUSCCON834', 'OEPASSIVE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EUSCCON834', 'OEACTIVE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EUSCCON834', 'SCHEDULED';

EXEC dbo.dsi_BDM_sp_ErrorCheck 'EUSCCON834';

EXEC dbo._dsi_usp_ExportRipOut @FormatCode = 'EUSCCON834', @AllObjects = 'Y', @IsWeb = 'N';
**********************************************************************************/
BEGIN
    ...
    IF OBJECT_ID('U_EUSCCON834_DedList','U') IS NOT NULL
        DROP TABLE dbo.U_EUSCCON834_DedList;
    SELECT DedCode = DedDedCode
        ,DedLongDesc
        ,DedType = DedDedType
    INTO dbo.U_EUSCCON834_DedList
    ...
    DELETE FROM dbo.U_EUSCCON834_EEList
    WHERE xCoID <> dbo.dsi_BDM_fn_GetCurrentCoID(xEEID)
    AND xEEID IN (SELECT xEEID FROM dbo.U_EUSCCON834_EEList GROUP BY xEEID HAVING COUNT(1) > 1);

    -- Remove Employees that Do Not Have a Benefit Plan in Deduction Code List
    DELETE FROM dbo.U_EUSCCON834_EEList
    WHERE NOT EXISTS (SELECT 1 FROM dbo.EmpDed JOIN dbo.U_EUSCCON834_DedList ON DedCode = EedDeDCode WHERE EedEEID = xEEID);
    ...
    IF OBJECT_ID('U_EUSCCON834_AuditFields','U') IS NOT NULL
        DROP TABLE dbo.U_EUSCCON834_AuditFields;
    CREATE TABLE dbo.U_EUSCCON834_AuditFields (aTableName VARCHAR(30),aFieldName VARCHAR(30));
    -- Employee Information
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepSSN');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepNameFirst');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepNameLast');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepNameMiddle');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepNamePrefix');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepNameSuffix');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepAddressLine1');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepAddressLine2');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepAddressCity');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepAddressState');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepAddressZipCode');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepAddressCountry');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepGender');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepDateOfBirth');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepIsDisabled');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepMaritalStatus');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpPers','EepPhoneHomeHumber');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpComp','EecDateOfLastHire');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpComp','EecDateOfTermination');
    -- Dependent Information
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConSSN');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConNameFirst');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConNameLast');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConNameMiddle');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConNameSuffix');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConDateOfBirth');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConIsDisabled');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConRelationship');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConAddressLine1');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConAddressLine2');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConAddressCity');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConAddressState');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConAddressZipCode');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('Contacts','ConAddressCountry');
    -- Employee Deduction/Benefit Information
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpDed','EedDedCode');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpDed','EedBenStatus');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpDed','EedBenOption');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpDed','EedBenStartDate');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('EmpDed','EedBenStopDate');
    -- Dependent Deduction/Benefit Information
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('DepBPlan','DbnDedCode');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('DepBPlan','DbnBenStatus');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('DepBPlan','DbnBenStartDate');
    INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('DepBPlan','DbnBenStopDate');
    -- Deduction/Benefit Information
    --INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('DedCode','DedBenAmt');
    --INSERT INTO dbo.U_EUSCCON834_AuditFields VALUES ('DedCode','DedBenAmtRateOrPct');

    -- Create audit table based on fields defined above
    IF OBJECT_ID('U_EUSCCON834_Audit','U') IS NOT NULL
        DROP TABLE dbo.U_EUSCCON834_Audit;
    SELECT audEEID = xEEID
        ...
        ,audTermPlan = CASE WHEN audFieldName IN ('EedBenStatus','DbnBenStatus') AND audOldValue = 'A' AND ISNULL(audNewValue,'') NOT IN ('A','') THEN 'Y'
                            ...
                            ELSE 'N'
                       END
    INTO dbo.U_EUSCCON834_Audit
    FROM dbo.U_EUSCCON834_EEList WITH (NOLOCK)
    JOIN dbo.vw_AuditData WITH (NOLOCK)
        ON xEEID = audKey1Value
    JOIN dbo.U_EUSCCON834_AuditFields WITH (NOLOCK)
    ...
    AND ((audTableName NOT IN ('EmpDed','DepBPlan'))
        OR (audTableName = 'EmpDed' AND audKey3Value IN (SELECT DedCode FROM dbo.U_EUSCCON834_DedList))
        OR (audTableName = 'DepBPlan' AND audKey2Value IN (SELECT DedCode FROM dbo.U_EUSCCON834_DedList))
    );
    ...
    BEGIN
        ...
        DELETE FROM dbo.U_EUSCCON834_EELIST
        WHERE NOT EXISTS (SELECT 1 FROM dbo.U_EUSCCON834_Audit WHERE audEEID = xEEID AND audRowNo = 1);
    END;
    ...
    FROM dbo.U_dsi_bdm_EUSCCON834 D
    JOIN dbo.U_dsi_bdm_EUSCCON834 E
    ...
    --=====================================================
    UPDATE dbo.U_dsi_bdm_EUSCCON834
        SET BdmUSGField2 = EedEmpDedTVID
    FROM dbo.U_dsi_bdm_EUSCCON834
    ...
    ***************************************************************************************************************/
    ...
    -- HEADER RECORD 
    -------------------
    IF OBJECT_ID('U_EUSCCON834_HdrTbl','U') IS NOT NULL
        DROP TABLE dbo.U_EUSCCON834_HdrTbl;
    SELECT DISTINCT drvISA05_SenderIDQual = 'ZZ'
        ,drvISA06_SenderID = 'V154771'
        ...
        ,drvDTP01_DateTimeQualifier007 = '007'
        ...
        ,drvN102_Name1 = 'United States Olympic Committee'
    ...
    INTO dbo.U_EUSCCON834_HdrTbl
    FROM dbo.U_EUSCCON834_EELIST WITH (NOLOCK)
    JOIN dbo.U_dsi_bdm_EUSCCON834 WITH (NOLOCK)
        ON BdmEEID = xEEID
        AND BdmCOID = xCOID;
    ...
    ***************************************************************************************************************/
    ...
    -- DETAIL RECORD 
    -------------------
    IF OBJECT_ID('U_EUSCCON834_DrvTbl','U') IS NOT NULL
        DROP TABLE dbo.U_EUSCCON834_DrvTbl;
    SELECT DISTINCT
        --=====================
        --LOOP 2000 RECORDS
        --=====================
    ...
    ***************************************************************************************************************/
    ...
    -- DETAIL RECORD 
    -------------------
    IF OBJECT_ID('U_EUSCCON834_DrvTbl_2300','U') IS NOT NULL
        DROP TABLE dbo.U_EUSCCON834_DrvTbl_2300;
    SELECT DISTINCT
        ...
        ,drvSubSort = CONVERT(CHAR(9),RTRIM(EepSSN)) + CONVERT(CHAR(12),ISNULL(ConSystemID,''))
                      + CASE BdmDedType
                             ...
                             ELSE '9'
                      END
    INTO dbo.U_EUSCCON834_DrvTbl_2300
    FROM dbo.U_EUSCCON834_EELIST WITH (NOLOCK)
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    JOIN dbo.EmpComp WITH (NOLOCK)
    ...
    **************************************************************************************************/
    ...
    -- TRAILER RECORD
    --------------------
    IF OBJECT_ID('U_EUSCCON834_TrlTbl') IS NOT NULL
        DROP TABLE dbo.U_EUSCCON834_TrlTbl;
    SELECT DISTINCT drvSE01_SegmentCount = '9999'
    INTO dbo.U_EUSCCON834_TrlTbl;

    --==========================================
    -- Set FileName
    --==========================================
    IF (dbo.dsi_fnVariable('EUSCCON834','UseFileName') = 'N')
    BEGIN
        UPDATE dbo.U_dsi_Parameters
            SET ExportFile = 'USOC_EUSCCON834_' + CONVERT(VARCHAR(8),GETDATE(),112) + '.txt'
        WHERE FormatCode = 'EUSCCON834';
    END;
...
--Alter the View
ALTER VIEW dbo.dsi_vwEUSCCON834_Export AS
    SELECT TOP 20000000 DATA FROM dbo.U_EUSCCON834_File (NOLOCK)
...
WHERE AdfHeaderSystemID LIKE 'EUSCCON834%'
...
WHERE ExpFormatCode = 'EUSCCON834';

**********************************************************************************/
GO
CREATE VIEW dbo.dsi_vwEUSCCON834_Export AS
    SELECT TOP 20000000 DATA FROM dbo.U_EUSCCON834_File (NOLOCK)
    ORDER BY CASE LEFT(Recordset,1) WHEN 'H' THEN 1 WHEN 'D' THEN 2 ELSE 3 END, InitialSort, SubSort, RIGHT(Recordset,2)
GO