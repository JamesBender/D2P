...
Client ID:      SUR1004
Date/time:      2021-12-29 11:15:31.740
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    E43
...
CREATE TABLE [dbo].[U_ESURGLINT_drvTbl] (
    ...
    [drvReviewGoalScoreDesc] nvarchar(1000) NULL,
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvReviewGoalScoreDesc = ReviewPerfRatingDesc
