...
Client ID:      CRO1008
Date/time:      2021-12-26 13:45:48.450
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    NWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECRSAPAEXP_20211226.txt';
...
EXEC dbo._dsi_usp_ExportRipOut @FormatCode = 'ECRSAPAEXP', @AllObjects = 'Y', @IsWeb = 'Y'
**********************************************************************************/
BEGIN
