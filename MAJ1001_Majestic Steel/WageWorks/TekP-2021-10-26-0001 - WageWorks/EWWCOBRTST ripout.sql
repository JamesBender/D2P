...
EWWCOBRTST: WageWorks COBRA TEST

FormatCode:     EWWCOBRTST
Project:        WageWorks COBRA TEST
Client ID:      MAJ1001
Date/time:      2022-01-16 14:55:46.030
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EWWCOBRTST_20220116.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,NULL,'Test Purposes Only','202201139','EMPEXPORT','TEST','May 17 2019  2:17PM','EWWCOBRTST',NULL,NULL,NULL,'202201139','May 17 2019 12:00AM','Dec 30 1899 12:00AM','202112011','23',NULL,NULL,'202112011',dbo.fn_GetTimedKey(),NULL,'ULTI_WPMJS',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EWWCOBRTST','TestPath','V',NULL);
...
if object_id('U_ECOBAPPINT_EEList') is not null
    drop table dbo.U_ECOBAPPINT_EEList;

select distinct
    xCOID = xcoid,
    xEEID = xeeid
into dbo.u_ECOBAPPINT_EEList
from dbo.u_EWWCOBRTST_EEList;

--BDM COBRA
DELETE FROM U_dsi_bdm_Configuration WHERE FormatCode = 'ECOBAPPINT';

--INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'DedCodes','HDHP,PPO,DEN,VIS,FSA'); 
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'StartDateTime',@StartDate);
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'EndDateTime',@EndDate);
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'TermSelectionOption','AuditDate');
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'UseCobraCoveredDeds', 'Y');

INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'RelationshipsSpouse', 'SPS');
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'RelationshipsChild', 'CHL,STC');
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'RelationshipsDomPartner', 'DP');
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'RelationshipsDPChild', 'DPC');

--COBRA BDM IN Inserts:
--*********************
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'NewEnrolleeType', '2');
...
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'NewEnrolleeIncludeEmps', 'Y');
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'NewEnrolleeDeps', '1') --Include SP and DP as dependents
INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'NewEnrolleeExcludeDeps', '1')
--INSERT INTO U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'ExclFutureDatedStartDates', 'Y'); --A.S. 08/28/2020 comment out
...
--INSERT INTO dbo.U_dsi_bdm_Configuration VALUES ('ECOBAPPINT', 'NewEnrolleeExcludeDeps', '1')
EXEC dbo.dsi_bdm_sp_PopulateDeductionsTable 'ECOBAPPINT';
...
from dbo.u_dsi_bdm_EElist
    ...
    join (select distinct eedeeid eeid, eedcoid coid, eedCobraReason, max(eedbenstartdate) CobraDate
            from dbo.u_dsi_bdm_EmpDeductions
            where eedFormatCode = 'ECOBAPPINT' and eedvalidforexport = 'Y'
    ...
    left join (select distinct dbneeid eeid, dbncoid coid
            from dbo.u_dsi_bdm_DepDeductions
            where dbnFormatCode = 'ECOBAPPINT' and dbnvalidforexport = 'Y') dp on xeeid = dp.eeid and xcoid = dp.coid
  where xFormatCode = 'ECOBAPPINT' and eecdateoflasthire < getdate();
...
from dbo.u_dsi_bdm_EElist
    ...
    join (select distinct dbneeid eeid, dbncoid coid, dbndeprecid, dbnCobraReason, max(dbnbenstartdate) CobraDate
            ...
            where dbnFormatCode = 'ECOBAPPINT' and dbnvalidforexport = 'Y'
...
WHERE expFormatCode = 'EWWCOBRTST' AND expExportCode like '%TEST%';
*/
...
UPDATE dbo.U_dsi_Configuration
 ...
 WHERE rpoFormatCode = 'EWWCOBRTST'
