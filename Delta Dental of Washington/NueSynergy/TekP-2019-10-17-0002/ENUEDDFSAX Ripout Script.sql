...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ENUEDDFSAX_20191226.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'NueSynergy FSA Payroll Export','201911279','EMPEXPORT','ONDEMAND',NULL,'ENUEDDFSAX',NULL,NULL,NULL,'201911279','Nov 27 2019 12:21PM','Nov 27 2019 12:21PM','201911271',NULL,'','','201911271',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ENUEDDFSAX_20191226.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201911279','EMPEXPORT','SCHEDULED',NULL,'ENUEDDFSAX',NULL,NULL,NULL,'201911279','Nov 27 2019 12:21PM','Nov 27 2019 12:21PM','201911271',NULL,'','','201911271',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ENUEDDFSAX_20191226.txt',NULL,'','',NULL,NULL,NULL,NULL,'Active Open Enrollment Export','201911279','EMPEXPORT','OEACTIVE',NULL,'ENUEDDFSAX',NULL,NULL,NULL,'201911279','Nov 27 2019 12:21PM','Nov 27 2019 12:21PM','201911271',NULL,'','','201911271',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ENUEDDFSAX_20191226.txt',NULL,'','',NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','201911279','EMPEXPORT','OEPASSIVE',NULL,'ENUEDDFSAX',NULL,NULL,NULL,'201911279','Nov 27 2019 12:21PM','Nov 27 2019 12:21PM','201911271',NULL,'','','201911271',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ENUEDDFSAX_20191226.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','201912069','EMPEXPORT','TEST','Dec 26 2019  1:31PM','ENUEDDFSAX',NULL,NULL,NULL,'201912069','Dec  6 2019 12:00AM','Dec 30 1899 12:00AM','201912061','115','','','201912061',dbo.fn_GetTimedKey(),NULL,'us3lKiWAS1006',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_ENUEDDFSAX_20191226.txt' END WHERE expFormatCode = 'ENUEDDFSAX';
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,FSAAmount     = SUM(CASE WHEN PdhDedCode IN ('FSA4', 'FSAHC', 'FSAI', 'FSAL', 'FSANM', 'FSAO', 'FSAU') THEN PdhEECurAmt ELSE 0.00 END)
    ...
    SELECT DISTINCT
        ...
        ,drvAccountTypeCode =    CASE WHEN ISNULL(bdmDedCode, '') <> '' THEN
                                    CASE WHEN bdmDedCode  in ('FSA4', 'FSAHC', 'FSAI', 'FSAL', 'FSANM', 'FSAO', 'FSAU') THEN  'FSA'
        ...
        ,drvPlanId =    CASE WHEN ISNULL(bdmDedCode, '') <> '' THEN
                            CASE WHEN bdmDedCode  in ('FSA4', 'FSAHC', 'FSAI', 'FSAL', 'FSANM', 'FSAO', 'FSAU') THEN  concat('FSA',YEAR(GETDATE()))
        ...
        ,drvEmployeeDepositAmount =    CASE WHEN ISNULL(bdmDedCode, '') <> '' THEN
                                        CASE WHEN BdmDedCode = 'FSADC' THEN CAST(CONVERT(DECIMAL(10,2),DCAAmount) as varchar(12))
                                            WHEN BdmDedCode in ('FSA4', 'FSAHC', 'FSAI', 'FSAL', 'FSANM', 'FSAO', 'FSAU') THEN CAST(CONVERT(DECIMAL(10,2),FSAAmount) as varchar(12))
                                        END
                                    ELSE
                                        CASE WHEN pdhDedCode = 'FSADC' THEN CAST(CONVERT(DECIMAL(10,2),DCAAmount) as varchar(12))
                                            WHEN pdhDedCode in ('FSA4', 'FSAHC', 'FSAI', 'FSAL', 'FSANM', 'FSAO', 'FSAU') THEN CAST(CONVERT(DECIMAL(10,2),FSAAmount) as varchar(12))
                                        END
                                    END
        ,drvERDepositAmt = ''
        ,drvCardHolder = '1'
    ...
    JOIN dbo.pDedHist a WITH (NOLOCK)
        ON a.pdhEEID = xEEID 
        AND PdhDedCode IN ('FSA4', 'FSAHC', 'FSAI', 'FSAL', 'FSANM', 'FSAO', 'FSAU', 'FSADC') 
