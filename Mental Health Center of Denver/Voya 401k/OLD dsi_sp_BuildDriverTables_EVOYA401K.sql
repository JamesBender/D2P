...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvAnnualSal"','64','(''UA''=''F'')','EVOYA401K0Z0','11','D','10','457',NULL,'ANNUAL SALARY',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EVOYA401K_20191211.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','201912319','EMPEXPORT','TEST','Nov 21 2019  8:32AM','EVOYA401K',NULL,NULL,NULL,'201912319','Nov 18 2019 12:00AM','Dec 30 1899 12:00AM','201901011','836','','','201901011',dbo.fn_GetTimedKey(),NULL,'US3JBEMEN1003',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EVOYA401K_20191211.txt',NULL,'','','',NULL,NULL,NULL,'Voya 401K Export','201912319','EMPEXPORT','ONDEMAND','Nov 21 2019  8:32AM','EVOYA401K',NULL,NULL,NULL,'201912319','Nov 18 2019 12:00AM','Dec 30 1899 12:00AM','201901011','836','','','201901011',dbo.fn_GetTimedKey(),NULL,'us3jBe01MEN1003',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EVOYA401K_20191211.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','201912319','EMPEXPORT','SCHEDULED','Nov 21 2019  8:32AM','EVOYA401K',NULL,NULL,NULL,'201912319','Nov 18 2019 12:00AM','Dec 30 1899 12:00AM','201901011','836','','','201901011',dbo.fn_GetTimedKey(),NULL,'us3jBe01MEN1003',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EVOYA401K_20191211.txt' END WHERE expFormatCode = 'EVOYA401K';
...
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EVOYA401K', 'TEST';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EVOYA401K', 'SCHEDULED';
...
BEGIN
    ...
    DELETE from  dbo.U_EVOYA401K_EEList  where xeeid in (select distinct EEcEEid  from EmpComp where EecEEType = 'TES')
