...
/*01*/ INSERT INTO dbo.CustomTemplates (Engine,EngineCode) SELECT Engine = AdhEngine, EngineCode = AdhFormatCode FROM dbo.AscDefH WITH (NOLOCK) WHERE AdhFormatCode = 'EWWCOBCMBX' AND AdhEngine = 'EMPEXPORT' AND NOT EXISTS(SELECT 1 FROM dbo.CustomTemplates WHERE EngineCode = AdhFormatCode AND Engine = AdhEngine); /* Insert field into CustomTemplates table */
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EWWCOBCMBX_20201031.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'WageWorks Combind COBRA -Test','202010289','EMPEXPORT','TEST_XOE','Oct 28 2020 12:40PM','EWWCOBCMBX',NULL,NULL,NULL,'202010289','Oct 28 2020 12:00AM','Dec 30 1899 12:00AM','202010011','21','','','202010011',dbo.fn_GetTimedKey(),NULL,'us3cPeREV1004',NULL);
...
/*01*/ UPDATE dbo.U_dsi_Configuration SET CfgValue = NULL WHERE FormatCode = 'EWWCOBCMBX' AND CfgName LIKE '%Path' AND CfgType = 'V'; /* Set paths to NULL for Web Exports */
/*02*/ UPDATE dbo.U_dsi_Configuration SET CfgValue = 'Y'  WHERE FormatCode = 'EWWCOBCMBX' AND CfgName = 'UseFileName'; /* Set UseFileName to 'Y' for Web Exports */
IF OBJECT_ID('U_EWWCOBCMBX_SavePath') IS NOT NULL DROP TABLE [dbo].[U_EWWCOBCMBX_SavePath];
GO
...
--                                WHEN EecEmplStatus = 'L' THEN '90'
        ...
        ,drvQuallifingEventType =    CASE WHEN ConRelationship IN ('SPS','DP') AND BdmBenStatus = 'T' AND BdmCobraReason IN ('204', 'LEVNT4') THEN '11'
                                        ...
                                        WHEN ConRelationship IN ('SPS','DP','CHL','DAU','SON','STC') AND BdmBenStatus = 'T' AND EecTermReason NOT IN ('202','203','208') THEN '18'
...
--Update Dates
UPDATE dbo.AscExp
    SET expLastStartPerControl = '201611011'
       ,expStartPerControl     = '201611011'
