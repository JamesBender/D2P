...
Client ID:      GPS1000
Date/time:      2022-02-28 09:21:05.413
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    E41
...
Web Filename:   GPS1000_ZLF1J_EEHISTORY_ECCCPAYEXP_ExportCode_YYYYMMDD_HHMMSS.txt
ExportPath:    
TestPath:      
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('1','ECCCPAYEXPZ0','50','D','10','1',NULL,'Company Identifier',NULL,NULL,'"718529"','(''DA''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('4','ECCCPAYEXPZ0','50','D','10','4',NULL,'Employee ID',NULL,NULL,'"drvEmployeeID"','(''UA''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('10','ECCCPAYEXPZ0','50','D','10','10',NULL,'Department Description',NULL,NULL,'""','(''DA''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('15','ECCCPAYEXPZ0','50','D','10','15',NULL,'Original Hire Date',NULL,NULL,'"drvOriginalHireDate"','(''UD101''=''T|'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('16','ECCCPAYEXPZ0','50','D','10','16',NULL,'Most Recent Hire Date',NULL,NULL,'"drvMostRecentHireDate"','(''UD101''=''T|'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('17','ECCCPAYEXPZ0','50','D','10','17',NULL,'Start Date',NULL,NULL,'"drvStartDate"','(''UD101''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('19','ECCCPAYEXPZ0','50','D','10','19',NULL,'Date of Birth',NULL,NULL,'"drvDateOfBirth"','(''UD101''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('28','ECCCPAYEXPZ0','50','D','10','28',NULL,'Employee Home Phone',NULL,NULL,'"drvEmployeeHomePhone"','(''UA''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('36','ECCCPAYEXPZ0','50','D','10','36',NULL,'Employee email',NULL,NULL,'"drvEmployeeEmail"','(''UA''=''T|'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('37','ECCCPAYEXPZ0','50','D','10','37',NULL,'Termination Date',NULL,NULL,'"drvTerminationDate"','(''UD101''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('42','ECCCPAYEXPZ0','50','D','10','42',NULL,'Pay Period Start Date',NULL,NULL,'"drvPayPeriodStartDate"','(''UD101''=''T|'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('43','ECCCPAYEXPZ0','50','D','10','43',NULL,'Pay Period Ending Date',NULL,NULL,'"drvPayPeriodEndDate"','(''UD101''=''T|'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('44','ECCCPAYEXPZ0','50','D','10','44',NULL,'Check Date',NULL,NULL,'"drvCheckDate"','(''UD101''=''T|'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECCCPAYEXP_20220228.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'CCC Payroll Export','202202079','EMPEXPORT','ONDEM_XOE','Feb  4 2022  9:52AM','ECCCPAYEXP',NULL,NULL,NULL,'202202079','Jan 31 2022  6:16AM','Jan 31 2022  6:16AM','202202071','13836','','','202202071',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'CCC Payroll Export-Sched','202202079','EMPEXPORT','SCH_ECCCPA','Feb  4 2022  9:52AM','ECCCPAYEXP',NULL,NULL,NULL,'202202079','Jan 31 2022  6:16AM','Jan 31 2022  6:16AM','202202071','13836','','','202202071',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,NULL,'CCC Payroll Export-Test','202202079','EMPEXPORT','TEST_XOE','Feb  8 2022 12:00AM','ECCCPAYEXP',NULL,NULL,NULL,'202202079','Feb  4 2022 12:00AM','Dec 30 1899 12:00AM','202202071','15813','','','202202071',dbo.fn_GetTimedKey(),NULL,'us3lKiGPS1000',NULL);
...
Service Request Number: TekP-2021-11-05-0001
...
/*    IF OBJECT_ID('U_ECCCPAYEXP_PEarHist','U') IS NOT NULL
    ...
    SELECT DISTINCT
       ...
       -- ,PehCurAmt              = SUM(CASE WHEN PehPerControl >= @StartPerControl THEN PehCurAmt ELSE 0.00 END)
        ...
        ,PexCurAmtYTD           = SUM(PehCurAmt)
        ,PexCurHrsYTD           = SUM(PehCurHrs)
    ...
    SELECT DISTINCT
        ...
        ,drvEmployeeStatus =    CASE WHEN EecEmplStatus = 'L' THEN 'L'
                                ...
                                WHEN EecEmplStatus = 'T' AND EecTermReason = '203' THEN 'Q'
        ...
        ,drvEmployeeEmail =    CASE WHEN ISNULL(EepAddressEmailAlternate, '') <> '' AND EepAddressEmailAlternate NOT LIKE '%@gpshospitality.com' THEN EepAddressEmailAlternate
                            WHEN ISNULL(EepAddressEMail, '') <> '' AND EepAddressEMail NOT LIKE '%@gpshospitality.com' THEN EepAddressEMail
                            END        
    ...
    JOIN (
            ...
            FROM (
                    SELECT PehEEID
                        ,PehCOID
                        ,PehPerControl
                        ,PehEarnCode =    CASE WHEN PehEarnCode IN ('AWARD','BON','BONA','BONV','CARE2','BOND','CARES','BONR','BONS','BONT') THEN 'B'
                                        WHEN PehEarnCode IN ('FRGNC','FBPRT','GTL','HSAER') THEN 'BD'
                                        WHEN PehEarnCode IN ('SEV') THEN 'E'
                                        WHEN PehEarnCode IN ('HOL') THEN 'H'
                                        WHEN PehEarnCode IN ('DRINC','GFTCD','MRNQ','RELOT','RELON','RELOU','TXGFT','TGFTG') THEN 'I'
                                        WHEN PehEarnCode IN ('WCRSD') THEN 'K'
                                        WHEN PehEarnCode IN ('BEREV','EOPTO','JURY','PTO','PER','PYPTO','PTOP') THEN 'N'
                                        WHEN PehEarnCode IN ('COPO','LITOT','OT','OTADJ') THEN 'O'
                                        WHEN PehEarnCode IN ('QP','LITRG','OVRPY','REG','SAL','MUPA1','MUPA2','TIPMK') THEN 'R'
                                        WHEN PehEarnCode IN ('BKPY','RETRO') THEN 'RA'
                                        WHEN PehEarnCode IN ('DCDPY','DCVST') THEN 'RD'
                                        WHEN PehEarnCode IN ('MDSCK','MISCK','NJSCK','SICK') THEN 'S'
                                        WHEN PehEarnCode IN ('TIPCA') THEN 'T'
                                        WHEN PehEarnCode IN ('VACPO') THEN 'UV'
                                        WHEN PehEarnCode IN ('PYVAC','VAC') THEN 'V'
                                        ELSE 'M'
                                        END
                        ,PehCurAmt
                        ,PehCurHrs
        ...
        ON PehEEID = xEEID 
        --AND PehCOID = xCOID
    WHERE EecEmplStatus <> 'T' OR (EecEmplStatus = 'T' AND (PehCurAmt > 0 OR PehCurHrs > 0 OR EecDateOfTermination BETWEEN DATEADD(YEAR, -1, @EndDate) AND @EndDate))
    ;
