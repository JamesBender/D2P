...
Laika - Replace with customer name
James Bender - Replace with TC name
Lea King - Replace with BA/IC name
10/8/2020 - Replace with date of creation
TekP-2020-09-17-0001 - Replace with SR number
ECOREMDFEX - Replace with Format Code (i.e., ESUNLIF834)
Coresource Med Den FSA 834 Export - Replace with Name of Interface (AdfFormatName) (i.e., Sunlife 834 Export)
LAIKA  - Replace with Company Code (i.e., GOOG)
...
-- Data parameters
LAIKA - Replace with Company Code for Customer
DNHMO,DNPPO,DCFSA,HCFSA,MDHDP,MDPPO - Replace with Deduction Code List in CSV format (i.e., DED1,DED2,DED3)
...
SP - Replace with SPS relationship codes in CSV format (i.e., SPS)
CH, CD, DC, DD, QO - Replace with CHL relationship codes in CSV format (i.e., CHL,STC)
DP,DQ - Replace with DP relationship codes in CSV format (i.e., DP)
...
*/
IF OBJECT_ID('dsi_vwECOREMDFEX_Export') IS NOT NULL DROP VIEW [dbo].[dsi_vwECOREMDFEX_Export];
GO
IF OBJECT_ID('dsi_sp_BuildDriverTables_ECOREMDFEX') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_BuildDriverTables_ECOREMDFEX];
GO
IF OBJECT_ID('dsi_sp_AfterCollect_ECOREMDFEX') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_AfterCollect_ECOREMDFEX];
GO
IF OBJECT_ID('U_ECOREMDFEX_TrlTbl') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_TrlTbl];
GO
IF OBJECT_ID('U_ECOREMDFEX_HdrTbl') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_HdrTbl];
GO
IF OBJECT_ID('U_ECOREMDFEX_File') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_File];
GO
IF OBJECT_ID('U_ECOREMDFEX_EEList') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_EEList];
GO
IF OBJECT_ID('U_ECOREMDFEX_DrvTbl_2300') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_DrvTbl_2300];
GO
IF OBJECT_ID('U_ECOREMDFEX_DrvTbl') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_DrvTbl];
GO
IF OBJECT_ID('U_ECOREMDFEX_DedList') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_DedList];
GO
IF OBJECT_ID('U_ECOREMDFEX_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_AuditFields];
GO
IF OBJECT_ID('U_ECOREMDFEX_Audit') IS NOT NULL DROP TABLE [dbo].[U_ECOREMDFEX_Audit];
GO
IF OBJECT_ID('U_dsi_BDM_ECOREMDFEX') IS NOT NULL DROP TABLE [dbo].[U_dsi_BDM_ECOREMDFEX];
GO
DELETE [dbo].[U_dsi_SQLClauses] FROM [dbo].[U_dsi_SQLClauses] WHERE FormatCode = 'ECOREMDFEX';
DELETE [dbo].[U_dsi_Configuration] FROM [dbo].[U_dsi_Configuration] WHERE FormatCode = 'ECOREMDFEX';
DELETE [dbo].[AscExp] FROM [dbo].[AscExp] WHERE expFormatCode = 'ECOREMDFEX';
DELETE [dbo].[AscDefF] FROM [dbo].[AscDefF] JOIN AscDefH ON AdfHeaderSystemID = AdhSystemID WHERE AdhFormatCode = 'ECOREMDFEX';
DELETE [dbo].[AscDefH] FROM [dbo].[AscDefH] WHERE AdhFormatCode = 'ECOREMDFEX';
GO

DECLARE @AdhSystemID VARCHAR(12), @FixedFormatName1 VARCHAR(50), @FixedFormatName2 VARCHAR(50);
SET @AdhSystemID = LEFT('ECOREMDFEX' + REPLICATE('0',10),10) + 'Z0';
SET @FixedFormatName1 = LEFT('Coresource Med Den FSA 834 Export',50);
SET @FixedFormatName2 = LEFT('Coresource Med Den FSA 834 Export',30);

INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) SELECT 'N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','ECOREMDFEX',@FixedFormatName1,'N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','2000','S','N',@AdhSystemID,'N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Changes Only File',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','CHANGES','Oct  1 2018 12:00AM','ECOREMDFEX',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Full File Only',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','FULLFILE','Oct  1 2018 12:00AM','ECOREMDFEX',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEACTIVE','Oct  1 2018 12:00AM','ECOREMDFEX',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEPASSIVE','Oct  1 2018 12:00AM','ECOREMDFEX',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,@FixedFormatName2,CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','SCHEDULED','Oct  1 2018 12:00AM','ECOREMDFEX',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECOREMDFEX','834LineFeed','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECOREMDFEX','EEList','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECOREMDFEX','ExportPath','V','@FileExportPath');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECOREMDFEX','InitialSort','C','LEFT(drvInitialSort,20)');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECOREMDFEX','Is834','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECOREMDFEX','SubSort','C','drvSubSort');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECOREMDFEX','Testing','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ECOREMDFEX','UseFileName','V','N');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H01','U_ECOREMDFEX_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H02','U_ECOREMDFEX_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H03','U_ECOREMDFEX_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H04','U_ECOREMDFEX_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H05','U_ECOREMDFEX_HdrTbl','ISNULL(drvREF01_RefNumberQual,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H06','U_ECOREMDFEX_HdrTbl','ISNULL(drvQTY01_QuantityQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H07','U_ECOREMDFEX_HdrTbl','ISNULL(drvQTY01_QuantityQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H08','U_ECOREMDFEX_HdrTbl','ISNULL(drvQTY01_QuantityQual3,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H09','U_ECOREMDFEX_HdrTbl','ISNULL(drvN101_EntityIDCodeSponsor1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','H10','U_ECOREMDFEX_HdrTbl','ISNULL(drvN101_EntityIDCodeSponsor2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D11','U_ECOREMDFEX_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D12','U_ECOREMDFEX_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D13','U_ECOREMDFEX_DrvTbl','ISNULL(drvREF01_RefNumberQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D14','U_ECOREMDFEX_DrvTbl','ISNULL(drvREF01_RefNumberQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D15','U_ECOREMDFEX_DrvTbl','ISNULL(drvDTP00_DateTime1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D16','U_ECOREMDFEX_DrvTbl','ISNULL(drvDTP00_DateTime2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D20','U_ECOREMDFEX_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D21','U_ECOREMDFEX_DrvTbl','ISNULL(drvPER03_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER05_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER07_CommNumberQualifier,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D22','U_ECOREMDFEX_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D23','U_ECOREMDFEX_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D24','U_ECOREMDFEX_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D25','U_ECOREMDFEX_DrvTbl','ISNULL(drvICM01_FrequencyCode,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D26','U_ECOREMDFEX_DrvTbl','ISNULL(drvAMT00_SegmentID1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D27','U_ECOREMDFEX_DrvTbl','ISNULL(drvAMT00_SegmentID2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D28','U_ECOREMDFEX_DrvTbl','ISNULL(drvHLH00_SegmentID,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D40','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D41','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_348,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D42','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_349,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D43','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_303,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D45','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvREF00_RefNumberQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D46','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvREF00_RefNumberQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D50','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvAMT00_AmountQualifierCode1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D51','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvAMT00_AmountQualifierCode2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D80','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvLS01_LoopIDCode,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D81','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvLX01_AssignedNumber,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D85','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvN101_EntityIDCodeSponsor,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D86','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvREF01_RefNumberQual,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','D87','U_ECOREMDFEX_DrvTbl_2300','ISNULL(drvLE01_LoopIDCode,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','T90','U_ECOREMDFEX_TrlTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','T91','U_ECOREMDFEX_TrlTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ECOREMDFEX','T92','U_ECOREMDFEX_TrlTbl',NULL);
GO
...
BEGIN
    ...
    UPDATE dbo.AscExp SET expAscFileName = @FilePath + @FileName WHERE expFormatCode = 'ECOREMDFEX';

    DELETE FROM dbo.U_dsi_Configuration WHERE FormatCode = 'ECOREMDFEX' AND CfgName IN ('TestPath','UDESPath');
END
GO
IF OBJECT_ID('U_ECOREMDFEX_EEList') IS NULL
CREATE TABLE [dbo].[U_ECOREMDFEX_EEList] (
    [xCOID] char(5) NULL,
    [xEEID] char(12) NULL
);
IF OBJECT_ID('U_ECOREMDFEX_File') IS NULL
CREATE TABLE [dbo].[U_ECOREMDFEX_File] (
...
GO
CREATE PROCEDURE [dbo].[dsi_sp_AfterCollect_ECOREMDFEX]
AS
SET NOCOUNT ON;
/************************************************************
Client: Laika
...
BEGIN
    ...
    --==================================================
    WHILE (SELECT COUNT(*) FROM dbo.U_ECOREMDFEX_File WHERE RIGHT(DATA,2) = '*~') > 0
    BEGIN
        UPDATE dbo.U_ECOREMDFEX_File SET DATA = REPLACE(DATA,'*~','~') WHERE RIGHT(RTRIM(DATA),2) = '*~';
    END;

    --========================================
    -- Remove Extra Records from PER Segment
    --========================================
    UPDATE dbo.U_ECOREMDFEX_File SET DATA = REPLACE(DATA,'HP**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%HP**%';
    UPDATE dbo.U_ECOREMDFEX_File SET DATA = REPLACE(DATA,'WP**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%WP**%';
    UPDATE dbo.U_ECOREMDFEX_File SET DATA = REPLACE(DATA,'EM**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%EM**%';

    --====================================
    -- Update Record Count in SE Segment
    --====================================
    DECLARE @RecordCount INT;
    SET @RecordCount = (SELECT COUNT(*) FROM dbo.U_ECOREMDFEX_File WHERE LEFT(Data, CHARINDEX('*',Data) - 1) NOT IN ('ISA','GS','IEA','GE'));

    UPDATE dbo.U_ECOREMDFEX_File
    SET Data = REPLACE(Data,'9999',@RecordCount)
    WHERE LEFT(Data,2) = 'SE';

END
GO
CREATE PROCEDURE [dbo].[dsi_sp_BuildDriverTables_ECOREMDFEX]
    @systemid CHAR(12)
AS
SET NOCOUNT ON;
/**********************************************************************************
...
Purpose: Coresource Med Den FSA 834 Export
...
SELECT * FROM dbo.U_dsi_Configuration WHERE FormatCode = 'ECOREMDFEX';
SELECT * FROM dbo.U_dsi_SqlClauses WHERE FormatCode = 'ECOREMDFEX';
SELECT * FROM dbo.U_dsi_Parameters WHERE FormatCode = 'ECOREMDFEX';
SELECT * FROM dbo.AscExp WHERE expFormatCode = 'ECOREMDFEX';
SELECT * FROM dbo.U_dsi_InterfaceActivityLog WHERE FormatCode = 'ECOREMDFEX' ORDER BY RunID DESC;

Execute Export
--------------
EXEC dbo.dsi_sp_TestSwitchbox_v2 'ECOREMDFEX', 'FULLFILE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'ECOREMDFEX', 'CHANGES';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'ECOREMDFEX', 'OEPASSIVE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'ECOREMDFEX', 'OEACTIVE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'ECOREMDFEX', 'SCHEDULED';

EXEC dbo.dsi_BDM_sp_ErrorCheck 'ECOREMDFEX';

EXEC dbo._dsi_usp_ExportRipOut @FormatCode = 'ECOREMDFEX', @AllObjects = 'Y', @IsWeb = 'Y';
**********************************************************************************/
BEGIN
    ...
    IF OBJECT_ID('U_ECOREMDFEX_DedList','U') IS NOT NULL
        DROP TABLE dbo.U_ECOREMDFEX_DedList;
    SELECT DedCode = DedDedCode
        ,DedLongDesc
        ,DedType = DedDedType
    INTO dbo.U_ECOREMDFEX_DedList
    ...
    DELETE FROM dbo.U_ECOREMDFEX_EEList
    WHERE xCoID <> dbo.dsi_BDM_fn_GetCurrentCoID(xEEID)
    AND xEEID IN (SELECT xEEID FROM dbo.U_ECOREMDFEX_EEList GROUP BY xEEID HAVING COUNT(1) > 1);

    -- Remove Employees that Do Not Have a Benefit Plan in Deduction Code List
    DELETE FROM dbo.U_ECOREMDFEX_EEList
    WHERE NOT EXISTS (SELECT 1 FROM dbo.EmpDed JOIN dbo.U_ECOREMDFEX_DedList ON DedCode = EedDeDCode WHERE EedEEID = xEEID);
    ...
    INSERT INTO dbo.U_dsi_bdm_Configuration VALUES (@FormatCode,'RelationshipsChild','CH, CD, DC, DD, QO');
    INSERT INTO dbo.U_dsi_bdm_Configuration VALUES (@FormatCode,'RelationshipsDomPartner','DP,DQ');
    ...
    FROM dbo.U_dsi_bdm_ECOREMDFEX D
    JOIN dbo.U_dsi_bdm_ECOREMDFEX E
    ...
    --=====================================================
    UPDATE dbo.U_dsi_bdm_ECOREMDFEX
        SET BdmUSGField2 = EedEmpDedTVID
    FROM dbo.U_dsi_bdm_ECOREMDFEX
    ...
    ***************************************************************************************************************/
    ...
    -- HEADER RECORD 
    -------------------
    IF OBJECT_ID('U_ECOREMDFEX_HdrTbl','U') IS NOT NULL
        DROP TABLE dbo.U_ECOREMDFEX_HdrTbl;
    SELECT DISTINCT drvISA05_SenderIDQual = ''
        ...
        ,drvN103_IDCodeQual2 = ''
        ,drvN104_IDCode2 = ''
    INTO dbo.U_ECOREMDFEX_HdrTbl
    FROM dbo.U_ECOREMDFEX_EELIST WITH (NOLOCK)
    JOIN dbo.U_dsi_bdm_ECOREMDFEX WITH (NOLOCK)
        ON BdmEEID = xEEID
        AND BdmCOID = xCOID;
    ...
    ***************************************************************************************************************/
    ...
    -- DETAIL RECORD 
    -------------------
    IF OBJECT_ID('U_ECOREMDFEX_DrvTbl','U') IS NOT NULL
        DROP TABLE dbo.U_ECOREMDFEX_DrvTbl;
    SELECT DISTINCT
        --=====================
        --LOOP 2000 RECORDS
        --=====================
        ...
        ,drvINS02_RelationshipCode = CASE WHEN BdmRecType = 'EMP' THEN '18'
                                          ELSE
                                                CASE WHEN ConRelationship IN ('SP','DP,DQ') THEN '01'
                                                     WHEN ConRelationship IN ('CH, CD, DC, DD, QO') THEN '19'
                                                     ELSE '19'
                                                END
                                     END
    ...
    ***************************************************************************************************************/
    ...
    -- DETAIL RECORD 
    -------------------
    IF OBJECT_ID('U_ECOREMDFEX_DrvTbl_2300','U') IS NOT NULL
        DROP TABLE dbo.U_ECOREMDFEX_DrvTbl_2300;
    SELECT DISTINCT
        ...
        ,drvSubSort = CONVERT(CHAR(9),RTRIM(EepSSN)) + CONVERT(CHAR(12),ISNULL(ConSystemID,''))
                      + CASE BdmDedType
                             ...
                             ELSE '9'
                      END
    INTO dbo.U_ECOREMDFEX_DrvTbl_2300
    FROM dbo.U_ECOREMDFEX_EELIST WITH (NOLOCK)
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    JOIN dbo.EmpComp WITH (NOLOCK)
    ...
    **************************************************************************************************/
    ...
    -- TRAILER RECORD
    --------------------
    IF OBJECT_ID('U_ECOREMDFEX_TrlTbl') IS NOT NULL
        DROP TABLE dbo.U_ECOREMDFEX_TrlTbl;
    SELECT DISTINCT drvSE01_SegmentCount = '9999'
    INTO dbo.U_ECOREMDFEX_TrlTbl;

    --==========================================
    -- Set FileName
    --==========================================
    IF (dbo.dsi_fnVariable('ECOREMDFEX','UseFileName') = 'N')
    BEGIN
        UPDATE dbo.U_dsi_Parameters
            SET ExportFile = 'LAIKA_ECOREMDFEX_' + CONVERT(VARCHAR(8),GETDATE(),112) + '.txt'
        WHERE FormatCode = 'ECOREMDFEX';
    END;
...
--Alter the View
ALTER VIEW dbo.dsi_vwECOREMDFEX_Export AS
    SELECT TOP 20000000 DATA FROM dbo.U_ECOREMDFEX_File (NOLOCK)
...
WHERE AdfHeaderSystemID LIKE 'ECOREMDFEX%'
...
WHERE ExpFormatCode = 'ECOREMDFEX';

**********************************************************************************/
GO
CREATE VIEW dbo.dsi_vwECOREMDFEX_Export AS
    SELECT TOP 20000000 DATA FROM dbo.U_ECOREMDFEX_File (NOLOCK)
    ORDER BY CASE LEFT(Recordset,1) WHEN 'H' THEN 1 WHEN 'D' THEN 2 ELSE 3 END, InitialSort, SubSort, RIGHT(Recordset,2)
GO