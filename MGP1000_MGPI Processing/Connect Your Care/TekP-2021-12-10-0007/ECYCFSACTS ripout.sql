...
ECYCFSACTS: Connect Your Care FSA HSA Census TEST

FormatCode:     ECYCFSACTS
Project:        Connect Your Care FSA HSA Census TEST
Client ID:      MGP1000
Date/time:      2022-01-28 19:29:03.580
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','SDF','ECYCFSACTS','Connect Your Care FSA HSA Census TEST','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','888','S','N','E4L0KL000020','N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N');
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECYCFSACTS_20220128.txt';
...
EXEC dbo._dsi_usp_ExportRipOut_v7_4 @FormatCode = 'ECYCFSACTS', @AllObjects = 'Y', @IsWeb = 'Y'
**********************************************************************************/
BEGIN
...
WHERE adfHeaderSystemID = (Select AdhSystemID FROM dbo.AscDefH WITH (NOLOCK) WHERE AdhFormatCode='ECYCFSACTS')
...
UPDATE dbo.U_dsi_Configuration
 ...
 WHERE rpoFormatCode = 'ECYCFSACTS'
