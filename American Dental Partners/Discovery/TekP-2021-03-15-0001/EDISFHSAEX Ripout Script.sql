...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISFHSAEX_20210526.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Discovery FSA/HSA Contrb-Test','202105149','EMPEXPORT','TEST_XOE','May 18 2021  1:47PM','EDISFHSAEX',NULL,NULL,NULL,'202105149','May 14 2021 12:00AM','Dec 30 1899 12:00AM','202105141','21','eecPayGroup','S10','202105141',dbo.fn_GetTimedKey(),NULL,'CPETITTI17',NULL);
