...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EEMPTR401K_20210901.txt';
...
--==========================================
    ...
    SELECT DISTINCT
        ...
        ,drvFiller1 = ''
        ,drvIRSNum = (SELECT CmmFedTaxId FROM dbo.CompMast WITH(NOLOCK))
        ,drvTotRemit = RIGHT('0000000000' + REPLACE(CAST(SUM(PdhERCurAmt) AS VARCHAR), '.', ''), 10)
