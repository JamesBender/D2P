...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"941726599"','38','(''DA''=''Q'')','EDISCCOBRAZ0','50','D','10','38',NULL,'ClientSpecificData',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvUsesFamilyInAddress"','20','(''DA''=''Q,'')','EDISCCOBRAZ0','50','D','70','20',NULL,'UsesFamilyInAddress',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBRA_20200817.txt',NULL,NULL,NULL,',V5C6H,V5C45',NULL,NULL,NULL,'Discovery COBRA - Friday 8:20a','202002289','EMPEXPORT','SCH_DISCA',NULL,'EDISCCOBRA',NULL,NULL,NULL,'202006129','Jan 13 2016  8:53AM','Jan 13 2016  8:53AM','202006051',NULL,'','','202002141',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBRA_20200817.txt',NULL,'','','',NULL,NULL,NULL,'NPM/Cobra Export','202002289','EMPEXPORT','ONDEMAND','Mar  2 2020  4:28PM','EDISCCOBRA',NULL,NULL,NULL,'202002289','Oct 30 2017 12:00AM','Dec 30 1899 12:00AM','202002141','3858','','','202002141',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBRA_20200817.txt',NULL,'','','',NULL,NULL,NULL,'Test NPM/Cobra Export','202007011','EMPEXPORT','TEST','Aug 13 2020  2:14PM','EDISCCOBRA',NULL,NULL,NULL,'202007011','Jul  1 2020 12:00AM','Dec 30 1899 12:00AM','202005011','111','','','202005011',dbo.fn_GetTimedKey(),NULL,'us3rVaNEL1003',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EDISCCOBRA_20200817.txt' END WHERE expFormatCode = 'EDISCCOBRA';
...
CREATE TABLE [dbo].[U_EDISCCOBRA_drvTbl_NPM] (
    ...
    [drvClientDivName] varchar(24) NULL,
    ...
    [drvUsesFamilyInAddress] varchar(4) NULL,
...
SET NOCOUNT ON;
/**********************************************************************************
Client Name: Gary D. Nelson Associates, Inc.

Created By: Marco Lagrosa
Business Analyst: Richard Vars
Create Date: 06/17/2020
Service Request Number: TekP-2020-04-14-0004
...
BEGIN
    ...
    DELETE FROM dbo.U_EDISCCOBRA_EEList
    WHERE  xEEID IN (Select distinct eeceeid from empcomp where EecDedGroupCode NOT IN  ('OCE','OCEX','OCNE','NCE','NCEX','NCNE','SCE','SCEX','SCNE'));
    ...
    */
    ...
    SELECT DISTINCT
        ...
        ,drvEmpNo           = ''
        ,drvClientName      = CONVERT(varchar(100),'Gary D Nelson & Associates 37424')
        ,drvClientDivName   = CASE WHEN EecDedGroupCode in ('OCE', 'OCEX', 'OCNE') THEN 'Gary D Nelson Staff'
                                   WHEN EecDedGroupCode in ('NCE', 'NCEX', 'NCNE') THEN 'Gary D Nelson Staff NCAL' 
                                   WHEN EecDedGroupCode in ('SCE', 'SCEX', 'SCNE') THEN 'Gary D Nelson Staff SCAL' 
                                   END
        ...
        ,drvUsesFamilyInAddress = Case when BdmBenOption = 'EEF' THEN 'TRUE' END
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName      = CONVERT(varchar(100),(CASE WHEN BdmDedCode in ('BCHSA')    THEN 'Anthem CA Medical BlueCross 1500 HDHP Staff' 
                                 WHEN BdmDedCode in ('BCPPO')    THEN 'Anthem CA Medical BlueCross Classic 750 PPO Staff' 
                                 WHEN BdmDedCode in ('DEN')    THEN 'Anthem CA Dental BlueCross Complete PPO Staff' 
                                 WHEN BdmDedCode in ('VSN')    THEN 'Anthem CA Vision BlueCross Blueview Staff' 
                                 WHEN BdmDedCode in ('FSA')    THEN 'HSA Bank FSA' 
                                 WHEN BdmDedCode in ('LPFSA')    THEN 'HSA Bank Limited FSA' 
                                 WHEN BdmDedCode in ('KAHSA')    THEN 'Kaiser CA Medical GDNA Staff 2800 HSA NCAL'
                                 WHEN BdmDedCode in ('KAHMO')    THEN 'Kaiser CA Medical GDNA Staff DHMO NCAL' 
                                 WHEN BdmDedCode in ('KHSAS')    THEN 'Kaiser CA Medical GDNA Staff 2800 HSA SCAL' 
                                 WHEN BdmDedCode in ('KHMOS')    THEN 'Kaiser CA Medical GDNA Staff DHMO SCAL' 
                            END))
        ,drvCoverageLevel = CASE WHEN BdmDedType in( 'FSA','LPFSA') THEN 'EE'
                                    WHEN BdmBenOption IN ('EEF','EE','EEW') THEN 'EE'
                                    WHEN BdmBenOption in ('EECH') THEN 'EE+CHILDREN'
                                    WHEN BdmBenOption in ('EESP') THEN 'EE+SPOUSE'
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName    = CONVERT(varchar(100),(CASE WHEN BdmDedCode in ('BCHSA')    THEN 'Anthem CA Medical BlueCross 1500 HDHP Staff' 
                                 ...
                                 WHEN BdmDedCode in ('KHMOS')    THEN 'Kaiser CA Medical GDNA Staff DHMO SCAL' 
                            END))
        ,drvRate        = CASE WHEN BDmDedcode in ('LFSA','FSA') THEN ISNULL(BdmEEAmt,'') ELSE '' END
        ,drvInitialSort = '21'
        ,drvSubSort     = drvSubSort
        ,drvSubSort2    = '3'
        ,drvSubSort3    = drvSubSort3
