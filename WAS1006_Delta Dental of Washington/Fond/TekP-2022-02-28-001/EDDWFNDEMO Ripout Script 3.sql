...
Client ID:      WAS1006
Date/time:      2022-06-08 10:05:29.630
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
Server:         EW3WUP1DB04
Database:       ULTIPRO_WPWADEN
Web Filename:   WAS1006_DA16E_EEHISTORY_EDDWFNDEMO_ExportCode_YYYYMMDD_HHMMSS.txt
ExportPath:    
TestPath:      
...
/*08*/ DECLARE @FileName varchar(1000) = 'EDDWFNDEMO_20220608.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Fond Demo Export','202205319','EMPEXPORT','ONDEM_XOE',NULL,'EDDWFNDEMO',NULL,NULL,NULL,'202205319','May 17 2022 11:14AM','May 17 2022 11:14AM','202201011',NULL,'','','202201011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','202205319','EMPEXPORT','SCHEDULED',NULL,'EDDWFNDEMO',NULL,NULL,NULL,'202205319','May 17 2022 11:14AM','May 17 2022 11:14AM','202201011',NULL,'','','202201011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202205319','EMPEXPORT','TEST_XOE','May 31 2022 12:00AM','EDDWFNDEMO',NULL,NULL,NULL,'202205319','May 31 2022 12:00AM','Dec 30 1899 12:00AM','202201011',NULL,'','','202201011',dbo.fn_GetTimedKey(),NULL,'us3cPeWAS1006',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDDWFNDEMO','ExportPath','V',NULL);
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDDWFNDEMO','Testing','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDDWFNDEMO','TestPath','V',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDDWFNDEMO','UseFileName','V','Y');
...
Execute Export
--------------
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EDDWFNDEMO', 'ONDEM_XOE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EDDWFNDEMO', 'TEST_XOE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EDDWFNDEMO', 'SCHEDULED';

EXEC dbo._dsi_usp_ExportRipOut_v7_4 @FormatCode = 'EDDWFNDEMO', @AllObjects = 'Y', @IsWeb = 'Y'
**********************************************************************************/
BEGIN
 ...
 --   -- Clean Terminated Employees
    DELETE el 
    FROM dbo.U_EDDWFNDEMO_EEList el
    JOIN dbo.EmpComp ON xEEID = EecEEID AND xCOID = EecCOID
    AND EecEmplStatus = 'T' --AND EecTermReason <> 'SRO'
    ...
    SELECT DISTINCT
        ...
        ,drvGroups = '"' + CASE WHEN LEN(OrgDesc) < 5 THEN OrgDesc
                          ELSE SUBSTRING(OrgDesc, 5, LEN(OrgDesc) - 4) 
                     END + '"'
        ,drvOfficeCity = LocAddressCity
        ,drvOfficState = LocAddressState
        ,drvOficeCountry = CASE WHEN LocAddressCountry = 'USA' THEN 'US' END
    ...
    LEFT JOIN dbo.EmpPers AS Sup WITH(NOLOCK)
