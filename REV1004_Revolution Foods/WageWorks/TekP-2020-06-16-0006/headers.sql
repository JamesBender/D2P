...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvLastPreCobraCovered"','32','(''UA''=''T,'')','EWWCOBCMBXZ0','50','D','10','32',NULL,'LAST_PRECOBRA_COVERED',NULL,NULL);
