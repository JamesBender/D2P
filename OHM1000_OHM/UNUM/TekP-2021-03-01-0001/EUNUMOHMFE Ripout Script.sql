...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EUNUMOHMFE_20210427.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202104219','EMPEXPORT','TEST','Apr 21 2021  4:44PM','EUNUMOHMFE',NULL,NULL,NULL,'202104219','Apr 21 2021 12:00AM','Dec 30 1899 12:00AM','202104071','946','','','202104071',dbo.fn_GetTimedKey(),NULL,'us3lKiOHM1000',NULL);
