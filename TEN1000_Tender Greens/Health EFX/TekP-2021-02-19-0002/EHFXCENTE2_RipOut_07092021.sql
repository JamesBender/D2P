...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EHFXCENTE2_20210709.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'TEST','202105059','EMPEXPORT','TEST','May  5 2021  1:49PM','EHFXCENTE2',NULL,NULL,NULL,'202105059','May  5 2021 12:00AM','Dec 30 1899 12:00AM','202104281','1000','','','202104281',dbo.fn_GetTimedKey(),NULL,'us3lKiTEN1000',NULL);
...
--        drvPeriodEndDate = CONVERT(varchar(10), PgpPeriodEndDate, 112)--case when eecemplstatus <> 'T' then CONVERT(varchar(10), PgpPeriodEndDate, 112) end
  ...
  from dbo.u_EHFXCENTE2_eelist with (nolock)
    ...
    LEFT JOIN (
                ...
                WHERE audTableName = 'EmpHJob' --audTableName = 'EmpComp' 
                   AND audFieldName = 'EjhFullTimeOrPartTime' -- AND audFieldName =  'EEcFullTimeOrPartTime' 
