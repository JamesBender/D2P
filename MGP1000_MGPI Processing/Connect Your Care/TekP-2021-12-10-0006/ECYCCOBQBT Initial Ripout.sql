...
>>>>>> NOTE: this ripout is cloned from ECYCCOBQB


ECYCCOBQBT: Connect Your Care Cobra QB Export

FormatCode:     ECYCCOBQBT
Project:        Connect Your Care Cobra QB Export
Client ID:      MGP1000
Date/time:      2022-01-20 12:52:21.610
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','ECYCCOBQBT','Connect Your Care Cobra QB Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','2000','S','N','ECYCCOBQBTZ0','N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N');
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECYCCOBQBT_20220120.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,NULL,'CYC Cobra QB-OnDemand','202103309','EMPEXPORT','ONDEM_XOE',NULL,'ECYCCOBQBT',NULL,NULL,NULL,'202103309','Jan 13 2016  8:53AM','Jan 13 2016  8:53AM','202103011',NULL,NULL,NULL,'202103011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N',NULL,NULL,NULL,NULL,'CYC Cobra QB-Scheduled','202004229','EMPEXPORT','SCH_ECYCCO',NULL,'ECYCCOBQBT',NULL,NULL,NULL,'202201149','Jan 13 2016  8:53AM','Jan 13 2016  8:53AM','202201071',NULL,NULL,NULL,'202001011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
EXEC dbo._dsi_usp_ExportRipOut @FormatCode = 'ECYCCOBQBT', @AllObjects = 'Y', @IsWeb = 'Y';
