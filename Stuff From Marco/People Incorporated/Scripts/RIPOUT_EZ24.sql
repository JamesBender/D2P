...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCreateTClockBatches,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhPreProcessSQL,AdhRecordSize,AdhRespectZeroPayRate,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhThirdPartyPay) VALUES ('N','C','Y','0','',NULL,'','N','','N','','013010','EMPEXPORT','CDE','EPRUDELIXP','Prudential Benefits Eligibility','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','dbo.dsi_sp_Switchbox_v2','3000','N','S','N','EPRUDELIXPZ0','N','Jan  1 1900 12:00AM','C','N');
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','4','(''DA''=''T~'')','EPRUDELIXPZ0','32','D','15','4',NULL,'Employee Identifier',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','20','(''DA''=''T~'')','EPRUDELIXPZ0','5','D','15','20',NULL,'Weekly Scheduled Hours Number',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','21','(''DA''=''T~'')','EPRUDELIXPZ0','5','D','15','21',NULL,'Daily Work Hours Number',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','43','(''DA''=''T~'')','EPRUDELIXPZ0','30','D','15','43',NULL,'Employment Location',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"ABS"','1','(''DA''=''T~'')','EPRUDELIXPZ0','1','D','20','1',NULL,'Record Type',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"59904"','2','(''DA''=''T~'')','EPRUDELIXPZ0','1','D','20','2',NULL,'Control Number',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvAbsEmpNo"','3','(''UA''=''T~'')','EPRUDELIXPZ0','1','D','20','3',NULL,'Associate ID',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','43','(''DA''=''T~'')','EPRUDELIXPZ0','50','D','20','43',NULL,'Reporting Code 1',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"HR Representative"','63','(''DA''=''T~'')','EPRUDELIXPZ0','5','D','20','63',NULL,'Contact 1 Type',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvEmploymentType"','95','(''UA''=''T~'')','EPRUDELIXPZ0','1','D','20','95',NULL,'Employment Type',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvEmploymentSector"','96','(''UA''=''T~'')','EPRUDELIXPZ0','1','D','20','96',NULL,'Employment Sector',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvFMLABranchCode"','97','(''UA''=''T~'')','EPRUDELIXPZ0','1','D','20','97',NULL,'FMLA Branch Code',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvFMLAWorkLocationCode"','98','(''UA''=''T~'')','EPRUDELIXPZ0','1','D','20','98',NULL,'FMLA Work Location Code',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvEEIndicator"','99','(''UA''=''T~'')','EPRUDELIXPZ0','1','D','20','99',NULL,'Key EE Indicator',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvStandardWorkSchedule"','100','(''UA''=''T~'')','EPRUDELIXPZ0','1','D','20','100',NULL,'Standard Work Schedule',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvHoursWorkLast12Months"','101','(''UA''=''T~'')','EPRUDELIXPZ0','1','D','20','101',NULL,'HoursWorkedinLast12Months',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvAsOfDateHoursLast12Months"','104','(''UD112''=''T~'')','EPRUDELIXPZ0','1','D','20','104',NULL,'AsofDateOtherHoursWorkedinLast12Months',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','17','(''DA''=''T~'')','EPRUDELIXPZ0','50','D','25','17',NULL,'Claim Branch Code',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','19','(''DA''=''T~'')','EPRUDELIXPZ0','1','D','25','19',NULL,'Assignment Indicator',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EPRUDELIXP_20191023.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Prudential Benefits Eligibilit','201910239','EMPEXPORT','ONDEMAND',NULL,'EPRUDELIXP',NULL,NULL,NULL,'201910239','Oct 23 2019 12:38PM','Oct 23 2019 12:38PM','201910231',NULL,'','','201910231',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EPRUDELIXP_20191023.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','201910239','EMPEXPORT','TEST',NULL,'EPRUDELIXP',NULL,NULL,NULL,'201910239','Oct 23 2019 12:38PM','Oct 23 2019 12:38PM','201910231',NULL,'','','201910231',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EPRUDELIXP_20191023.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201910239','EMPEXPORT','SCHEDULED',NULL,'EPRUDELIXP',NULL,NULL,NULL,'201910239','Oct 23 2019 12:38PM','Oct 23 2019 12:38PM','201910231',NULL,'','','201910231',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EPRUDELIXP_20191023.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','201910239','EMPEXPORT','OEACTIVE',NULL,'EPRUDELIXP',NULL,NULL,NULL,'201910239','Oct 23 2019 12:38PM','Oct 23 2019 12:38PM','201910231',NULL,'','','201910231',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EPRUDELIXP_20191023.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','201910239','EMPEXPORT','OEPASSIVE',NULL,'EPRUDELIXP',NULL,NULL,NULL,'201910239','Oct 23 2019 12:38PM','Oct 23 2019 12:38PM','201910231',NULL,'','','201910231',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\EPRUDELIXP_20191023.txt' END WHERE expFormatCode = 'EPRUDELIXP';
...
CREATE TABLE [dbo].[U_EPRUDELIXP_drvAstTbl] (
    ...
    [drvPhoneTypeCode2] varchar(6) NOT NULL,
    [drvPhoneNumber2] varchar(50) NULL,
    [drvEmailTypeCode1] varchar(50) NULL,
...
CREATE TABLE [dbo].[U_EPRUDELIXP_drvDepTbl] (
    ...
    [drvDepEmailAddressType1] varchar(7) NOT NULL,
...
CREATE TABLE [dbo].[U_EPRUDELIXP_drvEmpTbl] (
    ...
    [drvEarningTypeCode1] varchar(7) NOT NULL,
    ...
    [drvPayrollFreqCode] varchar(6) NOT NULL
);
IF OBJECT_ID('U_EPRUDELIXP_drvTrailer') IS NULL
CREATE TABLE [dbo].[U_EPRUDELIXP_drvTrailer] (
    [drvFileCreationDateTrailer] varchar(1) NOT NULL,
    [drvRecordCount] varchar(1) NOT NULL,
    [drvASTCount] varchar(1) NOT NULL,
    [drvEMPRecordCount] varchar(1) NOT NULL,
    [drvABSCount] varchar(1) NOT NULL,
    [drvCOVCount] varchar(1) NOT NULL,
    [drvDEPCount] varchar(1) NOT NULL,
    [drvTotalBenAmt] varchar(1) NOT NULL
);
...
CREATE TABLE [dbo].[U_EPRUDELIXP_Headerl] (
    ...
    [drvFileCreationDateTime] varchar(1) NOT NULL,
    [drvControlNumber] varchar(1) NOT NULL,
    [drvFileTypeVersion] varchar(1) NOT NULL,
    [drvSenderName] varchar(1) NOT NULL,
    [drvSenderPlatformName] varchar(1) NOT NULL,
    [drvTestProductionCode] varchar(1) NOT NULL,
    [drvTransmissionTypeCode] varchar(1) NOT NULL,
    [drvActivityDateTime] varchar(1) NOT NULL,
    [drvActivityEndDateTime] varchar(1) NOT NULL
);
GO
...
BEGIN
    ...
    -- Required parameters
    INSERT INTO dbo.U_dsi_BDM_Configuration VALUES(@FormatCode,'DedCodes','CIE,CIS,CIC,ACDNT,STDER,LTDER');
    ...
    SELECT DISTINCT
        ...
        ,drvDateOfRetirement = EecDateOfRetirement
    ...
    ---------------------------------
    IF OBJECT_ID('U_EPRUDELIXP_drvCovTbl','U') IS NOT NULL
    ...
    SELECT DISTINCT
        ...
        ,drvCovProductTier = CASE WHEN EedDedCode IN ('CIE') THEN 'EE' 
                                  ...
                                  WHEN EedDedCode IN ('ACDNT') And EedBenOption IN ('EE') THEN 'EE'
                                  WHEN EedDedCode IN ('ACDNT') And EedBenOption IN ('EES') THEN 'ES'
                                  WHEN EedDedCode IN ('ACDNT') And EedBenOption IN ('EEC') THEN 'EC'
                                  WHEN EedDedCode IN ('ACDNT') And EedBenOption IN ('EEF') THEN 'FM'
                             END
        ,drvCovProdPlanCode = ''
        ,drvCovBuyUpIndc = CASE WHEN EedDedCode IN ('STDER') THEN 'Y' ELSE 'N' END
        ,drvCovProdCovAmt = CASE WHEN EedDedCode IN ('CIE') THEN CAST(EedBenAmt as VARCHAR(12)) END
    ...
    SELECT DISTINCT
        ...
        ,drvDepRelationshipTypeCode = CASE WHEN ConRelationship = 'DP' THEN 'DOMESTIC PARTNER'
                                           ...
                                           WHEN ConRelationship In ('DIS', 'STC' , 'CHL') THEN 'CHILD' 
                                      END
        ,drvDEPSSN = eepSSN
        ,drvConGender = ConGender
        ...
        ,drvDepEmailAddressType1 = 'PESONAL'
    ...
    SELECT DISTINCT
         drvRecordType = 'HDR'
        ,drvTransmissionGUID = ''
        ,drvFileCreationDateTime = ''
        ,drvControlNumber = ''
        ,drvFileTypeVersion = ''
        ,drvSenderName = ''
        ,drvSenderPlatformName = ''
        ,drvTestProductionCode = ''
        ,drvTransmissionTypeCode = ''
        ,drvActivityDateTime = ''
        ,drvActivityEndDateTime = ''
...
CREATE VIEW dbo.dsi_vwEPRUDELIXP_Export AS 
    SELECT TOP 200000000 Data FROM dbo.U_EPRUDELIXP_File WITH (NOLOCK)
    ORDER BY RIGHT(RecordSet,2), InitialSort, SubSort