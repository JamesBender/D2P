...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EHEFXMXEXP_20210430.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N',',Y23F4,1KHF6,1KHLK,1KHQV,FB4R0',NULL,NULL,NULL,'HealthEFX Medical -6th of mnth','202010311','EMPEXPORT','SCH_MXEFXB','Jan 14 2021 12:00AM','EHEFXMXEXP',NULL,NULL,NULL,'202103319','Oct 31 2020 12:00AM','Dec 30 1899 12:00AM','202103011',NULL,'','','202010011',dbo.fn_GetTimedKey(),NULL,'us3mLaMAX1005',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','Y23F4,1KHF6,1KHLK,1KHQV,FB4R0',NULL,NULL,NULL,'Test Purposes Only','202101319','EMPEXPORT','TEST','Apr 19 2021  9:43AM','EHEFXMXEXP',NULL,NULL,NULL,'202101319','Jan 31 2021 12:00AM','Dec 30 1899 12:00AM','202101011','1365','','','202101011',dbo.fn_GetTimedKey(),NULL,'us3lKiMAX1005',NULL);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName = CASE WHEN ( (Select top 1 edhbenstatus from emphded where edheeid = xeeid and edhdedcode = bdmdedcode and edheffdate <=  @EndDate order by edheffdate desc,edhDateTimeCreated desc) ) <> 'W' THEN RTRIM(LTRIM(DedDesc)) END
    ...
    JOIN dbo.EmpComp WITH (NOLOCK)
        ON EECEEID = XEEID
        and EECCOID  = XCOID
    JOIN (select eedeeid as bdmeeid,eedcoid as bdmcoid, eeddedcode as bdmdedcode,eedbenstartdate as bdmbenstartdate,eedbenstopdate as bdmbenstopdate,eedbenstatus as bdmbenstatus,eedbenoption as bdmbenoption,null as bdmDeprecid,'EMP' as bdmrectype from U_dsi_BDM_EmpDeductions where   eedformatcode = @FormatCode and eedbenoption <> 'Z'
UNION
select dbneeid as bdmeeid,dbncoid as bdmcoid,dbndedcode as bdmdedcode,dbnbenstartdate as bdmbenstartdate,dbnbenstopdate as bdmbenstopdate,dbnbenstatus as bdmbenstatus,dbnbenoption as bdmbenoption,dbndeprecid as bdmdeprecid,'DEP' as bdmrectype from U_dsi_BDM_DepDeductions where dbnformatcode = @FormatCode and dbnbenoption <> 'Z') as BdmConsilidated
        ON BdmEEID = xEEID 
        AND BdmCoID = xCoID
