...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EFNBOGIEXP_20201111.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'FNB of Omaha Gen Int FF Test','202011101','EMPEXPORT','TEST_XOEFF','Nov 10 2020 11:15PM','EFNBOGIEXP',NULL,NULL,NULL,'202011101','Nov 10 2020 12:00AM','Dec 30 1899 12:00AM','202010271','2687','','','202010271',dbo.fn_GetTimedKey(),NULL,'us3cPeRUN1001',NULL);
...
--==========================================
    ...
    SELECT DISTINCT
        ...
        ,drvSort = ISNULL(EecUDField04, 'no 4') + ' :: ' + ISNULL(EecUDField05, 'no 5') + ' :: ' + ISNULL(EecUDField14, 'no 14') + ' :: ' + ISNULL(EecUDField15, 'no 15') 
        -- standard fields above and additional driver fields below
        ,drvEmployeeHRID = 'RUNN' + EecEmpNo
        ,drvNameFirst = EepNameFirst
        ,drvNameLast = EepNameLast
        ,drvEmailAddress = EepAddressEMail
        ,drvSubAgent =    CASE WHEN EecLocation IN ('80') THEN '000' 
        ...
        ,drvRole =    CASE WHEN EecJobCode = 'STORMGR' THEN 'Sales:Administrator:Report Level 2'
                        WHEN EecJObCode IN ('CASH','SALESASS') THEN 'Sales' + RTRIM(CONCAT(':' + EecUDField04, ':' + EecUDField05, ':' + EecUDField14, ':' + EecUDField15))
