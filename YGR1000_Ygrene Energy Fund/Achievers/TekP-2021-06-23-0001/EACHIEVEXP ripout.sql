...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"Groups"','9','(''DA''=''T,'')','EACHIEVEXPZ0','50','H','01','9',NULL,'Groups',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EACHIEVEXP_20210713.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Achievers Export-Test','202107109','EMPEXPORT','TEST_XOE','Jul  9 2021  6:56PM','EACHIEVEXP',NULL,NULL,NULL,'202107109','Jul 10 2021 12:00AM','Dec 30 1899 12:00AM','202107011','304','','','202107011',dbo.fn_GetTimedKey(),NULL,'us3cPeYGR1000',NULL);
