...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EIAPENELIG_20200824.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'iA Pension Eligibility Export','202008179','EMPEXPORT','ONDEMAND',NULL,'EIAPENELIG',NULL,NULL,NULL,'202008179','Jun  1 2020 10:05AM','Jun  1 2020 10:05AM','202008011',NULL,'','','202008011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EIAPENELIG_20200824.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','202008179','EMPEXPORT','SCHEDULED',NULL,'EIAPENELIG',NULL,NULL,NULL,'202008179','Jun  1 2020 10:05AM','Jun  1 2020 10:05AM','202008011',NULL,'','','202008011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EIAPENELIG_20200824.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','202008199','EMPEXPORT','TEST','Aug 19 2020 10:10AM','EIAPENELIG',NULL,NULL,NULL,'202008199','Aug 19 2020 12:00AM','Dec 30 1899 12:00AM','202008011','2693','','','202008011',dbo.fn_GetTimedKey(),NULL,'LKING01',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EIAPENELIG_20200824.txt' END WHERE expFormatCode = 'EIAPENELIG';
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvEmplStatusChange =    '"' + CASE WHEN EecEmplStatus = 'L' THEN 'Leave of absence'
                                    ...
                                    WHEN EecDateOfOriginalHire <> EecDateOfLastHire THEN 'Return at work'
