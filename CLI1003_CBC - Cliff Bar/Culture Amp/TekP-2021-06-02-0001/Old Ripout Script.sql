...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ECUTRAMPEX_20210702.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N','IAGFG,Y5USD,XI0GS,HG0SP,VLYMR,368IV,B57L5',NULL,NULL,NULL,'Culture Amp Demographic -Sched','202104229','EMPEXPORT','SCH_ECUTRA','Apr 22 2021 12:46PM','ECUTRAMPEX',NULL,NULL,NULL,'202107029','Apr 22 2021 12:00AM','Dec 30 1899 12:00AM','202107011','124','','','202104011',dbo.fn_GetTimedKey(),NULL,'us3rVaCLI1003',NULL);
