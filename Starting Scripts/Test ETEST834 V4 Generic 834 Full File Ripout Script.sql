...
Test Cust - Replace with customer name
James - Replace with TC name
IA - Replace with BA/IC name
1/1/2022 - Replace with date of creation
0000 - Replace with SR number
ETEST834 - Replace with Format Code (i.e., ESUNLIF834)
Test Export - Replace with Name of Interface (AdfFormatName) (i.e., Sunlife 834 Export)
...
EES,EDP - Replace with EE+CHILDREN benefit options for drvCoverageLevel (i.e., EES)
...
SET @FixedFormatName1 = LEFT('Test Export',50);
SET @FixedFormatName2 = LEFT('Test Export',30);
...
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D17','U_ETEST834_DrvTbl','ISNULL(drvREF01_RefNumberQual3,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D18','U_ETEST834_DrvTbl','ISNULL(drvREF01_RefNumberQual4,'''') <> ''''');


INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D19','U_ETEST834_DrvTbl','ISNULL(drvDTP00_DateTime1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D20','U_ETEST834_DrvTbl','ISNULL(drvDTP00_DateTime2,'''') <> ''''');

INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D21','U_ETEST834_DrvTbl','ISNULL(drvDTP00_DateTime3,'''') <> ''''');

INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D22','U_ETEST834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D23','U_ETEST834_DrvTbl','ISNULL(drvPER03_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER05_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER07_CommNumberQualifier,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D24','U_ETEST834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D25','U_ETEST834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D26','U_ETEST834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D27','U_ETEST834_DrvTbl','ISNULL(drvICM01_FrequencyCode,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D28','U_ETEST834_DrvTbl','ISNULL(drvAMT00_SegmentID1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D29','U_ETEST834_DrvTbl','ISNULL(drvAMT00_SegmentID2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('ETEST834','D30','U_ETEST834_DrvTbl','ISNULL(drvHLH00_SegmentID,'''') <> ''''');
...
ChangePoint Request Number: 0000
    ...
    SELECT DISTINCT
        ...
        ,drvHD05_CoverageLevelCode = 
                                                CASE WHEN BdmBenOption IN (SELECT * FROM dbo.dsi_BDM_fn_ListToTable('EE')) THEN 'EMP'
                                                     WHEN BdmBenOption IN (SELECT * FROM dbo.dsi_BDM_fn_ListToTable('EEC')) THEN 'ESP'
                                                     WHEN BdmBenOption IN (SELECT * FROM dbo.dsi_BDM_fn_ListToTable('EES,EDP')) THEN 'ECH'
