...
Client ID:      USG1000
Date/time:      2022-03-25 12:39:06.990
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EZ24
...
Web Filename:   USG1000_12634_EEHISTORY_EUNUMACIHX_ExportCode_YYYYMMDD_HHMMSS.txt
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('21','EUNUMACIHXZ0','50','D','10','21',NULL,'DATE_OF_LST_SLY_CHG',NULL,NULL,'"drvDateOfLastSalaryChange"','(''UA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('32','EUNUMACIHXZ0','50','D','10','32',NULL,'SP_COVG_TERM_DATE',NULL,NULL,'""','(''DA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('44','EUNUMACIHXZ0','50','D','10','44',NULL,'EFF_DATE_OF_SP_COVG',NULL,NULL,'""','(''DA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('45','EUNUMACIHXZ0','50','D','10','45',NULL,'SP_COVG_TERM_DATE',NULL,NULL,'"drvSpouseEffectiveDate2"','(''UDMDY''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('57','EUNUMACIHXZ0','50','D','10','57',NULL,'EFF_DATE_OF_SP_COVG',NULL,NULL,'""','(''DA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('58','EUNUMACIHXZ0','50','D','10','58',NULL,'SP_COVG_TERM_DATE',NULL,NULL,'"drvSpouseEffectiveDate3"','(''UDMDY''=''T,'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUNUMACIHX_20220325.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'UNUM Acc, Crit Il, Hosp -Test','202203259','EMPEXPORT','TEST_XOE',NULL,'EUNUMACIHX',NULL,NULL,NULL,'202203259','Mar 25 2022 12:38PM','Mar 25 2022 12:38PM','202203251',NULL,'','','202203251',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUNUMACIHX','ExportPath','V','\\ez2sup4db01\ultiprodata\[Name]\Exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUNUMACIHX','UseFileName','V','N');
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvGender = EepGender
        ,drvMostRecentDateOfHire = ''
        ,drvEETerminationDate = CASE WHEN EecEmplStatus = 'T' THEN EecDateOfTermination END
        ,drvDateOfLastSalaryChange = ''
        ,drvProduct1 = ''
        ,drvPolicyNumber1 = ''
        ,drvDivision1 = ''
        ,drvPolicyEligbilityGroup1 = ''
        ,drvChoice1 = ''
        ,drvEffectiveDateOfEECoverage1 = ''
        ,drvCoverageTerminationDate1 = ''
        ,drvEEBenefitAmount1 = ''
        ,drvCiSpInd1 = ''
        ,drvSpouseEffectiveDate1 = ''
        ,drvProduct2 = ''
        ,drvPolicyNumber2 = ''
        ,drvDivision2 = ''
        ,drvPolicyEligbilityGroup2 = ''
        ,drvChoice2 = ''
        ,drvEffectiveDateOfEECoverage2 = ''
        ,drvCoverageTerminationDate2 = ''
        ,drvSpouseEffectiveDate2 = ''
        ,drvChildEffeciveDate2 = ''
        ,drvChildTerminationDate2 = ''
        ,drvProduct3 = ''
        ,drvPolicyNumber3 = ''
        ,drvDivision3 = ''
        ,drvPolicyEligbilityGroup3 = ''
        ,drvChoice3 = ''
        ,drvEffectiveDateOfEECoverage3 = ''
        ,drvCoverageTerminationDate3 = ''
        ,drvSpouseEffectiveDate3 = ''
        ,drvChildEffeciveDate3 = ''
        ,drvChildTerminationDate3 = ''
