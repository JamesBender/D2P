...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EHFXCENTE2_20210720.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'TEST','202104219','EMPEXPORT','TEST','Jul 13 2021  7:55PM','EHFXCENTE2',NULL,NULL,NULL,'202104219','Apr 21 2021 12:00AM','Dec 30 1899 12:00AM','202104011','1263','','','202104011',dbo.fn_GetTimedKey(),NULL,'us3lKiTEN1000',NULL);
