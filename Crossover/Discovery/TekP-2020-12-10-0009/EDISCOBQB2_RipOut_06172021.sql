...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISCOBQB2_20210617.txt';
...
BEGIN
    ...
    -- Create table to re-create coverage logic
        ...
        left join dbo.U_dsi_BDM_EDISCOBQB2 c with(nolock) on c.bdmeeid = e.bdmeeid and s.bdmdedcode = e.bdmdedcode and c.bdmrelationship in ('chl', 'stc', 'dpc', 'ddp', 'grc')
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName =    CASE WHEN A.BdmDedCode IN ('XOMFT','XOMPT') THEN 'Aetna Medical XO First PPO' -- jcb
                        ...
                        END                    
        ,drvStartDate = CASE WHEN A.BdmDedCode = 'XOXO' AND DAY(DATEADD(DAY, 1, A.BdmBenStopDate)) <> '1' THEN DATEADD(d, 1, EOMONTH(current_timestamp)) ELSE 
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName = CASE WHEN BdmDedCode IN ('XOMFT','XOMPT') THEN 'Aetna Medical XO First PPO' 
                        ...
                        END                    
        ,drvStartDate = CASE WHEN BdmDedCode = 'XOXO' AND DAY(DATEADD(DAY, 1, BdmBenStopDate)) <> '1' THEN DATEADD(d, 1, EOMONTH(current_timestamp)) ELSE 
