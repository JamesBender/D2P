...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvCoverateDesc"','51','(''UA''=''T,'')','ESEQDEMOEXZ0','50','D','10','51',NULL,'COVERAGE DESCRIPTION',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ESEQDEMOEX_20210319.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N',',EZQDT,F1N78,H3NE9,NSEGA,F1NC2,CH10X,F1NG7,F1NDT,LNA6Q,F1NHS,CH0YK,CH0VR,LNAAL,LNA83,6TWV9,F1N9L,F1NM1,B2S45,C80WA',NULL,NULL,NULL,'Sequoia Demographics Exp-Sched','202011129','EMPEXPORT','SCH_ESEQDE',NULL,'ESEQDEMOEX',NULL,NULL,NULL,'202103199','Nov 12 2020  2:08PM','Nov 12 2020  2:08PM','202103121',NULL,'','','202011121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Sequoia Demographics Exp-Test','202103051','EMPEXPORT','TEST_XOE','Mar 17 2021  2:39PM','ESEQDEMOEX',NULL,NULL,NULL,'202103051','Mar  5 2021 12:00AM','Dec 30 1899 12:00AM','202103051','7159','','','202103051',dbo.fn_GetTimedKey(),NULL,'us3rVaCHA1019',NULL);
