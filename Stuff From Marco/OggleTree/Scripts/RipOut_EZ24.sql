...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCreateTClockBatches,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhPreProcessSQL,AdhRecordSize,AdhRespectZeroPayRate,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhThirdPartyPay) VALUES ('N','C','Y','0','',NULL,'','N','','N','','013010','EMPEXPORT','CDE','EYWFMLAEXP','York/CareWorks FMLA Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','dbo.dsi_sp_Switchbox_v2','6000','N','S','N','EYWFMLAEXPZ0','N','Jan  1 1900 12:00AM','C','N');
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvZipCode"','9','(''UA''=''T,'')','EYWFMLAEXPZ0','50','D','10','9',NULL,'Zip Code',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"Ogletree Deacon"','16','(''DA''=''T,'')','EYWFMLAEXPZ0','50','D','10','16',NULL,'Company Name',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','17','(''DA''=''T,'')','EYWFMLAEXPZ0','50','D','10','17',NULL,'Department',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','18','(''DA''=''T,'')','EYWFMLAEXPZ0','50','D','10','18',NULL,'Area',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','81','(''DA''=''T,'')','EYWFMLAEXPZ0','50','D','10','81',NULL,'Supervisor 2',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','84','(''DA''=''T,'')','EYWFMLAEXPZ0','50','D','10','84',NULL,'Supervisor 2 E-mail',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvLastRehireDate"','107','(''UA''=''T,'')','EYWFMLAEXPZ0','50','D','10','107',NULL,'Last Rehire Date',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EYWFMLAEXP_20191029.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'York/CareWorks FMLA Export','201910249','EMPEXPORT','ONDEMAND',NULL,'EYWFMLAEXP',NULL,NULL,NULL,'201910249','Oct 24 2019  4:22PM','Oct 24 2019  4:22PM','201910241',NULL,'','','201910241',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EYWFMLAEXP_20191029.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','201910249','EMPEXPORT','TEST',NULL,'EYWFMLAEXP',NULL,NULL,NULL,'201910249','Oct 24 2019  4:22PM','Oct 24 2019  4:22PM','201910241',NULL,'','','201910241',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EYWFMLAEXP_20191029.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201910249','EMPEXPORT','SCHEDULED',NULL,'EYWFMLAEXP',NULL,NULL,NULL,'201910249','Oct 24 2019  4:22PM','Oct 24 2019  4:22PM','201910241',NULL,'','','201910241',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\EYWFMLAEXP_20191029.txt' END WHERE expFormatCode = 'EYWFMLAEXP';
...
CREATE TABLE [dbo].[U_EYWFMLAEXP_drvTbl] (
    ...
    [drvStandardHours] varchar(2) NOT NULL,
    ...
    [drvWorkHoursLast12Months] varchar(12) NULL,
...
BEGIN
    ...
    IF OBJECT_ID('U_EYWFMLAEXP_DedList','U') IS NOT NULL
        DROP TABLE dbo.U_EYWFMLAEXP_DedList;
    SELECT DISTINCT
         DedCode = DedDedCode
        ,DedType = DedDedType
    INTO dbo.U_EYWFMLAEXP_DedList
    ...
    -----------------------------
    IF OBJECT_ID('U_EYWFMLAEXP_PDedHist','U') IS NOT NULL
        DROP TABLE dbo.U_EYWFMLAEXP_PDedHist;
    SELECT DISTINCT
         PdhEEID
    ...
    INTO dbo.U_EYWFMLAEXP_PDedHist
    FROM dbo.PDedHist WITH (NOLOCK)
    JOIN dbo.U_EYWFMLAEXP_DedList WITH (NOLOCK)
    ...
    SELECT DISTINCT
        ...
        ,PehCurAmtYTD           = SUM(CASE WHEN PehEarnCode NOT IN ('BRV','HOL','JUR','MEALP','MILPT','OFC','PFL','PFLS6','PFLS7','PFLS8','PFLS9','PRKNT','PT','STD','STD70','STD80','STD90','STDA','UNPD','VAC') THEN PehCurAmt ELSE 0.00 END)
    ...
    SELECT DISTINCT
        ...
        ,drvZipCodeEmp = EepAddressZipCode
        ,drvJobTitle = EecJobtitle
        ,drvLocationCode = EecLocation
        ,drvLocationName = (Select Top 1 LocName from Location where LocCode in (EEcLocation))
        ...
        ,drvWorkStatus = CASE WHEN EecFullTimeOrPartTime = 'F' THEN 'Full Time'
                                ELSE 'Part Time'
                         END
        ,drvEmployeeWorkPhone = EecPhoneBusinessNumber
        ...
        ,drvWorkHoursLast12Months = CAST(PehCurHrsYTD as VARCHAR(12))
    ...
    JOIN dbo.U_EYWFMLAEXP_PEarHist WITH (NOLOCK)
        on PehEEID = xEEID
    ;
