...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EEMPTR401K_20210903.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Pension 401a Emp Export-Sched','202108179','EMPEXPORT','SCH_EMP401',NULL,'EEMPTR401K',NULL,NULL,NULL,'202108179','Aug 17 2021  6:06PM','Aug 17 2021  6:06PM','202108171',NULL,'','','202108171',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Pension 401a Emp Export-Test','202108199','EMPEXPORT','TEST_XOE','Sep  2 2021  3:11PM','EEMPTR401K',NULL,NULL,NULL,'202108199','Aug 19 2021 12:00AM','Dec 30 1899 12:00AM','202108191','878','','','202108191',dbo.fn_GetTimedKey(),NULL,'us3lKiTRI1018',NULL);
...
09/03/2021 by AP:
		...
		- Removed employees that have a 0.00 amount for PdhERCurAmt.
...
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EEMPTR401K', 'SCH_EMP401';
...
--==========================================
    ...
    SELECT DISTINCT
        ...
        ,drvFiller1 = ''
        ,drvIRSNum = (SELECT CmmFedTaxId FROM dbo.CompMast WITH(NOLOCK))
        ,drvTotRemit = RIGHT('0000000000' + REPLACE(CAST(CAST(SUM(PdhERCurAmt) AS DECIMAL(10,2)) AS VARCHAR), '.', ''), 10)
		--RIGHT('0000000000' + REPLACE(CAST(SUM(PdhERCurAmt) AS VARCHAR), '.', ''), 10)
        --CAST(CAST(PdhERCurAmt AS DECIMAL(10,2)) AS VARCHAR)
        ,drvFiller2 = ''
        ,drvFormatCode = '03'
        ,drvFiller3 = ''
    ...
    SELECT DISTINCT
        ...
        ,drvSourceCode = 'ER'
        ,drvPartSSN = eepSSN
        ,drvContAmt = RIGHT('0000000000' + REPLACE(CAST(CAST(PdhERCurAmt AS DECIMAL(10,2)) AS VARCHAR), '.', ''), 10)
		--RIGHT('0000000000' + REPLACE(CAST(CAST(PdhERCurAmt AS DECIMAL(10,2)) AS VARCHAR), '.', ''), 10)
        --CAST(CAST(PdhERCurAmt AS DECIMAL(10,2)) AS VARCHAR)
        ,drvTaxYear = ''
        ,drvFundId = ''
        ,drvFiller1 = ''
    ...
    JOIN dbo.EmpPers WITH(NOLOCK) 
    ON EepEEID = xEEID
    JOIN (SELECT PdhEEID, PdhCOID, SUM(PdhERCurAmt) PdhERCurAmt
                FROM dbo.U_EEMPTR401K_PDedHist WITH(NOLOCK)
                WHERE PdhDedCode IN ('BCPA', 'BCPN')
				AND PdhERCurAmt <> '0.00'
