...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBQB_20200505.txt',NULL,'','','',NULL,NULL,NULL,'Active Open Enrollment Export','202004209','EMPEXPORT','OEACTIVE','Mar  3 2020 12:11PM','EDISCCOBQB',NULL,NULL,NULL,'202004209','Feb 25 2020  9:06AM','Feb 25 2020  9:06AM','202004131','589','','','200204131',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBQB_20200505.txt',NULL,'','','',NULL,NULL,NULL,'Passive Open Enrollment Export','202004209','EMPEXPORT','OEPASSIVE','Mar  3 2020 12:12PM','EDISCCOBQB',NULL,NULL,NULL,'202004209','Feb 25 2020  9:06AM','Feb 25 2020  9:06AM','202004131','589','','','200204131',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBQB_20200505.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202004299','EMPEXPORT','TEST','Apr 29 2020 11:57AM','EDISCCOBQB',NULL,NULL,NULL,'202004299','Apr 29 2020 12:00AM','Dec 30 1899 12:00AM','202004131','139','','','202004131',dbo.fn_GetTimedKey(),NULL,'us3lKiFOX1002',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EDISCCOBQB_20200505.txt' END WHERE expFormatCode = 'EDISCCOBQB';
        ...
        ,drvCoverageLevel =    CASE WHEN BdmDedCode IN ('HSP', 'HSPT') THEN
                                ...
                                WHEN BdmDedCode IN ('EYE') THEN
                                    CASE WHEN BdmBenOption IN ('EE') THEN 'EE'
                                        WHEN BdmBenOption IN ('EEC') THEN 'EE+CHILD'
                                        WHEN BdmBenOption IN ('EEF') THEN 'EE+FAMILY'
                                        WHEN BdmBenOption IN ('EEX') THEN 'EE+SPOUSE'
                                        ELSE 'EE+CHILDREN'
                                    END
