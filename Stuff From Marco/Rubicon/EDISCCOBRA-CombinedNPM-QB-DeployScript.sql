...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"UNKNOWN"','29','(''DA''=''Q,'')','EDISCCOBRAZ0','50','D','10','29',NULL,'EmployeeType',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"FALSE"','33','(''DA''=''Q,'')','EDISCCOBRAZ0','50','D','10','33',NULL,'UsesHCTC',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"TRUE"','20','(''DA''=''Q,'')','EDISCCOBRAZ0','50','D','70','20',NULL,'UsesFamilyInAddress',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBRA_20200715.txt',NULL,'','','',NULL,NULL,NULL,'NPM/Cobra Export','202002289','EMPEXPORT','ONDEMAND','Mar  2 2020  4:28PM','EDISCCOBRA',NULL,NULL,NULL,'202002289','Oct 30 2017 12:00AM','Dec 30 1899 12:00AM','202002141','3858','','','202002141',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBRA_20200715.txt',NULL,'','','',NULL,NULL,NULL,'Test NPM/Cobra Export','202006309','EMPEXPORT','TEST','Jun 30 2020 12:09PM','EDISCCOBRA',NULL,NULL,NULL,'202006309','Jun 30 2020 12:00AM','Dec 30 1899 12:00AM','202006011','134','','','202006011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EDISCCOBRA_20200715.txt',NULL,NULL,NULL,'',NULL,NULL,NULL,'Schedule Session','202007109','EMPEXPORT','SCH_DISC','Jul 15 2020 12:00AM','EDISCCOBRA',NULL,NULL,NULL,'202007109','Jul 10 2020 12:00AM','Dec 30 1899 12:00AM','202007031',NULL,'','','202007031',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EDISCCOBRA_20200715.txt' END WHERE expFormatCode = 'EDISCCOBRA';
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvSSN             = eepSSN
        ,drvEmpNo           = EecEmpNo
        ,drvClientName      = CONVERT(varchar(100),'Rubicon Oilfield International 38130')
        ,drvClientDivName   = CONVERT(varchar(100),'Rubicon Oilfield International')
    ...
    SELECT DISTINCT
        ...
        ,drvSSN            = eepSSN
        ,drvName           = CASE WHEN BdmRecType = 'DEP' THEN RTRIM(EepNameFirst) + ' ' + RTRIM(EepNameLast)
                                  ELSE ''
                             END
        ,drvInitialSort    = '21'
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName      = CONVERT(varchar(50),(CASE WHEN BdmDedCode in ('55DNT')    THEN 'Ameritas Dental' 
                                 WHEN BdmDedCode in ('55MHS')    THEN 'CIGNA Medical HSA' 
                                 WHEN BdmDedCode in ('55MPO')    THEN 'CIGNA Medical PPO 1500' 
                                 WHEN BdmDedCode in ('55MPB')    THEN 'CIGNA Medical PPO Buy Up 750' 
                                 WHEN BdmDedCode in ('55VIS')    THEN 'Ameritas Vision' 
                                 WHEN BdmDedCode in ('53MFS')    THEN 'DBI FSA' 
                            END))
    ...
    SELECT DISTINCT
        ...
        ,drvIsAddressSame  = CASE WHEN ConAddressIsDifferent = 'NO' THEN 'TRUE' ELSE 'FALSE' END
        ,drvAddressLine1   = CASE WHEN ConAddressIsDifferent <> 'NO' THEN ConAddressLine1 END
        ,drvAddressLine2   = CASE WHEN ConAddressIsDifferent <> 'NO' THEN ConAddressLine2 END
        ,drvAddressCity    = CASE WHEN ConAddressIsDifferent <> 'NO' THEN ConAddressCity END
        ,drvAddressState   = CASE WHEN ConAddressIsDifferent <> 'NO' THEN ConAddressState END
        ,drvAddressZipCode = CASE WHEN ConAddressIsDifferent <> 'NO' THEN ConAddressZipCode END
        ,drvGender         = ConGender
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName    =  CONVERT(varchar(50),(CASE WHEN BdmDedCode in ('55DNT')    THEN 'Ameritas Dental' 
                                 ...
                                 WHEN BdmDedCode in ('53MFS')    THEN 'DBI FSA' 
                            END))
        ,drvRate        = CASE WHEN BDmDedcode in ('53MFS') THEN BdmEEAmt END
        ,drvInitialSort = '21'
        ,drvSubSort     = drvSubSort
        ,drvSubSort2    = '3'
        ,drvSubSort3    = drvSubSort3
