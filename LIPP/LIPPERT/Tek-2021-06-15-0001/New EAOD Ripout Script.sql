...
Client ID:      LIP1000
Date/time:      2021-12-16 06:16:05.003
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    N12
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('32','EAOD000000Z0','50','H','01','32',NULL,'Hourly Status',NULL,NULL,'"Hourly Status"','(''DA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('33','EAOD000000Z0','50','H','01','33',NULL,'Hourly Status Date',NULL,NULL,'"Hourly Status Date"','(''DA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('34','EAOD000000Z0','50','H','01','34',NULL,'Term Date',NULL,NULL,'"Term Date"','(''DA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('35','EAOD000000Z0','50','H','01','35',NULL,'Last Review Date',NULL,NULL,'"Last Review Date"','(''DA''=''T'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('29','EAOD000000Z0','50','D','10','29',NULL,'Agency',NULL,NULL,'"drvagency"','(''UA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('32','EAOD000000Z0','50','D','10','32',NULL,'Hourly Status',NULL,NULL,'"drvhourlystatus"','(''UA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('33','EAOD000000Z0','50','D','10','33',NULL,'Hourly Status Date',NULL,NULL,'"drvhrstatusDate"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('34','EAOD000000Z0','50','D','10','34',NULL,'Term Date',NULL,NULL,'"drvtermdate"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('35','EAOD000000Z0','50','D','10','35',NULL,'Last Review Date',NULL,NULL,'"drvlastreviewdate"','(''UD101''=''T'')');
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','8Z3ZJ,DAJY5,7WA7Y,7W9PY,7WA4Z,7WA1D',NULL,NULL,NULL,'Changes Only','202110059','EMPEXPORT','CHGS_XOE','Sep  3 2021 10:48AM','EAOD',NULL,NULL,NULL,'202110059','Sep  2 2021 12:00AM','Dec 30 1899 12:00AM','202109211','3069','','','202109211',dbo.fn_GetTimedKey(),NULL,'us3jReLIP1000',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','8Z3ZJ,DAJY5,9QTBK,7WA7Y,7W9PY,7WA4Z,7WA1D',NULL,NULL,NULL,'Full File','202111249','EMPEXPORT','FULL_XOE','Nov 24 2021  3:09PM','EAOD',NULL,NULL,NULL,'202111249','Nov 24 2021 12:00AM','Dec 30 1899 12:00AM','202111241','44667','','','202111241',dbo.fn_GetTimedKey(),NULL,'us3jReLIP1000',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','8Z3ZJ,DAJY5,7WA7Y,7W9PY,7WA4Z,7WA1D',NULL,NULL,NULL,'Scheduled Session 8AM','202110059','EMPEXPORT','SCHEDU8AM',NULL,'EAOD',NULL,NULL,NULL,'202110059','Aug 13 2020  6:13PM','Aug 13 2020  6:13PM','202109211',NULL,'','','202109211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','8Z3ZJ,DAJY5,7WA7Y,7W9PY,7WA4Z,7WA1D',NULL,NULL,NULL,'Scheduled Session 11AM','202110059','EMPEXPORT','SCHEDUL11A',NULL,'EAOD',NULL,NULL,NULL,'202110059','Aug 13 2020  6:13PM','Aug 13 2020  6:13PM','202109211',NULL,'','','202109211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','8Z3ZJ,DAJY5,7WA7Y,7W9PY,7WA4Z,7WA1D',NULL,NULL,NULL,'Scheduled Session 2PM','202110059','EMPEXPORT','SCHEDUL2PM',NULL,'EAOD',NULL,NULL,NULL,'202110059','Aug 13 2020  6:13PM','Aug 13 2020  6:13PM','202109211',NULL,'','','202109211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','8Z3ZJ,DAJY5,7WA7Y,7W9PY,7WA4Z,7WA1D',NULL,NULL,NULL,'Scheduled Session 5PM','202110059','EMPEXPORT','SCHEDUL5PM',NULL,'EAOD',NULL,NULL,NULL,'202110059','Aug 13 2020  6:13PM','Aug 13 2020  6:13PM','202109211',NULL,'','','202109211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','8Z3ZJ,DAJY5,7WA7Y,7W9PY,7WA4Z,7WA1D',NULL,NULL,NULL,'Scheduled Session 9PM','202110059','EMPEXPORT','SCHEDULED',NULL,'EAOD',NULL,NULL,NULL,'202110059','Aug 13 2020  6:13PM','Aug 13 2020  6:13PM','202109211',NULL,'','','202109211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','8Z3ZJ,DAJY5,9QTBK,7WA7Y,7W9PY,7WA4Z,7WA1D',NULL,NULL,NULL,'Test File','202111249','EMPEXPORT','TEST_XOE','Nov 24 2021  3:09PM','EAOD',NULL,NULL,NULL,'202111249','Nov 24 2021 12:00AM','Dec 30 1899 12:00AM','202111241','44667','','','202111241',dbo.fn_GetTimedKey(),NULL,'us3jReLIP1000',NULL);
...
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EAOD', 'TEST_XOE';
...
EXEC dbo._dsi_usp_ExportRipOut_v7_4 @FormatCode = 'EAOD', @AllObjects = 'Y', @IsWeb = 'Y';
**********************************************************************************/
BEGIN
    ...
    insert into dbo.U_EAOD_AuditFields values ('empcomp','EecFullTimeOrPartTime');
    insert into dbo.U_EAOD_AuditFields values ('empcomp','EecEEType');
    insert into dbo.U_EAOD_AuditFields values ('empcomp','EecTimeclockID');
    insert into dbo.U_EAOD_AuditFields values ('emphjob','EjhFullTimeOrPartTime');  
...
/*
    ...
    IF OBJECT_ID('U_EAOD_StatusDate_Audit','U') IS NOT NULL
        DROP TABLE dbo.U_EAOD_StatusDate_Audit;
    SELECT 
        audEEID  = audKey1Value
        ,audKey2 = audKey2Value
        --,audKey3 = audKey3Value
        ...
        ,audSystemId
        ,audRowNo = ROW_NUMBER() OVER (PARTITION BY audKey1Value, audKey2Value /*, audKey3Value, audFieldName*/ ORDER BY audDateTime DESC)
    INTO dbo.U_EAOD_StatusDate_Audit                    --select * from U_EAOD_Audit
    FROM dbo.vw_AuditData WITH (NOLOCK) 
    JOIN dbo.U_EAOD_AuditFields WITH (NOLOCK) 
        ON audTableName = aTableName
        AND audFieldName = aFieldName
    JOIN dbo.U_EAOD_EEList WITH (NOLOCK)
        ON xEEID = audKey1Value
        AND xCOID = audKey2Value
    WHERE audAction <> 'DELETE';
*/
    --DELETE dbo.U_EAOD_StatusDate_Audit WHERE audRowNo <> 1;
    ...
    IF OBJECT_ID('U_EAOD_hrstatusdate','U') IS NOT NULL
        DROP TABLE dbo.U_EAOD_hrstatusdate;
    SELECT EjhEEID StEEID,EjhCOID StCOID, AudFieldName StAudFieldName,MAX(EjhJobEffDate) StDate
    INTO dbo.U_EAOD_hrstatusdate
    FROM dbo.U_EAOD_EEList WITH (NOLOCK)
    JOIN dbo.vw_int_EmpHJob WITH (NOLOCK)
        ON EjhEEID = xEEID
        AND EjhCOID = xCOID
    ...
    /*LEFT JOIN (
                ...
                FROM dbo.U_EAOD_StatusDate_Audit WITH (NOLOCK)
                JOIN dbo.vw_int_EmpComp WITH (NOLOCK)
                        ON EecEEID = audEEID 
                        AND EecCoID = audKey2
