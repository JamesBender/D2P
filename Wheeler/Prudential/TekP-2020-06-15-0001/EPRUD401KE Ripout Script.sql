...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EPRUD401KE_20210118.txt';
/*09*/ DECLARE @FILEPATH varchar(1000) = '\\' + @COUNTRY + '.saas\' + @SERVER + '\' + @ENVIRONMENT + '\Downloads\V10\Exports\' + @COCODE + '\EmployeeHistoryExport\';
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Active Open Enrollment Export','202007149','EMPEXPORT','OEACTIVE','Jul 14 2020  1:57PM','EPRUD401KE',NULL,NULL,NULL,'202007149','Jul 14 2020 12:29PM','Jul 14 2020 12:29PM','202001011','220','','','202001011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Passive Open Enrollment Export','202007149','EMPEXPORT','OEPASSIVE','Jul 14 2020  1:58PM','EPRUD401KE',NULL,NULL,NULL,'202007149','Jul 14 2020 12:29PM','Jul 14 2020 12:29PM','202001011','345','','','202001011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Prudendtial 006764 401K','202007149','EMPEXPORT','ONDEMAND','Jul 14 2020  2:00PM','EPRUD401KE',NULL,NULL,NULL,'202007149','Jul 14 2020 12:29PM','Jul 14 2020 12:29PM','202001011','345','','','202001011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Scheduled Session','202007149','EMPEXPORT','SCHEDULED','Jul 14 2020  2:01PM','EPRUD401KE',NULL,NULL,NULL,'202007149','Jul 14 2020 12:29PM','Jul 14 2020 12:29PM','202001011','345','','','202001011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202012111','EMPEXPORT','TEST','Dec 11 2020  1:32PM','EPRUD401KE',NULL,NULL,NULL,'202012111','Dec 11 2020 12:00AM','Dec  5 2020 12:00AM','202012111','297','eecPayGroup','BIWEEK,CCOBW,GDRBW,HTGBW,ICMBW,MELBW','202012111',dbo.fn_GetTimedKey(),NULL,'us3rVaWHE1001',NULL);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvContributionAmt1 = CASE WHEN N401P_DedCode IS NOT NULL OR N401F_DedCode IS NOT NULL OR  NCUPP_DedCode IS NOT NULL OR  NCUPF_DedCode IS NOT NULL THEN FORMAT(PdhSource1Amt*100, '000000000') END
        ,drvSource2 = CASE WHEN N401R_DedCode IS NOT NULL OR 'NCUPR' IS NOT NULL THEN 'J' END
        ,drvContributionAmt2 = CASE WHEN N401R_DedCode IS NOT NULL OR 'NCUPR' IS NOT NULL THEN FORMAT(PdhSource2Amt*100, '000000000') END
        ,drvSource3 = CASE WHEN _4ERM_DedCode IS NOT NULL THEN '6' END
        ,drvContributionAmt3 = CASE WHEN _4ERM_DedCode IS NOT NULL THEN FORMAT(PdhSource3Amt*100, '000000000') END
        ,drvSource4 = CASE WHEN NPRSH_DedCode IS NOT NULL THEN '1' END
        ,drvContributionAmt4 = CASE WHEN NPRSH_DedCode IS NOT NULL THEN FORMAT(PdhSource4Amt*100, '000000000') END
        ,drvSource5 = CASE WHEN N40AT_DedCode IS NOT NULL THEN 'K' END
        ,drvContributionAmt5 = CASE WHEN N40AT_DedCode IS NOT NULL THEN FORMAT(PdhSource5Amt*100, '000000000') END
        ...
        ,drvSubPlanNumber =    CASE WHEN PgpPayGroup IN ('CCOBW') AND CmpCompanyCode IN ('CCO') THEN '000001'
                                ...
                                WHEN PgpPayGroup IN ('BKWBW') AND CmpCompanyCode IN ('BKW') THEN '000006'
                                WHEN PgpPayGroup IN ('GDRBW','GDRWK') AND CmpCompanyCode IN ('GDR') THEN '000007'
                                WHEN PgpPayGroup IN ('MELBW') AND CmpCompanyCode IN ('MEL') THEN '000005'
                            END
