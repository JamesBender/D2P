...
Client ID:      EDU1002
Date/time:      2022-08-12 17:35:12.970
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    E15
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECLOHSACON_20220812.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Optum HSA Contribution Export','202208129','EMPEXPORT','ONDEM_XOE',NULL,'ECLOHSACON',NULL,NULL,NULL,'202208129','Jun 21 2022  4:29PM','Jun 21 2022  4:29PM','202208121',NULL,'','','202208121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Optum HSA Contribution E-Sched','202208129','EMPEXPORT','SCH_ECLOHS',NULL,'ECLOHSACON',NULL,NULL,NULL,'202208129','Jun 21 2022  4:29PM','Jun 21 2022  4:29PM','202208121',NULL,'','','202208121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'Optum HSA Contribution E-Test','202208129','EMPEXPORT','TEST_XOE','Jul 22 2022 12:00AM','ECLOHSACON',NULL,NULL,NULL,'202208129','Jul  1 2022 12:00AM','Jun 25 2022 12:00AM','202208121',NULL,'eecPayGroup','ACE,CLIK,CORP,EAP,EDALTE,FLESA,GROW,OESADM,OES,PAYB,RAY,ROSSIE,SCI,SCEAST,WORK,WORKRP','202208121',dbo.fn_GetTimedKey(),NULL,'us3cPeEDU1002',NULL);
...
CREATE TABLE [dbo].[U_ECLOHSACON_PDedHist] (
    ...
    [PdhEEHSADE] numeric NULL,
    [PdhEEHSAEE] numeric NULL,
    [PdhEEHSDCU] numeric NULL,
    [PdhEEHSECU] numeric NULL,
    [PdhERHSADE] numeric NULL,
    [PdhERHSAEE] numeric NULL,
    [PdhERHSDCU] numeric NULL,
    [PdhERHSECU] numeric NULL
);
GO
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,PdhEEHSADE     = SUM(CASE WHEN PdhDedCode IN ('HSADE') AND PdhPerControl BETWEEN @StartPerControl AND @EndPerControl THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhEEHSAEE     = SUM(CASE WHEN PdhDedCode IN ('HSAEE') AND PdhPerControl BETWEEN @StartPerControl AND @EndPerControl THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhEEHSDCU     = SUM(CASE WHEN PdhDedCode IN ('HSDCU') AND PdhPerControl BETWEEN @StartPerControl AND @EndPerControl THEN PdhEECurAmt ELSE 0.00 END)        
        ,PdhEEHSECU     = SUM(CASE WHEN PdhDedCode IN ('HSECU') AND PdhPerControl BETWEEN @StartPerControl AND @EndPerControl THEN PdhEECurAmt ELSE 0.00 END)
       -- ,PdhEEHSAUP     = SUM(CASE WHEN PdhDedCode IN ('HSAUP') THEN PdhEECurAmt ELSE 0.00 END)
        ,PdhERHSADE     = SUM(CASE WHEN PdhDedCode IN ('HSADE') AND PdhPerControl BETWEEN @StartPerControl AND @EndPerControl THEN ISNULL(PdhERCurAmt, 0) ELSE 0.00 END)
        ,PdhERHSAEE     = SUM(CASE WHEN PdhDedCode IN ('HSAEE') AND PdhPerControl BETWEEN @StartPerControl AND @EndPerControl THEN ISNULL(PdhERCurAmt, 0) ELSE 0.00 END)
        ,PdhERHSDCU     = SUM(CASE WHEN PdhDedCode IN ('HSDCU') AND PdhPerControl BETWEEN @StartPerControl AND @EndPerControl THEN ISNULL(PdhERCurAmt, 0) ELSE 0.00 END)
        ,PdhERHSECU     = SUM(CASE WHEN PdhDedCode IN ('HSECU') AND PdhPerControl BETWEEN @StartPerControl AND @EndPerControl THEN ISNULL(PdhERCurAmt, 0) ELSE 0.00 END)
    ...
    SELECT DISTINCT
        ...
        ,drvCreditAmount = REPLACE(LEFT(PdhEECurAmt, (LEN(PdhEECurAmt) - 2)), '.', '')
    ...
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON eepEEID = xEEID
    JOIN (SELECT pdhEEID as pdhEEID,
            CAST(PdhEEHSAEE + PdhEEHSDCU + PdhEEHSECU  + PdhEEHSADE AS VARCHAR) AS PdhEECurAmt
            FROM dbo.U_ECLOHSACON_PDedHist WITH (NOLOCK)
            WHERE PdhEEHSAEE + PdhEEHSDCU + PdhEEHSECU  + PdhEEHSADE > 0) AS pdhE_Flattened
        ON pdhEEID = xEEID
    ...
    --        AND bdmEEAmt > 0
    --        GROUP BY bdmEEID) AS BdmFlattenedEE
 --       ON BdmEEID = xEEID
    --JOIN dbo.PDedHist ON PdhEEID = xEEID
    ...
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON eepEEID = xEEID
    JOIN     (SELECT pdhEEID AS pdhEEID,
            CAST(PdhERHSAEE + PdhERHSDCU + PdhERHSECU  + PdhERHSADE AS VARCHAR) AS PdhERCurAmt
            FROM dbo.U_ECLOHSACON_PDedHist WITH (NOLOCK)
            WHERE PdhERHSAEE + PdhERHSDCU + PdhERHSECU + PdhERHSADE > 0) AS pdhR_Flattened
        ON pdhEEID = xEEID
