...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISHSAEXP_20210723.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Discovery HSA Export-Test','202107239','EMPEXPORT','TEST_XOE','Jul 22 2021  1:41PM','EDISHSAEXP',NULL,NULL,NULL,'202107239','Jul 23 2021 12:00AM','Dec 30 1899 12:00AM','202107231','598','eecPayGroup','BIWEEK','202107231',dbo.fn_GetTimedKey(),NULL,'us3cPeNOR1052',NULL);
...
07/13/2021 by AP:
        - Changed PO BOX to Post Office Box (see drvaddressline2).
        - Changed PDedHist join to LEFT join on EN record.

07/21/2021 by AP:
        - Removed use of prior PayDedHist from EN.

07/23/2021 by AP:
		- HSACC removed from PT record.
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvAddressLine2 = replace(replace(EepAddressLine2, 'po box', 'Post Office Box'), 'p.o. box', 'Post Office Box')
    ...
    --LEFT JOIN dbo.U_EDISHSAEXP_PDedHist WITH (NOLOCK)
    --    ON PdhEEID = xEEID
    --    AND PdhCOID = xCOID
