...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EUNUMDREXP_20210728.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'UNUM LTD STD Export-Test','202107279','EMPEXPORT','TEST_XOE','Jul 28 2021  5:59PM','EUNUMDREXP',NULL,NULL,NULL,'202107279','Jul 27 2021 12:00AM','Dec 30 1899 12:00AM','202107131','490','','','202107131',dbo.fn_GetTimedKey(),NULL,'us3lKiDRI1007',NULL);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvSickPayHrs = '0'
        ,drvDtLastSalChg =  dbo.dsi_fnlib_GetAnnSalary_EffDate_WithStartDate(EecEEID, EecCOID, '01/01/2010',EecDateInJob) 
        ...
        ,drvEarnings2 = CASE WHEN YEAR(EecDateOfLastHire) < YEAR(GETDATE()) THEN  
                            ...
                            WHEN YEAR(EecDateOfLastHire) = YEAR(GETDATE()) THEN
                                CASE WHEN STD IS NOT NULL AND EepAddressState = 'MA' THEN CAST(CONVERT(DECIMAL(10,2), ((EecAnnSalary + EecUDField09 + EecUDField10) / 52)) AS VARCHAR) END
                            END
        ...
        ,drvEarnings3 = CASE WHEN YEAR(EecDateOfLastHire) < YEAR(GETDATE()) THEN  
                            ...
                            WHEN YEAR(EecDateOfLastHire) = YEAR(GETDATE()) THEN
                                CASE WHEN LTD IS NOT NULL THEN CAST(CONVERT(DECIMAL(10,2), ((EecAnnSalary + EecUDField09 + EecUDField10) / 52)) AS VARCHAR) END
                            END
