...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ETAXSVRFSA_20200103.txt',NULL,'','','',NULL,NULL,NULL,'TaxSaver FSA Export','201912319','EMPEXPORT','ONDEMAND','Dec  5 2019  5:35AM','ETAXSVRFSA',NULL,NULL,NULL,'201912319','Dec  3 2019  8:56AM','Dec  3 2019  8:56AM','201912011','120','','','201912011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ETAXSVRFSA_20200103.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','201912319','EMPEXPORT','SCHEDULED','Dec  5 2019  5:36AM','ETAXSVRFSA',NULL,NULL,NULL,'201912319','Dec  3 2019  8:56AM','Dec  3 2019  8:56AM','201912011','120','','','201912011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ETAXSVRFSA_20200103.txt',NULL,'','','',NULL,NULL,NULL,'Active Open Enrollment Export','201912319','EMPEXPORT','OEACTIVE','Dec  5 2019  5:35AM','ETAXSVRFSA',NULL,NULL,NULL,'201912319','Dec  3 2019  8:56AM','Dec  3 2019  8:56AM','201912011','1','','','201912011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ETAXSVRFSA_20200103.txt',NULL,'','','',NULL,NULL,NULL,'Passive Open Enrollment Export','201912319','EMPEXPORT','OEPASSIVE','Dec  5 2019  5:59AM','ETAXSVRFSA',NULL,NULL,NULL,'201912319','Dec  3 2019  8:56AM','Dec  3 2019  8:56AM','201912011','120','','','201912011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ETAXSVRFSA_20200103.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202001039','EMPEXPORT','TEST','Jan  2 2020  1:04PM','ETAXSVRFSA',NULL,NULL,NULL,'202001039','Jan  3 2020 12:00AM','Dec 30 1899 12:00AM','202001031','10','eecPayGroup','KEY','202001031',dbo.fn_GetTimedKey(),NULL,'us3lKiTRU1009',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_ETAXSVRFSA_20200103.txt' END WHERE expFormatCode = 'ETAXSVRFSA';
...
UPDATE dbo.U_dsi_Configuration SET CfgValue = CASE WHEN CfgName = 'UseFileName' THEN 'Y' ELSE NULL END WHERE FormatCode = 'ETAXSVRFSA' AND CfgName IN ('UseFileName','ExportPath');
INSERT INTO dbo.CustomTemplates (CreationDate,Engine,EngineCode,IsActive,ModifiedDate) SELECT CreationDate = GETDATE(), Engine = AdhEngine, EngineCode = AdhFormatCode, IsActive = 1, ModifiedDate = GETDATE() FROM dbo.AscDefH WITH (NOLOCK) WHERE AdhFormatCode = 'ETAXSVRFSA' AND NOT EXISTS(SELECT 1 FROM dbo.CustomTemplates WHERE EngineCode = AdhFormatCode);
IF OBJECT_ID('U_ETAXSVRFSA_SavePath') IS NOT NULL DROP TABLE [dbo].[U_ETAXSVRFSA_SavePath];
GO
...
CREATE TABLE [dbo].[U_ETAXSVRFSA_drvTbl] (
    ...
    [drvHealthPlan] varchar(4) NULL,
    [drvEmpEmailAddr] varchar(50) NULL,
    [drvEmpPayCycle] varchar(1) NOT NULL,
...
Service Request Number: TekP-2019-10-25-0004
...
BEGIN
    ...
    SET @DedList = 'FSA,DEPCA,MEDH,MEDP';
    ...
    SELECT DISTINCT
        ...
        ,DepcaAmount     = SUM(CASE WHEN PdhDedCode IN ('DEPCA') THEN PdhEECurAmt ELSE 0.00 END)
    ...
    SELECT DISTINCT
        ...
        --,drvCheckOrSave = ''
        ,drvDebitCard = 'Y'
        ,drvHealthPlan =    CASE WHEN ISNULL(MedPCode, '') <> '' THEN 'MEDP'
                                WHEN ISNULL(MedHCode, '') <> '' THEN 'MEDH'
                            END
        ,drvEmpEmailAddr = EepAddressEMail
        ,drvEmpPayCycle = 'B'
        ,drvLimitedFSA = CASE WHEN ISNULL(FsaCode, '') <> '' AND ISNULL(MedHCode, '') <> '' THEN 'Y' ELSE 'N' END
    ...
    JOIN (Select  bdmEEID,bdmcoid
            ...
            ,DepcaCode = MAX((CASE WHEN BDMDedCode = 'DEPCA' then BDMDedCode END))
            ,DepcaAmt = SUM(CASE WHEN BDMDedCode = 'DEPCA' THEN BdmEEAmt ELSE 0 END)
            ,DepcaGtdAmt = MAX(CASE WHEN BDMDedCode = 'DEPCA' THEN BdmUSGField2 END)
            ,DepcaGoalAmt = SUM(CASE WHEN BDMDedCode = 'DEPCA' THEN BdmEEGoalAmt ELSE 0 END)
            ,DepcaStartDate = MAX((CASE WHEN BDMDedCode = 'DEPCA' then  BdmBenStartDate END))
            ,DepcaStopDate = MAX((CASE WHEN BDMDedCode = 'DEPCA' then  BdmBenStopDate END))
            ,MedPCode = MAX((CASE WHEN BDMDedCode = 'MEDP' then BDMDedCode END))
            ,MedHCode = MAX((CASE WHEN BDMDedCode = 'MEDH' then BDMDedCode END))            
