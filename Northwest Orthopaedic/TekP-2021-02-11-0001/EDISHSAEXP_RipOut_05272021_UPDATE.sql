...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISHSAEXP_20210527.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Discovery HSA Export-Test','202105109','EMPEXPORT','TEST_XOE','May 10 2021  5:16PM','EDISHSAEXP',NULL,NULL,NULL,'202105109','May 10 2021 12:00AM','Dec 30 1899 12:00AM','202105101','35','eecPayGroup','MIDLVL','202105101',dbo.fn_GetTimedKey(),NULL,'us3cPeNOR1052',NULL);
