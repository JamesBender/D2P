...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDRBMUSEXP_20210707.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Dearborn File Export-Test','202106301','EMPEXPORT','TEST_XOE','Jun 30 2021  8:17PM','EDRBMUSEXP',NULL,NULL,NULL,'202106301','Jun 30 2021 12:00AM','Jun 30 2021 12:00AM','202103151','1270','','','202103151',dbo.fn_GetTimedKey(),NULL,'us3cPeMUS1005',NULL);
