...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EPRINC4012_20210420.txt';
/*09*/ DECLARE @FILEPATH varchar(1000) = '\\' + @COUNTRY + '.saas\' + @SERVER + '\' + @ENVIRONMENT + '\Downloads\V10\Exports\' + @COCODE + '\EmployeeHistoryExport\';
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','M8C6I,EV7Z8,EDV92,CJC4Y,EV2EI',NULL,NULL,NULL,'Principal 401K OnDemand','202101291','EMPEXPORT','ONDEM_XOE','Feb 16 2021 10:37PM','EPRINC4012',NULL,NULL,NULL,'202101291','Jan 29 2021 12:00AM','Jan 23 2021 12:00AM','202101291','3301','','BWPAY,DTTBW,MTSBW,NALBW,NASBW,PRICBW,RACBW','202101291',dbo.fn_GetTimedKey(),NULL,'us3cPeCRO1008',NULL);
