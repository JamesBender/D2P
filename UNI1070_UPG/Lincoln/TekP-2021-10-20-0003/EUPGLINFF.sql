...
Client ID:      UNI1070
Date/time:      2022-01-17 09:19:47.023
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('6','EUPGLINFF0Z0','1','H','01','3000',NULL,'Record Delimiter',NULL,NULL,'"drvRecDelim"','(''UA''=''F'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('115','EUPGLINFF0Z0','8','D','10','2158',NULL,'Product 1 - Coverage Effective Date',NULL,NULL,'"drvP1CovEffDate"','(''UA''=''F'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('121','EUPGLINFF0Z0','8','D','10','2183',NULL,'Product 2 - Coverage Effective Date',NULL,NULL,'"drvP2CovEffDate"','(''UA''=''F'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('124','EUPGLINFF0Z0','5','D','10','2197',NULL,'Product 3 - Product Code',NULL,NULL,'"LEAVE"','(''DA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('125','EUPGLINFF0Z0','5','D','10','2202',NULL,'Product 3 - Benefit Type',NULL,NULL,'"FMLA "','(''DA''=''F'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('126','EUPGLINFF0Z0','1','D','10','2207',NULL,'Product 3 - Coverage Status',NULL,NULL,'"A"','(''DA''=''F'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('185','EUPGLINFF0Z0','1','D','10','3000',NULL,'Record Delimiter',NULL,NULL,'"drvRecordDelimiter"','(''UA''=''F'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('6','EUPGLINFF0Z0','1','T','90','3000',NULL,'Record Delimiter',NULL,NULL,'"drvRecordDelimiter"','(''UA''=''F'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUPGLINFF_20220117.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'Lincoln Export','202201109','EMPEXPORT','ONDEM_XOE',NULL,'EUPGLINFF',NULL,NULL,NULL,'202201109','Jan 10 2022  1:58PM','Jan 10 2022  1:58PM','202201101',NULL,'','','202201101',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Lincoln Export - Sched','202201109','EMPEXPORT','SCH_EUPGLI',NULL,'EUPGLINFF',NULL,NULL,NULL,'202201109','Jan 10 2022  1:58PM','Jan 10 2022  1:58PM','202201101',NULL,'','','202201101',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'Lincoln Export - Test','202201109','EMPEXPORT','TEST_XOE',NULL,'EUPGLINFF',NULL,NULL,NULL,'202201109','Jan 10 2022  1:58PM','Jan 10 2022  1:58PM','202201101',NULL,'','','202201101',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
CREATE TABLE [dbo].[U_EUPGLINFF_drvTbl] (
    ...
    [drvDisSubCode] varchar(4) NOT NULL,
    [drvEmpID] char(9) NULL,
    [drvEmpState] varchar(255) NULL,
    [drvDisLocCode] char(6) NULL,
    ...
    [drvHourlyWage] varchar(1) NOT NULL,
    ...
    [drvP1CovEffDate] varchar(1) NOT NULL,
    ...
    [drvP2CovEffDate] varchar(1) NOT NULL,
    [drvP2EmpPremContrib] varchar(3) NOT NULL,
    [drvP2BenefitLvl] varchar(3) NOT NULL,
    [drvP3CovEffDate] datetime NULL,
    [drvP3EmpPremContrib] varchar(3) NOT NULL,
    [drvP4EmpPremContrib] varchar(3) NOT NULL,
    ...
    [drvEligAmtDur] varchar(1) NOT NULL,
...
CREATE TABLE [dbo].[U_EUPGLINFF_H_drvTbl] (
    ...
    [drvRecDelim] varchar(1) NOT NULL
);
...
BEGIN
    ...
    WHERE audDateTime BETWEEN dateadd(D, -90, @EndDate) AND @EndDate
    ...
    SELECT DISTINCT
        ...
        ,drvP1ProdCode = CASE WHEN BDMSTD.Bdmdedcode = 'NMSTD' THEN 'STD  ' ELSE '     'END
        ,drvP1BenType = CASE    WHEN BDMSTD.Bdmdedcode = 'NMSTD' then 'STD02'
                                WHEN BDMLEX.Bdmdedcode =  'LEX' THEN 'STD03'
                                WHEN BDMCSUN.Bdmdedcode = 'CSUN' THEN 'STD04'
                                else 'STD01' 
                        END
        ,drvP1CovStatus = CASE WHEN BDMSTD.Bdmdedcode = 'NMSTD' THEN 'A' ELSE ' ' END
        ,drvP1CovEffDate = CASE WHEN BDMSTD.Bdmdedcode = 'NMSTD' AND BDMSTD.Bdmbenstartdate < 2022-01-01 THEN 2022-01-01 else BDMSTD.Bdmbenstartdate END 
        --ELSE '        ' END   THEN CASE WHEN 
        ,drvP1EmpPremContr = CASE WHEN BDMSTD.Bdmdedcode = 'NMSTD' THEN '000' ELSE '0  ' END
        ,drvP1BenefitLvl = CASE WHEN BDMSTD.Bdmdedcode = 'NMSTD' THEN '060' ELSE '0  ' END
        ,drvP2ProdCode = CASE WHEN BDMLTD.Bdmdedcode = 'LTD' THEN 'LTD  ' ELSE '     ' END
        ,drvP2BenType = CASE WHEN BDMLTD.Bdmdedcode = 'LTD' THEN 'XXXX ' ELSE '     ' END
        ,drvP2CovStatus = CASE WHEN BDMLTD.Bdmdedcode = 'LTD' THEN 'A' ELSE ' ' END
        ,drvP2CovEffDate = CASE WHEN BDMLTD.Bdmdedcode = 'LTD' AND BDMLTD.Bdmbenstartdate < 2022-01-01 THEN 2022-01-01 else BDMLTD.Bdmbenstartdate END 
        --ELSE '        ' END 
        ,drvP2EmpPremContrib = CASE WHEN BDMLTD.Bdmdedcode = 'LTD' THEN '000' ELSE ' ' END
        ,drvP2BenefitLvl = CASE WHEN BDMLTD.Bdmdedcode = 'LTD' THEN '060' ELSE '0  ' END
        ,drvP3CovEffDate = eecdateoflasthire
        ,drvP3EmpPremContrib = '000'
        ,drvP4EmpPremContrib = '000'
        ,drvP4BenefitLvl = '0  '
    ...
    JOIN dbo.vw_int_EmpComp WITH (NOLOCK)
        ...
        AND EecCoID = xCoID
          ...
          and EXISTS (Select 1 from dbo.U_EUPGLINFF_Audit where audEEID = xcoid and audfieldname = 'eecemplstatus' and audNewValue = 'T')))
...
UPDATE dbo.AscExp
    SET expLastStartPerControl = '202201031'
       ...
       ,expLastEndPerControl   = '202201109'
       ,expEndPerControl       = '202201109'
WHERE expFormatCode = 'EUPGLINFF';
