...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EACEN401EX_20210908.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Acensus 401K Eligibilty -Test','202109031','EMPEXPORT','TEST_XOE','Sep  3 2021  9:55AM','EACEN401EX',NULL,NULL,NULL,'202109031','Sep  3 2021 12:00AM','Aug 28 2021 12:00AM','202108201','274','','','202108201',dbo.fn_GetTimedKey(),NULL,'us3rVaSAL1011',NULL);
