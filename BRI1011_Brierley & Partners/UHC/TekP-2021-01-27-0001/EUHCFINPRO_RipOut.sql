...
Client ID:      BRI1011
Date/time:      2021-11-03 13:16:30.680
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUHCFINPRO_20211103.txt';
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvTierCode = CASE
                        ...
                        END
        ,drvMemberOrigEffDate = dbo.dsi_fnGetMinMaxDates('MAX', EecDateOfLastHire, @FileMinCovDate) 
