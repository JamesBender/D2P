...
Client ID:      PAT1012
Date/time:      2022-05-04 13:47:35.047
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EPATOPTENR_20220504.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',',2O3DP',NULL,NULL,NULL,'Optum HSA Enrollment-Test','202204079','EMPEXPORT','TEST_XOE','Apr  7 2022 12:00AM','EPATOPTENR',NULL,NULL,NULL,'202204079','Apr  7 2022 12:00AM','Dec 30 1899 12:00AM','202204061','38','','','202204061',dbo.fn_GetTimedKey(),NULL,'us3cBePAT1012',NULL);
