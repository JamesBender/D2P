...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EEMP403EXP_20200522.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201909069','EMPEXPORT','SCHEDULED',NULL,'EEMP403EXP',NULL,NULL,NULL,'201909069','Sep  6 2019  1:35PM','Sep  6 2019  1:35PM','201909061',NULL,'','','201909061',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EEMP403EXP_20200522.txt',NULL,'','','',NULL,NULL,NULL,'Empower 401k','201909069','EMPEXPORT','ONDEMAND','Sep  6 2019  3:23PM','EEMP403EXP',NULL,NULL,NULL,'201909069','Sep  6 2019 12:00AM','Dec 30 1899 12:00AM','201908111','193','','','201908111',dbo.fn_GetTimedKey(),NULL,'us3mLaHEN1004',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EEMP403EXP_20200522.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202005229','EMPEXPORT','TEST','May 20 2020  2:45PM','EEMP403EXP',NULL,NULL,NULL,'202005229','May 22 2020 12:00AM','Dec 30 1899 12:00AM','202005221','362','','','202005221',dbo.fn_GetTimedKey(),NULL,'us3lKiPEO1006',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EEMP403EXP_20200522.txt' END WHERE expFormatCode = 'EEMP403EXP';
...
BEGIN
   ...
   IF OBJECT_ID('U_EEMP403EXP_DedList','U') IS NOT NULL
    ...
    SELECT DISTINCT
        ...
        ,PdhSource7     = SUM(CASE WHEN PdhDedCode IN ('HSAER') THEN ISNULL(PdhEECurAmt, 0) ELSE 0.00 END)
