...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ENAVIRESAP_20210818.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Navigator Census Export-Test','202108181','EMPEXPORT','TEST_XOE','Aug 18 2021 12:00AM','ENAVIRESAP',NULL,NULL,NULL,'202108181','Aug 18 2021 12:00AM','Aug 15 2021 12:00AM','202108041','350','','','202108041',dbo.fn_GetTimedKey(),NULL,'us3rVaRES1015',NULL);
