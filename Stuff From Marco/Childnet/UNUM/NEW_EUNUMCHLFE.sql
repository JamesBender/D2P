...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitId2"','30','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','30',NULL,'BENEFIT ID',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPlanCode2"','31','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','31',NULL,'PLAN CODE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitQualifyingDate2"','32','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','32',NULL,'BENEFIT QUALIFYING DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitTerminationDate2"','33','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','33',NULL,'BENEFIT TERM DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitSelectionAmt2"','34','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','34',NULL,'BENEFIT SELECTION AMOUNT',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitId3"','35','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','35',NULL,'BENEFIT ID',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPlanCode3"','36','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','36',NULL,'PLAN CODE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitQualifyingDate3"','37','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','37',NULL,'BENEFIT QUALIFYING DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitTerminationDate3"','38','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','38',NULL,'BENEFIT TERM DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitSelectionAmt3"','39','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','39',NULL,'BENEFIT SELECTION AMOUNT',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitId4"','40','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','40',NULL,'BENEFIT ID',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPlanCode4"','41','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','41',NULL,'PLAN CODE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitQualifyingDate4"','42','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','42',NULL,'BENEFIT QUALIFYING DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitTerminationDate4"','43','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','43',NULL,'BENEFIT TERM DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitSelectionAmt4"','44','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','44',NULL,'BENEFIT SELECTION AMOUNT',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitId5"','45','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','45',NULL,'BENEFIT ID',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPlanCode5"','46','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','46',NULL,'PLAN CODE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitQualifyingDate5"','47','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','47',NULL,'BENEFIT QUALIFYING DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitTerminationDate5"','48','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','48',NULL,'BENEFIT TERM DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitSelectionAmt5"','49','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','49',NULL,'BENEFIT SELECTION AMOUNT',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitId6"','50','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','50',NULL,'BENEFIT ID',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPlanCode6"','51','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','51',NULL,'PLAN CODE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitQualifyingDate6"','52','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','52',NULL,'BENEFIT QUALIFYING DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitTerminationDate6"','53','(''UD101''=''T,'')','EUNUMCHLFEZ0','50','D','10','53',NULL,'BENEFIT TERM DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitSelectionAmt6"','54','(''UA''=''T,'')','EUNUMCHLFEZ0','50','D','10','54',NULL,'BENEFIT SELECTION AMOUNT',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenefitSelection"','55','(''UA''=''T'')','EUNUMCHLFEZ0','50','D','10','55',NULL,'BENEFIT SELECTION',NULL,NULL);
DECLARE @UDENV varchar(3) = (SELECT CASE WHEN LEFT(@@SERVERNAME,3) IN ('WP1','WP2','WP3','WP4','WP5') THEN 'WP' ELSE LEFT(@@SERVERNAME,3) END);
DECLARE @ARNUM varchar(12) = (SELECT RTRIM(CmmContractNo) FROM dbo.CompMast);
DECLARE @UDSERVER varchar(5) = (SELECT RTRIM(LEFT(@@SERVERNAME,PATINDEX('%[0-9]%',@@SERVERNAME)) + SUBSTRING(@@SERVERNAME,PATINDEX('%UP[0-9]%',@@SERVERNAME)+2,1)));
SELECT @UDSERVER = CASE WHEN @UDSERVER = 'EW21' THEN 'WP6' WHEN @UDSERVER = 'EW22' THEN 'WP7' ELSE @UDSERVER END;
DECLARE @UDCOCODE varchar(5) = (SELECT RTRIM(CmmCompanyCode) FROM dbo.CompMast);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EUNUMCHLFE_20191104.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unum Life Export','201909259','EMPEXPORT','ONDEMAND',NULL,'EUNUMCHLFE',NULL,NULL,NULL,'201909259','Sep 25 2019 12:30PM','Sep 25 2019 12:30PM','201909251',NULL,'','','201909251',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EUNUMCHLFE_20191104.txt',NULL,'','','IAGFG',NULL,NULL,NULL,'Active Open Enrollment Export','201910221','EMPEXPORT','OEACTIVE','Nov  4 2019 12:00AM','EUNUMCHLFE',NULL,NULL,NULL,'201910221','Oct 22 2019 12:00AM','Dec 30 1899 12:00AM','201910081','1','','','201910081',dbo.fn_GetTimedKey(),NULL,'us3mLaCHI1014',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EUNUMCHLFE_20191104.txt',NULL,'','','',NULL,NULL,NULL,'Passive Open Enrollment Export','201909259','EMPEXPORT','OEPASSIVE','Nov  4 2019 11:55AM','EUNUMCHLFE',NULL,NULL,NULL,'201909259','Sep 25 2019 12:00AM','Dec 30 1899 12:00AM','201809251','848','','','201809251',dbo.fn_GetTimedKey(),NULL,'us3mLaCHI1014',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EUNUMCHLFE_20191104.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','201909259','EMPEXPORT','SCHEDULED','Nov  4 2019 12:00AM','EUNUMCHLFE',NULL,NULL,NULL,'201909259','Sep 25 2019 12:00AM','Dec 30 1899 12:00AM','201909251','833','','','201909251',dbo.fn_GetTimedKey(),NULL,'us3mLaCHI1014',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EUNUMCHLFE_20191104.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','201911049','EMPEXPORT','TEST','Nov  4 2019  1:27PM','EUNUMCHLFE',NULL,NULL,NULL,'201911049','Nov  4 2019 12:00AM','Dec 30 1899 12:00AM','201910011','27','','','201910011',dbo.fn_GetTimedKey(),NULL,'us3mLaCHI1014',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EUNUMCHLFE_20191104.txt' END WHERE expFormatCode = 'EUNUMCHLFE';
...
CREATE TABLE [dbo].[U_EUNUMCHLFE_drvTbl] (
    ...
    [drvBenefitSelectionAmt1] money NULL,
    ...
    [drvBenefitSelectionAmt2] money NULL,
    ...
    [drvBenefitSelectionAmt3] money NULL,
    [drvBenefitId4] varchar(2)  NULL,
    [drvPlanCode4] varchar(6)  NULL,
    [drvBenefitQualifyingDate4] datetime NOT NULL,
    [drvBenefitTerminationDate4] datetime NOT NULL,
    [drvBenefitSelectionAmt4] money NOT NULL,
    [drvBenefitId5] varchar(2)  NULL,
    [drvPlanCode5] varchar(6)  NULL,
    [drvBenefitQualifyingDate5] datetime NOT NULL,
    [drvBenefitTerminationDate5] datetime NOT NULL,
    [drvBenefitSelectionAmt5] money NOT NULL,
    [drvBenefitId6] varchar(2)  NULL,
    [drvPlanCode6] varchar(6)  NULL,
    [drvBenefitQualifyingDate6] datetime NOT NULL,
    [drvBenefitTerminationDate6] datetime NOT NULL,
    [drvBenefitSelectionAmt6] money  NULL,
    [drvBenefitSelection] varchar(1) NULL
);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvClass = CASE WHEN LIFES IN ('LIFES') or LIFEE IN ('LIFEE') or LIFEC in ('LIFEC') THEN '1000' 
                         WHEN EECDedGroupCode IN ('AVP','DIRVP','EXEC') THEN '1001' ELSE '2002' END
        ...
        ,drvBenefitTerminationDate4 = ''
        ,drvBenefitSelectionAmt4 = ''
        ,drvBenefitId5 =''
        ,drvPlanCode5 = ''
        ,drvBenefitQualifyingDate5 = ''
        ,drvBenefitTerminationDate5 = ''
        ,drvBenefitSelectionAmt5 = ''
        ,drvBenefitId6 = ''
        ,drvPlanCode6 = ''
        ,drvBenefitQualifyingDate6 = ''
        ,drvBenefitTerminationDate6 = ''
        ,drvBenefitSelectionAmt6 = ''
        ,drvBenefitSelection = CASE WHEN LIFEE IS NOT NULL or LIFEC IS NOT NULL or LIFEE IS NOT NULL  THEN 'Y' END
    ...
    JOIN (
            ...
            ,GEN_EEAmt = MAX((CASE WHEN BDMDedCode IN ('LTD','GLIFE') then  bdmeeAmt END))
            ...
            ,LIFEE_EEAmt = MAX((CASE WHEN BDMDedCode IN ('LIFEE') then  bdmeeAmt END))
            ...
            ,LIFES_EEAmt = MAX((CASE WHEN BDMDedCode IN ('LIFES') then  bdmeeAmt END))
            ...
            ,LIFEC_EEAmt = MAX((CASE WHEN BDMDedCode IN ('LIFEC') then  bdmeeAmt END))
    ...
    Update dbo.U_EUNUMCHLFE_drvTbl set 
		drvBenefitId4 = CASE WHEN drvBenefitId1 = 'LM' THEN 'AM' END
        ,drvPlanCode4 =  CASE WHEN drvPlanCode1 = '5.0N30' THEN '5.0N29' END
        ...
        ,drvBenefitSelectionAmt4 = CASE WHEN drvPlanCode1 = '5.0N30' THEN drvBenefitSelectionAmt1 END
        ,drvBenefitId5 = CASE WHEN drvBenefitId2 = 'LS' THEN 'AS' END
        ,drvPlanCode5 = CASE WHEN drvPlanCode2 = '5.AN39' THEN '5.0Q03' END
        ...
        ,drvBenefitSelectionAmt5 = CASE WHEN drvPlanCode2 = '5.AN39' THEN drvBenefitSelectionAmt2 END
        ,drvBenefitId6 = CASE WHEN drvBenefitId3 = 'LC' THEN 'AC' END
        ,drvPlanCode6 = CASE WHEN drvPlanCode3 = '5.AM17' THEN '5.0AM5' END
        ...
        ,drvBenefitSelectionAmt6 = CASE WHEN drvPlanCode3 = '5.AM17' THEN drvBenefitSelectionAmt3 END
