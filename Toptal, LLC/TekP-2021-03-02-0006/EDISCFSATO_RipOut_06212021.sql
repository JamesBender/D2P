...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISCFSATO_20210621.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Discovery FSA Export-Test','202106011','EMPEXPORT','TEST_XOE','Jun  8 2021  8:39PM','EDISCFSATO',NULL,NULL,NULL,'202106011','Jun  1 2021 12:00AM','May 31 2021 12:00AM','202106011','137','eecPayGroup','CRTEAM','202106011',dbo.fn_GetTimedKey(),NULL,'us3cPeTOP1004',NULL);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,ContAmt = CAST(CASE WHEN PdhDedCode IN ('DCFSA', 'FSA', 'HSACF', 'HSACI', 'HSAF', 'HSAI', 'HSAER', 'PARK', 'CMT') AND PdhEECurAmt > 0 THEN CAST(PdhEECurAmt AS DECIMAL(10,2)) END AS VARCHAR)
        ,AmtType = 'Actual'
        ,TaxYear = 'Current'
        ,drvInitialSort = LTRIM(RTRIM(EepSSN))
        ,drvSubSort = '3'
