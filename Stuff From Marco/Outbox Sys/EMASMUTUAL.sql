...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EMASMUTUAL_20200611.txt',NULL,'','','',NULL,NULL,NULL,'COMBINED Files','202005221','EMPEXPORT','COMBINED','Jun 10 2020  3:49PM','EMASMUTUAL',NULL,NULL,NULL,'202005221','May 22 2020 12:00AM','May 15 2020 12:00AM','202001011','1255','','1099,HOURLY,SAL,SAUS,SCAN,SIRE,SPH,SUK','202001011',dbo.fn_GetTimedKey(),NULL,'us3mLaOUT1004',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EMASMUTUAL_20200611.txt',NULL,'','','Z3IKL',NULL,NULL,NULL,'TEST COMBINED','202005221','EMPEXPORT','TEST_COMBI','Jun 11 2020  4:31PM','EMASMUTUAL',NULL,NULL,NULL,'202005221','May 22 2020 12:00AM','May 15 2020 12:00AM','202005221','927','','','202005221',dbo.fn_GetTimedKey(),NULL,'us3lKiOUT1004',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EMASMUTUAL_20200611.txt' END WHERE expFormatCode = 'EMASMUTUAL';
...
CREATE TABLE [dbo].[U_EMASMUTUAL_Demo_drvTbl] (
    ...
    [drvPayFrequency] varchar(2) NOT NULL,
    [drvEEID] char(12) NULL,
    [drvCoID] char(5) NULL,
    [drvInitialSort] char(11) NULL,
    [drvFileType] varchar(4) NOT NULL,
...
CREATE TABLE [dbo].[U_EMASMUTUAL_Header] (
    [drvContractNumber] varchar(10) NULL,
    [drvFileDescription] varchar(20) NULL,
...
Service Request Number: TekP-2020-04-01-0004
...
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EMASMUTUAL', 'TEST_COMBI';
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,PdhSource     = CASE WHEN PdhDedCode IN ('401F', '401P') THEN 'DS'
                            WHEN PdhDedCode IN ('ROTHF','ROTHP') THEN 'ROTH'
                            WHEN PdhDedCode IN ('401M') THEN 'MATCH'
                            WHEN PdhDedCode IN ('401L') THEN 'PLAN1' 
    ...
    AND PdhDedCode IN ('401F','401P','ROTHF','ROTHP','401L','401L')

    GROUP BY PdhEEID,CASE WHEN PdhDedCode IN ('401F','401P') THEN 'DS'
                            WHEN PdhDedCode IN ('ROTHF','ROTHP') THEN 'ROTH'
                            WHEN PdhDedCode IN ('401M') THEN 'MATCH'
                            WHEN PdhDedCode IN ('401L') THEN 'PLAN1' 
                        END
    ...
    AND ErnEarnCode in ('ANNBS', 'BONUS','COMM','CERT','HOL','MATRY','OT','PTO','PATRY','QTRLY','REG','REFR','RETRO','SAL','SEMI','SEV')
    ...
    SELECT DISTINCT
        ...
        ,drvFileDescription     = CASE WHEN Header_Type = 'DEMO' THEN 'Simplus Demo File'

                                       WHEN Header_Type = 'CONT' THEN 'Simplus Contrib File'

                                       WHEN Header_Type = 'COMP' THEN 'Simplus Comp File'
    ...
    IF @ExportCode LIKE '%DEMO'  or @ExportCode LIKE 'COMBINED%' or  @ExportCode LIKE '%COMBI'
    ...
    BEGIN
        ...
        SELECT DISTINCT
            ...
            ,drvGender              = CASE WHEN ISNULL(EepGender,'') = '' or ISNULL(EepGender,'') = 'Z' THEN 'U' ELSE EepGender END

            ,drvMaritalStatus       = CASE WHEN eepMaritalStatus = 'M' THEN 'M' 
                                            WHEN eepMaritalStatus = 'S' THEN 'S' 
                                            ELSE 'U' END

            ,drvEmploymentClass     = CASE WHEN eeceetype = 'INT' THEN 'N' ELSE 'Y' END
    ...
    IF @ExportCode LIKE '%CONT%'  or @ExportCode LIKE '%COMBINED' or @ExportCode LIKE '%COMBI'
    ...
    BEGIN
        ...
        SELECT DISTINCT
            ...
            ,drvContributionAmount  = CASE WHEN PdhSource = 'MATCH' THEN 
        ...
        LEFT JOIN (SELECT PgpPayGroup, MAX(PgpPayDate) as PrgPayDate, MAX(PgpPeriodStartDate) PrgPeriodStart, MAX(PgpPeriodEndDate) PrgPeriodEnd 
    ...
    IF @ExportCode LIKE '%COMP'  or @ExportCode LIKE '%COMBINED' or @ExportCode LIKE '%COMBI'
