...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EPFPAYRSNK_20200601.txt',NULL,'Null','N','Q6UBF,QJI1W',NULL,NULL,NULL,'PayFlex FSA Payroll','201712151','EMPEXPORT','EPFPAYRSNK','Dec 26 2017  3:45PM','EPFPAYRSNK',NULL,NULL,NULL,'201712151','Dec 15 2017 12:00AM','Dec  9 2017 12:00AM','201712151','96','eecPayGroup','BW','201712151',dbo.fn_GetTimedKey(),NULL,'ULTI_WPSNKST',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EPFPAYRSNK_20200601.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PayFlex FSA Payroll OE ACTIVE','201510099','EMPEXPORT','OEACTIVE',NULL,'EPFPAYRSNK',NULL,NULL,NULL,'201510099',NULL,NULL,'201507111',NULL,NULL,NULL,'201507111',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EPFPAYRSNK_20200601.txt' END WHERE expFormatCode = 'EPFPAYRSNK';
...
(@FormatCode, 'DedCodes','DCARE, HCARE, LSFS1, LSFS2, LSFS3, LSFS4, HSAER, HSAE1, HSAE2, HSAE3, HSAE4, HSAF1, HSAF2, HSAF3, HSAF4, HSEC1, HSEC2, HSEC3, HSEC4, HSFC1, HSFC2, HSFC3, HSFC4')
...
-- standard fields above and additional driver fields below
 ...
 drvPlanYearEffectiveDate= case when ISNULL(eedBenStartDate,'01/01/1900') < @PlanDate then convert(varchar(10),@PlanDate,101) else convert(varchar(10),eedBenStartDate,101) end,
 drvAccountType= case 
     when dh.dedcode = 'HCARE' then '5' 
     when dh.dedcode = 'DCARE' then '4' 
     when dh.dedcode IN ('LSFSA','LSFS1','LSFS2','LSFS3','LSFS4') then '11' 
     when dh.dedcode IN ('HSAEC','HSAEE','HSAEF','HSAFC','HSAER','HSAE1','HSAE2','HSAE3','HSAE4','HSAF1','HSAF2','HSAF3','HSAF4','HSEC1','HSEC2','HSEC3','HSEC4','HSFC1','HSFC2','HSFC3','HSFC4') then '16' 
     else '' 
     end, 
