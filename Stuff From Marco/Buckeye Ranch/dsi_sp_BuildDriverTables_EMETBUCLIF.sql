...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EMETBUCLIF_20210407.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202103291','EMPEXPORT','TEST','Mar 29 2021  7:27PM','EMETBUCLIF',NULL,NULL,NULL,'202103291','Mar 29 2021 12:00AM','Dec 30 1899 12:00AM','202103151','649','','','202103151',dbo.fn_GetTimedKey(),NULL,'us3cPeBUC1008',NULL);
