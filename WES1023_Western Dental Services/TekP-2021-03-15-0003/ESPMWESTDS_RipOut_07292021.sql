...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ESPMWESTDS_20210729.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'SPM Benefits Export-Test','202107141','EMPEXPORT','TEST_XOE','Jul 14 2021 11:15PM','ESPMWESTDS',NULL,NULL,NULL,'202107141','Jul 14 2021 12:00AM','Dec 30 1899 12:00AM','202107011','814','','','202107011',dbo.fn_GetTimedKey(),NULL,'CPETITTI16',NULL);
...
CREATE TABLE [dbo].[U_ESPMWESTDS_spmTbl] (
    ...
    [drvClientDivName] varchar(8000) NULL,
