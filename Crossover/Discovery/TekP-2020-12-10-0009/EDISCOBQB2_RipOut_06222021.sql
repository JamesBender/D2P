...
GO
IF OBJECT_ID('U_EDISCOBQB2_coverage') IS NOT NULL DROP TABLE [dbo].[U_EDISCOBQB2_coverage];
GO
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvRecordIdentifier"','1','(''UA''=''Q,'')','EDISCOBQB2Z0','50','D','35','1',NULL,'Record Identifier',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPlanName"','2','(''UA''=''Q,'')','EDISCOBQB2Z0','50','D','35','2',NULL,'Plan Name',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvStartDate"','3','(''UD101''=''Q,'')','EDISCOBQB2Z0','50','D','35','3',NULL,'Start Date',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','4','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','4',NULL,'End Date',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvCoverageLevel"','5','(''UA''=''Q,'')','EDISCOBQB2Z0','50','D','35','5',NULL,'Coverage Level',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','6','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','6',NULL,'First Day Of COBRA',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','7','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','7',NULL,'Last Day Of COBRA',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','8','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','8',NULL,'COBRA Duration Months',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','9','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','9',NULL,'Days To Elect',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','10','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','10',NULL,'Days To Make 1st Payment',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','11','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','11',NULL,'Days To Make Subsequent Payments',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','12','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','12',NULL,'Election Postmark Date',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','13','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','13',NULL,'Last Date Rates Notified',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','14','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','14',NULL,'Number Of Units',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"FALSE"','15','(''DA''=''Q,'')','EDISCOBQB2Z0','50','D','35','15',NULL,'Send Plan Change Letter For Legacy',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPlanBundle"','16','(''UA''=''Q,'')','EDISCOBQB2Z0','50','D','35','16',NULL,'Plan Bundle Name',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvStartDate"','3','(''UD101''=''Q,'')','EDISCOBQB2Z0','50','D','55','3',NULL,'PlanName',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvStartDate"','3','(''UD101''=''Q,'')','EDISCOBQB2Z0','50','D','60','3',NULL,'StartDate',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvEndDate"','4','(''UD101''=''Q,'')','EDISCOBQB2Z0','50','D','60','4',NULL,'EndDate',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvRate"','5','(''UA''=''Q'')','EDISCOBQB2Z0','50','D','60','5',NULL,'Rate',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISCOBQB2_20210622.txt';
/*09*/ DECLARE @FILEPATH varchar(1000) = '\\' + @COUNTRY + '.saas\' + @SERVER + '\' + @ENVIRONMENT + '\Downloads\V10\Exports\' + @COCODE + '\EmployeeHistoryExport\';
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Discovery COBRA QB','202105179','EMPEXPORT','ONDEMAND','Jan  2 2020 12:00AM','EDISCOBQB2',NULL,NULL,NULL,'202105179','Jan  2 2020 12:00AM','Dec 30 1899 12:00AM','202101011',NULL,'','','202101011',dbo.fn_GetTimedKey(),NULL,'ULTI_WPCHMS',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,'SPXBO,SPXK9',NULL,NULL,NULL,'Discovery COBRA QB','202105179','EMPEXPORT','SCHEDULED',NULL,'EDISCOBQB2',NULL,NULL,NULL,'202105179','Nov  5 2019  4:57PM','Nov  5 2019  4:57PM','202101011',NULL,'','','202101011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','SPXBO,SPXK9',NULL,NULL,NULL,'Test Purposes Only','202106149','EMPEXPORT','TEST','Jun 17 2021  3:05PM','EDISCOBQB2',NULL,NULL,NULL,'202106149','Jun 14 2021 12:00AM','Dec 30 1899 12:00AM','202104011','315','','','202104011',dbo.fn_GetTimedKey(),NULL,'us3rVaCRO1006',NULL);
...
IF OBJECT_ID('U_EDISCOBQB2_coverage') IS NULL
CREATE TABLE [dbo].[U_EDISCOBQB2_coverage] (
    [bdmeeid] char(12) NOT NULL,
    [bdmcoid] char(5) NULL,
    [bdmdedcode] char(5) NULL,
...
CREATE TABLE [dbo].[U_EDISCOBQB2_drvTbl_QBPLAN] (
    ...
    [drvRecordIdentifier] varchar(8) NOT NULL,
    [drvPlanName] varchar(50) NULL,
    [drvStartDate] datetime NULL,
    [drvCoverageLevel] varchar(50) NULL,
    [drvPlanBundle] varchar(50) NULL,
    [drvSubSort] char(11) NULL,
    [drvSubSort2] varchar(1) NOT NULL,
...
CREATE TABLE [dbo].[U_EDISCOBQB2_drvTbl_QBPLANMBRSPCRATE] (
    ...
    [drvCoID] char(5) NULL,
    [drvDepRecID] varchar(1) NOT NULL,
    [drvRecordIdentifier] varchar(26) NOT NULL,
...
06/07/2021 by AP:
        - Updated Coverage Level for Discovery Benefits HSA section.
        - Updated Plan Name for QBPLAN and QBDEPENDENTPLAN.

06/11/2021 by AP:
        - Reworked coverage logic.
        - Updated event date to date + 1.
        - Updated QBDEPENDENTPLAN start date to match QBPLAN.
        - Added QBPLANMEMBERSPECIFICRATE.

06/17/2021 by AP:
        - Removed + 1 from EVENT.
        - Fixed U_EDISCOBQB2_coverage issue with incorrect values for spouse.
        - Added XOXO ded code to all sub-sections.
        - Fixed start date for XOXO ded codes to be start of next month.
...
BEGIN
    ...
    INSERT INTO dbo.U_dsi_BDM_Configuration VALUES (@FormatCode,'DedCodes','XOMFT,XOMPT,DENFT,DENPT,VISFT,VISPT,MEDFT,MEDPT,FSA,FSAPT,LFAPT,LPFFT,XOXO,XOXO2,XOXO3');
    ...
    DELETE dbo.U_dsi_BDM_EDISCOBQB2 WHERE BdmBenStatus = 'C';

    -- Create table to re-create coverage logic
        IF OBJECT_ID('U_EDISCOBQB2_coverage','U') IS NOT NULL 
        DROP TABLE dbo.U_EDISCOBQB2_coverage;

        SELECT e.bdmeeid, e.bdmcoid, e.bdmdedcode, count(distinct(s.bdmdateofbirth)) as spouse_count, count(distinct(c.bdmdateofbirth)) as child_count
        into dbo.U_EDISCOBQB2_coverage 
        FROM dbo.U_dsi_BDM_EDISCOBQB2 e WITH(NOLOCK) 
        left JOIN dbo.U_dsi_BDM_EDISCOBQB2 s WITH(NOLOCK) ON s.bdmeeid = e.bdmeeid  and s.bdmdedcode = e.bdmdedcode and s.bdmrelationship in ('sps', 'dp', 'dpn')
        left join dbo.U_dsi_BDM_EDISCOBQB2 c with(nolock) on c.bdmeeid = e.bdmeeid and c.bdmdedcode = e.bdmdedcode and c.bdmrelationship in ('chl', 'stc', 'dpc', 'ddp', 'grc')
        --WHERE e.bdmeeid = 'D0WWV1000030' 

        group by e.bdmeeid, e.bdmcoid, e.bdmdedcode
    ...
    SELECT DISTINCT
		...
		,drvIsCon = CASE WHEN BdmRecType = 'EMP' THEN '0' ELSE '1' END
        ,drvSubSort        = EepSSN /* CASE WHEN BdmRecType = 'EMP' THEN eepSSN
    ...
    LEFT JOIN dbo.Company WITH (NOLOCK)
        ON CmpCOID = BdmCOID
    WHERE BdmIsPQB = 'Y'
        AND BdmDedCode IN  ('XOMFT', 'XOXO', 'XOMPT','DENFT','DENPT','VISFT','VISPT','MEDFT','MEDPT','FSA','FSAPT','LFAPT','LPFFT') --('XOMFT','XOMPT')
    ;
    ---------------------------------
    ...
    SELECT DISTINCT
        ...
        --DATEADD(DAY, 1, BdmDateOfCOBRAEvent) -- Day of COBRA EVENT + 1
    ...
    JOIN (SELECT
              ...
              FROM dbo.U_dsi_BDM_EDISCOBQB2 WITH (NOLOCK)
              WHERE BdmIsPQB = 'Y' AND BdmDedCode IN ('XOMFT', 'XOXO', 'XOMPT','DENFT','DENPT','VISFT','VISPT','MEDFT','MEDPT','FSA','FSAPT','LFAPT','LPFFT') -- ('XOMFT','XOMPT')
              GROUP BY BdmEEID, BdmCoID, BdmDepRecID, BdmRecType) BDM
         ON BdmEEID = drvEEID
         AND BdmCoID = drvCoID
         AND ISNULL(BdmDepRecID,'') = drvDepRecID
    --JOIN dbo.U_dsi_BDM_EDISCOBQB2 BDM WITH (NOLOCK)
        --ON Bdm.BdmEEID = EecEEID
        --AND Bdm.BdmCOID = EecCoID
    ...
    SELECT DISTINCT
        ...
        ,drvPlanName = CASE
                            ...
                            WHEN BdmDedCode IN ('XOXO','XOXO2','XOXO3') THEN 'Crossover Health XOXO'
    ...
    JOIN dbo.U_dsi_BDM_EDISCOBQB2 WITH (NOLOCK)
        ...
        AND BdmCoID = drvCoID
        AND ISNULL(BdmDepRecID,'') = drvDepRecID
        AND BdmDedCode NOT IN ('XOMPT')
    WHERE BdmIsPQB = 'Y'
    ;*/
    DELETE dbo.U_EDISCOBQB2_drvTbl_QBPLANINITIAL;

    IF OBJECT_ID('U_EDISCOBQB2_drvTbl_QBPLAN','U') IS NOT NULL 
        DROP TABLE dbo.U_EDISCOBQB2_drvTbl_QBPLAN;

    -- This is to get around that stupid "data will be truncated" error.
    CREATE TABLE [dbo].[U_EDISCOBQB2_drvTbl_QBPLAN] (
    [drvEEID] char(12) NOT NULL,
    [drvCoID] char(5) NULL,
    [drvDepRecID] varchar(1) NOT NULL,
    ...
    INSERT INTO dbo.U_EDISCOBQB2_drvTbl_QBPLAN
    SELECT DISTINCT
         drvEEID = a.bdmEEID
        ,drvCoID = a.bdmCoID
        ,drvDepRecID = '' --drvDepRecID
        ,drvRecordIdentifier = '[QBPLAN]'
        ,drvPlanName =    CASE WHEN A.BdmDedCode IN ('XOMFT','XOMPT') THEN 'Aetna Medical XO First PPO' -- jcb
                            -- WHEN A.BdmDedCode = 'DENFT' AND EecEmplStatus = 'L' THEN 'Direct Bill Guardian Dental PPO Preferred (FT)'
                            -- WHEN A.BdmDedCode = 'DENPT' AND EecEmplStatus = 'L' THEN 'Direct Bill Guardian Dental PPO Preferred (PT)'
                            WHEN A.BdmDedCode IN ('DENFT','DENPT') THEN 'Guardian Dental PPO Preferred'
                            -- WHEN A.BdmDedCode = 'VISFT' AND EecEmplStatus = 'L' THEN 'Direct Bill Guardian Vision (FT)'
                            -- WHEN A.BdmDedCode = 'VISPT' AND EecEmplStatus = 'L' THEN 'Direct Bill Guardian Vision (PT)'
                            WHEN A.BdmDedCode IN ('VISFT','VISPT') THEN 'Guardian Vision'
                            -- WHEN A.BdmDedCode = 'MEDFT' THEN 'Direct Bill Aetna Medical PPO HSA 2000 (FT)'
                            -- WHEN A.BdmDedCode = 'MEDPT' THEN 'Direct Bill Aetna Medical PPO HSA 2000 (PT)'
                            WHEN A.BdmDedCode IN ('MEDFT','MEDPT') THEN 'Aetna Medical PPO HSA 2000'
                            WHEN A.BdmDedCode IN ('FSA','FSAPT','LFAPT','LPFFT') THEN 'Discovery Benefits FSA'
                            WHEN A.BdmDedCode = 'XOXO' THEN 'Crossover Health XOXO'
                        END                    
        ,drvStartDate = CASE WHEN A.BdmDedCode = 'XOXO' AND DAY(DATEADD(DAY, 1, A.BdmBenStopDate)) <> '1' THEN DATEADD(d, 1, EOMONTH(A.BdmBenStopDate)) ELSE 
                                    DATEADD(DAY, 1, A.BdmBenStopDate) END
        ,drvCoverageLevel =    CASE WHEN A.BdmCobraReason IN ('200','201','202','204','205','206','207','208','209','210','LEVNT1','LEVNT2','LEVNT3','LEVNT4','LEVNT5') THEN
                                  CASE WHEN c.spouse_count >= 1 and c.child_count = 0 and c.bdmdedcode = a.bdmdedcode THEN 'EE+SPOUSE'
                                        WHEN c.spouse_count >= 1 and c.child_count >= 1 THEN 'EE+FAMILY'
                                        WHEN c.spouse_count = 0 AND c.child_count = 1 THEN 'EE+CHILD'
                                        WHEN c.spouse_count = 0 AND c.child_count >= 1 THEN 'EE+CHILDREN'
                                    ELSE 'EE'
                                END
                            END
                                --CASE WHEN (SELECT * FROM dbo.U_dsi_BDM_EDISCOBQB2 s WITH(NOLOCK) LEFT JOIN dbo.U_dsi_BDM_EDISCOBQB2 c WITH(NOLOCK) ON s.bdmeeid = c.bdmeeid WHERE s.bdmrelationship = 'SPS'
                                --CASE 
                                    
                                --    WHEN A.BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode = A.BdmDedCode AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) < 1 THEN 'EE+SPOUSE'                                
                                -- --   WHEN A.BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode = A.BdmDedCode AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) = 1 THEN 'EE+CHILD'
                                --    WHEN A.BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode = A.BdmDedCode AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) >= 1 THEN 'EE+FAMILY'
                                --    --WHEN A.BdmRelationship IN ('CHL','DPC','STC','DCH') THEN 'EE+CHILDREN'
                                --    ELSE --'EE'
                                --        CASE WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode = A.BdmDedCode AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) = 1 THEN 'EE+CHILD'
                                --            WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode = A.BdmDedCode AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) >= 1 THEN 'EE+FAMILY'
                                --            WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode = A.BdmDedCode AND B.BdmRelationship IN ('SPS')) = 1 THEN 'EE+SPOUSE'
                                --            --WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode = A.BdmDedCode AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) < 0 AND () THEN 'EE+SPOUSE'                                
                                --            ELSE 'EE'
                                --        END
                                
                                    /*WHEN A.BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode IN ('XOMFT','XOMPT') AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) < 1 THEN 'EE+SPOUSE'                                
                                    WHEN A.BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode IN ('XOMFT','XOMPT') AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) = 1 THEN 'EE+CHILD'
                                    WHEN A.BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode IN ('XOMFT','XOMPT') AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) > 1 THEN 'EE+FAMILY'
                                    --WHEN A.BdmRelationship IN ('CHL','DPC','STC','DCH') THEN 'EE+CHILDREN'
                                    ELSE --'EE'
                                        CASE WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode IN ('XOMFT','XOMPT') AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) = 1 THEN 'EE+CHILD'
                                            WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode IN ('XOMFT','XOMPT') AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) > 1 THEN 'EE+FAMILY'
                                            WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode IN ('XOMFT','XOMPT') AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) < 0 AND () THEN 'EE+SPOUSE'                                
                                            ELSE 'EE'
                                        END*/
        ,drvPlanBundle = CASE WHEN a.BdmDedCode IN ('XOMFT', 'XOMPT') THEN 'Aetna Medical XO First PPO/Discovery Benefits HRA' ELSE '' END
        ,drvSubSort =    EepSSN /*CASE WHEN BdmRecType = 'EMP' THEN eepSSN
                            ELSE ISNULL(NULLIF(ConSSN,''),eepSSN) + CONVERT(char(8),ConDateOfBirth,112)
                        END*/
        ,drvSubSort2 = '2'
    ...
    JOIN dbo.EmpComp WITH (NOLOCK)
        ON EecEEID = BdmEEID 
        AND EecCoID = BdmCoID
    JOIN dbo.U_EDISCOBQB2_coverage c WITH(NOLOCK)
        ON c.bdmeeid = eeceeid
        AND c.bdmcoid = eeccoid
        AND c.bdmdedcode = a.bdmdedcode
    LEFT JOIN dbo.Contacts WITH (NOLOCK)
        ON ConEEID = A.BdmEEID
        AND ConSystemID = A.BdmDepRecID
    WHERE a.BdmDedCode IN ('XOMFT','XOXO', 'XOMPT','DENFT','DENPT','VISFT','VISPT','MEDFT','MEDPT','FSA','FSAPT','LFAPT','LPFFT')
        AND BdmIsPQB = 'Y'
    ;
    ...
    SELECT DISTINCT
        ...
        ,drvDepRecID = '' --drvDepRecID
        ,drvRecordIdentifier = '[QBPLAN]'
        ,drvPlanName = CASE WHEN a.BdmDedCode IN ('XOMFT','XOMPT') THEN 'Discovery Benefits HRA' END                    
                                ...
                                CASE 
                                 ...
                                 --   WHEN A.BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode = A.BdmDedCode AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) = 1 THEN 'EE+CHILD'
                                    ...
                                    ELSE --'EE'
                                        ...
                                        END  */
        -- ,drvCoverageLevel =    CASE WHEN A.BdmCobraReason IN ('200','201','202','204','205','206','207','208','209','210','LEVNT1','LEVNT2','LEVNT3','LEVNT4','LEVNT5') THEN
        --                         CASE WHEN BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) = 1 THEN 'EE+CHILD'
        --                             WHEN BdmRelationship = 'SPS' AND (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) > 1 THEN 'EE+CHILDREN'
        --                            -- WHEN BdmRelationship IN ('CHL','DPC','STC','DCH') THEN 'EE+CHILDREN'
        --                             ELSE --'EE'
        --                                 CASE WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode IN ('XOMFT','XOMPT') AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) = 1 THEN 'EE+CHILD'
        --                                     WHEN (SELECT COUNT(*) FROM dbo.U_dsi_BDM_EDISCOBQB2 B WITH (NOLOCK) WHERE A.BdmEEID = B.BdmEEID AND B.BdmDedCode IN ('XOMFT','XOMPT') AND B.BdmRelationship IN ('CHL','DPC','STC','DCH')) > 1 THEN 'EE+CHILDREN'
        --                                     ELSE 'EE'
        --                                 END
    ...
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = A.BdmEEID
    JOIN dbo.U_EDISCOBQB2_coverage c WITH(NOLOCK)
        ON c.bdmeeid = a.bdmeeid
        AND c.bdmcoid = a.bdmcoid
        AND c.bdmdedcode = a.bdmdedcode
    LEFT JOIN dbo.Contacts WITH (NOLOCK)
        ON ConEEID = A.BdmEEID
        AND ConSystemID = A.BdmDepRecID
    WHERE a.BdmDedCode IN ('XOMFT','XOMPT')
        AND BdmIsPQB = 'Y'
    ;
    ...
    JOIN dbo.U_dsi_BDM_EDISCOBQB2 WITH (NOLOCK)
     ...
     JOIN dbo.Contacts WITH (NOLOCK)
        ...
        AND ConSystemID = BdmDepRecID
    WHERE --BdmIsPQB = 'N'
         BdmDedCode IN ('XOMFT','XOXO', 'XOMPT','DENFT','DENPT','VISFT','VISPT','MEDFT','MEDPT','FSA','FSAPT','LFAPT','LPFFT') --('XOMFT','XOMPT')
        --AND BdmDedCode IN ('XOMFT','XOMPT','DENFT','DENPT','VISFT','VISPT','MEDFT','MEDPT','FSA','FSAPT','LFAPT','LPFFT')
		--AND NOT EXISTS (SELECT *
		--					FROM dbo.U_EDISCOBQB2_drvTbl_QB a WITH(NOLOCK)
		--					WHERE a.drveeid = BdmEEID)
	    AND drvIsCon = '0'
    ;
    ...
    SELECT DISTINCT
        ...
        ,drvDepRecID = BdmDepRecID
        -- standard fields above and additional driver fields below
        ,drvPlanName = CASE WHEN BdmDedCode IN ('XOMFT','XOMPT') THEN 'Aetna Medical XO First PPO' 
                            -- WHEN BdmDedCode = 'DENFT' AND EecEmplStatus = 'L' THEN 'Direct Bill Guardian Dental PPO Preferred (FT)'
                            -- WHEN BdmDedCode = 'DENPT' AND EecEmplStatus = 'L' THEN 'Direct Bill Guardian Dental PPO Preferred (PT)'
                            WHEN BdmDedCode IN ('DENFT','DENPT') THEN 'Guardian Dental PPO Preferred'
                            -- WHEN BdmDedCode = 'VISFT' AND EecEmplStatus = 'L' THEN 'Direct Bill Guardian Vision (FT)'
                            -- WHEN BdmDedCode = 'VISPT' AND EecEmplStatus = 'L' THEN 'Direct Bill Guardian Vision (PT)'
                            WHEN BdmDedCode IN ('VISFT','VISPT') THEN 'Guardian Vision'
                            -- WHEN BdmDedCode = 'MEDFT' THEN 'Direct Bill Aetna Medical PPO HSA 2000 (FT)'
                            -- WHEN BdmDedCode = 'MEDPT' THEN 'Direct Bill Aetna Medical PPO HSA 2000 (PT)'
                            WHEN BdmDedCode IN ('MEDFT','MEDPT') THEN 'Aetna Medical PPO HSA 2000'
                            WHEN BdmDedCode IN ('FSA','FSAPT','LFAPT','LPFFT') THEN 'Discovery Benefits FSA'
                            WHEN BdmDedCode = 'XOXO' THEN 'Crossover Health XOXO'
                        END                    
        ,drvStartDate = CASE WHEN BdmDedCode = 'XOXO' AND DAY(DATEADD(DAY, 1, BdmBenStopDate)) <> '1' THEN DATEADD(d, 1, EOMONTH(BdmBenStopDate)) ELSE 
                                    DATEADD(DAY, 1, BdmBenStopDate) END
        --CONVERT(VARCHAR,DATEADD(DAY, 1, BdmBenStopDate), 101)
        /*CONVERT(VARCHAR,DATEADD(DAY, 1, BdmBenStartDate), 101)*/
        ,drvEndDate = ''
        ,drvSubSort  = drvSubSort
        ,drvSubSort2 = '2' + CASE WHEN BdmRelationship IN ('SPS','DP','DPN') THEN 'A'
                                      ELSE 'B' + RTRIM(ISNULL(ConSSN,ConNameFirst))
    ...
    --AND BdmDedCode IN ('XOMFT','XOMPT')
         BdmDedCode IN  ('XOMFT', 'XOXO', 'XOMPT','DENFT','DENPT','VISFT','VISPT','MEDFT','MEDPT','FSA','FSAPT','LFAPT','LPFFT')
		 --AND NOT EXISTS (SELECT *
			--				FROM dbo.U_EDISCOBQB2_drvTbl_QB a WITH(NOLOCK)
			--				WHERE a.drveeid = BdmEEID)
		AND drvIsCon = '0'
    ...
    WHERE drvPlanName = 'Aetna Medical XO First PPO'
    /*JOIN dbo.U_dsi_BDM_EDISCOBQB2 WITH (NOLOCK)
        ON BdmEEID = drvEEID 
        AND BdmCoID = drvCoID
    WHERE BdmDedCode IN ('XOMFT','XOMPT')*/
    ...
    SELECT DISTINCT
        ...
        ,drvDepRecID = drvDepRecID
        -- standard fields above and additional driver fields below
        ,drvRecordIdentifier = '[QBPLANMEMBERSPECIFICRATE]'
        ,drvPlanName = 'Discovery Benefits FSA' 
        ,drvStartDate = DATEADD(DAY, 1, BdmBenStopDate)
    ...
    JOIN dbo.EmpComp WITH (NOLOCK)
        ...
        AND EecCoID = BdmCoID
    WHERE BdmIsPQB = 'Y'
    AND BdmDedCode IN ('FSA', 'FSAPT', 'LFAPT', 'LPFFT')
    ;

   -- DELETE dbo.U_EDISCOBQB2_drvTbl_QBPLANMBRSPCRATE;
