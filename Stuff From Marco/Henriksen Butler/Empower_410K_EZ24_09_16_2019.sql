...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EHENEMP401_20190916.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Empower 401k','201909169','EMPEXPORT','ONDEMAND',NULL,'EHENEMP401',NULL,NULL,NULL,'201909169','Sep 16 2019  3:35PM','Sep 16 2019  3:35PM','201909161',NULL,'','','201909161',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EHENEMP401_20190916.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','201909169','EMPEXPORT','TEST',NULL,'EHENEMP401',NULL,NULL,NULL,'201909169','Sep 16 2019  3:35PM','Sep 16 2019  3:35PM','201909161',NULL,'','','201909161',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\EHENEMP401_20190916.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201909169','EMPEXPORT','SCHEDULED',NULL,'EHENEMP401',NULL,NULL,NULL,'201909169','Sep 16 2019  3:35PM','Sep 16 2019  3:35PM','201909161',NULL,'','','201909161',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\EHENEMP401_20190916.txt' END WHERE expFormatCode = 'EHENEMP401';
...
CREATE TABLE [dbo].[U_EHENEMP401_drvTbl] (
    ...
    [drvEmpBeforeTax] varchar(1) NOT NULL,
    [drvEmpRoth] varchar(1) NOT NULL,
    [drvERMatching] varchar(1) NOT NULL,
    [drvLoan01] varchar(1) NOT NULL,
    ...
    [drvPlanCompensation] varchar(1) NOT NULL,
...
--Update Dates
UPDATE dbo.AscExp
    SET expLastStartPerControl = '201909091'
       ,expStartPerControl     = '201909091'
       ,expLastEndPerControl   = '201909169'
       ,expEndPerControl       = '201909169'
