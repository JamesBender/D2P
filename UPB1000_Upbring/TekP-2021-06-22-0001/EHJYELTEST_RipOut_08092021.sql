...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EHJYELTEST_20210809.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'HealthJoy Eligibility Ex-Test','202107201','EMPEXPORT','TEST_XOE','Jul 20 2021 10:12PM','EHJYELTEST',NULL,NULL,NULL,'202107201','Jul 20 2021 12:00AM','Dec 30 1899 12:00AM','202107061','792','','','202107061',dbo.fn_GetTimedKey(),NULL,'us3jReUPB1000',NULL);
...
CREATE TABLE [dbo].[U_EHJYELTEST_drvTbl] (
    ...
    [drvAccPlanName] varchar(1) NOT NULL,
    [drvAccAmount] varchar(1) NOT NULL,
    [drvAccEffDate] int NULL,
    [drvAccTermDate] int NULL,
