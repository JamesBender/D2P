...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test Cobra Export','202105019','EMPEXPORT','TESTQB','Jul 30 2020 11:55AM','ECOBRPOINT',NULL,NULL,NULL,'202105019','Jul 16 2020 12:00AM','Dec 30 1899 12:00AM','202101011','17','','','202101011',dbo.fn_GetTimedKey(),NULL,'us3mLaTRI1021',NULL);
...
BEGIN
    ...
    --==========================================
        ...
        JOIN dbo.U_dsi_BDM_ECOBRPOINT WITH (NOLOCK)
           ...
           AND ISNULL(BdmDepRecID,'') = drvDepRecID
        WHERE BdmIsPQB = 'Y'
            AND (BdmDedCode <> 'FSA' OR (BdmDedCode = 'FSA' AND ISNULL(BdmEEGoalAmt, 0.00) > 0.00));
