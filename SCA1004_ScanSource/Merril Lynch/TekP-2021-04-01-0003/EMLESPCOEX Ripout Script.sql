...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EMLESPCOEX_20210722.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Merrill Lynch ESSP Contr-Test','202107089','EMPEXPORT','TEST_XOE','Jul 15 2021  9:06PM','EMLESPCOEX',NULL,NULL,NULL,'202107089','Jul  8 2021 12:00AM','Dec 30 1899 12:00AM','202107081','306','','','202107081',dbo.fn_GetTimedKey(),NULL,'us3rVaSCA1004',NULL);
