...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EBAPCQBEXP_20210611.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Basic Pacific QB File Ex-Test','202105159','EMPEXPORT','TEST_XOE','May 28 2021  3:47PM','EBAPCQBEXP',NULL,NULL,NULL,'202105159','May 15 2021 12:00AM','Dec 30 1899 12:00AM','202103011','91','','','202103011',dbo.fn_GetTimedKey(),NULL,'us3cPeTYL1001',NULL);
