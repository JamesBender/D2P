...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ESPMWESTDS_20210730.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'SPM Benefits Export-Test','202107301','EMPEXPORT','TEST_XOE','Jul 30 2021  9:52AM','ESPMWESTDS',NULL,NULL,NULL,'202107301','Jul 30 2021 12:00AM','Jul 25 2021 12:00AM','202107011','747','','','202107011',dbo.fn_GetTimedKey(),NULL,'CPETITTI16',NULL);
