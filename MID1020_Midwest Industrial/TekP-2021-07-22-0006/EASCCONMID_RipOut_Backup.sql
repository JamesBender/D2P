...
Client ID:      MID1020
Date/time:      2021-12-12 22:45:52.167
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','ZCBOZ',NULL,NULL,NULL,'Test Purposes Only','202001029','EMPEXPORT','TEST','Jan 21 2020 12:00AM','EASCCONMID',NULL,NULL,NULL,'202001029','Jan  2 2020 12:00AM','Dec 30 1899 12:00AM','202001021','180','','','202001021',dbo.fn_GetTimedKey(),NULL,'ULTI_WPMIDI',NULL);
...
BEGIN
    ...
    SET @DedList = '401KF,401KP,R401F,R401P,ER401,401L,401L2,401L3';
