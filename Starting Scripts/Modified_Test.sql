...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','834','(''DA''=''T|'')','EHRTSLFEXPZ0','50','D','10','',NULL,'Benefit Deduct End Date 7',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20200120.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Hartford LTD STD and FMLA Expo','201910159','EMPEXPORT','ONDEMAND',NULL,'EHRTSLFEXP',NULL,NULL,NULL,'201910159','Oct 15 2019  5:41PM','Oct 15 2019  5:41PM','201910151',NULL,'','','201910151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20200120.txt',NULL,NULL,NULL,',IAGFG,HTEZ2,S9JHB,KFUDU,ZVN7G,A97O7,TJFST,ZVPSX',NULL,NULL,NULL,'Hartford LTDSTDFMLA - Fri 5am','201910159','EMPEXPORT','SCHEDULED',NULL,'EHRTSLFEXP',NULL,NULL,NULL,'202001179','Oct 15 2019  5:41PM','Oct 15 2019  5:41PM','202001101',NULL,'','','201910151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20200120.txt',NULL,'','','IAGFG,HTEZ2,S9JHB,KFUDU,ZVN7G,A97O7,TJFST,ZVPSX',NULL,NULL,NULL,'Test Purposes Only','202001179','EMPEXPORT','TEST','Jan 17 2020  9:55AM','EHRTSLFEXP',NULL,NULL,NULL,'202001179','Jan 17 2020 12:00AM','Dec 30 1899 12:00AM','202001101','1210','','','202001101',dbo.fn_GetTimedKey(),NULL,'us3lKiAPP1004',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EHRTSLFEXP_20200120.txt' END WHERE expFormatCode = 'EHRTSLFEXP';
...
BEGIN
    ...
    WHERE LEFT(PehPerControl,4) = LEFT(@StartPerControl,4) or LEFT(PehPerControl,4) = LEFT(@EndPerControl,4) 
     --PehPerControl >=  @Last8WeekPerControl and PehPerControl <= @StartPerControl
    GROUP BY PehEEID
