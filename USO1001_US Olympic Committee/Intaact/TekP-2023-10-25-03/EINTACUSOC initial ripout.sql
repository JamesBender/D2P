...
Client ID:      USG1000
Date/time:      2023-12-13 12:54:26.407
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EZ24
...
Web Filename:   USG1000_79690_EEHISTORY_EINTACUSOC_ExportCode_YYYYMMDD_HHMMSS.txt
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('10','EINTACUSOCZ0','50','H','01','10',NULL,'EMAIL1',NULL,NULL,'"EMAIL1"','(''DA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('13','EINTACUSOCZ0','50','H','01','13',NULL,'NEW_HIRE',NULL,NULL,'"NEW_HIRE"','(''DA''=''T'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('13','EINTACUSOCZ0','50','D','10','13',NULL,'NEW_HIRE',NULL,NULL,'"drvNewHire"','(''UA''=''T'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EINTACUSOC_20231213.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'USOC Intaact File','202312129','EMPEXPORT','ONDEM_XOE',NULL,'EINTACUSOC',NULL,NULL,NULL,'202312129','Dec 12 2023  3:21PM','Dec 12 2023  3:21PM','202312121',NULL,'','','202312121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'USOC Intaact File-Sched','202312129','EMPEXPORT','SCH_EINTAC',NULL,'EINTACUSOC',NULL,NULL,NULL,'202312129','Dec 12 2023  3:21PM','Dec 12 2023  3:21PM','202312121',NULL,'','','202312121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'USOC Intaact File-Test','202312129','EMPEXPORT','TEST_XOE',NULL,'EINTACUSOC',NULL,NULL,NULL,'202312129','Dec 12 2023  3:21PM','Dec 12 2023  3:21PM','202312121',NULL,'','','202312121',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EINTACUSOC','ExportPath','V','\\ez2sup4db01\ultiprodata\[Name]\Exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EINTACUSOC','UseFileName','V','N');
...
BEGIN
    ...
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpComp','EecEmpNo');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpComp','EecEEType');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpComp','EecDateOfLastHire');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpComp','EecEmplStatus');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpComp','EecOrgLvl4');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpPers','EepNameFirst');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpPers','EepNameLast');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpPers','eepAddressEmail');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpPers','eepAddressEmailAlternate');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpPers','EepNamePreferred');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpComp','eecDateofTermination');
    INSERT INTO dbo.U_EIATFIDENR_AuditFields VALUES ('EmpComp','eecDateOfLastHire');
    ...
    SELECT DISTINCT
        ...
        ,drvNewHire = CASE When EecDateOfLastHire BETWEEN @StartDate AND @EndDate then 'Y' END
