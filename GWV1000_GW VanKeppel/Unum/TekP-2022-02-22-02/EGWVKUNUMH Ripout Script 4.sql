...
Client ID:      GWV1000
Date/time:      2022-05-11 12:24:03.243
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    NWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EGWVKUNUMH_20220511.txt';
...
--INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','202205289','EMPEXPORT','OEACTIVE',NULL,'EGWVKUNUMH',NULL,NULL,NULL,'202204289','Apr 28 2022  4:12PM','Apr 28 2022  4:12PM','202204211',NULL,'','','202205211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
--INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','202205289','EMPEXPORT','OEPASSIVE',NULL,'EGWVKUNUMH',NULL,NULL,NULL,'202204289','Apr 28 2022  4:12PM','Apr 28 2022  4:12PM','202204211',NULL,'','','202205211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unum Health and Welfare Export','202205289','EMPEXPORT','ONDEM_XOE',NULL,'EGWVKUNUMH',NULL,NULL,NULL,'202204289','Apr 28 2022  4:12PM','Apr 28 2022  4:12PM','202204211',NULL,'','','202205211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Unum Health and Welfare -Sched','202205289','EMPEXPORT','SCH_EGWVKU',NULL,'EGWVKUNUMH',NULL,NULL,NULL,'202204289','Apr 28 2022  4:12PM','Apr 28 2022  4:12PM','202204211',NULL,'','','202205211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,NULL,'Unum Health and Welfare -Test','202205289','EMPEXPORT','TEST_XOE',NULL,'EGWVKUNUMH',NULL,NULL,NULL,'202204289','Apr 28 2022  4:12PM','Apr 28 2022  4:12PM','202204211',NULL,'','','202205211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,NULL,'Unum Health & Welfare Changes','202205289','EMPEXPORT','CHANGES',NULL,'EGWVKUNUMH',NULL,NULL,NULL,'202204289','Apr 28 2022  4:12PM','Apr 28 2022  4:12PM','202204211',NULL,'','','202205211',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
-----------
-- AscImp inserts
-----------
...
BEGIN
    ...
    INSERT INTO dbo.U_EGWVKUNUMH_AuditFields VALUES ('EmpComp','EecEmplStatus')
    INSERT INTO dbo.U_EGWVKUNUMH_AuditFields VALUES ('EmpComp','EecAnnSalary')
    INSERT INTO dbo.U_EGWVKUNUMH_AuditFields VALUES ('EmpDed','eedBenAmt')
    INSERT INTO dbo.U_EGWVKUNUMH_AuditFields VALUES ('EmpDed','EedEEEligDate')
	INSERT INTO dbo.U_EGWVKUNUMH_AuditFields VALUES ('EmpComp','EecDateofTermination');
	INSERT INTO dbo.U_EGWVKUNUMH_AuditFields VALUES ('EmpComp','EecTermReason');
    ...
    SELECT
        ...
        ,audTerm = CASE WHEN audTableName = 'EmpComp' AND audFieldName = 'EecEmplStatus' AND ISNULL(audOldValue,'') = 'A' AND ISNULL(audNewValue,'') = 'T' THEN 'Y' ELSE 'N' END
    ...
    -- Create Index
    CREATE CLUSTERED INDEX CDX_U_EGWVKUNUMH_Audit ON dbo.U_EGWVKUNUMH_Audit (audEEID,audKey2);
