...
select drvINS02_RelationshipCode, drvNM109_IDCode1, * from dbo.U_EGRD834EXP_DrvTbl
where drvEEID = 'COPWJQ00A040'
AND drvNM109_IDCode1 = '999999999'
...
select DISTINCT ConSSN, ConRelationship, BdmDepRecId, BdmDedCode from Contacts
			join dbo.U_dsi_bdm_EGRD834EXP A
			ON ConEEID = BdmEEID
