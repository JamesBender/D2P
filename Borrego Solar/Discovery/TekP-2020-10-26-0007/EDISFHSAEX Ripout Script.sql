...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISFHSAEX_20210204.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Discovery FSA/HSA Export-Test','202101221','EMPEXPORT','TEST_XOE','Feb  3 2021 10:43AM','EDISFHSAEX',NULL,NULL,NULL,'202101221','Jan 22 2021 12:00AM','Jan 23 2021 12:00AM','202101221','822','eecPayGroup','BSSIAR,BSSINE,BSSI','202101221',dbo.fn_GetTimedKey(),NULL,'us3cPeBOR1002',NULL);
