...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','XBO8J,XBOH9,XBOY6,XMKY0',NULL,NULL,NULL,@FixedFormatName2,'202106169','EMPEXPORT','SCH_EDSQBN','May 12 2021  2:38PM','@CustomFormatCode',NULL,NULL,NULL,'202112319','May 11 2021  3:59PM','May 11 2021  3:59PM','202112241','300','','','202106161',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
EXEC dbo.dsi_sp_TestSwitchbox_v2 '@CustomFormatCode', 'SCH_EDSQBN';
