...
Client ID:      CRO1008
Date/time:      2022-03-17 21:42:07.070
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    NWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECIGMED834_20220317.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N',',M8C6I,USJ16,JE6DL,EDV92,CJC4Y,EV2EI,JG341,EV7Z8',NULL,NULL,NULL,'Cigna Medical 834 Export','202103139','EMPEXPORT','SCH_CIGMD','Oct  1 2018 12:00AM','ECIGMED834',NULL,NULL,NULL,'202203119','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM','202203041',NULL,'','','202103131',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',',M8C6I,USJ16,JE6DL,EDV92,CJC4Y,EV2EI,JG341,EV7Z8',NULL,NULL,NULL,'Test Export','202203119','EMPEXPORT','TEST','Jan 10 2022  5:12PM','ECIGMED834',NULL,NULL,NULL,'202203119','Jan  7 2022 12:00AM','Jan  1 2022 12:00AM','202203041','20393','','','202203041',dbo.fn_GetTimedKey(),NULL,'us3cPeCRO1008',NULL);
...
--Update Dates
UPDATE dbo.AscExp
    SET ExpLastStartPerControl = '202203041'
       ,ExpStartPerControl     = '202203041'
       ,ExpLastEndPerControl   = '202203119'
       ,ExpEndPerControl       = '202203119'
       ...
       ,expCOIDList            = ',M8C6I,USJ16,JE6DL,EDV92,CJC4Y,EV2EI,JG341,EV7Z8'
WHERE ExpFormatCode = 'ECIGMED834' and expExportcode LIKE '%TEST%';
