...
Web Filename:   USG1000_12634_EEHISTORY_EUCCULDEMO_ExportCode_YYYYMMDD_HHMMSS.txt
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('22','EUCCULDEMOZ0','50','H','01','22',NULL,'Salary',NULL,NULL,'"Salary"','(''DQ''=''T'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('11','EUCCULDEMOZ0','50','D','10','11',NULL,'Job Title',NULL,NULL,'"drvJobTitle"','(''UA''=''T,'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUCCULDEMO_20221013.txt';
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUCCULDEMO','ExportPath','V','\\ez2sup4db01\ultiprodata\[Name]\Exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EUCCULDEMO','UseFileName','V','N');
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvStartDate = '"' + CONVERT(VARCHAR, EecDateOfLastHire, 23) + '"'
        ,drvEndDate = CONVERT(VARCHAR, EecDateOfTermination, 23) + '"'
