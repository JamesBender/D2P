...
FlatIron - Replace with customer name
Marco Lagrosa - Replace with TC name
Richard Vars - Replace with BA/IC name
06/03/2021 - Replace with date of creation
TekP-2021-04-02-0002 - Replace with SR number
EFLAUHC834 - Replace with Format Code (i.e., ESUNLIF834)
UHC 834 Export - Replace with Name of Interface (AdfFormatName) (i.e., Sunlife 834 Export)
CIPLI - Replace with Company Code (i.e., GOOG)
...
-- Data parameters
CIPLI - Replace with Company Code for Customer
...
*/
IF OBJECT_ID('dsi_vwEFLAUHC834_Export') IS NOT NULL DROP VIEW [dbo].[dsi_vwEFLAUHC834_Export];
GO
IF OBJECT_ID('dsi_sp_BuildDriverTables_EFLAUHC834') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_BuildDriverTables_EFLAUHC834];
GO
IF OBJECT_ID('dsi_sp_AfterCollect_EFLAUHC834') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_AfterCollect_EFLAUHC834];
GO
IF OBJECT_ID('U_EFLAUHC834_TrlTbl') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_TrlTbl];
GO
IF OBJECT_ID('U_EFLAUHC834_HdrTbl') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_HdrTbl];
GO
IF OBJECT_ID('U_EFLAUHC834_File') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_File];
GO
IF OBJECT_ID('U_EFLAUHC834_EEList') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_EEList];
GO
IF OBJECT_ID('U_EFLAUHC834_DrvTbl_2300') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_DrvTbl_2300];
GO
IF OBJECT_ID('U_EFLAUHC834_DrvTbl') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_DrvTbl];
GO
IF OBJECT_ID('U_EFLAUHC834_DedList') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_DedList];
GO
IF OBJECT_ID('U_EFLAUHC834_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_AuditFields];
GO
IF OBJECT_ID('U_EFLAUHC834_Audit') IS NOT NULL DROP TABLE [dbo].[U_EFLAUHC834_Audit];
GO
IF OBJECT_ID('U_dsi_BDM_EFLAUHC834') IS NOT NULL DROP TABLE [dbo].[U_dsi_BDM_EFLAUHC834];
GO
DELETE [dbo].[U_dsi_SQLClauses] FROM [dbo].[U_dsi_SQLClauses] WHERE FormatCode = 'EFLAUHC834';
DELETE [dbo].[U_dsi_Configuration] FROM [dbo].[U_dsi_Configuration] WHERE FormatCode = 'EFLAUHC834';
DELETE [dbo].[AscExp] FROM [dbo].[AscExp] WHERE expFormatCode = 'EFLAUHC834';
DELETE [dbo].[AscDefF] FROM [dbo].[AscDefF] JOIN AscDefH ON AdfHeaderSystemID = AdhSystemID WHERE AdhFormatCode = 'EFLAUHC834';
DELETE [dbo].[AscDefH] FROM [dbo].[AscDefH] WHERE AdhFormatCode = 'EFLAUHC834';
GO

DECLARE @AdhSystemID VARCHAR(12), @FixedFormatName1 VARCHAR(50), @FixedFormatName2 VARCHAR(50);
SET @AdhSystemID = LEFT('EFLAUHC834' + REPLICATE('0',10),10) + 'Z0';
SET @FixedFormatName1 = LEFT('UHC 834 Export',50);
SET @FixedFormatName2 = LEFT('UHC 834 Export',30);

INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) SELECT 'N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','EFLAUHC834',@FixedFormatName1,'N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','2000','S','N',@AdhSystemID,'N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Changes Only File',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','CHANGES','Oct  1 2018 12:00AM','EFLAUHC834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Full File Only',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','FULLFILE','Oct  1 2018 12:00AM','EFLAUHC834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEACTIVE','Oct  1 2018 12:00AM','EFLAUHC834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEPASSIVE','Oct  1 2018 12:00AM','EFLAUHC834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,@FixedFormatName2,CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','SCHEDULED','Oct  1 2018 12:00AM','EFLAUHC834',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFLAUHC834','834LineFeed','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFLAUHC834','EEList','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFLAUHC834','ExportPath','V','@FileExportPath');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFLAUHC834','InitialSort','C','LEFT(drvInitialSort,20)');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFLAUHC834','Is834','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFLAUHC834','SubSort','C','drvSubSort');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFLAUHC834','Testing','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EFLAUHC834','UseFileName','V','N');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H01','U_EFLAUHC834_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H02','U_EFLAUHC834_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H03','U_EFLAUHC834_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H04','U_EFLAUHC834_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H05','U_EFLAUHC834_HdrTbl','ISNULL(drvREF01_RefNumberQual,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H06','U_EFLAUHC834_HdrTbl','ISNULL(drvQTY01_QuantityQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H07','U_EFLAUHC834_HdrTbl','ISNULL(drvQTY01_QuantityQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H08','U_EFLAUHC834_HdrTbl','ISNULL(drvQTY01_QuantityQual3,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H09','U_EFLAUHC834_HdrTbl','ISNULL(drvN101_EntityIDCodeSponsor1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','H10','U_EFLAUHC834_HdrTbl','ISNULL(drvN101_EntityIDCodeSponsor2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D11','U_EFLAUHC834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D12','U_EFLAUHC834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D13','U_EFLAUHC834_DrvTbl','ISNULL(drvREF01_RefNumberQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D14','U_EFLAUHC834_DrvTbl','ISNULL(drvREF01_RefNumberQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D15','U_EFLAUHC834_DrvTbl','ISNULL(drvDTP00_DateTime1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D16','U_EFLAUHC834_DrvTbl','ISNULL(drvDTP00_DateTime2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D20','U_EFLAUHC834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D21','U_EFLAUHC834_DrvTbl','ISNULL(drvPER03_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER05_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER07_CommNumberQualifier,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D22','U_EFLAUHC834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D23','U_EFLAUHC834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D24','U_EFLAUHC834_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D25','U_EFLAUHC834_DrvTbl','ISNULL(drvICM01_FrequencyCode,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D26','U_EFLAUHC834_DrvTbl','ISNULL(drvAMT00_SegmentID1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D27','U_EFLAUHC834_DrvTbl','ISNULL(drvAMT00_SegmentID2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D28','U_EFLAUHC834_DrvTbl','ISNULL(drvHLH00_SegmentID,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D40','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D41','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_348,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D42','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_349,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D43','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_303,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D45','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvREF00_RefNumberQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D46','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvREF00_RefNumberQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D50','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvAMT00_AmountQualifierCode1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D51','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvAMT00_AmountQualifierCode2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D80','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvLS01_LoopIDCode,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D81','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvLX01_AssignedNumber,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D85','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvN101_EntityIDCodeSponsor,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D86','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvREF01_RefNumberQual,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','D87','U_EFLAUHC834_DrvTbl_2300','ISNULL(drvLE01_LoopIDCode,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','T90','U_EFLAUHC834_TrlTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','T91','U_EFLAUHC834_TrlTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EFLAUHC834','T92','U_EFLAUHC834_TrlTbl',NULL);
GO
...
BEGIN
    ...
    UPDATE dbo.AscExp SET expAscFileName = @FilePath + @FileName WHERE expFormatCode = 'EFLAUHC834';

    DELETE FROM dbo.U_dsi_Configuration WHERE FormatCode = 'EFLAUHC834' AND CfgName IN ('TestPath','UDESPath');
END
GO
IF OBJECT_ID('U_EFLAUHC834_EEList') IS NULL
CREATE TABLE [dbo].[U_EFLAUHC834_EEList] (
    [xCOID] char(5) NULL,
    [xEEID] char(12) NULL
);
IF OBJECT_ID('U_EFLAUHC834_File') IS NULL
CREATE TABLE [dbo].[U_EFLAUHC834_File] (
...
GO
CREATE PROCEDURE [dbo].[dsi_sp_AfterCollect_EFLAUHC834]
AS
SET NOCOUNT ON;
/************************************************************
Client: FlatIron
...
ChangePoint Request Number: TekP-2021-04-02-0002
...
BEGIN
    ...
    --==================================================
    WHILE (SELECT COUNT(*) FROM dbo.U_EFLAUHC834_File WHERE RIGHT(DATA,2) = '*~') > 0
    BEGIN
        UPDATE dbo.U_EFLAUHC834_File SET DATA = REPLACE(DATA,'*~','~') WHERE RIGHT(RTRIM(DATA),2) = '*~';
    END;

    --========================================
    -- Remove Extra Records from PER Segment
    --========================================
    UPDATE dbo.U_EFLAUHC834_File SET DATA = REPLACE(DATA,'HP**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%HP**%';
    UPDATE dbo.U_EFLAUHC834_File SET DATA = REPLACE(DATA,'WP**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%WP**%';
    UPDATE dbo.U_EFLAUHC834_File SET DATA = REPLACE(DATA,'EM**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%EM**%';

    --====================================
    -- Update Record Count in SE Segment
    --====================================
    DECLARE @RecordCount INT;
    SET @RecordCount = (SELECT COUNT(*) FROM dbo.U_EFLAUHC834_File WHERE LEFT(Data, CHARINDEX('*',Data) - 1) NOT IN ('ISA','GS','IEA','GE'));

    UPDATE dbo.U_EFLAUHC834_File
    SET Data = REPLACE(Data,'9999',@RecordCount)
    WHERE LEFT(Data,2) = 'SE';

END
GO
CREATE PROCEDURE [dbo].[dsi_sp_BuildDriverTables_EFLAUHC834]
    @systemid CHAR(12)
AS
SET NOCOUNT ON;
/**********************************************************************************
...
SELECT * FROM dbo.U_dsi_Configuration WHERE FormatCode = 'EFLAUHC834';
SELECT * FROM dbo.U_dsi_SqlClauses WHERE FormatCode = 'EFLAUHC834';
SELECT * FROM dbo.U_dsi_Parameters WHERE FormatCode = 'EFLAUHC834';
SELECT * FROM dbo.AscExp WHERE expFormatCode = 'EFLAUHC834';
SELECT * FROM dbo.U_dsi_InterfaceActivityLog WHERE FormatCode = 'EFLAUHC834' ORDER BY RunID DESC;

Execute Export
--------------
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EFLAUHC834', 'FULLFILE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EFLAUHC834', 'CHANGES';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EFLAUHC834', 'OEPASSIVE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EFLAUHC834', 'OEACTIVE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EFLAUHC834', 'SCHEDULED';

EXEC dbo.dsi_BDM_sp_ErrorCheck 'EFLAUHC834';

EXEC dbo._dsi_usp_ExportRipOut @FormatCode = 'EFLAUHC834', @AllObjects = 'Y', @IsWeb = 'N';
**********************************************************************************/
BEGIN
    ...
    IF OBJECT_ID('U_EFLAUHC834_DedList','U') IS NOT NULL
        DROP TABLE dbo.U_EFLAUHC834_DedList;
    SELECT DedCode = DedDedCode
        ,DedLongDesc
        ,DedType = DedDedType
    INTO dbo.U_EFLAUHC834_DedList
    ...
    DELETE FROM dbo.U_EFLAUHC834_EEList
    WHERE xCoID <> dbo.dsi_BDM_fn_GetCurrentCoID(xEEID)
    AND xEEID IN (SELECT xEEID FROM dbo.U_EFLAUHC834_EEList GROUP BY xEEID HAVING COUNT(1) > 1);

    -- Remove Employees that Do Not Have a Benefit Plan in Deduction Code List
    DELETE FROM dbo.U_EFLAUHC834_EEList
    WHERE NOT EXISTS (SELECT 1 FROM dbo.EmpDed JOIN dbo.U_EFLAUHC834_DedList ON DedCode = EedDeDCode WHERE EedEEID = xEEID);
    ...
    FROM dbo.U_dsi_bdm_EFLAUHC834 D
    JOIN dbo.U_dsi_bdm_EFLAUHC834 E
    ...
    --=====================================================
    UPDATE dbo.U_dsi_bdm_EFLAUHC834
        SET BdmUSGField2 = EedEmpDedTVID
    FROM dbo.U_dsi_bdm_EFLAUHC834
    ...
    ***************************************************************************************************************/
    ...
    -- HEADER RECORD 
    -------------------
    IF OBJECT_ID('U_EFLAUHC834_HdrTbl','U') IS NOT NULL
        DROP TABLE dbo.U_EFLAUHC834_HdrTbl;
    SELECT DISTINCT drvISA05_SenderIDQual = ''
        ...
        ,drvN103_IDCodeQual2 = ''
        ,drvN104_IDCode2 = ''
    INTO dbo.U_EFLAUHC834_HdrTbl
    FROM dbo.U_EFLAUHC834_EELIST WITH (NOLOCK)
    JOIN dbo.U_dsi_bdm_EFLAUHC834 WITH (NOLOCK)
        ON BdmEEID = xEEID
        AND BdmCOID = xCOID;
    ...
    ***************************************************************************************************************/
    ...
    -- DETAIL RECORD 
    -------------------
    IF OBJECT_ID('U_EFLAUHC834_DrvTbl','U') IS NOT NULL
        DROP TABLE dbo.U_EFLAUHC834_DrvTbl;
    SELECT DISTINCT
        --=====================
        --LOOP 2000 RECORDS
        --=====================
    ...
    ***************************************************************************************************************/
    ...
    -- DETAIL RECORD 
    -------------------
    IF OBJECT_ID('U_EFLAUHC834_DrvTbl_2300','U') IS NOT NULL
        DROP TABLE dbo.U_EFLAUHC834_DrvTbl_2300;
    SELECT DISTINCT
        ...
        ,drvSubSort = CONVERT(CHAR(9),RTRIM(EepSSN)) + CONVERT(CHAR(12),ISNULL(ConSystemID,''))
                      + CASE BdmDedType
                             ...
                             ELSE '9'
                      END
    INTO dbo.U_EFLAUHC834_DrvTbl_2300
    FROM dbo.U_EFLAUHC834_EELIST WITH (NOLOCK)
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    JOIN dbo.EmpComp WITH (NOLOCK)
    ...
    **************************************************************************************************/
    ...
    -- TRAILER RECORD
    --------------------
    IF OBJECT_ID('U_EFLAUHC834_TrlTbl') IS NOT NULL
        DROP TABLE dbo.U_EFLAUHC834_TrlTbl;
    SELECT DISTINCT drvSE01_SegmentCount = '9999'
    INTO dbo.U_EFLAUHC834_TrlTbl;

    --==========================================
    -- Set FileName
    --==========================================
    IF (dbo.dsi_fnVariable('EFLAUHC834','UseFileName') = 'N')
    BEGIN
        UPDATE dbo.U_dsi_Parameters
            SET ExportFile = 'CIPLI_EFLAUHC834_' + CONVERT(VARCHAR(8),GETDATE(),112) + '.txt'
        WHERE FormatCode = 'EFLAUHC834';
    END;
...
--Alter the View
ALTER VIEW dbo.dsi_vwEFLAUHC834_Export AS
    SELECT TOP 20000000 DATA FROM dbo.U_EFLAUHC834_File (NOLOCK)
...
WHERE AdfHeaderSystemID LIKE 'EFLAUHC834%'
...
WHERE ExpFormatCode = 'EFLAUHC834';

**********************************************************************************/
GO
CREATE VIEW dbo.dsi_vwEFLAUHC834_Export AS
    SELECT TOP 20000000 DATA FROM dbo.U_EFLAUHC834_File (NOLOCK)
    ORDER BY CASE LEFT(Recordset,1) WHEN 'H' THEN 1 WHEN 'D' THEN 2 ELSE 3 END, InitialSort, SubSort, RIGHT(Recordset,2)
GO