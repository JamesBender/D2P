...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ETRUSTKWPM_20210719.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Trustmark Critical Illne-Test','202107129','EMPEXPORT','TEST_XOE','Jul 12 2021  2:43PM','ETRUSTKWPM',NULL,NULL,NULL,'202107129','Jul 12 2021 12:00AM','Dec 30 1899 12:00AM','202106281','78','','','202106281',dbo.fn_GetTimedKey(),NULL,'us3lKiKWP1000',NULL);
...
;
    ...
    SELECT DISTINCT
        ...
        ,TIER = CASE WHEN EedBenOption IN ('EE', 'EENW', 'EEO') THEN 'Employee'
						...
						WHEN EedBenOption IN ('EEF', 'EEDPF', 'EEFNW', 'FAM') THEN 'Employee' END
