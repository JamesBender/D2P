...
Client ID:      SUR1004
Date/time:      2022-04-26 09:39:35.780
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    E43
...
Web Filename:   SUR1004_WUIU2_EEHISTORY_ESURCORNJT_ExportCode_YYYYMMDD_HHMMSS.txt
ExportPath:    
TestPath:      
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('8','ESURCORNJTZ0','50','H','01','8',NULL,'Region',NULL,NULL,'"Region"','(''DA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('9','ESURCORNJTZ0','50','H','01','9',NULL,'Featured Job?',NULL,NULL,'"Featured Job?"','(''DA''=''T'')');--Added ? on the end of column name
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('8','ESURCORNJTZ0','50','D','10','8',NULL,'Region',NULL,NULL,'""','(''SS''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('9','ESURCORNJTZ0','50','D','10','9',NULL,'Featured Job?',NULL,NULL,'""','(''SS''=''T'')'); --Added ? on the end of column name
...
/*08*/ DECLARE @FileName varchar(1000) = 'ESURCORNJT_20220426.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'Cornerstone Job Title-Test','202204211','EMPEXPORT','TEST_XOE','Apr 21 2022  9:20AM','ESURCORNJT',NULL,NULL,NULL,'202204211','Apr 21 2022 12:00AM','Dec 30 1899 12:00AM','202204211','1293','','','202204211',dbo.fn_GetTimedKey(),NULL,'us3cPeSUR1004',NULL);
...
Marie Waters    04/26/2022     TekP-2022-01-31-05/SR-2022-00360788   Add a question mark on end of Featured Job column
