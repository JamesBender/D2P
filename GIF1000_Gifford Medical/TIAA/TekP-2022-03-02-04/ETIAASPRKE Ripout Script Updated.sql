...
Client ID:      GIF1000
Date/time:      2022-10-25 15:57:57.870
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    E31
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('44','ETIAASPRKEZ0','50','D','10','44',NULL,'CONTRIBUTION SOURCE CODE4',NULL,NULL,'"drvContributionSourceCode4"','(''UA''=''T|'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('45','ETIAASPRKEZ0','50','D','10','45',NULL,'CONTRIBUTION SOURCE AMOUNT4',NULL,NULL,'"drvContributionSourceAmount4"','(''UA''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('55','ETIAASPRKEZ0','50','D','10','55',NULL,'LOAN NUMBER 1',NULL,NULL,'"drvLoanNumber1"','(''UA''=''T|'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('88','ETIAASPRKEZ0','50','D','10','88',NULL,'PLAN ENTRY DATE',NULL,NULL,'"drvPlanEntryDate"','(''UA''=''T|'')');
...
/*08*/ DECLARE @FileName varchar(1000) = 'ETIAASPRKE_20221025.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,'TIAA SPARK Def Comp Export','202208259','EMPEXPORT','ONDEM_XOE',NULL,'ETIAASPRKE',NULL,NULL,NULL,'202208259','Aug  4 2022  8:31AM','Aug  4 2022  8:31AM','202208251',NULL,'','','202208251',dbo.fn_GetTimedKey(),NULL,'ULTI','',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N',NULL,NULL,NULL,'TIAA SPARK DC-Thurs Biwkly 4pm','202208259','EMPEXPORT','SCH_ETIAAS',NULL,'ETIAASPRKE',NULL,NULL,NULL,'202210209','Aug  4 2022  8:31AM','Aug  4 2022  8:31AM','202210071',NULL,'','','202208251',dbo.fn_GetTimedKey(),NULL,'ULTI','HY9DG,G05N9,XFI1I',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',NULL,NULL,NULL,'TIAA SPARK Def Comp Expo-Test','202210209','EMPEXPORT','TEST_XOE','Oct 25 2022 11:44AM','ETIAASPRKE',NULL,NULL,NULL,'202210209','Oct 20 2022 12:00AM','Dec 30 1899 12:00AM','202210071','534','','','202210071',dbo.fn_GetTimedKey(),NULL,'us3lKiGIF1000','KA0OU,HY9DG,G05N9,XFI1I',NULL);
...
CREATE TABLE [dbo].[U_ETIAASPRKE_drvTbl] (
    ...
    [drvResidencyCode] varchar(1) NOT NULL,
    ...
    [drvContributionSourceCode4] varchar(1) NULL,
    [drvContributionSourceAmount4] nvarchar(4000) NULL,
    [drvLoanNumber1] varchar(3) NULL,
    ...
    [drvPerPayCompensation] nvarchar(4000) NULL,
    [drvEmployeePlanStatus] varchar(1) NULL,
    [drvPlanEntryDate] varchar(8) NULL,
    [drvEEContributionEligSource1] varchar(1) NULL,
    [drvEEContributionEligDate1] varchar(8) NULL
);
...
CREATE TABLE [dbo].[U_ETIAASPRKE_Trailer] (
    ...
    [drvRemittanceAmountTotal] nvarchar(4000) NULL,
    [drvLoanAmountTotal] nvarchar(4000) NULL
);
GO
...
Marie Waters      09/06/2022     SR-2022-000XXXXX   Updated RESIDENCY CODE field to include Null in case statement and updated EEContributionEligDate1 to use UDF EECUDFIELD01
Marie Waters      09/09/2022     SR-2022-000XXXXX   Added column and EecDateOfLastHire to Plan Entry Date for 408330 
Marie Waters	  10/25/2022	 TekP-2022-03-02-04 Updated the code to pull Loannumbers differently to remove duplicate rows
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,PdhSrc1P1     = SUM(CASE WHEN PdhDedCode IN ('403') THEN PdhERCurAmt ELSE 0.00 END)
        ...
        ,Pdhsrc2P1b     = SUM(CASE WHEN PdhDedCode IN ('403M', 'ROTH') THEN PdhERCurAmt ELSE 0.00 END)
  ...
  SELECT DISTINCT drvEEID = xEEID
        ...
        ,drvRecipientVendorPlanId =    --CASE WHEN BdmDedCode IN ('403','403CU','403M','403PD','ROTH') THEN 
                                    ...
                                    --WHEN BdmDedCode IN ('457','457CU') THEN '408330'
                                    --END
        ,drvPayrollFrequency = CASE WHEN PgrPayFrequency = 'B' THEN '26' END
        ...
        ,drvAddressCountry = CASE WHEN EepAddressCountry = 'USA' THEN 'US' END
        ,drvResidencyCode = CASE WHEN EepI9WorkAuth IN ('U','P','C') or EepI9WorkAuth IS NULL THEN 'U' ELSE 'N' END
        ...
        ,drvContributionSourceCode1 = CASE WHEN DedCode_403 IS NOT NULL OR PdhSrc1P1 > 0 THEN 'F' END
        ,drvContributionSourceAmount1 = CASE WHEN DedCode_403 IS NOT NULL OR PdhSrc1P1 > 0 THEN FORMAT(PdhSrc1P1, '#0.00') END
        ,drvContributionSourceCode2 = CASE WHEN DedCode_403x IS NOT NULL OR Pdhsrc2P1a > 0 THEN 'E' END
        ,drvContributionSourceAmount2 = CASE WHEN DedCode_403x IS NOT NULL OR Pdhsrc2P1a > 0 THEN FORMAT(Pdhsrc2P1a, '#0.00') END -- removed + Pdhsrc2P1b
        ,drvContributionSourceCode3 = CASE WHEN DedCode_ROTH IS NOT NULL OR PdhROTH > 0 THEN '2' END
        ,drvContributionSourceAmount3 = CASE WHEN DedCode_ROTH IS NOT NULL OR PdhROTH > 0 THEN FORMAT(PdhROTH, '#0.00') END
        ,drvContributionSourceCode4 = CASE WHEN DedCode_403M IS NOT NULL OR Pdhsrc2P1b > 0 THEN 'D' END -- added
        ,drvContributionSourceAmount4 = CASE WHEN DedCode_403M IS NOT NULL OR Pdhsrc2P1b > 0 THEN FORMAT(Pdhsrc2P1b, '#0.00') END -- added
        ,drvLoanNumber1 =    CASE WHEn Loan002 IS not null then Loan002 ELSE Loan001 END
                    
        ,drvLoanRepaymentAmount1 = CASE WHEN Loan002 IS not null or  Loan001 is not null THEN FORMAT(Pdh403L, '#0.00') END
        ...
        ,drvEmploymentSubType =    CASE WHEN EecEmplStatus = 'A' AND EecDateOfLastHire = EecDateOfOriginalHire THEN 'O'
                                ...
                                END
        ,drvEmploymentStatusDate = EecEmplStatusStartDate--EshStatusStartDate
        ...
        ,drvPerPayCompensation = FORMAT(EecPeriodPayRate, '#0.00')
        ,drvEmployeePlanStatus =    CASE WHEN (DedCode_403x IS NOT NULL OR DedCode_ROTH IS NOT NULL) AND DedCode_403x_StopDate IS NULL THEN 'P'
                                    ...
                                    ELSE 'E'
                                    END
        ,drvPlanEntryDate = CONVERT(VARCHAR(8), EecDateOfLastHire,112)
        ,drvEEContributionEligSource1 = CASE WHEN DedCode_403 IS NOT NULL and DedCode_403StartDate <= PdhPayDate THEN 'F' END
        ,drvEEContributionEligDate1 = CASE WHEN DedCode_403 IS NOT NULL and DedCode_403StartDate <= PdhPayDate THEN CONVERT(CHAR(8),CAST(EECUDFIELD01 AS DATETIME),112) END --CASE WHEN DedCode_403 IS NOT NULL THEN CONVERT(VARCHAR(8),EecDateOfBenefitSeniority,112) END
    ...
    LEFT JOIN (
                SELECT BdmEEID AS BdmP1EEID, BdmCOID AS BdmP1COID
                    ...
                    ,Max(CASE WHEN BdmDedCode = '403' THEN BdmBenStartDate END) as DedCode_403StartDate
                    ...
                    ,MAX(CASE WHEN BdmDedCode IN ('403M','ROTH') THEN BdmDedCode END) AS DedCode_403M -- added
             ...
             GROUP BY BdmEEID, BdmCOID,EedDedCode, eednotes 
        ) AS PlanOneBdm
        ON BdmP1EEID = xEEID
        AND BdmP1COID = xCOID
    LEFT JOIN (    

                 SELECT BdmEEID AS LoanEEID, BdmCOID AS LoanCOID
                    ,MAX(CASE WHEN BdmDedCode IN ('403L') THEN BdmDedCode END) AS DedCode_403L
                    ,Max(CASE WHEN BdmDedCode = '403L' and  eednotes  = '002' THEN '002' END) Loan002 
                    ,Max(CASE WHEN BdmDedCode = '403L' and  eednotes  <> '002' THEN '001' END)Loan001
                FROM dbo.U_dsi_BDM_ETIAASPRKE WITH (NOLOCK)
                JOIN dbo.EmpDed WITH (NOLOCK)
                ON EedEEID = BdmEEID
                and EedDedCode = BdmDedCode
                and EedDedCode = '403L'
                WHERE BdmDedCode IN ('403L') 
    ...
    SELECT DISTINCT drvEEID = xEEID
        ...
        ,drvContributionSourceCode4 = ''
        ,drvContributionSourceAmount4 = ''
        ,drvLoanNumber1 = ''
        ...
        ,drvEmployeePlanStatus =    CASE WHEN EecDedGroupCode IN ('PHYSF','PHYSP') AND DedCode_457 IS NOT NULL AND DedCode_457_StopDate IS NULL THEN 'P'
                                    ...
                                    END
        ,drvPlanEntryDate = CONVERT(VARCHAR(8), EecDateOfLastHire,112) -- added
    ...
    SELECT DISTINCT
         drvRecordCount = (SELECT COUNT(*) FROM dbo.U_ETIAASPRKE_drvTbl) + 2
        ,drvRemittanceAmountTotal = FORMAT((SELECT SUM(CAST(drvContributionSourceAmount1 AS MONEY)) + SUM(CAST(drvContributionSourceAmount2 AS MONEY)) + SUM(CAST(drvContributionSourceAmount3 AS MONEY))+ SUM(CAST(drvContributionSourceAmount4 AS MONEY)) FROM dbo.U_ETIAASPRKE_drvTbl WITH (NOLOCK)), '#0.00')
        ,drvLoanAmountTotal = FORMAT((SELECT SUM(CAST(drvLoanRepaymentAmount1 AS MONEY)) FROM dbo.U_ETIAASPRKE_drvTbl WITH (NOLOCK)), '#0.00')
