...
>>>>>> NOTE: this ripout is cloned from ECYCCONTR


ECYCCONTST: Connect Your Care FSA/HSA Contribution Export

FormatCode:     ECYCCONTST
Project:        Connect Your Care FSA/HSA Contribution Export
Client ID:      MGP1000
Date/time:      2022-01-25 21:01:29.077
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','SDF','ECYCCONTST','Connect Your Care FSA/HSA Contribution Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','250','S','N','E4L12H000020','N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N');
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECYCCONTST_20220125.txt';
...
EXEC dbo._dsi_usp_ExportRipOut_v7 @FormatCode = 'ECYCCONTST', @AllObjects = 'Y', @IsWeb = 'Y'
**********************************************************************************/
BEGIN
...
WHERE AdfHeaderSystemID LIKE 'ECYCCONTST%'
