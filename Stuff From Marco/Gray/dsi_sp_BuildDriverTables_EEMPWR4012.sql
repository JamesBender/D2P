...
Client ID:      GRA1017
Date/time:      2021-12-09 20:46:07.427
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    E43
...
/*08*/ DECLARE @FileName varchar(1000) = 'EEMPWR4012_20211209.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'XXXt Purposes Only','202111159','EMPEXPORT','TEST','Nov 15 2021  5:58PM','EEMPWR4012',NULL,NULL,NULL,'202111159','Nov 15 2021 12:00AM','Dec 30 1899 12:00AM','202111011','7492','','','202111011',dbo.fn_GetTimedKey(),NULL,'RVARS17',NULL);
