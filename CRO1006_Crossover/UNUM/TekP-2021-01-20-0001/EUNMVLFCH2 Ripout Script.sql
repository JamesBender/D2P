...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EUNMVLFCH2_20210419.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'UNUM Voluntary Life - TEST','202103221','EMPEXPORT','TEST','Apr  2 2021  1:12PM','EUNMVLFCH2',NULL,NULL,NULL,'202103221','Mar 22 2021 12:00AM','Mar 15 2021 12:00AM','202101011','318','','','202101011',dbo.fn_GetTimedKey(),NULL,'us3rVaCRO1006',NULL);
