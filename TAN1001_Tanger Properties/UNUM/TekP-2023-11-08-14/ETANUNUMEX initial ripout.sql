...
Client ID:      USG1000
Date/time:      2023-12-18 17:02:19.417
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EZ24
...
/*08*/ DECLARE @FileName varchar(1000) = 'ETANUNUMEX_20231218.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Tanger Properties UNUM E-Test','202312189','EMPEXPORT','TEST_XOE',NULL,'ETANUNUMEX',NULL,NULL,NULL,'202312189','Dec 18 2023  5:01PM','Dec 18 2023  5:01PM','202312181',NULL,'','','202312181',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ETANUNUMEX','ExportPath','V','\\ez2sup4db01\ultiprodata\[Name]\Exports\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ETANUNUMEX','UseFileName','V','N');
