...
Client ID:      COL1025
Date/time:      2022-01-18 04:56:49.877
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EANT834EXP_20220118.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'Full File Only','202201039','EMPEXPORT','FULLFILE','Jan  3 2022 12:05PM','EANT834EXP',NULL,NULL,NULL,'202201039','Jan  3 2022 12:00AM','Dec 30 1899 12:00AM','202112201','4700','','','202112201',dbo.fn_GetTimedKey(),NULL,'us3rVaCOL1025',NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','',NULL,NULL,NULL,'Test File Only','202201179','EMPEXPORT','TEST_XOE','Jan 17 2022  1:32PM','EANT834EXP',NULL,NULL,NULL,'202201179','Jan 17 2022 12:00AM','Dec 30 1899 12:00AM','202201031','4708','','','202201031',dbo.fn_GetTimedKey(),NULL,'us3rVaCOL1025',NULL);
    ...
    ***************************************************************************************************************/
    ...
    SELECT DISTINCT
        ...
        ,drvHD05_CoverageLevelCode = CASE WHEN BdmRecType = 'EMP' THEN
                                                CASE WHEN BdmBenOption IN ('EE','E12') THEN 'EMP'
