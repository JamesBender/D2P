...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ESPMWESTDS_20210714.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'SPM Benefits Export-Test','202107141','EMPEXPORT','TEST_XOE','Jul 14 2021  1:23PM','ESPMWESTDS',NULL,NULL,NULL,'202107141','Jul 14 2021 12:00AM','Dec 30 1899 12:00AM','202107011','812','','','202107011',dbo.fn_GetTimedKey(),NULL,'CPETITTI16',NULL);
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvClientDivName = REPLACE(CmpCompanyName, ',', '')
