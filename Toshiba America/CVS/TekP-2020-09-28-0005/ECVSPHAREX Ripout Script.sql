...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ECVSPHAREX_20201223.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'CVS Pharmacy Export-Test','202012221','EMPEXPORT','TEST_XOE','Dec 22 2020 12:56PM','ECVSPHAREX',NULL,NULL,NULL,'202012221','Dec 22 2020 12:00AM','Dec 30 1899 12:00AM','202012081','905','','','202012081',dbo.fn_GetTimedKey(),NULL,'us3cPeTOS1003',NULL);
