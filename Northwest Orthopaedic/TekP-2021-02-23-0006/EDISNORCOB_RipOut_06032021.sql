...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISNORCOB_20210603.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test NPM/Cobra Export','202106029','EMPEXPORT','TEST','Jun  2 2021  9:48AM','EDISNORCOB',NULL,NULL,NULL,'202106029','Jun  2 2021 12:00AM','Dec 30 1899 12:00AM','202012011','41','','','202012011',dbo.fn_GetTimedKey(),NULL,'us3cPeNOR1052',NULL);
