...
@CustomFormatCode - Replace with Format Code (i.e., ECORNERDPG)
@CustomFormatName - Replace with Name of Interface (AdfFormatName) (i.e., Cornerstone Export - Division/Position/Grade)
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Conrerstone-Division','201710019','EMPEXPORT','DIVISION',NULL,'@CustomFormatCode',NULL,NULL,NULL,'201710019','Oct  1 2017  4:49PM','Oct  1 2017  4:49PM','201710011',NULL,'','','201710011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Cornerstone-Position','201710019','EMPEXPORT','POSITION',NULL,'@CustomFormatCode',NULL,NULL,NULL,'201710019','Oct  1 2017  4:49PM','Oct  1 2017  4:49PM','201710011',NULL,'','','201710011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Cornerstone-Grade','201710019','EMPEXPORT','GRADE',NULL,'@CustomFormatCode',NULL,NULL,NULL,'201710019','Oct  1 2017  4:49PM','Oct  1 2017  4:49PM','201710011',NULL,'','','201710011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL;
...
Purpose: Cornerstone Export - Division/Position/Grade
...
BEGIN
    ...
    ---------------------------------
    INSERT INTO dbo.U_@CustomFormatCode_drvTbl (drvInitialSort,drvOUID,drvOUName,drvParentID,drvOwnerID,drvDescription,drvActive,drvAllowReconciliation)
    SELECT DISTINCT
    ...
    BEGIN
        ...
        SET ExportFile = CASE @ExportCode
                              WHEN 'DIVISION' THEN 'Division.txt'
                              WHEN 'POSITION' THEN 'Position.txt'
                              WHEN 'GRADE' THEN 'Grade.txt'
                         END    
        WHERE FormatCode = @FormatCode;
    END
