...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EBASICPFSA_20210603.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Basic Pacific FSA Export-Test','202104291','EMPEXPORT','TEST_XOE','Apr 29 2021  9:25PM','EBASICPFSA',NULL,NULL,NULL,'202104291','Apr 29 2021 12:00AM','Dec 30 1899 12:00AM','202104151','161','','','202104151',dbo.fn_GetTimedKey(),NULL,'us3cPeTYL1001',NULL);
...
CREATE TABLE [dbo].[U_EBASICPFSA_drvTbl] (
    ...
    [drvElectionChangeDate] VARCHAR(10) NULL,
...
BEGIN
    ...
    -- Create Index
    CREATE CLUSTERED INDEX CDX_U_EBASICPFSA_Audit ON dbo.U_EBASICPFSA_Audit (audEEID,audKey2);
    ...
    LEFT JOIN dbo.U_EBASICPFSA_Audit WITH (NOLOCK)
