...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,',DAJ4C,DCQJ1,DAJ8D,CIUJE,CITIX',NULL,NULL,NULL,'Benefit Express Census-Wed 6am','202103059','EMPEXPORT','ONDEM_XOE',NULL,'EBENEXDEMO',NULL,NULL,NULL,'202109019','Mar  5 2021  7:49AM','Mar  5 2021  7:49AM','202108251',NULL,'','','202103051',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'Null','N',',DAJ4C,DCQJ1,DAJ8D,CIUJE,CITIX',NULL,NULL,NULL,'Benefit Express Census-Mon 6am','202103059','EMPEXPORT','SCH_EBENEX',NULL,'EBENEXDEMO',NULL,NULL,NULL,'202108309','Mar  5 2021  7:49AM','Mar  5 2021  7:49AM','202108231',NULL,'','','202103051',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','DAJ4C,DCQJ1,DAJ8D,CIUJE,CITIX',NULL,NULL,NULL,'Benefit Express Census E-Test','202108189','EMPEXPORT','TEST_XOE','Aug 18 2021 10:42AM','EBENEXDEMO',NULL,NULL,NULL,'202108189','Aug 18 2021 12:00AM','Dec 30 1899 12:00AM','202108041','4200','','','202108041',dbo.fn_GetTimedKey(),NULL,'LKING16',NULL);
...
-----------------------------
 ...
 --   HAVING SUM(PehCurAmt) <> 0.00;
    ...
    SELECT DISTINCT
        ...
        ,drvNVarChar4 = (SELECT top 1 CodDesc from dbo.empcomp WITH (NOLOCK)
                                JOIN dbo.Codes WITH (NOLOCK)
                                    ON EecLocation = CodCode
                                    AND codtable = 'CO_HRMANAGERBYLOCATI'
                                    WHERE eecLocation = EMPC.EecLocation) --SUPC.EecEmpno --eecempno where EecSupervisorID = EecEEID where CodDesc FROM dbo.Codes = EecEmpNo AND codCode FROM dbo.Codes = EecLocation where codTable = 'CO_HRMANAGERBYLOCATI' see coding used in export EMSHEDEMXP
