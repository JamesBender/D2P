...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPFLStateEnrolled"','138','(''UA''=''T|'')','EHRTSLFEXPZ0','50','D','10','138',NULL,'State PFL Enrolled',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPFLCovEffDate"','139','(''UD112''=''T|'')','EHRTSLFEXPZ0','50','D','10','139',NULL,'Coverage Effective Date',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPFLCovTermDate"','140','(''UD112''=''T|'')','EHRTSLFEXPZ0','50','D','10','140',NULL,'Coverage Termination Date',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPFLPlaSummary"','141','(''UA''=''T|'')','EHRTSLFEXPZ0','50','D','10','141',NULL,'Plan Summary',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPFLEmpGroupId"','142','(''UA''=''T|'')','EHRTSLFEXPZ0','50','D','10','142',NULL,'Employee Group ID',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPFLEmpClassCode"','143','(''UA''=''T|'')','EHRTSLFEXPZ0','50','D','10','143',NULL,'Employee Class Code',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20200331.txt',NULL,NULL,NULL,',IAGFG,HTEZ2,S9JHB,KFUDU,ZVN7G,A97O7,TJFST,ZVPSX',NULL,NULL,NULL,'Hartford LTD STD FMLA-ONDEMAND','201910159','EMPEXPORT','ONDEMAND',NULL,'EHRTSLFEXP',NULL,NULL,NULL,'201910159','Oct 15 2019  5:41PM','Oct 15 2019  5:41PM','201910151',NULL,'','','201910151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20200331.txt',NULL,'Null','N','IAGFG,HTEZ2,S9JHB,KFUDU,ZVN7G,A97O7,TJFST,ZVPSX',NULL,NULL,NULL,'Hartford LTDSTDFMLA - Fri 5am','201910159','EMPEXPORT','HRTS_SCHED',NULL,'EHRTSLFEXP',NULL,NULL,NULL,'202003279','Oct 15 2019  5:41PM','Oct 15 2019  5:41PM','202003201',NULL,'','','201910151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHRTSLFEXP_20200331.txt',NULL,'','','IAGFG,HTEZ2,S9JHB,KFUDU,ZVN7G,A97O7,TJFST,ZVPSX',NULL,NULL,NULL,'Test Purposes Only','202001179','EMPEXPORT','TEST','Jan 17 2020  9:55AM','EHRTSLFEXP',NULL,NULL,NULL,'202001179','Jan 17 2020 12:00AM','Dec 30 1899 12:00AM','202001101','1210','','','202001101',dbo.fn_GetTimedKey(),NULL,'us3lKiAPP1004',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EHRTSLFEXP_20200331.txt' END WHERE expFormatCode = 'EHRTSLFEXP';
...
CREATE TABLE [dbo].[U_EHRTSLFEXP_drvTbl] (
    ...
    [drvPFLCovEffDate] datetime NULL,
    [drvPFLCovTermDate] datetime NULL,
    [drvPFLPlaSummary] varchar(3) NULL,
    [drvPFLEmpGroupId] varchar(2) NULL,
    [drvPFLEmpClassCode] varchar(1) NULL,
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvNSTCoveragePlanOption = CASE WHEN STD = 'STD' THEN
                            ...
                            END 
        /*
        if EedDedCode = STD or SALCO and EecSalaryOrHourly = H and eecdateoflasthire is 366 days or older than today send 1A2
            if EedDedCode = STD or SALCO and EecSalaryOrHourly = H and eecdateoflasthire is less than 366 days send 1A1

            if EedDedCode = STD or SALCO and EecSalaryOrHourly = S and eecdateoflasthire is 366 days or older than today send 2A2
            if EedDedCode = STD or SALCO and EecSalaryOrHourly = S and eecdateoflasthire is less than 366 days send 2A1
        */
        ,drvNSTPlanSummary = CASE WHEN STD = 'STD' THEN
                                CASE WHEN EecSalaryOrHourly = 'H'  and datediff(day,eecdateoflasthire,getdate()) >= 366 THEN '1A2'
                                 WHEN EecSalaryOrHourly = 'H'  and datediff(day,eecdateoflasthire,getdate()) < 366 THEN '1A1'
                                 WHEN EecSalaryOrHourly = 'S'  and datediff(day,eecdateoflasthire,getdate()) >= 366 THEN '2A2'
                                 WHEN EecSalaryOrHourly = 'S'  and datediff(day,eecdateoflasthire,getdate()) < 366 THEN '2A1'
                                END
                            END
...
*/
        ...
        ---PFL Section Start
        ,drvPFLStateEnrolled =  CASE WHEN STD IS NOT NULL then (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) END
        ,drvPFLCovEffDate = CASE WHEN STD IS NOT NULL then STD_BenefitDate END
        ,drvPFLCovTermDate = CASE WHEN STD IS NOT NULL then STD_BenefitStopDate END
        /*
        if EedDedCode = STD or SALCO and eecdateoflasthire is less than 366 days and EecSalaryOrHourly = S and LocAddressState in eeclocation <> NY send 1J1
        if EedDedCode = STD or SALCO and eecdateoflasthire is more  than 366 days and EecSalaryOrHourly = S and LocAddressState in eeclocation <> NY send 1J2
        if EedDedCode = STD or SALCO and eecdateoflasthire is less than 366 days and EecSalaryOrHourly = H and LocAddressState in eeclocation <> NY send 1J3
        if EedDedCode = STD or SALCO and eecdateoflasthire is more  than 366 days and EecSalaryOrHourly = H and LocAddressState in eeclocation <> NY send 1J4
        if EedDedCode = STD or SALCO and LocAddressState in eeclocation = NY send 2J1
        */
        ,drvPFLPlaSummary = CASE WHEN STD = 'STD' THEN
                                CASE WHEN EecSalaryOrHourly = 'H'  and datediff(day,eecdateoflasthire,getdate()) >= 366 and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '1J4'
                                 WHEN EecSalaryOrHourly = 'H'  and datediff(day,eecdateoflasthire,getdate()) < 366 and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '1J3'
                                 WHEN EecSalaryOrHourly = 'S'  and datediff(day,eecdateoflasthire,getdate()) >= 366 and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '1J2'
                                 WHEN EecSalaryOrHourly = 'S'  and datediff(day,eecdateoflasthire,getdate()) < 366 and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '1J1'
                                END
                            END
                            /*
                            if EedDedCode = STD or SALCO and EecCoID <> A97O7 or TJFST and LocAddressState in eeclocation <> NY send 9
                            if EedDedCode = STD or SALCO and EecCoID = TJFST and LocAddressState in eeclocation <> NY send 1
                            if EedDedCode = STD or SALCO and EecCoID <> A97O7 or TJFST and LocAddressState in eeclocation = NY send 15
                            if EedDedCode = STD or SALCO and EecCoID = A97O7 and LocAddressState in eeclocation = NY send 16
                            if EedDedCode = STD or SALCO and EecCoID = A97O7 and LocAddressState in eeclocation <> NY send 19
                    */
        ,drvPFLEmpGroupId = CASE WHEN STD = 'STD' THEN
                                CASE WHEN EECCOID NOT IN ('A97O7','TJFST')  and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '9'
                                     WHEN EECCOID NOT IN ('A97O7','TJFST')  and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '1'
                                     WHEN EECCOID NOT IN ('A97O7','TJFST')  and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'NY' THEN '15'
                                     WHEN EECCOID  IN ('A97O7')  and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'NY' THEN '16'
                                     WHEN EECCOID  IN ('A97O7')  and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '19'
                                END
                            END
        ,drvPFLEmpClassCode = CASE WHEN STD = 'STD' THEN
                                CASE WHEN EecSalaryOrHourly = 'H'  and datediff(day,eecdateoflasthire,getdate()) >= 366 and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '4'
                                 WHEN EecSalaryOrHourly = 'H'  and datediff(day,eecdateoflasthire,getdate()) < 366 and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '3'
                                 WHEN EecSalaryOrHourly = 'S'  and datediff(day,eecdateoflasthire,getdate()) >= 366 and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) <> 'NY' THEN '2'
                                 WHEN EecSalaryOrHourly = 'S'  and datediff(day,eecdateoflasthire,getdate()) < 366 and (Select Top 1 LocAddressState from Location where LocCode in (EEcLocation)) = 'NY' THEN '1'
                                END
                            END
        ---PFL Section End
