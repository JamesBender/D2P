...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPCRPremium"','21','(''UA''=''T,'')','EPNGCOBRAXZ0','10','D','30','291',NULL,'Premium',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPCRCost"','22','(''UA''=''T,'')','EPNGCOBRAXZ0','10','D','30','302',NULL,'Cost',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPCRFiller"','23','(''UA''=''T,'')','EPNGCOBRAXZ0','3','D','30','313',NULL,'Filler',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPCRHRAElectionAmt"','24','(''UA''=''T,'')','EPNGCOBRAXZ0','10','D','30','317',NULL,'FSA/HRA Election Amount',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPCRPayrollDedAmt"','25','(''UA''=''T,'')','EPNGCOBRAXZ0','10','D','30','328',NULL,'FSA Payroll Deduction Amount',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPCRHRAYTDContributions"','26','(''UA''=''T,'')','EPNGCOBRAXZ0','10','D','30','339',NULL,'FSA/HRA Year to date Contributions',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPCRHRAYTDClaims"','27','(''UA''=''T'')','EPNGCOBRAXZ0','10','D','30','350',NULL,'FSA/HRA Year to date claims paid',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvPCRComments"','28','(''UA''=''T'')','EPNGCOBRAXZ0','50','D','30','361',NULL,'Comment',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EPNGCOBRAX_20200219.txt',NULL,'','',NULL,NULL,NULL,NULL,'P&A Group Cobra Export','201911079','EMPEXPORT','ONDEMAND',NULL,'EPNGCOBRAX',NULL,NULL,NULL,'201911079','Nov  7 2019  1:11PM','Nov  7 2019  1:11PM','201911071',NULL,'','','201911071',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EPNGCOBRAX_20200219.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201911079','EMPEXPORT','SCHEDULED',NULL,'EPNGCOBRAX',NULL,NULL,NULL,'201911079','Nov  7 2019  1:11PM','Nov  7 2019  1:11PM','201911071',NULL,'','','201911071',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EPNGCOBRAX_20200219.txt',NULL,'','','WXL0D,IAGFG',NULL,NULL,NULL,'Test Purposes Only','202003319','EMPEXPORT','TEST','Feb 14 2020 12:34PM','EPNGCOBRAX',NULL,NULL,NULL,'202003319','Mar 31 2020 12:00AM','Dec 30 1899 12:00AM','202002011','46','','','202002011',dbo.fn_GetTimedKey(),NULL,'us3lKiNIS1000',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EPNGCOBRAX_20200219.txt' END WHERE expFormatCode = 'EPNGCOBRAX';
...
CREATE TABLE [dbo].[U_EPNGCOBRAX_drvPcr] (
    ...
    [drvPCRPremium] varchar(1) NOT NULL,
    [drvPCRCost] varchar(1) NOT NULL,
    [drvPCRFiller] varchar(1) NOT NULL,
    [drvPCRHRAElectionAmt] varchar(1) NOT NULL,
    [drvPCRPayrollDedAmt] varchar(1) NOT NULL,
    [drvPCRHRAYTDContributions] varchar(1) NOT NULL,
    [drvPCRHRAYTDClaims] varchar(1) NOT NULL,
    [drvPCRComments] varchar(1) NOT NULL
);
