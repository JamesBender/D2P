...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhPreProcessSQL,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','ESPAWED401','TIAA 401(k) Demo Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','dbo.dsi_sp_Switchbox_v2','4000','S','N','ESPAWED401Z0','N','Jan  1 1900 12:00AM','C','N',NULL,'N');
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ESPAWED401_20191011.txt',NULL,'','','',NULL,NULL,NULL,'TIAA 401(k) Demo Export','201909099','EMPEXPORT','ONDEMAND','Sep 11 2019 11:16AM','ESPAWED401',NULL,NULL,NULL,'201909099','Sep  9 2019  3:18PM','Sep  9 2019  3:18PM','201909091','831','','','201909091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ESPAWED401_20191011.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','201909099','EMPEXPORT','SCHEDULED','Sep 11 2019 11:23AM','ESPAWED401',NULL,NULL,NULL,'201909099','Sep  9 2019  3:18PM','Sep  9 2019  3:18PM','201909091','831','','','201909091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ESPAWED401_20191011.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','201910099','EMPEXPORT','TEST','Oct 11 2019 11:02AM','ESPAWED401',NULL,NULL,NULL,'201910099','Oct  9 2019 12:00AM','Dec 30 1899 12:00AM','201909251','1260','','','201909251',dbo.fn_GetTimedKey(),NULL,'us3lKiWES1032',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_ESPAWED401_20191011.txt' END WHERE expFormatCode = 'ESPAWED401';
...
CREATE TABLE [dbo].[U_ESPAWED401_drvTbl] (
    ...
    [drvPhoneNumber1] varchar(50) NOT NULL,
    ...
    [drvContribSourceAmt1] varchar(4) NOT NULL,
    [drvContribSourceCode2] varchar(1) NOT NULL,
    [drvContribSourceAmt2] varchar(4) NOT NULL,
    [drvContribSourceCode3] varchar(1) NOT NULL,
    [drvContribSourceAmt3] varchar(4) NOT NULL,
    [drvContribSourceCode4] varchar(1) NOT NULL,
    [drvContribSourceAmt4] varchar(4) NOT NULL,
    [drvContribSourceCode5] varchar(1) NOT NULL,
    [drvContribSourceAmt5] varchar(4) NOT NULL,
    [drvContribSourceCode6] varchar(1) NOT NULL,
    [drvContribSourceAmt6] varchar(4) NOT NULL,
    [drvContribSourceCode7] varchar(1) NOT NULL,
    [drvContribSourceAmt7] varchar(4) NOT NULL,
    [drvContribSourceCode8] varchar(1) NOT NULL,
    [drvContribSourceAmt8] varchar(4) NOT NULL,
    ...
    [drvPlanEntryDate] datetime NULL,
    [drvPlanVestedDate] varchar(1) NOT NULL,
...
CREATE TABLE [dbo].[U_ESPAWED401_Trailer] (
    ...
    [drvRemittanceAmount] varchar(4) NOT NULL,
...
Purpose: TIAA 401(k) Demo Export

Revision History
----------------
Update By           Date           Request Num        Desc
Marco Lagrosa     09/19/2019     TekP-2019-8-28-0002  Added additional mapping for employer plan id and recipient plan id
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,drvEmployerEin = ''
        ,drvEmployerPlanId = CASE  WHEN bdmDedCode IN ('TIA3M') THEN '104189'
                                   WHEN bdmDedCode IN ('TIA3F','TIA3P','TIAAS')     THEN '104190'
                                   WHEN bdmDedCode IN ('TIA7P','TIAA7')     THEN '403386'
                                   WHEN bdmDedCode IN ('TIAA5')     THEN '405979'
                             END
        ,drvSubPlanId = 'GOR'
        ,drvOrigVendorPlanId = ''
        ,drvOrigVendorSubPlanId = ''
        ,drvRecipientVendorPlanId = CASE  WHEN bdmDedCode IN ('TIA3M') THEN '104189'
                                   WHEN bdmDedCode IN ('TIA3F','TIA3P','TIAAS')     THEN '104190'
                                   WHEN bdmDedCode IN ('TIA7P','TIAA7')     THEN '403386'
                                   WHEN bdmDedCode IN ('TIAA5')     THEN '405979'
                             END
        ...
        ,drvPhoneNumber1 = ISNULL(EepPhoneHomeNumber,'')
        ...
        ,drvPayrollDate = EecLastRegPayDate
        ,drvContribSourceCode1 = ''
        ,drvContribSourceAmt1 = '0.00'
        ,drvContribSourceCode2 = ''
        ,drvContribSourceAmt2 = '0.00'
        ,drvContribSourceCode3 = ''
        ,drvContribSourceAmt3 = '0.00'
        ,drvContribSourceCode4 = ''
        ,drvContribSourceAmt4 = '0.00'
        ,drvContribSourceCode5 = ''
        ,drvContribSourceAmt5 = '0.00'
        ,drvContribSourceCode6 = ''
        ,drvContribSourceAmt6 = '0.00'
        ,drvContribSourceCode7 = ''
        ,drvContribSourceAmt7 = '0.00'
        ,drvContribSourceCode8 = ''
        ,drvContribSourceAmt8 = '0.00'
        ,drvLoanNumber1 = ''
        ...
        ,drvEmploymentSubType = CASE  WHEN EecEmplStatus IN ('A','S') AND EecDateOfOriginalHire <> EecDateOfLastHire  THEN 'R'
                                                   ELSE 'O' 
                                END
        ,drvEmpoymentStatusDate = CASE WHEN EecEmplStatus = 'T' THEN EecDateOfTermination
    ...
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    --JOIN (Select BdmCoid,BdmEEID,max(bdmBenStartDate) as BenStartDate,max(bdmBenStopdate) as BenStopdate,Max(bdmDedCode) as bdmDedCode from U_dsi_BDM_ESPAWED401  (NOLOCK) group by BdmCoid,BdmEEID) 
    --    as BdmGroups
    JOIN U_dsi_BDM_ESPAWED401
        ON BdmEEID = xEEID 
        AND BdmCoID = xCoID
