...
Client ID:      LUB1000
Date/time:      2022-10-20 12:21:30.013
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    NWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECOBRAPTQB_20221020.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N','BQ2L8,MVNEE,MVN6N,MVN97,MVNCJ,MVN3A',NULL,NULL,NULL,'EBC QB Cobra Export-Sched','202103039','EMPEXPORT','SCH_ECOBRA',NULL,'ECOBRAPTQB',NULL,NULL,NULL,'202210149','Nov 11 2020  8:21AM','Nov 11 2020  8:21AM','202210071',NULL,'','','202103031',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','BQ2L8',NULL,NULL,NULL,'EBC QB Cobra Export-Test','202210141','EMPEXPORT','TEST_XOE','Oct 20 2022 12:00AM','ECOBRAPTQB',NULL,NULL,NULL,'202210141','Oct 14 2022 12:00AM','Dec 30 1899 12:00AM','202210081','65','','','202210081',dbo.fn_GetTimedKey(),NULL,'us3mWaLUB1000',NULL);
...
Marie Waters      10/20/2022    TekP-2020-09-03-0001  Changed codes for QBDEPENDENTPLANINITIAL
...
WHERE edhChangeReason IN ('210') 
 ...
 where BdmDedRowStatus IN ('Data Inserted for 204 Chg reason','Data Inserted for 201 Chg reason','Data Inserted for 210 Chg reason') and bdmBenStopDate is null 
    ...
    --    AND EedValidForExport = 'Y'
     WHERE BdmRunID = 'QB'
      AND BdmIsPQB = 'N'
      AND BdmDedCode NOT IN ('LIFEC','GCICH''GRACC','GCISP','GCISP','FSA','LIFES','GRACC') -- MW added GRACC to excluded codes for Dep
    ; 
    ---------------------------------
...
WHERE BdmIsPQB = 'N' and BdmRunID = 'QB'
    AND BdmDedCode  IN ('MED5', 'MED','MED4', 'MED6S','VIS', 'VISSC','DEN', 'DENSC') -- 10/20/22 MW changed from using NOT IN ('LIFEC','GCICH''GRACC','GCISP','GCISP','FSA','LIFES')
       ; 
    ;
    ---------------------------------
