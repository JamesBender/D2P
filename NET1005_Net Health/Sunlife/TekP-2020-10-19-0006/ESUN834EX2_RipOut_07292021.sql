...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ESUN834EX2_20210729.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Full File Only','202107279','EMPEXPORT','FULLFILE','Jul 27 2021 10:01AM','ESUN834EX2',NULL,NULL,NULL,'202107279','Jul 27 2021 12:00AM','Dec 30 1899 12:00AM','202107131','25761','','','202107131',dbo.fn_GetTimedKey(),NULL,'us3lKiNET1005',NULL);
    ...
    ***************************************************************************************************************/
    ...
    SELECT DISTINCT
        ...
        */
		...
		,drvBenStartDate = BdmBenStartDate
