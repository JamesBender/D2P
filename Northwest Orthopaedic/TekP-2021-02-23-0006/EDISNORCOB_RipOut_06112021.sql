...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EDISNORCOB_20210611.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test NPM/Cobra Export','202106101','EMPEXPORT','TEST','Jun 10 2021  7:55PM','EDISNORCOB',NULL,NULL,NULL,'202106101','Jun 10 2021 12:00AM','Jun 30 2021 12:00AM','202103011','95','','','202103011',dbo.fn_GetTimedKey(),NULL,'us3cPeNOR1052',NULL);
