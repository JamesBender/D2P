...
EDSICCBTST: Discovery Benefits Cobra TEST

FormatCode:     EDSICCBTST
Project:        Discovery Benefits Cobra TEST
Client ID:      NEW1020
Date/time:      2022-03-06 09:51:57.083
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','EDSICCBTST','Discovery Benefits Cobra TEST','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','2000','S','N','E6M7G1000030','N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDSICCBTST','TestPath','V',NULL);
...
EXEC dbo._dsi_usp_ExportRipOut_V7_4 @FormatCode = 'EDSICCBTST', @AllObjects = 'Y', @IsWeb = 'Y'
...
UPDATE dbo.U_dsi_Configuration
 ...
 WHERE rpoFormatCode = 'EDSICCBTST'
