...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"Job Title"','8','(''DA''=''T,'')','EINTFULAC2K0','50','H','01','9',NULL,NULL,NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EINTFULAC2_20210617.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'TEST','202105281','EMPEXPORT','TEST','Jun 17 2021  9:32AM','EINTFULAC2',NULL,NULL,NULL,'202105281','May 28 2021 12:00AM','Dec 30 1899 12:00AM','202105271','757','','','202105271',dbo.fn_GetTimedKey(),NULL,'us3rVaACS1003',NULL);
