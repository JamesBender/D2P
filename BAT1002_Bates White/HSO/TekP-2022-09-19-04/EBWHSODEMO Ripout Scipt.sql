...
Client ID:      USG1000
Date/time:      2022-10-27 10:10:44.937
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EZ24
...
Web Filename:   USG1000_12634_EEHISTORY_EBWHSODEMO_ExportCode_YYYYMMDD_HHMMSS.txt
ExportPath:    
TestPath:      
...
/*08*/ DECLARE @FileName varchar(1000) = 'EBWHSODEMO_20221027.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','202210279','EMPEXPORT','TEST_XOE',NULL,'EBWHSODEMO',NULL,NULL,NULL,'202210279','Oct 27 2022 10:07AM','Oct 27 2022 10:07AM','202210271',NULL,'','','202210271',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
