...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EASC401CEN_20210908.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202109031','EMPEXPORT','TEST','Sep  3 2021  9:56AM','EASC401CEN',NULL,NULL,NULL,'202109031','Sep  3 2021 12:00AM','Aug 28 2021 12:00AM','202108201','457','','','202108201',dbo.fn_GetTimedKey(),NULL,'us3rVaSAL1011',NULL);
