...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EMETPLALIF_20210419.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202104091','EMPEXPORT','TEST','Apr  9 2021  9:12AM','EMETPLALIF',NULL,NULL,NULL,'202104091','Apr  9 2021 12:00AM','Apr  4 2021 12:00AM','202103261','511','','','202103261',dbo.fn_GetTimedKey(),NULL,'us3cPePLA1016',NULL);
...
BEGIN
    ...
    */
    ...
    SELECT DISTINCT
        ...
        ,drvBenefitAmount19 = CASE WHEN CritIllness_Code IS NOT NULL  and BdmRecType = 'EMP' THEN dbo.dsi_fnpadzero((ISNULL((Select max(CritIllness_BdmBenAmount) from U_EMETPLALIF_Consolidated C  where C.bdmeeid = B.bdmeeid),0)),8,0)  END
        ...
        ,drvBenefitAmount20 = CASE WHEN CritIllnessDep_Code IS NOT NULL THEN dbo.dsi_fnpadzero((ISNULL((Select max(cast(CritIllnessDep_BdmBenAmount as money) / 2 )  from U_EMETPLALIF_Consolidated C  where C.bdmeeid = B.bdmeeid),0)),8,0)  END
