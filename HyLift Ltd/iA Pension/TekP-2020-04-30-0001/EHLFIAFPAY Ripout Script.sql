...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"Plan Information"','9','(''DA''=''Q,'')','EHLFIAFPAYZ0','50','H','01','9',NULL,'Plan Information',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"Plan Information"','10','(''DA''=''Q,'')','EHLFIAFPAYZ0','50','H','01','10',NULL,'Plan Information',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHLFIAFPAY_20200625.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'iA Financial Group Payroll Exp','202006039','EMPEXPORT','ONDEMAND','Jun 16 2020 12:00AM','EHLFIAFPAY',NULL,NULL,NULL,'202006039','Jun  3 2020 12:00AM','Dec 30 1899 12:00AM','202006031',NULL,'','','202006031',dbo.fn_GetTimedKey(),NULL,'MLAGROSA',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHLFIAFPAY_20200625.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','202006039','EMPEXPORT','SCH_IAPH','Jun 16 2020 12:00AM','EHLFIAFPAY',NULL,NULL,NULL,'202006039','Jun  3 2020 12:00AM','Dec 30 1899 12:00AM','202006031','1','','','202006031',dbo.fn_GetTimedKey(),NULL,'MLAGROSA',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EHLFIAFPAY_20200625.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','202006059','EMPEXPORT','TEST','Jun 23 2020  8:12AM','EHLFIAFPAY',NULL,NULL,NULL,'202006059','Jun  5 2020 12:00AM','Dec 30 1899 12:00AM','202006051','4632','','','202006051',dbo.fn_GetTimedKey(),NULL,'LKING01',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EHLFIAFPAY_20200625.txt' END WHERE expFormatCode = 'EHLFIAFPAY';
...
CREATE TABLE [dbo].[U_EHLFIAFPAY_drvTbl] (
    ...
    [drvContributiontype] varchar(35) NULL,
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,PdhRegularContrib    = SUM(CASE WHEN PdhDedCode IN ('PNUN2','PENSE','PENSN','RRSPV') THEN PdhEECurAmt ELSE 0.00 END)
