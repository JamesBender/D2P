...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EBAPCQBEXP_20210617.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Basic Pacific QB File Ex-Test','202106169','EMPEXPORT','TEST_XOE','Jun 16 2021  6:05PM','EBAPCQBEXP',NULL,NULL,NULL,'202106169','Jun 16 2021 12:00AM','Dec 30 1899 12:00AM','202105031','67','','','202105031',dbo.fn_GetTimedKey(),NULL,'us3cPeTYL1001',NULL);
