...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ESPMWESTDS_20210622.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'SPM Benefits Export-Test','202106189','EMPEXPORT','TEST_XOE','Jun 21 2021 12:00AM','ESPMWESTDS',NULL,NULL,NULL,'202106189','Jun 18 2021 12:00AM','Dec 30 1899 12:00AM','202106181','17710','','','202106181',dbo.fn_GetTimedKey(),NULL,'CPETITTI16',NULL);
...
CREATE TABLE [dbo].[U_ESPMWESTDS_spmplanTbl] (
	...
	drvSubSort varchar(10) NOT NULL
);
...
BEGIN
    ...
    ON EecEEID = drvEEID AND EecCOID = drvEEID
