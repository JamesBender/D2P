...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ESPAWED401_20190913.txt',NULL,'','','',NULL,NULL,NULL,'TIAA 401(k) Demo Export','201909099','EMPEXPORT','ONDEMAND','Sep 11 2019 11:16AM','ESPAWED401',NULL,NULL,NULL,'201909099','Sep  9 2019  3:18PM','Sep  9 2019  3:18PM','201909091','831','','','201909091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ESPAWED401_20190913.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','201909099','EMPEXPORT','SCHEDULED','Sep 11 2019 11:23AM','ESPAWED401',NULL,NULL,NULL,'201909099','Sep  9 2019  3:18PM','Sep  9 2019  3:18PM','201909091','831','','','201909091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ESPAWED401_20190913.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','201909129','EMPEXPORT','TEST','Sep 13 2019 10:32AM','ESPAWED401',NULL,NULL,NULL,'201909129','Sep 12 2019 12:00AM','Dec 30 1899 12:00AM','201908291','723','','','201908291',dbo.fn_GetTimedKey(),NULL,'us3lKiWES1032',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_ESPAWED401_20190913.txt' END WHERE expFormatCode = 'ESPAWED401';
...
BEGIN
    ...
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    JOIN (Select BdmCoid,BdmEEID,max(bdmBenStartDate) as BenStartDate,max(bdmBenStopdate) as BenStopdate from U_dsi_BDM_ESPAWED401 (NOLOCK) group by BdmCoid,BdmEEID) 
        as BdmGroups
        ON BdmEEID = xEEID 
        AND BdmCoID = xCoID
    ;
