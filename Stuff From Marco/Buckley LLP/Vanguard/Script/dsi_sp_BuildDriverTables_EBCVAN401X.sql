...
GO
IF OBJECT_ID('dsi_sp_AfterCollect_EBCVAN401X') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_AfterCollect_EBCVAN401X];
GO
...
GO
IF OBJECT_ID('U_dsi_BDM_EBCVAN401X') IS NOT NULL DROP TABLE [dbo].[U_dsi_BDM_EBCVAN401X];
GO
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EBCVAN401X_20200721.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Vanguard 401k Export','202001249','EMPEXPORT','ONDEMAND',NULL,'EBCVAN401X',NULL,NULL,NULL,'202001249','Jan 24 2020 11:28AM','Jan 24 2020 11:28AM','202001241',NULL,'','','202001241',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EBCVAN401X_20200721.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','202001249','EMPEXPORT','BCX_SCHED',NULL,'EBCVAN401X',NULL,NULL,NULL,'202001249','Jan 24 2020 11:28AM','Jan 24 2020 11:28AM','202001241',NULL,'','','202001241',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EBCVAN401X_20200721.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202006301','EMPEXPORT','TEST','Jul 21 2020  1:07PM','EBCVAN401X',NULL,NULL,NULL,'202006301','Jun 30 2020 12:00AM','Jun 30 2020 12:00AM','202006301','512','eecPayGroup','SEMI','202006301',dbo.fn_GetTimedKey(),NULL,'us3mLaBUC1006',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EBCVAN401X_20200721.txt' END WHERE expFormatCode = 'EBCVAN401X';
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EBCVAN401X','NoEmpty','V','Y');
...
IF OBJECT_ID('U_dsi_BDM_EBCVAN401X') IS NULL
CREATE TABLE [dbo].[U_dsi_BDM_EBCVAN401X] (
...
CREATE TABLE [dbo].[U_EBCVAN401X_drvContBTbl] (
    ...
    [drvContCSource1] varchar(3) NULL,
    [drvContCTotalAmt1] varchar(31) NULL,
    [drvContCSource2] varchar(3) NULL,
...
CREATE TABLE [dbo].[U_EBCVAN401X_drvPartTbl] (
    ...
    [drvPartGender] varchar(1) NOT NULL,
...
GO
CREATE PROCEDURE [dbo].[dsi_sp_AfterCollect_EBCVAN401X] 
AS 
SET NOCOUNT ON; 
/************************************************************ 
Client: Buckley LLP
...
Purpose: Delete File table if there is no contributons
...
BEGIN 
    ...
    SET @RecordCount = (Select count(*) from dbo.U_EBCVAN401X_drvContBTbl where drvContCSource1 is not null and drvContCSource2 is not null); 
    IF @RecordCount <= 0 
        Delete from dbo.U_EBCVAN401X_File;
...
BEGIN
    ...
    WHERE adrType IN (1,2,5,6) -- Insert/Update; remove this to include Deletes and Viewed
      AND adrProcessedDateTime BETWEEN @StartDate -14  AND @EndDate;
    ...
    Delete FROM dbo.U_EBCVAN401X_EEList
    WHERE xEEID IN (
        select eeceeid from dbo.empcomp 
        where eecdedgroupCode = 'PB' or EecEEType IN ('TMP', 'PB', 'SUM' , 'INT') 
            except
        select eeceeid from dbo.empcomp Join dbo.U_EBCVAN401X_PDedHist 
            on eeceeid = pdheeid
        where eecdedgroupCode = 'PB' or EecEEType IN ('TMP', 'PB', 'SUM' , 'INT')  );
    --==========================================
    -- Build Driver Tables
    ...
    SELECT DISTINCT
        ...
        ,drvPartGender =  CASE WHEN Eepgender ='M' THEN '1'
    ...
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    /*LEFT JOIN dbo.U_EBCVAN401X_PEarHist WITH (NOLOCK)
        on Peheeid = xeeid
    */
    ;
    
   -- Delete from dbo.U_EBCVAN401X_drvPartTbl where drveeid not in ( select pdheeid from dbo.U_EBCVAN401X_PDedHist) and drvPartTerminationDate is not null
    ...
    SELECT DISTINCT
        ...
        ,drvContFund1 = ''
        ,drvContSource1 = CASE WHEN isnull(PdhSource1,0) <> 0 THEN 'AAA' END 
        ,drvContAmt1 =  CASE WHEN isnull(PdhSource1,0) >  0 THEN CONVERT(VARCHAR,dbo.dsi_fnPadZero(PdhSource1*100,9,0))  + '+'  END 
        ,drvContAmt1Raw =  CASE WHEN PdhSource1 is not null THEN PdhSource1  END 
        ,drvContFiller2 = ''
        ,drvContSource2 =  CASE WHEN isnull(PdhSource2,0) <> 0 THEN 'NRB' END 
        ,drvContAmt2 =  CASE WHEN PdhSource2 > 0 THEN CONVERT(VARCHAR,dbo.dsi_fnPadZero(PdhSource2*100,9,0)) + '+' END 
        ,drvContAmt2Raw =  CASE WHEN PdhSource2 is not null THEN PdhSource2 END 
        ,drvContFiller3 = ''
    INTO dbo.U_EBCVAN401X_drvContATbl
    FROM dbo.U_EBCVAN401X_EEList WITH (NOLOCK)
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
     JOIN dbo.EmpComp WITH (NOLOCK)
    ...
    Delete from dbo.U_EBCVAN401X_drvContATbl where drvContSource1 is null and drvContSource2 is null;
    ---------------------------------
    ...
    SELECT DISTINCT
        ...
        ,drvContCFiller1 = ''
        ,drvContCSource1 = case when (Select sum(drvContAmt1Raw)  from U_EBCVAN401X_drvContATbl) is not null then 'AAA' END
        ,drvContCTotalAmt1 =  (Select CONVERT(VARCHAR,dbo.dsi_fnPadZero(sum(drvContAmt1Raw)*100,9,0))  from U_EBCVAN401X_drvContATbl) + '+'
        ,drvContCSource2 = case when (Select sum(drvContAmt2Raw)  from U_EBCVAN401X_drvContATbl) is not null then 'NRB' END
    ...
    SELECT DISTINCT
        ...
        ,drvLoanFiller1 = ''
        ,drvLoanNumber1 = ''
        ,drvLoanPayrollEndDate1 = Case when PdhSource6 > 0 Then @EndDate END
        ,drvLoanPaymentAmt1 = CASE WHEN PdhSource6 > 0 THEN CONVERT(VARCHAR,dbo.dsi_fnPadZero(PdhSource6*100,9,0))  + '+' END 
        ,drvLoanPaymentAmt1Raw =PdhSource6
        ,drvLoanNumber2 = ''
        ,drvLoanPayrollEndDate2 = Case when PdhSource7 > 0 Then @EndDate END
        ,drvLoanPaymentAmt2 = CASE WHEN PdhSource7 > 0 THEN  CONVERT(VARCHAR,dbo.dsi_fnPadZero(PdhSource7*100,9,0))  + '+' END 
   ...
   JOIN dbo.EmpPers WITH (NOLOCK)
    ...
    SELECT DISTINCT
        ...
        ,drvCompCompensationAmt =  CONVERT(VARCHAR,dbo.dsi_fnPadZero(eecAnnSalary*100,13,0))  + '+'
        ,drvCompBlank = ''
        ,drvCompFiller2 = ''
 ...
 JOIN dbo.EmpPers WITH (NOLOCK)
    ...
    SELECT DISTINCT
        ...
        ,drvEMRecordCount =  CONVERT(VARCHAR,dbo.dsi_fnPadZero((Select (
                            (Select count(*) from dbo.U_EBCVAN401X_drvEmailTbl) +
                            (Select count(*) from dbo.U_EBCVAN401X_drvCompTbl) +
                            (Select count(*) from dbo.U_EBCVAN401X_drvLoanTbl) +
                            (Select count(*) from dbo.U_EBCVAN401X_drvContBTbl) +
                            (Select count(*) from dbo.U_EBCVAN401X_drvContATbl) + 
                            (Select count(*) from dbo.U_EBCVAN401X_drvPartTbl) )),9,0))
                ,drvEMFiller2 = ''
