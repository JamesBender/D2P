...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ECOBREGLQB_20200429.txt',NULL,'Null','N','STH8G,QG52B',NULL,NULL,NULL,'Discovery Cobra QB Wkly File','201710039','EMPEXPORT','ECOBREGLQB','Sep 26 2017  5:37PM','ECOBREGLQB',NULL,NULL,NULL,'202002259','Oct  3 2017 12:00AM','Dec 30 1899 12:00AM','202002111','8','','','201709121',dbo.fn_GetTimedKey(),NULL,'ULTI_WPREGLT',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ECOBREGLQB_20200429.txt',NULL,'','',',STH8G,QG52B',NULL,NULL,NULL,'Discovery Cobra QB Test File','202004289','EMPEXPORT','TEST','Apr 28 2020  9:48AM','ECOBREGLQB',NULL,NULL,NULL,'202004289','Apr 28 2020 12:00AM','Dec 30 1899 12:00AM','202003011','578','','','202003011',dbo.fn_GetTimedKey(),NULL,'us3lKiREG1002',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_ECOBREGLQB_20200429.txt' END WHERE expFormatCode = 'ECOBREGLQB';
...
Changes:
04/28/2020    Marco Lagrosa     SF 09999999              Updates to add/change deductions
...
SELECT * FROM dbo.U_dsi_InterfaceActivityLog WHERE FormatCode = 'ECOBREGLQB' ORDER BY RunID DESC;
...
join (select  a.dbneeid as dbneeidx,dbndeprecid as dbndeprecidx,max(a.dbnBenStopDate) as dbnBenStopDate,max(dbnDepBplanTVID) as dbnDepBplanTVIDX,deddedtype as deddedtypeX
   from dbo.U_dsi_bdm_DepDeductions a WHERE a.DbnFormatCode = 'ECOBREGLQB'
   AND a.DbnValidForExport = 'Y'
