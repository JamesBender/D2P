...
Client ID:      BRI1011
Date/time:      2023-02-24 13:16:14.110
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
GO
IF OBJECT_ID('U_dsi_BDM_EUHCFINPRO') IS NOT NULL DROP TABLE [dbo].[U_dsi_BDM_EUHCFINPRO];
GO
...
/*08*/ DECLARE @FileName varchar(1000) = 'EUHCFINPRO_20230224.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','202301099','EMPEXPORT','OEACTIVE',NULL,'EUHCFINPRO',NULL,NULL,NULL,'202301099','May  3 2021  1:27PM','May  3 2021  1:27PM','202301091',NULL,'','','202301091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','202301099','EMPEXPORT','OEPASSIVE',NULL,'EUHCFINPRO',NULL,NULL,NULL,'202301099','May  3 2021  1:27PM','May  3 2021  1:27PM','202301091',NULL,'','','202301091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'UHC Financial Protection','202301099','EMPEXPORT','ONDEM_XOE',NULL,'EUHCFINPRO',NULL,NULL,NULL,'202301099','May  3 2021  1:27PM','May  3 2021  1:27PM','202301091',NULL,'','','202301091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'UHC Financial Protection-Sched','202301099','EMPEXPORT','SCH_EUHCFI',NULL,'EUHCFINPRO',NULL,NULL,NULL,'202301099','May  3 2021  1:27PM','May  3 2021  1:27PM','202301091',NULL,'','','202301091',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','',',HWJHQ',NULL,NULL,NULL,'UHC Financial Protection-Test','202302239','EMPEXPORT','TEST_XOE','Feb 23 2023  3:52PM','EUHCFINPRO',NULL,NULL,NULL,'202302239','Feb 23 2023 12:00AM','Dec 30 1899 12:00AM','202302091','648','','','202302091',dbo.fn_GetTimedKey(),NULL,'us3cBeBRI1011',NULL);
...
-----------
-- Create table U_dsi_BDM_EUHCFINPRO
-----------

IF OBJECT_ID('U_dsi_BDM_EUHCFINPRO') IS NULL
CREATE TABLE [dbo].[U_dsi_BDM_EUHCFINPRO] (
...
1/09/2023 By MW
--- Totally changed the logic on how the age was calculated for the coverageamt

02/24/2023 By MW
---  Updated the code for Spouse LIFES 
...
BEGIN
    ...
    SELECT
        ...
        ,@FileMinCovDate  = CAST('01/01/2023' AS DATETIME)
    ...
    SELECT DISTINCT
        ...
        ,drvPlanCode = CASE
                            ...
                            WHEN RTRIM(LTRIM(EecDedGroupCode)) IN ('EXEC', 'FT') AND EedBenAmt = 2500 AND RTRIM(LTRIM(EedDedCode)) = 'CIC2' THEN 'LE000079'
                            WHEN RTRIM(LTRIM(EecDedGroupCode)) IN ('EXEC', 'FT') AND EedBenAmt = 5000 AND RTRIM(LTRIM(EedDedCode)) = 'CIC5' THEN 'LE000251'
                            WHEN RTRIM(LTRIM(EecDedGroupCode)) IN ('EXEC', 'FT') AND EedBenAmt = 2500 AND RTRIM(LTRIM(EedDedCode)) = 'CIC5' THEN 'LE000079'
        ...
        ,drvTierCode = CASE
                            ...
                            WHEN RTRIM(LTRIM(EedDedCode)) IN ('GTLEX','ADDCX','LIFEE','CIE20','STDER','LTDEX','LTD','GTLEE','ADDCE','CIE10') THEN 'C'
                            WHEN RTRIM(LTRIM(EedDedCode)) IN ('ACCL','ACC','HSPL','HSPH') AND EedBenOption = 'EEC' THEN 'D'
                            WHEN RTRIM(LTRIM(EedDedCode)) IN ('LIFES','CIS10','CIS5') THEN 'F'
                            WHEN RTRIM(LTRIM(EedDedCode)) IN ('LIFEC','CIC5','CIC2') THEN 'G'
                        END
        ,drvMemberOrigEffDate = ISNULL(CONVERT(VARCHAR, (CASE WHEN EedDedCode IN ('GTLEX', 'ADDCX', 'CIE20', 'CIS10', 'CIS5','ACC', 'HSPL', 'HSPH', 'STDER', 'LTDEX', 'GTLEE', 'ADDCE', 'LIFEE', 'LIFES', 'LIFEC', 'LTD', 'ACCL','CIC2','CIC5') THEN
        ...
        ,drvSubscriberClassID = CASE WHEN EecDedGroupCode = 'EXEC' THEN '2001'
                                 ...
                                 END
        ,drvSubClassEffDate = dbo.dsi_fnGetMinMaxDates('MAX', EecDateOfLastHire,@FileMinCovDate) 
        --dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,'11/1/2022') 
        ...
        ,drvSalaryEffDate = CASE WHEN EedDedCode IN ('STDER','LTD','LTDEX','CIS5','GTLEX','ADDCX','LIFEE','LIFES','CIE20','CIE10','CIS10','GTLEE','ADDCE','ADDCX','LIFEC','CIC2','CIC5','ACCL','ACC','HSPL','HSPH') THEN CONVERT(VARCHAR, dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate), 112)
        ...
        ,drvCoverageAmount =        FORMAT(
                                        CASE WHEN EedDedCode IN ('GTLEX','ADDCX') AND EecDedGroupCode = 'EXEC' THEN                                                                        --Seperated the LTD, LTDEX and STDER out CB/LK 20230106
                                            CASE WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) <= 65 THEN
                                                CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))/.50) > 500000 THEN 500000 ELSE Ceiling(((EecAnnSalary + isnull(EecUDField20,0.00))*2.0)/1000.0)*1000  END -- Added X2 to the expression CB/LK 20230106
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) BETWEEN 65 AND 69 THEN
                                                CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))/.50) > 500000 THEN 500000 *.65 ELSE Ceiling((((EecAnnSalary + isnull(EecUDField20,0.00))*2.0)*.65)/1000.0)*1000  END -- If under 500K, X2 then X.65 for Age reduction
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) BETWEEN 70 AND 74 THEN
                                                CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))/.50) > 500000 THEN 500000 *.40 ELSE Ceiling((((EecAnnSalary + isnull(EecUDField20,0.00))*2.0)*.40)/1000.0)*1000  END
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) >= 75 THEN
                                                CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))/.50) > 500000 THEN 500000 *.25 ELSE Ceiling((((EecAnnSalary + isnull(EecUDField20,0.00))*2.0)*.25)/1000.0)*1000 END                                        
                                            END        
                                            
                                         WHEN EedDedCode IN ('STDER','LTDEX') AND EecDedGroupCode = 'EXEC' THEN (EecAnnSalary + isnull(EecUDField20,0.00))     
                                         --Seperated the LTD, LTDEX and STDER out CB/LK 20230106

                                         WHEN EedDedCode IN ('GTLEE','ADDCE') AND EecDedGroupCode = 'FT' THEN                                                                            
                                            CASE WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) <= 65 THEN
                                                CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5) > 500000 THEN 500000 ELSE Ceiling(((EecAnnSalary + isnull(EecUDField20,0.00))*1.5)/1000.0)*1000 END  -- Added X1.5 to the expression CB/LK 20230106
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) BETWEEN 65 AND 69 THEN
                                                CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5) > 500000 THEN 500000 *.65 ELSE Ceiling((((EecAnnSalary + isnull(EecUDField20,0.00))*1.5)*.65)/1000.0)*1000 END
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) BETWEEN 70 AND 74 THEN
                                                CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5) > 500000 THEN 500000 *.40 ELSE Ceiling((((EecAnnSalary + isnull(EecUDField20,0.00))*1.5)*.40)/1000.0)*1000 END
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) >= 75 THEN
                                                CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5) > 500000 THEN 500000 *.25 ELSE Ceiling((((EecAnnSalary + isnull(EecUDField20,0.00))*1.5)*.25)/1000.0)*1000 END                                        
                                            END        
                                    
                                         WHEN EedDedCode IN ('STDER','LTD') AND EecDedGroupCode = 'FT' THEN (EecAnnSalary + isnull(EecUDField20,0.00))                                     --Seperated the LTD, LTDEX and STDER out CB/LK 20230106
                                            
                                    
                                        WHEN EedDedCode IN ('CIE20','CIS10') THEN EedBenAmt
                                        WHEN EedDedCode IN ('LIFEE','LIFES') THEN
                                            CASE WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1)< 65 THEN EedBenAmt
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) BETWEEN 65 AND 69 THEN EedBenAmt*.65
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) BETWEEN 70 AND 74 THEN EedBenAmt*.40
                                            WHEN DateDiff(yy, EepDateOfBirth, DateAdd(dd, + 0, DateAdd(yy, DateDiff(yy, 0, GetDate()), 0))+-1) >= 75 THEN EedBenAmt*.25
                                            END
                                        END, '#0.000')
                                    
        
        
        ---CASE WHEN EedDedCode IN ('LIFEC','CIC2','CIC5','ACCL','ACC','HSPL','HSPH') THEN '' -- Removed STDER, LTDEX and LTD
                                --ELSE
                                    --FORMAT(
                                    --    CASE WHEN EedDedCode IN ('GTLEX','ADDCX') AND EecDedGroupCode = 'EXEC' THEN                                                                        --Seperated the LTD, LTDEX and STDER out CB/LK 20230106
                                    --        CASE WHEN DATEDIFF(HOUR ,EepDateOfBirth, GETDATE())/8766 <= 65 THEN
                                    --            CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))/.50) > 500000 THEN 500000 ELSE (EecAnnSalary + isnull(EecUDField20,0.00))/.50 END -- Added X2 to the expression CB/LK 20230106
                                    --        WHEN DATEDIFF(HOUR ,EepDateOfBirth, GETDATE())/8766 BETWEEN 65 AND 69 THEN
                                    --            CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))/.50) > 500000 THEN 500000 *.65 ELSE ((EecAnnSalary + isnull(EecUDField20,0.00))*2.0)*.65 END -- If under 500K, X2 then X.65 for Age reduction
                                    --        WHEN DATEDIFF(HOUR ,EepDateOfBirth, GETDATE())/8766 BETWEEN 70 AND 74 THEN
                                    --            CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))/.50) > 500000 THEN 500000 *.40 ELSE ((EecAnnSalary + isnull(EecUDField20,0.00))*2.0)*.40 END
                                    --        WHEN DATEDIFF(HOUR ,EepDateOfBirth, GETDATE())/8766 >= 75 THEN
                                    --            CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))/.50) > 500000 THEN 500000 *.25 ELSE ((EecAnnSalary + isnull(EecUDField20,0.00))*2.0)*.25 END                                        
                                    --        END        
                                            
                                    --     WHEN EedDedCode IN ('STDER','LTDEX') AND EecDedGroupCode = 'EXEC' THEN (EecAnnSalary + isnull(EecUDField20,0.00))                             --Seperated the LTD, LTDEX and STDER out CB/LK 20230106

                                 --        WHEN EedDedCode IN ('GTLEE','ADDCE') AND EecDedGroupCode = 'FT' THEN                                                                            
                                    --        CASE WHEN DATEDIFF(HOUR ,EepDateOfBirth, GETDATE())/8766 <= 65 THEN
                                    --            CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5) > 500000 THEN 500000 ELSE (EecAnnSalary + isnull(EecUDField20,0.00))*1.5 END  -- Added X1.5 to the expression CB/LK 20230106
                                    --        WHEN DATEDIFF(HOUR ,EepDateOfBirth, GETDATE())/8766 BETWEEN 65 AND 69 THEN
                                    --            CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5) > 500000 THEN 500000 *.65 ELSE ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5)*.65 END
                                    --        WHEN DATEDIFF(HOUR ,EepDateOfBirth, GETDATE())/8766 BETWEEN 70 AND 74 THEN
                                    --            CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5) > 500000 THEN 500000 *.40 ELSE ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5)*.40 END
                                    --        WHEN DATEDIFF(HOUR ,EepDateOfBirth, GETDATE())/8766 >= 75 THEN
                                    --            CASE WHEN ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5) > 500000 THEN 500000 *.25 ELSE ((EecAnnSalary + isnull(EecUDField20,0.00))*1.5)*.25 END                                        
                                    --        END        
  ...
  --                                  WHEN EedDedCode IN ('LIFEE', 'LIFES', 'CIE20', 'CIS10') THEN CAST(ROUND(EedBenAmt, -3) AS VARCHAR) END, '.00', ''), 6)
   ...
   --                             WHEN EedDedCode IN ('GTLEX','ADDCX','LIFEE','LIFES','CIE20','CIS10','GTLEE','ADDCE') AND EecDedGroupCode = 'FT' THEN CAST((EecAnnSalary + EecUDField20) * 1.5 AS VARCHAR) END
        ...
        ,drvCoverageAmountEffDate =    CASE WHEN EedDedCode IN ('STDER', 'LTDEX' , 'LTD','CIS5','GTLEX','ADDCX','LIFEE','LIFES','CIE20','CIE10','CIS10','GTLEE','ADDCE','ADDCX','LIFEC','CIC2','CIC5','ACCL','ACC','HSPL','HSPH') THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate) 
                                    END
 ...
 --       ON pdhEEID = xEEID
    ...
    SELECT DISTINCT
        ...
        ,drvRelationship = CASE 
                                    WHEN ConRelationship IN ('DP','SP','SPS') THEN 'SP'
        ...
        ,drvBenStartDate = CASE WHEN DbnDedCode IN ('CIS5','LIFES','CIS10','ACCL','ACC','HSPL','HSPH') THEN dbo.dsi_fnGetMinMaxDates('MAX', DbnBenStartDate,@FileMinCovDate)
                                WHEN eedDedCode IN ('LIFES')and ISNULL(EedDepRecID, '') <> '' and DbnDedCode = '' THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate)--MW changed to pull life as other codes were not in join
                                --WHEN eedDedCode IN ('CIS5','LIFES','CIS10')and ISNULL(EedDepRecID, '') <> '' and DbnDedCode = '' THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate) --MW c
                                    END
                                    --dbo.dsi_fnGetMinMaxDates('MAX', DbnBenStartDate,@FileMinCovDate)
        ,drvPlanCode
        --CASE
  ...
  --                      END
        ,drvTierCode = CASE
                            ...
                            WHEN RTRIM(LTRIM(DbnDedCode)) IN ('CIS5','CIS10') THEN 'F'
                            WHEN RTRIM(LTRIM(eedDedCode)) = 'LIFES' THEN 'F'
                            WHEN RTRIM(LTRIM(DbnDedCode)) IN ('LIFEC','CIC5') THEN 'G'
                        END
        ,drvMemberOrigEffDate = ISNULL(CONVERT(VARCHAR, (CASE WHEN DbnDedCode IN ('CIS5','LIFES','CIS10','ACCL','ACC','HSPL','HSPH') THEN dbo.dsi_fnGetMinMaxDates('MAX', DbnBenStartDate,@FileMinCovDate) 
                                                              WHEN eedDedCode IN ('LIFES')and ISNULL(EedDepRecID, '') <> '' and DbnDedCode = '' THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate)--MW changed to pull life as other codes were not in join
                                                        --WHEN eedDedCode IN ('CIS5','LIFES','CIS10')and ISNULL(EedDepRecID, '') <> '' and DbnDedCode = '' THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate) --MW c
                                    END), 112), '')
        ...
        ,drvSubClassEffDate = CASE WHEN DbnDedCode IN ('CIS5','LIFES','CIS10','ACCL','ACC','HSPL','HSPH') THEN dbo.dsi_fnGetMinMaxDates('MAX', DbnBenStartDate,@FileMinCovDate)
                                   WHEN eedDedCode IN ('LIFES')and ISNULL(EedDepRecID, '') <> '' and DbnDedCode = '' THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate)--MW changed to pull life as other codes were not in join
                                        --WHEN eedDedCode IN ('CIS5','LIFES','CIS10')and ISNULL(EedDepRecID, '') <> '' and DbnDedCode = '' THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate) --MW c
                                    END
                            --dbo.dsi_fnGetMinMaxDates('MAX', DbnBenStartDate,@FileMinCovDate)
  ...
  --                              WHEN DbnDedCode IN ('GTLEX','ADDCX','LIFEE','LIFES','CIE20','CIS10','GTLEE','ADDCE') AND EecDedGroupCode = 'FT' THEN CAST((EecAnnSalary + EecUDField20) * 1.5 AS VARCHAR) END
        ...
        ,drvCoverageAmountEffDate = CASE WHEN DbnDedCode IN ('CIS5','LIFES','CIS10','ACCL','ACC','HSPL','HSPH') THEN dbo.dsi_fnGetMinMaxDates('MAX', DbnBenStartDate,@FileMinCovDate)
                                        WHEN eedDedCode IN ('LIFES')and ISNULL(EedDepRecID, '') <> '' and DbnDedCode = '' THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate)--MW changed to pull life as other codes were not in join
                                        --WHEN eedDedCode IN ('CIS5','LIFES','CIS10')and ISNULL(EedDepRecID, '') <> '' and DbnDedCode = '' THEN dbo.dsi_fnGetMinMaxDates('MAX', EedBenStartDate,@FileMinCovDate) --MW changed to pull life as other codes were not in join
                                    END
    ...
    JOIN dbo.U_dsi_BDM_DepDeductions WITH (NOLOCK)
        ...
        --AND drvDedCode = DbnDedCode -- MW commented out this join 2/24/23
        AND DbnFormatCode = 'EUHCFINPRO'--@FormatCode 
        AND DbnValidForExport = 'Y'
        AND DbnBenStatus = 'A'
        AND DbnRelationship IN ('SP', 'DP','SPS')
        AND DbnDedCode IN ('CIS5','CIS10','ACCL','ACC','HSPL','HSPH') -- MW added this to Join 2/24/23
    Left JOIN dbo.EmpDed WITH (NOLOCK)
        on eedeeid = drvEEID
        --and eeddedcode = DbnDedCode
        --and EedDepRecID = DbnDepRecID
...
--    AND 
  ...
  --                              WHEN DbnDedCode IN ('GTLEX','ADDCX','LIFEE','LIFES','CIE20','CIS10','GTLEE','ADDCE') AND EecDedGroupCode = 'FT' THEN CAST((EecAnnSalary + EecUDField20) * 1.5 AS VARCHAR) END
        --CASE WHEN DbnDedCode IN ('GTLEX','ADDCX','LIFEE','LIFES','CIE20','CIS10','GTLEE','ADDCE') THEN DedEEBenAmt END
        ,drvCoverageAmountEffDate =     CASE WHEN DbnDedCode IN ('LTD','STDER','LTDEX','CIS5','GTLEX','ADDCX','LIFEE','LIFES','CIE20','CIE10','CIS10','GTLEE','ADDCE','ADDCX','LIFEC','CIC2','CIC5','ACCL','ACC','HSPL','HSPH') THEN dbo.dsi_fnGetMinMaxDates('MAX', DbnBenStartDate,@FileMinCovDate) 
                                        END
        --CASE WHEN DbnDedCode IN ('GTLEX','ADDCX','LIFEE','LIFES','CIE20','CIS10','GTLEE','ADDCE','HSPH','STDER','LIFEC','LTDEX','HSPL','ACCL','ACC','LTD') THEN dbo.dsi_fnGetMinMaxDates('MAX', DbnBenStartDate, @FileMinCovDate) END
        ,drvALTMemberIndicator = RTRIM(LTRIM(ConSSN))+'00'
        ,drvDedCode
