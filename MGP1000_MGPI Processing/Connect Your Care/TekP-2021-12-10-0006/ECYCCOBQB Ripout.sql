...
Client ID:      MGP1000
Date/time:      2022-02-10 05:47:37.670
Ripout version: 7.4
Export Type:    Web
Status:         Production
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'ECYCCOBQB_20220210.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'Null','N',',M0UP1,M0U4Y',NULL,NULL,NULL,'CYC Cobra QB-Scheduled','202004229','EMPEXPORT','SCH_ECYCCO',NULL,'ECYCCOBQB',NULL,NULL,NULL,'202202049','Jan 13 2016  8:53AM','Jan 13 2016  8:53AM','202201281',NULL,'','','202001011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
EXEC dbo._dsi_usp_ExportRipOut_v7_4 @FormatCode = 'ECYCCOBQB', @AllObjects = 'Y', @IsWeb = 'Y';
...
BEGIN
    ...
    --==========================================
        ...
        SELECT DISTINCT
            ...
            ,drvAgedOut        = iif(BdmRelationship ='CHL' AND BdmDateOfBirth <= DATEADD(Y, -26, @EndDate) AND BdmCobraReason IN ('201','LEVNT3'), 'Y','N') 
