...
/*01*/ INSERT INTO dbo.CustomTemplates (Engine,EngineCode) SELECT Engine = AdhEngine, EngineCode = AdhFormatCode FROM dbo.AscDefH WITH (NOLOCK) WHERE AdhFormatCode = 'EFUALOK401' AND AdhEngine = 'EMPEXPORT' AND NOT EXISTS(SELECT 1 FROM dbo.CustomTemplates WHERE EngineCode = AdhFormatCode AND Engine = AdhEngine); /* Insert field into CustomTemplates table */
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EFUALOK401_20201231.txt';
/*09*/ DECLARE @FILEPATH varchar(1000) = '\\' + @COUNTRY + '.saas\' + @SERVER + '\' + @ENVIRONMENT + '\Downloads\V10\Exports\' + @COCODE + '\EmployeeHistoryExport\';
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment Export','202012319','EMPEXPORT','OEACTIVE',NULL,'EFUALOK401',NULL,NULL,NULL,'202012319','Jun 17 2020 10:31AM','Jun 17 2020 10:31AM','202011011',NULL,'','','202011011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment Export','202012319','EMPEXPORT','OEPASSIVE',NULL,'EFUALOK401',NULL,NULL,NULL,'202012319','Jun 17 2020 10:31AM','Jun 17 2020 10:31AM','202011011',NULL,'','','202011011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'ForUsAll 401K Export','202012319','EMPEXPORT','ONDEMAND',NULL,'EFUALOK401',NULL,NULL,NULL,'202012319','Jun 17 2020 10:31AM','Jun 17 2020 10:31AM','202011011',NULL,'','','202011011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','202012319','EMPEXPORT','SCH_FUALO',NULL,'EFUALOK401',NULL,NULL,NULL,'202012319','Jun 17 2020 10:31AM','Jun 17 2020 10:31AM','202011011',NULL,'','','202011011',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','LRVCT',NULL,NULL,NULL,'Test Purposes Only','202012319','EMPEXPORT','TEST','Dec 30 2020  8:42AM','EFUALOK401',NULL,NULL,NULL,'202012319','May  5 2020 12:00AM','Dec 30 1899 12:00AM','202011011','129','eecPayGroup','HOURLY,SALARY','202011011',dbo.fn_GetTimedKey(),NULL,'us3lKiLOO1000',NULL);
...
/*01*/ UPDATE dbo.U_dsi_Configuration SET CfgValue = NULL WHERE FormatCode = 'EFUALOK401' AND CfgName LIKE '%Path' AND CfgType = 'V'; /* Set paths to NULL for Web Exports */
/*02*/ UPDATE dbo.U_dsi_Configuration SET CfgValue = 'Y'  WHERE FormatCode = 'EFUALOK401' AND CfgName = 'UseFileName'; /* Set UseFileName to 'Y' for Web Exports */
IF OBJECT_ID('U_EFUALOK401_SavePath') IS NOT NULL DROP TABLE [dbo].[U_EFUALOK401_SavePath];
GO
...
CREATE TABLE [dbo].[U_EFUALOK401_PEarHist] (
    ...
    [PehCurAmtPlanEarn] numeric NULL,
    [PehCurAmtPlanEarnYTD] numeric NULL
);
...
BEGIN
    ...
    --INSERT INTO dbo.U_dsi_BDM_Configuration VALUES(@FormatCode,'EndDateTime',@EndDate+30);
    ...
    WHERE adrType IN (1,2,5,6) -- Insert/Update; remove this to include Deletes and Viewed
      ...
      AND adrProcessedDateTime < @EndDate + 30;
    ...
    SELECT DISTINCT
        ...
        ,PehCurAmtPlanEarn  = SUM(CASE WHEN   PehPerControl BETWEEN @StartPerControl AND @EndPerControl and PehEarnCode  not in ('GTL', 'HSAEE', 'HSARF', 'HSRSC', 'PTOO', 'SEV') THEN PehCurAmt ELSE 0.00 END)
        ,PehCurAmtPlanEarnYTD  = SUM(CASE WHEN  PehEarnCode  not in ('GTL', 'HSAEE', 'HSARF', 'HSRSC', 'PTOO', 'SEV') THEN PehCurAmt ELSE 0.00 END)
    ...
    SELECT DISTINCT
        ...
        ,drvPlanEarnings =  CAST(CONVERT(DECIMAL(10,2),CASE WHEN PdhDedCalcBasisAmt401k <> 0 and PdhDedCalcBasisAmtRoth <> 0 THEN CASE WHEN PdhDedCalcBasisAmt401k <> 0 THEN PdhDedCalcBasisAmt401k ELSE  PdhDedCalcBasisAmtRoth END  ELSE PdhDedCalcBasisAmt END ) as varchar(12)) 
    ...
    on PayrollDate.PgpPayGroup =  eecPayGroup
     JOIN dbo.Company  WITH (NOLOCK)
        on cmpcoid = xcoid
    --LEFT JOIN dbo.U_EFUALOK401_Audit WITH (NOLOCK)
    --    ON audKey1Value = xEEID
    --    AND audKey2Value = xCOID
    --    and AudRowNo = 1
    --WHERE audNewValue IS NOT NULL AND (audNewValue <> 'T' OR (audNewValue = 'T'AND audDateTime BETWEEN @StartDate and DATEADD(DAY, 30, @EndDate)))
    WHERE EecEmplStatus <> 'T' OR (EecEmplStatus = 'T' AND EecDateOfTermination BETWEEN @StartDate AND DATEADD(DAY, 60, @EndDate))
    ;


    Update dbo.U_EFUALOK401_drvTbl set drvPlanEarnings  = CONVERT(DECIMAL(10,2),PehCurAmtPlanEarn) from dbo.U_EFUALOK401_drvTbl 
    JOIN U_EFUALOK401_PEarHist on peheeid = drveeid
    where CAST(ISNULL(drvPlanEarnings,0) as money) <=0 


    Update dbo.U_EFUALOK401_drvTbl set drvYTDPlanEarnings  =  CONVERT(DECIMAL(10,2),PehCurAmtPlanEarnYTD) from dbo.U_EFUALOK401_drvTbl 
    JOIN U_EFUALOK401_PEarHist on peheeid = drveeid
    where CAST(ISNULL(drvYTDPlanEarnings,0) as money) <=0 


    Update dbo.U_EFUALOK401_drvTbl set drvPlanEarnings =  CAST(drvPlanEarnings as decimal(10,2)) ,drvYTDPlanEarnings = CAST(drvYTDPlanEarnings as decimal(10,2))
...
--Update Dates
UPDATE dbo.AscExp
    SET expLastStartPerControl = '202011011'
       ,expStartPerControl     = '202011011'
