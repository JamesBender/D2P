...
Client ID:      SPE1014
Date/time:      2022-02-26 14:35:30.677
Ripout version: 7.4
Export Type:    Web
Status:         Testing
Environment:    EWP
...
/*08*/ DECLARE @FileName varchar(1000) = 'EEMPOW401K_20220226.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FilePath) + LTRIM(RTRIM(@FileName)),NULL,'','','ZLXEN,ZLXFP,ZLX6Z,ZLXAY,6PJW1,6PK5J,ZLXGT,ZLXBY,ZLX92,ZLXCU,ZLXDO,ZLX9U,ZLXLO,ZLXJX,ZLXHP,7RV7K',NULL,NULL,NULL,'Test Purposes Only','202103109','EMPEXPORT','TEST','Mar 12 2021  8:50AM','EEMPOW401K',NULL,NULL,NULL,'202103109','Mar 10 2021 12:00AM','Dec 30 1899 12:00AM','202103101','2971','','','202103101',dbo.fn_GetTimedKey(),NULL,'us3lKiSPE1014A',NULL);
...
--Update Dates
UPDATE dbo.AscExp
    SET expLastStartPerControl = '202102102'
       ,expStartPerControl     = '202102102'
       ,expLastEndPerControl   = '202102102'
       ,expEndPerControl       = '202102102'
WHERE expFormatCode = 'EEMPOW401K' and expExportcode ='TEST';
--202102251    202102251
**********************************************************************************/
GO
