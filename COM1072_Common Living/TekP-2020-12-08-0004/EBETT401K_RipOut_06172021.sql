...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EBETT401K_20210617.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','BI1HN,H3M21,NZJU7,H3MBW',NULL,NULL,NULL,'Betterment 401K Export-Test','202106189','EMPEXPORT','TEST_XOE','Jun 17 2021  8:14PM','EBETT401K',NULL,NULL,NULL,'202106189','Jun 18 2021 12:00AM','Dec 30 1899 12:00AM','202106181','127','eecPayGroup','HRWKLY','202106181',dbo.fn_GetTimedKey(),NULL,'us3lKiCOM1072',NULL);
...
CREATE TABLE [dbo].[U_EBETT401K_drvTbl] (
	...
	drvPdhEECurAmt varchar(30) NULL
);
