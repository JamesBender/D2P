...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvYTDHoursPaid"','40','(''UNT0''=''T,'')','EVMAKCS401Z0','12','D','10','40',NULL,'Plan YTD Hours Paid',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EVMAKCS401_20190923.txt',NULL,'','','',NULL,NULL,NULL,'Scheduled Session','201907319','EMPEXPORT','SCHEDULED','Aug  6 2019 11:09AM','EVMAKCS401',NULL,NULL,NULL,'201907319','Jul 31 2019  2:45PM','Jul 31 2019  2:45PM','201907311','120','','','201907311',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EVMAKCS401_20190923.txt',NULL,'','','V4D2R',NULL,NULL,NULL,'Charles Schwab 401(k) Export','201907319','EMPEXPORT','ONDEMAND','Aug 15 2019 12:31PM','EVMAKCS401',NULL,NULL,NULL,'201907319','Jul 31 2019 12:00AM','Dec 30 1899 12:00AM','201907311','178','','','201907311',dbo.fn_GetTimedKey(),NULL,'us3mLaVAL1007',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EVMAKCS401_20190923.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','201909139','EMPEXPORT','TEST','Sep 23 2019 11:06AM','EVMAKCS401',NULL,NULL,NULL,'201909139','Sep 13 2019 12:00AM','Dec 30 1899 12:00AM','201909131','165','','','201909131',dbo.fn_GetTimedKey(),NULL,'us3lKiVAL1007',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EVMAKCS401_20190923.txt' END WHERE expFormatCode = 'EVMAKCS401';
...
CREATE TABLE [dbo].[U_EVMAKCS401_drvTbl] (
    ...
    [drvPayPeriodTotalCompensation] numeric NULL,
...
GO
        ...
        **********************************************************************************/
        BEGIN
            ...
            -- Delete EE list with emptype of TES
            Delete from U_EVMAKCS401_EEList
            WHERE xCoID = dbo.dsi_BDM_fn_GetCurrentCOID(xEEID)
            ...
            SELECT DISTINCT
                ...
                ,drvLastName = dbo.fn_AddDoubleQuotes(LEFT(UPPER(EepNameLast + ', ' + EepNameFirst + ' '  + LEFT(ISNULL(EepNameMiddle,' '),1) ),32))
                ,drv401K = Source401k
                ,drvRoth = SourceRoth
                ...
                ,drvYTDHoursPaid = Round(PehInclInDefCompHrsYTD,0)
                ,drvPayFrequency = 'S'
        ...
        --else if EecFullTimeOrPartTime is P, send P
            ...
            Delete from U_EVMAKCS401_drvTbl where  drvPayrollStatus IN ('T','D','R') and 
            drvYTDHoursPaid is null and 
            drvDateOfTermination between  DATEADD(MM, - 12, @EndDate) and @EndDate
