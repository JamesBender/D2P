...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"EE_CLASS_01_PRODUCT"','48','(''DA''=''T,'')','ETRUSTKWPMZ0','54','H','01','48',NULL,'EE_CLASS_01_PRODUCT',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"EE_CLASS_01_PRODUCT"','52','(''DA''=''T,'')','ETRUSTKWPMZ0','54','H','01','52',NULL,'EE_CLASS_01_PRODUCT',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"EE_PAYROLL_CYCLE"','40','(''UA''=''T,'')','ETRUSTKWPMZ0','54','D','10','40',NULL,'EE_PAYROLL_CYCLE',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"EE_CLASS_01_PRODUCT"','48','(''UA''=''T,'')','ETRUSTKWPMZ0','54','D','10','48',NULL,'EE_CLASS_01_PRODUCT',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"EE_CLASS_01_PRODUCT"','52','(''UA''=''T,'')','ETRUSTKWPMZ0','54','D','10','52',NULL,'EE_CLASS_01_PRODUCT',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','',NULL,NULL,NULL,NULL,'Trustmark Critical Illne-Test','202107079','EMPEXPORT','TEST_XOE',NULL,'ETRUSTKWPM',NULL,NULL,NULL,'202107079','Jul  7 2021  1:01PM','Jul  7 2021  1:01PM','202107071',NULL,'','','202107071',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
...
CREATE TABLE [dbo].[U_ETRUSTKWPM_drvTbl] (
    ...
    [EE_ADDRESS_LINE_1] varchar(255) NULL,
    [EE_ADDRESS_LINE_2] varchar(255) NULL,
    ...
    [PRIMARY_BENEFIT_AMT] varchar(30) NULL,
    [SPOUSE_BENEFIT_AMT] varchar(30) NULL,
    [CHILD_BENEFIT_AMT] varchar(30) NULL,
    ...
    [TOTAL_NUM_DEPENDENTS] varchar(1) NOT NULL,
    [DEP1_FIRST_NAME] varchar(1) NOT NULL,
    [DEP1_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP1_LAST_NAME] varchar(1) NOT NULL,
    ...
    [DEP1_RELATION] varchar(1) NOT NULL,
    [DEP1_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP1_CITY] varchar(255) NULL,
    [DEP1_STATE] varchar(255) NULL,
    [DEP1_ZIP] varchar(1) NOT NULL,
    [DEP1_COUNTRY] char(3) NULL,
    [DEP1_ADDRESS_EFF_DATE] varchar(1) NOT NULL,
    [DEP1_ADDRESS_SOURCE] varchar(1) NOT NULL,
    [DEP2_FIRST_NAME] varchar(1) NOT NULL,
    [DEP2_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP2_LAST_NAME] varchar(1) NOT NULL,
    ...
    [DEP2_RELATION] varchar(1) NOT NULL,
    [DEP2_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP2_CITY] varchar(255) NULL,
    [DEP2_STATE] varchar(255) NULL,
    [DEP2_ZIP] varchar(1) NOT NULL,
    [DEP2_COUNTRY] char(3) NULL,
    [DEP2_ADDRESS_EFF_DATE] varchar(1) NOT NULL,
    [DEP2_ADDRESS_SOURCE] varchar(1) NOT NULL,
    [DEP3_FIRST_NAME] varchar(1) NOT NULL,
    [DEP3_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP3_LAST_NAME] varchar(1) NOT NULL,
    ...
    [DEP3_RELATION] varchar(1) NOT NULL,
    [DEP3_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP3_CITY] varchar(255) NULL,
    [DEP3_STATE] varchar(255) NULL,
    [DEP3_ZIP] varchar(1) NOT NULL,
    [DEP3_COUNTRY] char(3) NULL,
    [DEP3_ADDRESS_EFF_DATE] varchar(1) NOT NULL,
    [DEP3_ADDRESS_SOURCE] varchar(1) NOT NULL,
    [DEP4_FIRST_NAME] varchar(1) NOT NULL,
    [DEP4_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP4_LAST_NAME] varchar(1) NOT NULL,
    ...
    [DEP4_RELATION] varchar(1) NOT NULL,
    [DEP4_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP4_CITY] varchar(255) NULL,
    [DEP4_STATE] varchar(255) NULL,
    [DEP4_ZIP] varchar(1) NOT NULL,
    [DEP4_COUNTRY] char(3) NULL,
    [DEP4_ADDRESS_EFF_DATE] varchar(1) NOT NULL,
    [DEP4_ADDRESS_SOURCE] varchar(1) NOT NULL,
    [DEP5_FIRST_NAME] varchar(1) NOT NULL,
    [DEP5_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP5_LAST_NAME] varchar(1) NOT NULL,
    ...
    [DEP5_RELATION] varchar(1) NOT NULL,
    [DEP5_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP5_CITY] varchar(255) NULL,
    [DEP5_STATE] varchar(255) NULL,
    [DEP5_ZIP] varchar(1) NOT NULL,
    [DEP5_COUNTRY] char(3) NULL,
    [DEP5_ADDRESS_EFF_DATE] varchar(1) NOT NULL,
    [DEP5_ADDRESS_SOURCE] varchar(1) NOT NULL,
    [DEP6_FIRST_NAME] varchar(1) NOT NULL,
    [DEP6_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP6_LAST_NAME] varchar(1) NOT NULL,
    [DEP6_UNIQUE_ID] varchar(1) NOT NULL,
    [DEP6_SSN] varchar(1) NOT NULL,
    [DEP6_DOB] varchar(1) NOT NULL,
    [DEP6_DOD] varchar(1) NOT NULL,
    [DEP6_PREFIX] varchar(1) NOT NULL,
    [DEP6_SUFFIX] varchar(1) NOT NULL,
    [DEP6_GENDER] varchar(1) NOT NULL,
    ...
    [DEP6_RELATION] varchar(1) NOT NULL,
    [DEP6_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP7_FIRST_NAME] varchar(1) NOT NULL,
    [DEP7_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP7_LAST_NAME] varchar(1) NOT NULL,
    [DEP7_UNIQUE_ID] varchar(1) NOT NULL,
    [DEP7_SSN] varchar(1) NOT NULL,
    [DEP7_DOB] varchar(1) NOT NULL,
    [DEP7_DOD] varchar(1) NOT NULL,
    [DEP7_PREFIX] varchar(1) NOT NULL,
    [DEP7_SUFFIX] varchar(1) NOT NULL,
    [DEP7_GENDER] varchar(1) NOT NULL,
    ...
    [DEP7_RELATION] varchar(1) NOT NULL,
    [DEP7_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP8_FIRST_NAME] varchar(1) NOT NULL,
    [DEP8_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP8_LAST_NAME] varchar(1) NOT NULL,
    [DEP8_UNIQUE_ID] varchar(1) NOT NULL,
    [DEP8_SSN] varchar(1) NOT NULL,
    [DEP8_DOB] varchar(1) NOT NULL,
    [DEP8_DOD] varchar(1) NOT NULL,
    [DEP8_PREFIX] varchar(1) NOT NULL,
    [DEP8_SUFFIX] varchar(1) NOT NULL,
    [DEP8_GENDER] varchar(1) NOT NULL,
    ...
    [DEP8_RELATION] varchar(1) NOT NULL,
    [DEP8_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP9_FIRST_NAME] varchar(1) NOT NULL,
    [DEP9_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP9_LAST_NAME] varchar(1) NOT NULL,
    [DEP9_UNIQUE_ID] varchar(1) NOT NULL,
    [DEP9_SSN] varchar(1) NOT NULL,
    [DEP9_DOB] varchar(1) NOT NULL,
    [DEP9_DOD] varchar(1) NOT NULL,
    [DEP9_PREFIX] varchar(1) NOT NULL,
    [DEP9_SUFFIX] varchar(1) NOT NULL,
    [DEP9_GENDER] varchar(1) NOT NULL,
    ...
    [DEP9_RELATION] varchar(1) NOT NULL,
    [DEP9_DISABLED_INDIC] varchar(1) NOT NULL,
    ...
    [DEP10_FIRST_NAME] varchar(1) NOT NULL,
    [DEP10_MIDDLE_NAME] varchar(1) NOT NULL,
    [DEP10_LAST_NAME] varchar(1) NOT NULL,
    [DEP10_UNIQUE_ID] varchar(1) NOT NULL,
    [DEP10_SSN] varchar(1) NOT NULL,
    [DEP10_DOB] varchar(1) NOT NULL,
    [DEP10_DOD] varchar(1) NOT NULL,
    [DEP10_PREFIX] varchar(1) NOT NULL,
    [DEP10_SUFFIX] varchar(1) NOT NULL,
    [DEP10_GENDER] varchar(1) NOT NULL,
    ...
    [DEP10_RELATION] varchar(1) NOT NULL,
    [DEP10_DISABLED_INDIC] varchar(1) NOT NULL,
...
;
    ...
    SELECT DISTINCT
        ...
        ,EE_WORK_PHONE = ''
        ,EE_WORK_EXT = ''
        ,EE_EMAIL = EepAddressEMail
        ,EE_WORK_EMAIL = EepAddressEMail  -- Check work email field and see mapping logic.
        ,EE_ADDRESS_TYPE = 'C'
        ,EE_ADDRESS_LINE_1 = EepAddressLine1
        ,EE_ADDRESS_LINE_2 = EepAddressLine2
        ,EE_ADDRESS_LINE_3 = ''
        ...
        ,TIER = CASE WHEN t.is_crile = '1' and t.is_crill = '1' and t.is_crils = '1' then 'Family'
        ...
        ,SPOUSE_SMOKER_STATUS = CASE WHEN ConRelationship = 'SPS' OR ConRelationship = 'DP' AND ConIsSmoker = 'Y' THEN 'Y' ELSE 'N' END
        ,EOI_BYPASS = 'Y'
        ,PRIMARY_HEIGHT_FT = ''
        ,PRIMARY_HEIGHT_IN = ''
        ,PRIMARY_WEIGHT = ''
        ...
        ON DbnEEID = xEEID AND DbnCOID = xCOID AND dbnFormatCode = @FormatCode
