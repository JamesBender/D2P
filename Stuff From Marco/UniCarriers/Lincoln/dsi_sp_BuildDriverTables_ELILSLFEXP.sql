...
GO
IF OBJECT_ID('U_ELILSLFEXP_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_ELILSLFEXP_AuditFields];
GO
IF OBJECT_ID('U_ELILSLFEXP_Audit') IS NOT NULL DROP TABLE [dbo].[U_ELILSLFEXP_Audit];
GO
...
INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhPreProcessSQL,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) VALUES ('N','C','Y','0','','','N','','N','','','EMPEXPORT','CDE','ELILSLFEXP','Lincoln STD LTD FMLA Export','N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','dbo.dsi_sp_Switchbox_v2','3000','S','N','ELILSLFEXPZ0','N','Jan  1 1900 12:00AM','C','N',NULL,'N');
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"0.0       "','79','(''DA''=''F'')','ELILSLFEXPZ0','10','D','10','79',NULL,'Bonus Amount',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"      0.00"','80','(''DA''=''F'')','ELILSLFEXPZ0','10','D','10','80',NULL,'Commission Amount',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"      0.00"','82','(''DA''=''F'')','ELILSLFEXPZ0','10','D','10','82',NULL,'Year to Date Wages',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"0 "','83','(''UA''=''F'')','ELILSLFEXPZ0','2','D','10','83',NULL,'W4 Withholding Allowance',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"0   "','95','(''DA''=''F'')','ELILSLFEXPZ0','4','D','10','95',NULL,'Service Months',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"   0.0"','100','(''DA''=''F'')','ELILSLFEXPZ0','6','D','10','100',NULL,'Hours Last 12 Months',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"   0.0"','101','(''DA''=''F'')','ELILSLFEXPZ0','10','D','10','101',NULL,'Hours Worked Per Week',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"      1.0"','102','(''DA''=''F'')','ELILSLFEXPZ0','9','D','10','102',NULL,'Hours Worked Per Day',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"drvBenEffectiveDate3"','127','(''UA''=''F'')','ELILSLFEXPZ0','8','D','10','127',NULL,'Product 3 - Coverage Effective Date',NULL,NULL);
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELILSLFEXP_20200723.txt',NULL,'','',NULL,NULL,NULL,NULL,'Lincoln STD LTD FMLA Export','201910259','EMPEXPORT','ONDEMAND',NULL,'ELILSLFEXP',NULL,NULL,NULL,'201910259','Oct 25 2019 12:35PM','Oct 25 2019 12:35PM','201910251',NULL,'','','201910251',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELILSLFEXP_20200723.txt',NULL,NULL,NULL,',EKBYF,WXL0D,WCO05,IAGFG,IW55O',NULL,NULL,NULL,'Lincoln Dis_FMLA-Fri 6:10pm','201911219','EMPEXPORT','SCHEDULED',NULL,'ELILSLFEXP',NULL,NULL,NULL,'202007179','Oct 25 2019 12:35PM','Oct 25 2019 12:35PM','202007101',NULL,'','','201910251',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELILSLFEXP_20200723.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'OEACTIVE','201910259','EMPEXPORT','OEACTIVE','Nov 14 2019 12:00AM','ELILSLFEXP',NULL,NULL,NULL,'201910259','Oct 25 2019 12:00AM','Dec 30 1899 12:00AM','201910251',NULL,'','','201910251',dbo.fn_GetTimedKey(),NULL,'us3mLaNIS1000',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELILSLFEXP_20200723.txt',NULL,'','','',NULL,NULL,NULL,'OEPASSIVE','202001319','EMPEXPORT','OEPASSIVE','Nov 18 2019  5:25PM','ELILSLFEXP',NULL,NULL,NULL,'202001319','Jan 31 2020 12:00AM','Dec 30 1899 12:00AM','202001011','471','','','202001011',dbo.fn_GetTimedKey(),NULL,'us3lKiNIS1000',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_ELILSLFEXP_20200723.txt',NULL,'','','',NULL,NULL,NULL,'Test Purposes Only','202005019','EMPEXPORT','TEST','May  1 2020  3:44PM','ELILSLFEXP',NULL,NULL,NULL,'202005019','May  1 2020 12:00AM','Dec 30 1899 12:00AM','202004171','447','','','202004171',dbo.fn_GetTimedKey(),NULL,'us3lKiNIS1000',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_ELILSLFEXP_20200723.txt' END WHERE expFormatCode = 'ELILSLFEXP';
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('ELILSLFEXP','BCPParms','V','-c -t -r ""');
...
IF OBJECT_ID('U_ELILSLFEXP_Audit') IS NULL
CREATE TABLE [dbo].[U_ELILSLFEXP_Audit] (
...
IF OBJECT_ID('U_ELILSLFEXP_AuditFields') IS NULL
CREATE TABLE [dbo].[U_ELILSLFEXP_AuditFields] (
...
CREATE TABLE [dbo].[U_ELILSLFEXP_drvTbl] (
    ...
    [drvOccupationDesc] varchar(25) NULL,
    ...
    [drvCustomDateElement1] varchar(80) NULL,
    ...
    [drvProductBenefitType1] varchar(5) NOT NULL,
    [drvCoverageStatus1] varchar(1) NOT NULL,
    [drvEffectiveDate1] datetime NULL,
    [drvPremiumContribution1] varchar(5) NOT NULL,
    [drvBenefitLevel1] varchar(4) NOT NULL,
    ...
    [drvRecordDelimiter2] char(1) NULL
);
...
CREATE TABLE [dbo].[U_ELILSLFEXP_Headerl] (
    ...
    [drvRecordDelimiter] char(1) NULL
);
...
CREATE TABLE [dbo].[U_ELILSLFEXP_Trailer] (
    ...
    [drvDateTrailer] datetime NOT NULL,
    [drvNumberOfDetRecTrailer] varchar(7) NULL,
    [drvFillerTrailer] varchar(1) NOT NULL,
    [drvDelimiterTrailer] char(1) NULL
);
GO
...
BEGIN
    ...
    --Only include REG type employee
    ...
    FROM dbo.U_dsi_bdm_ELILSLFEXP D
    JOIN dbo.U_dsi_bdm_ELILSLFEXP E
    ...
    --=====================================================
    UPDATE dbo.U_dsi_bdm_ELILSLFEXP
        SET BdmUSGField2 = EedEmpDedTVID
    FROM dbo.U_dsi_bdm_ELILSLFEXP
    ...
    SELECT DISTINCT
        ...
        ,PehCurHrsYTD           = SUM(CASE  WHEN PehPerControl >=  @Last52WeekPerControl and PehPerControl <= @StartPerControl THEN PehCurHrs ELSE 0.00 END)
    ...
    IF OBJECT_ID('U_ELILSLFEXP_AuditFields','U') IS NOT NULL
        DROP TABLE dbo.U_ELILSLFEXP_AuditFields;
    CREATE TABLE dbo.U_ELILSLFEXP_AuditFields (aTableName varchar(128),aFieldName varchar(128));
    
    -- Insert tables/fields to be audited
    INSERT INTO dbo.U_ELILSLFEXP_AuditFields VALUES ('empcomp','eecemplstatus');    
    
    -- Create audit table
    IF OBJECT_ID('U_ELILSLFEXP_Audit','U') IS NOT NULL
        DROP TABLE dbo.U_ELILSLFEXP_Audit;
    SELECT
    ...
    INTO dbo.U_ELILSLFEXP_Audit
    FROM (SELECT *
          FROM dbo.AuditRecords WITH (NOLOCK)
          WHERE adrTableName IN (SELECT aTableName FROM dbo.U_ELILSLFEXP_AuditFields WITH (NOLOCK))) ADR
    JOIN (SELECT *
          FROM dbo.AuditFields WITH (NOLOCK)
          WHERE adfFieldName IN (SELECT aFieldName FROM dbo.U_ELILSLFEXP_AuditFields WITH (NOLOCK))) ADF
    ...
    -- Create Index
    CREATE CLUSTERED INDEX CDX_U_ELILSLFEXP_Audit ON dbo.U_ELILSLFEXP_Audit (audKey1Value, audKey2Value);
    ...
    SELECT DISTINCT
        ...
        ,drvOccupationDesc = (select top 1 JbcDesc from JobCode where JbcJobCode =  eecJobCode)
        ...
        ,drvSalaryMode = CASE WHEN EecSalaryOrHourly = 'S' THEN '6'
                              ...
                              ELSE SPACE(1)
                         END
        ,drvCustomDateElement1 = CASE WHEN CRITI in ('CRITI') and CRITI_Amount = 10000 THEN  'CRITIL10K'
                                      WHEN CRITI in ('CRITI') and CRITI_Amount= 20000 THEN  'CRITIL20K'
                                      WHEN CRITI in ('CRITI') and CRITI_Amount = 1000 THEN  'CRITIL1K'
                                      WHEN CRITI in ('CRITI') and CRITI_Amount = 2500 THEN  'CRITIL2K'
                                      WHEN CRITI in ('CRITI') and CRITI_Amount = 7500 THEN  'CRITIL7K'
                                      WHEN CRITI in ('CRITI') and CRITI_Amount = 5000 THEN  'CRITIL5K'
                                      WHEN CRITI in ('CRITI') and CRITI_Amount = 15000 THEN  'CRITIL15K'
                        

                                      ELSE SPACE(80)
                                 END
        ,drvCustomDateElement2 = CASE WHEN CRITI in ('CRITI')  THEN ISNULL(CRITI_BenefitStartDate,SPACE(80)) END
        ,drvCustomDateElement3 = CASE WHEN ACCID in ('ACCID')  THEN 'ACCIDCOV' ELSE '' END
        ,drvCustomDateElement4 =  CASE WHEN ACCID in ('ACCID')  THEN ISNULL(ACCID_BenefitStartDate,NULL) ELSE NULL END
        ...
        ,drvProductCode1 = CASE WHEN STD in ('STD') THEN 'STD  ' END
        ,drvProductBenefitType1 =  CASE  WHEN (select top  1 cmpCompanyCode from company (NOLOCK) where cmpCoid = xCoID) =  'NFCNA' and STD in ('STD') THEN 'STD04'
                                        WHEN (select top  1 cmpCompanyCode from company (NOLOCK) where cmpCoid = xCoID) = 'CEH'   and STD in ('STD')  THEN 'STD02'
                                        ELSE '     '
                                     END
        ,drvCoverageStatus1 = CASE WHEN STD in ('STD')  and STD_EedBenStatus = 'T' THEN 'T' 
                                   WHEN STD in ('STD')  and LTD_EedBenStatus = 'A' THEN 'A'
                                   Else ' '
                                END
        ,drvEffectiveDate1 = CASE  WHEN (select top  1 cmpCompanyCode from company (NOLOCK) where cmpCoid = xCoID) =  'NFCNA' and STD in ('STD') THEN eecdateoflasthire
                                        WHEN (select top  1 cmpCompanyCode from company (NOLOCK) where cmpCoid = xCoID) = 'CEH '   and STD in ('STD')  THEN LTD_BenefitStartDate
                                        ELSE SPACE(8)
                                     END
        ,drvPremiumContribution1 =  CASE  WHEN (select top  1 cmpCompanyCode from company (NOLOCK) where cmpCoid = xCoID) =  'NFCNA' and STD in ('STD') THEN '000'
                                        WHEN (select top  1 cmpCompanyCode from company (NOLOCK) where cmpCoid = xCoID) = 'CEH '   and STD in ('STD')  THEN '100'
                                        ELSE '0    '
                                     END
        ,drvBenefitLevel1 =  CASE  WHEN (select top  1 cmpCompanyCode from company (NOLOCK) where cmpCoid = xCoID) =  'NFCNA' and  STD in ('STD') THEN '070 '
                                   WHEN (select top  1 cmpCompanyCode from company (NOLOCK) where cmpCoid = xCoID) = 'CEH ' and STD in ('STD')  THEN '060'
                                   ELSE '0  '
                              END
        ,drvProductCode2 = CASE WHEN LTD in ('LTD') THEN 'LTD' ELSE '     ' END
        ,drvProductBenefitType2 = CASE  WHEN LTD in ('LTD') THEN 'LTD01' ELSE '     ' END
        ,drvCoverageStatus2 = CASE  WHEN LTD in ('LTD') and LTD_EedBenStatus = 'T' THEN 'T'  
                                   WHEN LTD in ('LTD') and LTD_EedBenStatus = 'A' THEN 'A'  
                                  END
        ,drvEffectiveDate2 =  CASE WHEN LTD in ('LTD') THEN LTD_BenefitStartDate  END
        ,drvPremiumContribution2 = CASE WHEN LTD in ('LTD') THEN '000' ELSe '0'  END
        ,drvBenefitLevel2 = CASE WHEN LTD in ('LTD') THEN '060' ELSe '0'  END
        ,drvProductBenefitCode3 = CASE WHEN EecEEType = 'REG' THEN  'LEAVE' ELSE '     ' END
        ,drvProductBenefitType3 =  CASE WHEN EecEEType = 'REG' THEN 'FMLA ' ELSe '     ' END

        ,drvProductBenCovStatus =  CASE WHEN EecEEType = 'REG' THEN  'A' ELSe ' ' END
        ,drvBenEffectiveDate3 = CASE WHEN EecEEType = 'REG' THEN  convert(varchar(10), cast(EecDateOfOriginalHire as datetime), 112)  ELSE '        ' END
        ...
        ,drvServiceMode = 'M'
        ,drvServiceAmount = DATEDIFF(month,EecDateOfSeniority,GETDATE()) 
        ...
        ,drvUnionIndicator = ''
        ,drvExemptEmployeeIndicator = CASE WHEN (select top 1 EjhFLSACategory from EmpHJob where ejhcoid in (xCoid) and ejheeid in (xeeid) order by ejhDateTimeCreated desc) = 'E' THEN 'Y' ELSE  'N' END
        ,drvDateCreated = GETDATE()
        ,drvFiller10 = ''
        ,drvRecordDelimiter2 = CHAR(10)
    ...
    JOIN dbo.EmpComp WITH (NOLOCK)
        ...
        and (eecemplstatus <> 'T' OR (eecemplstatus= 'T' and eectermreason <>'TRO' 
                                      and EXISTS(select 1 from dbo.U_ELILSLFEXP_Audit where  audKey1Value = xEEID AND audKey2Value = xcoid and audfieldname = 'eecemplstatus' and audNewValue = 'T')))
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    LEFT JOIN (Select   EedEEID,EedCoid
            ,LTD = MAX((CASE WHEN EEdDedCode in ('93','343') then 'LTD' END))
            ,STD = MAX((CASE WHEN EEdDedCode in ('94','342') then 'STD' END))
            ,CRITI = MAX((CASE WHEN EEdDedCode in ('345', '287', '288' ,'289') then 'CRITI' END))
            ,ACCID
             = MAX((CASE WHEN EEdDedCode in ('286','346') then 'ACCID' END))
            ,LTD_BenefitStartDate = MAX((CASE WHEN EEdDedCode in ('93','343') then  EedBenStartDate END))
            ,STD_BenefitStartDate = MAX((CASE WHEN EEdDedCode in ('94','342') then  EedBenStartDate END))
            ,LTD_EedBenStatus = MAX((CASE WHEN EEdDedCode in ('93','343') then  EedBenStatus END))
            ,STD_EedBenStatus = MAX((CASE WHEN EEdDedCode in ('94','342') then  EedBenStatus END))
            ,CRITI_BenefitStartDate = MAX((CASE WHEN EEdDedCode in ('345', '287', '288' ,'289') then EedBenStartDate END))
            ,ACCID_BenefitStartDate = MAX((CASE WHEN EEdDedCode in ('286','346') then EedBenStartDate END))
            ,CRITI_Amount = SUM((CASE WHEN EEdDedCode in ('345', '287', '288' ,'289') then EedBenAmt END))
            from U_dsi_BDM_EmpDeductions where  EedFormatCode = @FormatCode 
    ...
    SELECT DISTINCT
        ...
        ,drvDateTrailer = getDATE()
        ,drvNumberOfDetRecTrailer = CAST((Select count(*) from dbo.U_ELILSLFEXP_drvTbl) as varchar(7))
        ,drvFillerTrailer = ''
        ,drvDelimiterTrailer  = CHAR(10)
