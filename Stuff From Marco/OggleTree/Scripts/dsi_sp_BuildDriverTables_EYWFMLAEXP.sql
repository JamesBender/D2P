...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EYWFMLAEXP_20191029.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'York/CareWorks FMLA Export','201910249','EMPEXPORT','ONDEMAND',NULL,'EYWFMLAEXP',NULL,NULL,NULL,'201910249','Oct 24 2019  4:22PM','Oct 24 2019  4:22PM','201910241',NULL,'','','201910241',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EYWFMLAEXP_20191029.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Test Purposes Only','201910249','EMPEXPORT','TEST','Oct 29 2019  1:38PM','EYWFMLAEXP',NULL,NULL,NULL,'201910249','Oct 24 2019  4:22PM','Oct 24 2019  4:22PM','201910241','2360','','','201910241',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\[UDENV]\[UDSERVER]\Downloads\V10\Exports\[UDCOCODE]\EmployeeHistoryExport\[UDCOCODE]_EYWFMLAEXP_20191029.txt',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Scheduled Session','201910249','EMPEXPORT','SCHEDULED',NULL,'EYWFMLAEXP',NULL,NULL,NULL,'201910249','Oct 24 2019  4:22PM','Oct 24 2019  4:22PM','201910241',NULL,'','','201910241',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
UPDATE dbo.AscExp SET expAscFileName = CASE WHEN LEFT(@UDENV,2) IN ('NW','EW','WP') THEN REPLACE(REPLACE(REPLACE(expAscFileName,'[UDENV]',@UDENV),'[UDSERVER]',@UDSERVER),'[UDCOCODE]',@UDCOCODE) ELSE '\\us.saas\' + LEFT(@UDENV,2) + '\Public\' + @ARNUM + '\Exports\' + @UDCOCODE + '_EYWFMLAEXP_20191029.txt' END WHERE expFormatCode = 'EYWFMLAEXP';
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ,PehCurHrsYTD           = SUM(CASE WHEN PehEarnCode NOT IN ('BRV','HOL','JUR','MEALP','MILPT','OFC','PFL','PFLS6','PFLS7','PFLS8','PFLS9','PRKNT','PT','STD','STD70','STD80','STD90','STDA','UNPD','VAC') THEN PehCurHrs ELSE 0  END)
    ...
    SELECT DISTINCT
        ...
        ,drvWorkHoursLast12Months = CAST(CONVERT(DECIMAL(7,2),PehCurHrsYTD) as VARCHAR(9))
