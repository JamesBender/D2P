...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','3','(''SS''=''F'')','EMLEQESPEXZ0','15','H','01','17',NULL,'IB_INBOUND_ID',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','6','(''SS''=''F'')','EMLEQESPEXZ0','8','H','01','46',NULL,'IBSH00_CYCLE_DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','7','(''SS''=''F'')','EMLEQESPEXZ0','8','H','01','54',NULL,'IBSH00_PAYCHECK_END_DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','8','(''SS''=''F'')','EMLEQESPEXZ0','8','H','01','62',NULL,'IBSH00_ELIG_DATE',NULL,NULL);
...
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','10','(''SS''=''F'')','EMLEQESPEXZ0','4','H','01','71',NULL,'IBSH00_DC_COMPANY_CODE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','11','(''SS''=''F'')','EMLEQESPEXZ0','30','H','01','75',NULL,'IBSH00_DB_PAYROLL_ID',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','12','(''SS''=''F'')','EMLEQESPEXZ0','1','H','01','105',NULL,'IBSH00_MW_FILE_TYPE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','13','(''SS''=''F'')','EMLEQESPEXZ0','8','H','01','106',NULL,'IBSH00_MW_PRIOR_PAY_PERIOD_END_DATE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','14','(''SS''=''F'')','EMLEQESPEXZ0','4','H','01','114',NULL,'IBSH00_MW_PLAN_YEAR',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"01"','15','(''DA''=''F'')','EMLEQESPEXZ0','2','H','01','118',NULL,'IBSH00_TRANSMISSION_SITE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','16','(''SS''=''F'')','EMLEQESPEXZ0','30','H','01','120',NULL,'IBSH00_CONTACT_NAME',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','17','(''SS''=''F'')','EMLEQESPEXZ0','30','H','01','150',NULL,'IBSH00_CONTACT_NUMBER',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','18','(''SS''=''F'')','EMLEQESPEXZ0','100','H','01','180',NULL,'IBSH00_CONTACT_EMAIL',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"1"','19','(''DA''=''F'')','EMLEQESPEXZ0','1','H','01','280',NULL,'IBSH00_ESPP_AUTO_ENROLL',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('"SCSC"','20','(''DA''=''F'')','EMLEQESPEXZ0','12','H','01','281',NULL,'IBSH00_ESPP_COMPANY_CODE',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','21','(''SS''=''F'')','EMLEQESPEXZ0','20','H','01','293',NULL,'IBSH00_FILE_DESCRIPTION',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','22','(''SS''=''F'')','EMLEQESPEXZ0','1','H','01','313',NULL,'IBSH00_AUTOREHIRE_INDICATOR',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','23','(''SS''=''F'')','EMLEQESPEXZ0','1','H','01','314',NULL,'IBSH00_MATCH_CALC_IND',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','24','(''SS''=''F'')','EMLEQESPEXZ0','1','H','01','315',NULL,'IBSH00_CHANGES_ONLY_INDICATOR',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','25','(''SS''=''F'')','EMLEQESPEXZ0','3','H','01','316',NULL,'IBSH00_PAYROLL_LOCATION',NULL,NULL);
INSERT INTO [dbo].[AscDefF] (AdfExpression,AdfFieldNumber,AdfForCond,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType) VALUES ('""','26','(''SS''=''F'')','EMLEQESPEXZ0','5182','H','01','319',NULL,'FILLER',NULL,NULL);
...
/*08*/ DECLARE @FILENAME varchar(1000) = 'EMLEQESPEX_20210828.txt';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','','',NULL,NULL,NULL,'Merrill Equity and ESSP -Test','202108239','EMPEXPORT','TEST_XOE','Aug 25 2021 11:08AM','EMLEQESPEX',NULL,NULL,NULL,'202108239','Aug 23 2021 12:00AM','Dec 30 1899 12:00AM','202108091','4986','','','202108091',dbo.fn_GetTimedKey(),NULL,'us3rVaSCA1004',NULL);
...
CREATE TABLE [dbo].[U_EMLEQESPEX_drvTbl_IBEN01] (
    ...
    [drvPlanNumber] varchar(7) NOT NULL,
    [drvPartNumer] char(25) NULL
);
...
BEGIN
    ...
    --Remove HR CORBRA AND HR Only Companies
    DELETE FROM dbo.U_EMLEQESPEX_EEList WHERE xCOID IN ('3U6ND','3U6PP');
    --==========================================
    ...
    SELECT DISTINCT    
        ...
        ,drvProductType = CONVERT(VARCHAR(4),'AC' )
        ,drvPlanNumber = 'XOP1590'
        ,drvPartNumer = CASE WHEN EepSSN IS NOT NULL THEN EepSSN ELSE EepUDField01 END
    ...
    WHERE EecEmplStatus IN ('L', 'A')
      AND EepUDField01 = 'STOCK'
    ;
    --ESPP RECORDS
    INSERT INTO dbo.U_EMLEQESPEX_drvTbl_IBEN01
    SELECT DISTINCT    
         drvEEID = xEEID
        ,drvCoID = xCoID
        ,drvDepRecID = CONVERT(varchar(12),'1') --DELETE IF NOT USING DEPENDENT DATA
    ...
    JOIN dbo.Location WITH (NOLOCK)
        ON LocCode = EecLocation
    WHERE EecEmplStatus IN ('L', 'A')
    AND LocAddressCountry IN ('USA','CAN') 
    AND FLOOR(DATEDIFF(DAY, EepDateOfBirth,GETDATE()) / 365.25) > 18  
    ...
    SELECT DISTINCT
        ...
        ,drvCoID = xCoID
        ,drvDepRecID = CONVERT(varchar(12),'1') --DELETE IF NOT USING DEPENDENT DATA
        ,drvSort = LocCode -- CAST(YtdMedicareAmt AS VARCHAR) -- xEEID + ' 2'
        -- standard fields above and additional driver fields below
        ...
        ,drvYtdFicaOas = FORMAT(OasAmount*1000000, '000000000000000') -- JCB
    ...
    JOIN dbo.EmpTax WITH (NOLOCK)
        ...
        AND LocAddressState = LEFT(EetTaxCode, 2)
    JOIN (
            SELECT PthEEID, PthCOID
                ,SUM(CASE WHEN PthTaxCode IN ('USSOCEE') THEN PthCurTaxAmt ELSE 0.00 END) AS OasAmount
