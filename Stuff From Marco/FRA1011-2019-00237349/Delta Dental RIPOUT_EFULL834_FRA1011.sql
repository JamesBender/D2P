...
Frasier Meadows Manor Inc - Replace with customer name
Marco Lagrosa - Replace with TC name
Lea King - Replace with BA/IC name
07/12/2019 - Replace with date of creation
SR-2019-00237349- Replace with SR number
EDT834FMMI- Replace with Format Code (i.e., ESUNLIF834)
Delta Dental 834 Export (FMMI) - Replace with Name of Interface (AdfFormatName) (i.e., Sunlife 834 Export)
FMMI - Replace with Company Code (i.e., GOOG)
...
-- Data parameters
FMMI - Replace with Company Code for Customer
DPPO, DMO - Replace with Deduction Code List in CSV format (i.e., DED1,DED2,DED3)
...
*/
IF OBJECT_ID('dsi_vwEDT834FMMI_Export') IS NOT NULL DROP VIEW [dbo].[dsi_vwEDT834FMMI_Export];
GO
IF OBJECT_ID('dsi_sp_BuildDriverTables_EDT834FMMI') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_BuildDriverTables_EDT834FMMI];
GO
IF OBJECT_ID('dsi_sp_AfterCollect_EDT834FMMI') IS NOT NULL DROP PROCEDURE [dbo].[dsi_sp_AfterCollect_EDT834FMMI];
GO
IF OBJECT_ID('U_EDT834FMMI_TrlTbl') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_TrlTbl];
GO
IF OBJECT_ID('U_EDT834FMMI_HdrTbl') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_HdrTbl];
GO
IF OBJECT_ID('U_EDT834FMMI_File') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_File];
GO
IF OBJECT_ID('U_EDT834FMMI_EEList') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_EEList];
GO
IF OBJECT_ID('U_EDT834FMMI_DrvTbl_2300') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_DrvTbl_2300];
GO
IF OBJECT_ID('U_EDT834FMMI_DrvTbl') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_DrvTbl];
GO
IF OBJECT_ID('U_EDT834FMMI_DedList') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_DedList];
GO
IF OBJECT_ID('U_EDT834FMMI_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_AuditFields];
GO
IF OBJECT_ID('U_EDT834FMMI_Audit') IS NOT NULL DROP TABLE [dbo].[U_EDT834FMMI_Audit];
GO
IF OBJECT_ID('U_dsi_BDM_EDT834FMMI') IS NOT NULL DROP TABLE [dbo].[U_dsi_BDM_EDT834FMMI];
GO
DELETE [dbo].[U_dsi_SQLClauses] FROM [dbo].[U_dsi_SQLClauses] WHERE FormatCode = 'EDT834FMMI';
DELETE [dbo].[U_dsi_Configuration] FROM [dbo].[U_dsi_Configuration] WHERE FormatCode = 'EDT834FMMI';
DELETE [dbo].[AscExp] FROM [dbo].[AscExp] WHERE expFormatCode = 'EDT834FMMI';
DELETE [dbo].[AscDefF] FROM [dbo].[AscDefF] JOIN AscDefH ON AdfHeaderSystemID = AdhSystemID WHERE AdhFormatCode = 'EDT834FMMI';
DELETE [dbo].[AscDefH] FROM [dbo].[AscDefH] WHERE AdhFormatCode = 'EDT834FMMI';
GO

DECLARE @AdhSystemID VARCHAR(12), @FixedFormatName1 VARCHAR(50), @FixedFormatName2 VARCHAR(50);
SET @AdhSystemID = LEFT('EDT834FMMI' + REPLICATE('0',10),10) + 'Z0';
SET @FixedFormatName1 = LEFT('Delta Dental 834 Export (FMMI)',50);
SET @FixedFormatName2 = LEFT('Delta Dental 834 Export (FMMI)',30);

INSERT INTO [dbo].[AscDefH] (AdhAccrCodesUsed,AdhAggregateAtLevel,AdhAuditStaticFields,AdhChildTable,AdhClientTableList,AdhCustomDLLFileName,AdhDedCodesUsed,AdhDelimiter,AdhEarnCodesUsed,AdhEEIdentifier,AdhEndOfRecord,AdhEngine,AdhFileFormat,AdhFormatCode,AdhFormatName,AdhFundCodesUsed,AdhImportExport,AdhInputFormName,AdhIsAuditFormat,AdhIsSQLExport,AdhModifyStamp,AdhOutputMediaType,AdhRecordSize,AdhSortBy,AdhSysFormat,AdhSystemID,AdhTaxCodesUsed,AdhYearStartFixedDate,AdhYearStartOption,AdhPreProcessSQL,AdhRespectZeroPayRate,AdhCreateTClockBatches,AdhThirdPartyPay) SELECT 'N','C','Y','0','','','N','','N','','013010','EMPEXPORT','CDE','EDT834FMMI',@FixedFormatName1,'N','E','FORM_EMPEXPORT','N','C',dbo.fn_GetTimedKey(),'D','2000','S','N',@AdhSystemID,'N','Jan  1 1900 12:00AM','C','dbo.dsi_sp_Switchbox_v2','N',NULL,'N';
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Changes Only File',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','CHANGES','Oct  1 2018 12:00AM','EDT834FMMI',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Full File Only',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','FULLFILE','Oct  1 2018 12:00AM','EDT834FMMI',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Active Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEACTIVE','Oct  1 2018 12:00AM','EDT834FMMI',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,'Passive Open Enrollment',CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','OEPASSIVE','Oct  1 2018 12:00AM','EDT834FMMI',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expCOIDList,expIEXSystemID) SELECT 'File Name is Auto Generated',NULL,NULL,NULL,NULL,NULL,NULL,@FixedFormatName2,CONVERT(CHAR(8),GETDATE(),112) + '9','EMPEXPORT','SCHEDULED','Oct  1 2018 12:00AM','EDT834FMMI',NULL,NULL,NULL,CONVERT(CHAR(8),GETDATE(),112) + '9','Oct  1 2018 12:00AM','Dec 30 1899 12:00AM',CONVERT(CHAR(8),GETDATE(),112) + '1',NULL,'','',CONVERT(CHAR(8),GETDATE(),112) + '1',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL,NULL;
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDT834FMMI','834LineFeed','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDT834FMMI','EEList','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDT834FMMI','ExportPath','V','@FileExportPath');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDT834FMMI','InitialSort','C','LEFT(drvInitialSort,20)');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDT834FMMI','Is834','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDT834FMMI','SubSort','C','drvSubSort');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDT834FMMI','Testing','V','Y');
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EDT834FMMI','UseFileName','V','N');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H01','U_EDT834FMMI_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H02','U_EDT834FMMI_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H03','U_EDT834FMMI_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H04','U_EDT834FMMI_HdrTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H05','U_EDT834FMMI_HdrTbl','ISNULL(drvREF01_RefNumberQual,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H06','U_EDT834FMMI_HdrTbl','ISNULL(drvQTY01_QuantityQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H07','U_EDT834FMMI_HdrTbl','ISNULL(drvQTY01_QuantityQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H08','U_EDT834FMMI_HdrTbl','ISNULL(drvQTY01_QuantityQual3,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H09','U_EDT834FMMI_HdrTbl','ISNULL(drvN101_EntityIDCodeSponsor1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','H10','U_EDT834FMMI_HdrTbl','ISNULL(drvN101_EntityIDCodeSponsor2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D11','U_EDT834FMMI_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D12','U_EDT834FMMI_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D13','U_EDT834FMMI_DrvTbl','ISNULL(drvREF01_RefNumberQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D14','U_EDT834FMMI_DrvTbl','ISNULL(drvREF01_RefNumberQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D15','U_EDT834FMMI_DrvTbl','ISNULL(drvDTP00_DateTime1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D16','U_EDT834FMMI_DrvTbl','ISNULL(drvDTP00_DateTime2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D20','U_EDT834FMMI_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D21','U_EDT834FMMI_DrvTbl','ISNULL(drvPER03_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER05_CommNumberQualifier,'''') <> '''' OR ISNULL(drvPER07_CommNumberQualifier,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D22','U_EDT834FMMI_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D23','U_EDT834FMMI_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D24','U_EDT834FMMI_DrvTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D25','U_EDT834FMMI_DrvTbl','ISNULL(drvICM01_FrequencyCode,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D26','U_EDT834FMMI_DrvTbl','ISNULL(drvAMT00_SegmentID1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D27','U_EDT834FMMI_DrvTbl','ISNULL(drvAMT00_SegmentID2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D28','U_EDT834FMMI_DrvTbl','ISNULL(drvHLH00_SegmentID,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D40','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D41','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_348,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D42','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_349,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D43','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvDTP00_DateTime_303,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D45','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvREF00_RefNumberQual1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D46','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvREF00_RefNumberQual2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D50','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvAMT00_AmountQualifierCode1,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D51','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvHD00_HealthCoverage,'''') <> '''' AND ISNULL(drvAMT00_AmountQualifierCode2,'''') <> ''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D80','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvLS01_LoopIDCode,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D81','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvLX01_AssignedNumber,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D85','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvN101_EntityIDCodeSponsor,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D86','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvREF01_RefNumberQual,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','D87','U_EDT834FMMI_DrvTbl_2300','ISNULL(drvLE01_LoopIDCode,'''') <>''''');
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','T90','U_EDT834FMMI_TrlTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','T91','U_EDT834FMMI_TrlTbl',NULL);
INSERT INTO [dbo].[U_dsi_SQLClauses] (FormatCode,RecordSet,FromClause,WhereClause) VALUES ('EDT834FMMI','T92','U_EDT834FMMI_TrlTbl',NULL);
GO
...
DECLARE @FileName VARCHAR(1000) = 'EDT834FMMI' + '_' + CONVERT(VARCHAR(8),GETDATE(),112) + '.txt';
...
IF (@ISWEB = 'Y')
BEGIN
    UPDATE dbo.U_Dsi_Configuration SET CfgValue = 'N' WHERE FormatCode = 'EDT834FMMI' AND CfgName IN ('Testing','UseFileName');
    UPDATE dbo.U_Dsi_Configuration SET CfgValue = NULL WHERE FormatCode = 'EDT834FMMI' AND CfgName = 'ExportPath';

    DELETE FROM dbo.AscExp WHERE expFormatCode = 'EDT834FMMI' AND expExportCode = 'ZAP';
    UPDATE dbo.AscExp SET expAscFileName = @FilePath + @FileName WHERE expFormatCode = 'EDT834FMMI';

    DELETE FROM dbo.U_dsi_Configuration WHERE FormatCode = 'EDT834FMMI' AND CfgName IN ('TestPath','UDESPath');
END
GO
IF OBJECT_ID('U_EDT834FMMI_EEList') IS NULL
CREATE TABLE [dbo].[U_EDT834FMMI_EEList] (
    [xCOID] char(5) NULL,
    [xEEID] char(12) NULL
);
IF OBJECT_ID('U_EDT834FMMI_File') IS NULL
CREATE TABLE [dbo].[U_EDT834FMMI_File] (
...
GO
CREATE PROCEDURE [dbo].[dsi_sp_AfterCollect_EDT834FMMI]
AS
SET NOCOUNT ON;
/************************************************************
...
BEGIN
    ...
    --==================================================
    WHILE (SELECT COUNT(*) FROM dbo.U_EDT834FMMI_File WHERE RIGHT(DATA,2) = '*~') > 0
    BEGIN
        UPDATE dbo.U_EDT834FMMI_File SET DATA = REPLACE(DATA,'*~','~') WHERE RIGHT(RTRIM(DATA),2) = '*~';
    END;

    --========================================
    -- Remove Extra Records from PER Segment
    --========================================
    UPDATE dbo.U_EDT834FMMI_File SET DATA = REPLACE(DATA,'HP**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%HP**%';
    UPDATE dbo.U_EDT834FMMI_File SET DATA = REPLACE(DATA,'WP**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%WP**%';
    UPDATE dbo.U_EDT834FMMI_File SET DATA = REPLACE(DATA,'EM**','') WHERE LEFT(DATA,3) = 'PER' AND DATA LIKE '%EM**%';

    --====================================
    -- Update Record Count in SE Segment
    --====================================
    DECLARE @RecordCount INT;
    SET @RecordCount = (SELECT COUNT(*) FROM dbo.U_EDT834FMMI_File WHERE LEFT(Data, CHARINDEX('*',Data) - 1) NOT IN ('ISA','GS','IEA','GE'));

    UPDATE dbo.U_EDT834FMMI_File
    SET Data = REPLACE(Data,'9999',@RecordCount)
    WHERE LEFT(Data,2) = 'SE';

END
GO
CREATE PROCEDURE [dbo].[dsi_sp_BuildDriverTables_EDT834FMMI]
    @systemid CHAR(12)
AS
SET NOCOUNT ON;
/**********************************************************************************
...
Purpose: Delta Dental 834 Export (FMMI)
...
SELECT * FROM dbo.U_dsi_Configuration WHERE FormatCode = 'EDT834FMMI';
SELECT * FROM dbo.U_dsi_SqlClauses WHERE FormatCode = 'EDT834FMMI';
SELECT * FROM dbo.U_dsi_Parameters WHERE FormatCode = 'EDT834FMMI';
SELECT * FROM dbo.AscExp WHERE expFormatCode = 'EDT834FMMI';
SELECT * FROM dbo.U_dsi_InterfaceActivityLog WHERE FormatCode = 'EDT834FMMI' ORDER BY RunID DESC;

Execute Export
--------------
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EDT834FMMI', 'FULLFILE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EDT834FMMI', 'CHANGES';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EDT834FMMI', 'OEPASSIVE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EDT834FMMI', 'OEACTIVE';
EXEC dbo.dsi_sp_TestSwitchbox_v2 'EDT834FMMI', 'SCHEDULED';

EXEC dbo.dsi_BDM_sp_ErrorCheck 'EDT834FMMI';

EXEC dbo._dsi_usp_ExportRipOut EDT834FMMI = 'EDT834FMMI', @AllObjects = 'Y', @IsWeb = 'N';
**********************************************************************************/
BEGIN
    ...
    WHERE FormatCode = 'EDT834FMMI';

    --==========================================
    -- Deduction Code List
    --==========================================
    DECLARE @DedList VARCHAR(MAX);
    SET @DedList = 'DPPO, DMO';

    IF OBJECT_ID('U_EDT834FMMI_DedList','U') IS NOT NULL
        DROP TABLE dbo.U_EDT834FMMI_DedList;
    SELECT DedCode = DedDedCode
        ,DedLongDesc
        ,DedType = DedDedType
    INTO dbo.U_EDT834FMMI_DedList
    ...
    DELETE FROM dbo.U_EDT834FMMI_EEList
    WHERE xCoID <> dbo.dsi_BDM_fn_GetCurrentCoID(xEEID)
    AND xEEID IN (SELECT xEEID FROM dbo.U_EDT834FMMI_EEList GROUP BY xEEID HAVING COUNT(1) > 1);

    -- Remove Employees that Do Not Have a Benefit Plan in Deduction Code List
    DELETE FROM dbo.U_EDT834FMMI_EEList
    WHERE NOT EXISTS (SELECT 1 FROM dbo.EmpDed JOIN dbo.U_EDT834FMMI_DedList ON DedCode = EedDeDCode WHERE EedEEID = xEEID);
    ...
    FROM dbo.U_dsi_bdm_EDT834FMMI D
    JOIN dbo.U_dsi_bdm_EDT834FMMI E
    ...
    --=====================================================
    UPDATE dbo.U_dsi_bdm_EDT834FMMI
        SET BdmUSGField2 = EedEmpDedTVID
    FROM dbo.U_dsi_bdm_EDT834FMMI
    ...
    ***************************************************************************************************************/
    ...
    -- HEADER RECORD 
    -------------------
    IF OBJECT_ID('U_EDT834FMMI_HdrTbl','U') IS NOT NULL
        DROP TABLE dbo.U_EDT834FMMI_HdrTbl;
    SELECT DISTINCT drvISA05_SenderIDQual = '30'
        ,drvISA06_SenderID = '840503809'
    ...
    INTO dbo.U_EDT834FMMI_HdrTbl
    FROM dbo.U_EDT834FMMI_EELIST WITH (NOLOCK)
    JOIN dbo.U_dsi_bdm_EDT834FMMI WITH (NOLOCK)
        ON BdmEEID = xEEID
        AND BdmCOID = xCOID;
    ...
    ***************************************************************************************************************/
    ...
    -- DETAIL RECORD 
    -------------------
    IF OBJECT_ID('U_EDT834FMMI_DrvTbl','U') IS NOT NULL
        DROP TABLE dbo.U_EDT834FMMI_DrvTbl;
    SELECT DISTINCT
        --=====================
        --LOOP 2000 RECORDS
        --=====================
    ...
    ***************************************************************************************************************/
    ...
    -- DETAIL RECORD 
    -------------------
    IF OBJECT_ID('U_EDT834FMMI_DrvTbl_2300','U') IS NOT NULL
        DROP TABLE dbo.U_EDT834FMMI_DrvTbl_2300;
    SELECT DISTINCT
        ...
        ,drvHD05_CoverageLevelCode = CASE WHEN BdmDedType IN ('MED','DEN','VIS') THEN
                                                CASE WHEN BdmBenOption IN ('EE') THEN 'EMP'
                                                     ...
                                                     WHEN BdmBenOption IN ('EEF','EEFPF') THEN 'FAM'
                                                END
                                     END
        ...
        ,drvREF02_RefNumberQual2 = CASE WHEN BdmDedType IN ('MED','DEN','VIS') THEN 
         CASE 
                WHEN BdmDedCode = 'DPPO' THEN '00001' 
                WHEN BdmDedCode = 'DMO' THEN '00002' 
            END
        END
        ...
        ,drvSubSort = CONVERT(CHAR(9),RTRIM(EepSSN)) + CONVERT(CHAR(12),ISNULL(ConSystemID,''))
                      + CASE BdmDedType
                             ...
                             ELSE '9'
                      END
    INTO dbo.U_EDT834FMMI_DrvTbl_2300
    FROM dbo.U_EDT834FMMI_EELIST WITH (NOLOCK)
    JOIN dbo.EmpPers WITH (NOLOCK)
        ON EepEEID = xEEID
    JOIN dbo.EmpComp WITH (NOLOCK)
    ...
    **************************************************************************************************/
    ...
    -- TRAILER RECORD
    --------------------
    IF OBJECT_ID('U_EDT834FMMI_TrlTbl') IS NOT NULL
        DROP TABLE dbo.U_EDT834FMMI_TrlTbl;
    SELECT DISTINCT drvSE01_SegmentCount = '9999'
    INTO dbo.U_EDT834FMMI_TrlTbl;

    --==========================================
    -- Set FileName
    --==========================================
    IF (dbo.dsi_fnVariable('EDT834FMMI','UseFileName') = 'N')
    BEGIN
        UPDATE dbo.U_dsi_Parameters
            SET ExportFile = 'FMMI_EDT834FMMI_' + CONVERT(VARCHAR(8),GETDATE(),112) + '.txt'
        WHERE FormatCode = 'EDT834FMMI';
    END;
...
--Alter the View
ALTER VIEW dbo.dsi_vwEDT834FMMI_Export AS
    SELECT TOP 20000000 DATA FROM dbo.U_EDT834FMMI_File (NOLOCK)
...
WHERE AdfHeaderSystemID LIKE 'EDT834FMMI%'
...
WHERE ExpFormatCode = 'EDT834FMMI';

**********************************************************************************/
GO
CREATE VIEW dbo.dsi_vwEDT834FMMI_Export AS
    SELECT TOP 20000000 DATA FROM dbo.U_EDT834FMMI_File (NOLOCK)
    ORDER BY CASE LEFT(Recordset,1) WHEN 'H' THEN 1 WHEN 'D' THEN 2 ELSE 3 END, InitialSort, SubSort, RIGHT(Recordset,2)
GO