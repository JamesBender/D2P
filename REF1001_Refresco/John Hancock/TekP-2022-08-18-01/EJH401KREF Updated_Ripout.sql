...
Client ID:      REF1001
Date/time:      2022-12-29 12:14:02.220
Ripout version: 7.4
...
GO
IF OBJECT_ID('U_EJH401KREF_IncludeUntil') IS NOT NULL DROP TABLE [dbo].[U_EJH401KREF_IncludeUntil];
GO
...
GO
IF OBJECT_ID('U_EJH401KREF_AuditFields') IS NOT NULL DROP TABLE [dbo].[U_EJH401KREF_AuditFields];
GO
IF OBJECT_ID('U_EJH401KREF_Audit') IS NOT NULL DROP TABLE [dbo].[U_EJH401KREF_Audit];
GO
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('4','EJH401KREFZ0','50','D','10','4',NULL,'Name',NULL,NULL,'"drvName"','(''UA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('45','EJH401KREFZ0','16','D','10','45',NULL,'Year tp date pensionable hours',NULL,NULL,'"drvYTDPensionableHrs"','(''UA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('46','EJH401KREFZ0','16','D','10','46',NULL,'Total YTD match compensation',NULL,NULL,'"drvParollPeriodEndDate"','(''UDMDY''=''T,'')');
...
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('File Name is  Auto Generated',NULL,NULL,NULL,'DAJ4C,DCQJ1,DAJ8D,CIUJE,CITIX',NULL,NULL,NULL,'Scheduled Export','202212291','EMPEXPORT','SCHEDULED','Dec 29 2022  6:15AM','EJH401KREF',NULL,NULL,NULL,'202212291','Oct  8 2018 12:00AM','Dec 30 1899 12:00AM','202212222','6123','','','202212222',dbo.fn_GetTimedKey(),NULL,'ULTI_RBUS',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES ('\\us.saas\E4\Public\REF1001\Exports\JohnHancock\EJH401KREF_TEST_20220721.txt',NULL,NULL,NULL,'DAJ4C,DCQJ1,DAJ8D,CIUJE,CITIX',NULL,NULL,NULL,'For Testing JH 401K','202209021','EMPEXPORT','TEST','Sep  2 2022  8:05PM','EJH401KREF',NULL,NULL,NULL,'202209021','Sep  2 2022 12:00AM','Dec 30 1899 12:00AM','202208251','6479','','','202208251',dbo.fn_GetTimedKey(),NULL,'ULTI_RBUS',NULL);
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EJH401KREF','ExportPath','V','\\us.saas\E0\data_exchange\REF1001\Exports\UDES\');
...
INSERT INTO [dbo].[U_dsi_Configuration] (FormatCode,CfgName,CfgType,CfgValue) VALUES ('EJH401KREF','UDESPath','V','\\us.saas\E4\Public\REF1001\Exports\JohnHancock\');
...
-----------
-- Create table U_EJH401KREF_Audit
-----------

IF OBJECT_ID('U_EJH401KREF_Audit') IS NULL
CREATE TABLE [dbo].[U_EJH401KREF_Audit] (
...
-----------
-- Create table U_EJH401KREF_AuditFields
-----------

IF OBJECT_ID('U_EJH401KREF_AuditFields') IS NULL
CREATE TABLE [dbo].[U_EJH401KREF_AuditFields] (
...
-----------
-- Create table U_EJH401KREF_IncludeUntil
-----------

IF OBJECT_ID('U_EJH401KREF_IncludeUntil') IS NULL
CREATE TABLE [dbo].[U_EJH401KREF_IncludeUntil] (
...
BEGIN
    ...
    IF OBJECT_ID('U_EJH401KREF_IncludeUntil','U') IS NOT NULL
        DROP TABLE dbo.U_EJH401KREF_IncludeUntil;
    ;WITH FPD
    ...
    INTO dbo.U_EJH401KREF_IncludeUntil 
    FROM [dbo].[U_EJH401KREF_EEList]
    ...
    --Audit Table
    IF OBJECT_ID('U_EJH401KREF_AuditFields','U') IS NOT NULL
        DROP TABLE dbo.U_EJH401KREF_AuditFields;
    CREATE TABLE dbo.U_EJH401KREF_AuditFields (aTableName varchar(128),aFieldName varchar(128));
    
    -- Insert tables/fields to be audited
    INSERT INTO dbo.U_EJH401KREF_AuditFields VALUES ('EmpComp','EecEmplStatus');    
    
    -- Create audit table
    IF OBJECT_ID('U_EJH401KREF_Audit','U') IS NOT NULL
        DROP TABLE dbo.U_EJH401KREF_Audit;
    SELECT
    ...
    INTO dbo.U_EJH401KREF_Audit
    FROM (SELECT *
          FROM dbo.AuditRecords WITH (NOLOCK)
          WHERE adrTableName IN (SELECT aTableName FROM dbo.U_EJH401KREF_AuditFields WITH (NOLOCK))) ADR
    JOIN (SELECT *
          FROM dbo.AuditFields WITH (NOLOCK)
          WHERE adfFieldName IN (SELECT aFieldName FROM dbo.U_EJH401KREF_AuditFields WITH (NOLOCK))) ADF
    ...
    -- Create Index
    CREATE CLUSTERED INDEX CDX_U_EJH401KREF_Audit ON dbo.U_EJH401KREF_Audit (audKey1Value, audKey2Value);
    ...
    DELETE dbo.U_EJH401KREF_EEList
    FROM dbo.U_EJH401KREF_EEList A
    ...
    WHERE NOT EXISTS (SELECT 1 FROM dbo.pdedhist WITH (NOLOCK) WHERE pdhEEID = A.xEEID AND PdhPayDate >= DATEADD(yy, DATEDIFF(yy,0,@StartDate), 0))   --do not delete if they have a deduction in or after the start pay period control year
      AND NOT EXISTS (SELECT 1 FROM dbo.U_EJH401KREF_Audit WITH (NOLOCK) WHERE AudKey1Value = A.xEEID)  --Include any terms keyed between @StartDate and @EndDate  
      AND NOT EXISTS (SELECT 1 FROM U_EJH401KREF_IncludeUntil WITH (NOLOCK) WHERE xEEID = incEEID AND xCOID = incCOID AND incUntil >= @StartDate) --Do not delete if marked for inclusion
...
--20221229 - MW
         ,drvDateOfLastHire =     
            CASE WHEN (( EecUnionLocal = 'PAW22000' or EecDedGroupCode = 'CNCDU' or EecEEType in ('CON', 'EXP', 'Z')) AND EecDateOfLastHire <> EecDateofOriginalHire AND EecJoBChangeReason ='101') THEN NUll -- MW Changed
  ...
  --                                       END
  --20221229 - MW
     ,drvExcludCode = CASE WHEN EecUnionLocal = 'PAW22000' or EecDedGroupCode = 'CNCDU' or EecEEType in ('CON', 'EXP', 'Z') then 'X'Else Null END -- MW Changed 
...
-- 20200327
    ...
    WHERE EecEmplStatus <> 'T'  
        ...
        OR EXISTS (SELECT 1 FROM dbo.U_EJH401KREF_Audit WITH (NOLOCK) WHERE AudKey1Value = xEEID)  --Include anyone with a term keyed between start/end date
        OR EXISTS (SELECT 1 FROM [dbo].[U_EJH401KREF_IncludeUntil] WHERE incEEID = xEEID AND incCOID = xCOID AND incUntil >= @StartDate)
