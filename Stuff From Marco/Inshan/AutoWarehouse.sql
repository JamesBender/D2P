...
/*08*/ DECLARE @FILENAME varchar(1000) = 'ECYCCOBRA_20201029.txt';
/*09*/ DECLARE @FILEPATH varchar(1000) = '\\' + @COUNTRY + '.saas\' + @SERVER + '\' + @ENVIRONMENT + '\Downloads\V10\Exports\' + @COCODE + '\EmployeeHistoryExport\';
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','',',89C3O,88X2J',NULL,NULL,NULL,'CYC COBRA NPM Export','202010319','EMPEXPORT','NPMFILE',NULL,'ECYCCOBRA',NULL,NULL,NULL,'202010319','Feb 27 2020  5:41AM','Feb 27 2020  5:41AM','202010151',NULL,'','','202010151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,'','',',89C3O,88X2J',NULL,NULL,NULL,'CYC COBRA QB Export','202010319','EMPEXPORT','QBFILE',NULL,'ECYCCOBRA',NULL,NULL,NULL,'202010319','Feb 27 2020  5:41AM','Feb 27 2020  5:41AM','202010151',NULL,'','','202010151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,',89C3O,88X2J',NULL,NULL,NULL,'CYC COBRA NPM TEST','202010319','EMPEXPORT','TESTNPM',NULL,'ECYCCOBRA',NULL,NULL,NULL,'202010319','Feb 27 2020  5:41AM','Feb 27 2020  5:41AM','202010151',NULL,'','','202010151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
INSERT INTO [dbo].[AscExp] (expAscFileName,expAsOfDate,expCOID,expCOIDAllCompanies,expCOIDList,expDateOrPerControl,expDateTimeRangeEnd,expDateTimeRangeStart,expDesc,expEndPerControl,expEngine,expExportCode,expExported,expFormatCode,expGLCodeTypes,expGLCodeTypesAll,expGroupBy,expLastEndPerControl,expLastPayDate,expLastPeriodEndDate,expLastStartPerControl,expNoOfRecords,expSelectByField,expSelectByList,expStartPerControl,expSystemID,expTaxCalcGroupID,expUser,expIEXSystemID) VALUES (RTRIM(@FILEPATH) + LTRIM(RTRIM(@FILENAME)),NULL,NULL,NULL,',89C3O,88X2J',NULL,NULL,NULL,'CYC COBRA QB TEST','202010319','EMPEXPORT','TESTQB',NULL,'ECYCCOBRA',NULL,NULL,NULL,'202010319','Feb 27 2020  5:41AM','Feb 27 2020  5:41AM','202010151',NULL,'','','202010151',dbo.fn_GetTimedKey(),NULL,'ULTI',NULL);
   ...
   left JOIN dbo.CONTACTS WITH(NOLOCK)
    ...
    SELECT DISTINCT
        ...
        ,drvEveECYCntTypeQBEv = Case
                                    ...
                                    ELSE 'TERMINATION'
                                END
        ,drvEventDateQBEv =  CONVERT(VARCHAR, dbo.dsi_fnGetMinMaxDates('MAX',eecdateoftermination, @FileMinCovDate), 101)
  ...
  --  WHERE DedDedType IN ('MED', 'DEN', 'VIS', 'DRG') AND BdmDedcode <> 'MMOPT' AND isNULL(BdmBenStopDate, '') <> '' 
    ...
    SELECT DISTINCT
        ...
        ,drvStartDateQBPL = CASE WHEN BdmDedType IN ('MED', 'DEN', 'VIS', 'DRG') 
                                    ...
                                    THEN CONVERT(VARCHAR, DateAdd(Day,1,BdmBenStopDate), 101)
                            END
        ,drvEndDateQBPL = '' -- Leave Blank
        ,drvCoverageLevelQBPL = CASE WHEN (Select count(*) from U_dsi_BDM_ECYCCOBRA where  bdmdedType  IN ('DEN', 'VIS', 'MED', 'DRG') and  bdmDedCode <> 'MMOPT' and bdmeeid = xeeid and bdmrectype = 'DEP') > 0 THEN 'EE+Family'
                                     ELSE 'EE'
                                END 
