...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('15','EMSUFCUUNMZ0','79','D','10','15',NULL,'EE_DOB',NULL,NULL,'"drvDOB"','(''UA''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('16','EMSUFCUUNMZ0','80','D','10','16',NULL,'SP_DOB',NULL,NULL,'"drvConDOB"','(''UA''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('19','EMSUFCUUNMZ0','83','D','10','19',NULL,'MOST_RCNT_HIRE_DATE',NULL,NULL,'"drvDateOfLastHire"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('20','EMSUFCUUNMZ0','84','D','10','20',NULL,'EE_TERM_DATE',NULL,NULL,'"drvDateOfTemination"','(''UD101''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('28','EMSUFCUUNMZ0','92','D','10','28',NULL,'EFF_DATE_OF_EE_COVG',NULL,NULL,'"drvEffDateChange1"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('29','EMSUFCUUNMZ0','93','D','10','29',NULL,'COVG_TERM_DATE',NULL,NULL,'"drvCovgTermDate1"','(''UD101''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('31','EMSUFCUUNMZ0','95','D','10','31',NULL,'EFF_DATE_OF_SP_COVG',NULL,NULL,'"drvSpEffCovgDate1"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('32','EMSUFCUUNMZ0','96','D','10','32',NULL,'SP_COVG_TERM_DATE',NULL,NULL,'"drvSpCovgTermDate1"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('33','EMSUFCUUNMZ0','97','D','10','33',NULL,'EFF_DATE_OF_CH_COVG',NULL,NULL,'"drvDateOfChCovg1"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('34','EMSUFCUUNMZ0','98','D','10','34',NULL,'CH_COVG_TERM_DATE',NULL,NULL,'"drvChCvgTermDate1"','(''UD101''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('42','EMSUFCUUNMZ0','106','D','10','42',NULL,'EFF_DATE_OF_EE_COVG 2',NULL,NULL,'"drvEffDateChange2"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('43','EMSUFCUUNMZ0','107','D','10','43',NULL,'COVG_TERM_DATE 2',NULL,NULL,'"drvCovgTermDate2"','(''UD101''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('45','EMSUFCUUNMZ0','109','D','10','45',NULL,'EFF_DATE_OF_SP_COVG 2',NULL,NULL,'"drvSpEffCovgDate2"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('46','EMSUFCUUNMZ0','110','D','10','46',NULL,'SP_COVG_TERM_DATE 2',NULL,NULL,'"drvSpCovgTermDate2"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('47','EMSUFCUUNMZ0','111','D','10','47',NULL,'EFF_DATE_OF_CH_COVG 2',NULL,NULL,'"drvDateOfChCovg2"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('48','EMSUFCUUNMZ0','112','D','10','48',NULL,'CH_COVG_TERM_DATE 2',NULL,NULL,'"drvChCvgTermDate2"','(''UD101''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('56','EMSUFCUUNMZ0','120','D','10','56',NULL,'EFF_DATE_OF_EE_COVG 3',NULL,NULL,'"drvEffDateChange3"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('57','EMSUFCUUNMZ0','121','D','10','57',NULL,'COVG_TERM_DATE 3',NULL,NULL,'"drvCovgTermDate3"','(''UD101''=''T,'')');
...
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('59','EMSUFCUUNMZ0','123','D','10','59',NULL,'EFF_DATE_OF_SP_COVG 3',NULL,NULL,'"drvSpEffCovgDate3"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('60','EMSUFCUUNMZ0','124','D','10','60',NULL,'SP_COVG_TERM_DATE 3',NULL,NULL,'"drvSpCovgTermDate3"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('61','EMSUFCUUNMZ0','125','D','10','61',NULL,'EFF_DATE_OF_CH_COVG 3',NULL,NULL,'"drvDateOfChCovg3"','(''UD101''=''T,'')');
INSERT INTO [dbo].[AscDefF] (AdfFieldNumber,AdfHeaderSystemID,AdfLen,AdfRecType,AdfSetNumber,AdfStartPos,AdfTableName,AdfTargetField,AdfVariableName,AdfVariableType,AdfExpression,AdfForCond) VALUES ('62','EMSUFCUUNMZ0','126','D','10','62',NULL,'CH_COVG_TERM_DATE 3',NULL,NULL,'"drvChCvgTermDate3"','(''UD101''=''T,'')');
...
BEGIN
   ...
   -- DELETE FROM dbo.U_EMSUFCUUNM_EEList
    ...
    SET @DedList = 'ACCID,CRILL,CISP,HOSP1,HOSP2,MED,401K';
    ...
    SELECT DISTINCT
        ...
        ,drvConDOB = CASE WHEN ConRelationship in ('SPS','DP') then ConDateOfBirth END
        ,drvGender = EepGender
        ,drvDateOfLastHire = EecDateOfLastHire
        ,drvDateOfTemination = eecDateOfTermination
        ,drvProduct1 = CASE WHEN ACCIDBdmDedCode IS NOT NULL THEN '824' END
        ,drvPolicyNbr1 = CASE WHEN ACCIDBdmDedCode IS NOT NULL THEN '947924' END
        ,drvDivision1 = CASE WHEN ACCIDBdmDedCode IS NOT NULL THEN '1' END
        ,drvPolicyEligibleGrp1 = CASE WHEN ACCIDBdmDedCode IS NOT NULL THEN '1' END
        ,drvChoice1 = CASE WHEN ACCIDBdmDedCode IS NOT NULL THEN '1' END
        ,drvEffDateChange1 = CASE WHEN ACCIDBdmDedCode IS NOT NULL THEN dbo.dsi_fnGetMinMaxDates('MAX',ACCIDBDmBenStartDate,@FileMinCovDate) END
        ,drvCovgTermDate1 = CASE WHEN ACCIDBdmDedCode IS NOT NULL THEN ACCIDBDmBenStopDate END
        ,drvEEBenAmt1 = ''
        ,drvSpEffCovgDate1 = CASE WHEN ACCIDBdmRelationship_SP IS NOT NULL THEN dbo.dsi_fnGetMinMaxDates('MAX',ACCIDBDmBenStartDate,@FileMinCovDate) END
        ,drvSpCovgTermDate1 =  CASE WHEN ACCIDBdmRelationship_SP IS NOT NULL THEN ACCIDBdmBenStopDate END
        ,drvDateOfChCovg1 = CASE WHEN ACCIDChangeReason IS NOT NULL THEN dbo.dsi_fnGetMinMaxDates('MAX',ACCIDBDmBenStartDate,@FileMinCovDate) END
        ,drvChCvgTermDate1 = CASE WHEN ACCIDBdmRelationship_CH IS NOT NULL THEN ACCIDBdmBenStopDate END
        ,drvCiSpInd1 = ''
        ,drvProduct2 = CASE WHEN CRITBdmDedCode IS NOT NULL THEN '822' END
        ,drvPolicyNbr2 = CASE WHEN CRITBdmDedCode IS NOT NULL THEN '947925' END
        ,drvDivision2 = CASE WHEN CRITBdmDedCode IS NOT NULL THEN '1' END
        ,drvPolicyEligibleGrp2 = CASE WHEN CRITBdmDedCode IS NOT NULL THEN '1' END
        ,drvChoice2 = CASE WHEN CRITBdmDedCode IS NOT NULL THEN 
                        CASE WHEN CRITBdmBenAmt = '1000' THEN '1'
                             WHEN CRITBdmBenAmt = '2000' THEN '2'
                             WHEN CRITBdmBenAmt = '3000' THEN '3'
                             END
                      END
                        
        ,drvEffDateChange2 = CASE WHEN CRITBdmDedCode IS NOT NULL THEN  dbo.dsi_fnGetMinMaxDates('MAX',CRITBdmBenStartDate,@FileMinCovDate) END
        ,drvCovgTermDate2 =  CASE WHEN CRITBdmDedCode IS NOT NULL THEN CRITBdmBenStopDate END
        ,drvEEBenAmt2 =  CASE WHEN CRITBdmDedCode IS NOT NULL THEN CRITBdmBenAmt END
        ,drvSpEffCovgDate2 = CASE WHEN CRITBdmRelationship_SP IS NOT NULL THEN dbo.dsi_fnGetMinMaxDates('MAX',CRITBdmBenStartDate,@FileMinCovDate)  END
        ,drvSpCovgTermDate2 = CASE WHEN CRITBdmRelationship_SP IS NOT NULL THEN CRITBdmBenStopDate END
        ,drvDateOfChCovg2 = CASE WHEN CRITChangeReason IS NOT NULL THEN dbo.dsi_fnGetMinMaxDates('MAX',CRITBdmBenStartDate,@FileMinCovDate)  END
        ,drvChCvgTermDate2 = CASE WHEN CRITBdmRelationship_CH IS NOT NULL THEN CRITBdmBenStopDate END
        ,drvCiSpInd2 = CASE WHEN CRITBdmDedCode IN ('CRILL') THEN 'N'
                            WHEN CRITBdmDedCode IN ('CISP') THEN 'Y'
                            END
        ,drvProduct3 = CASE WHEN HOSPBDmDedCode IS NOT NULL THEN '825' END
        ,drvPolicyNbr3 = CASE WHEN HOSPBDmDedCode IS NOT NULL THEN '947926' END
        ,drvDivision3 = CASE WHEN HOSPBDmDedCode IS NOT NULL THEN '1' END
        ,drvPolicyEligibleGrp3 = CASE WHEN HOSPBDmDedCode IS NOT NULL THEN '1' END
        ,drvChoice3 = CASE WHEN HOSPBdmDedCode_1 IS NOT NULL THEN '1'
                           WHEN HOSPBdmDedCode_2 IS NOT NULL THEN '2'
                           END
        ,drvEffDateChange3 = CASE WHEN HOSPBDmDedCode IS NOT NULL THEN dbo.dsi_fnGetMinMaxDates('MAX',HOSPBdmBenStartDate,@FileMinCovDate)  END
        ,drvCovgTermDate3 = CASE WHEN HOSPBDmDedCode IS NOT NULL THEN HOSPBdmBenStopDate END
        ,drvEEBenAmt3 = ''
        ,drvSpEffCovgDate3 = CASE WHEN HOSPBdmRelationship_SP IS NOT NULL THEN dbo.dsi_fnGetMinMaxDates('MAX',HOSPBdmBenStartDate,@FileMinCovDate) END
        ,drvSpCovgTermDate3 = CASE WHEN HOSPBdmRelationship_SP IS NOT NULL THEN HOSPBdmBenStopDate END
        ,drvDateOfChCovg3 = CASE WHEN HOSPChangeReason IS NOT NULL THEN dbo.dsi_fnGetMinMaxDates('MAX',HOSPBdmBenStartDate,@FileMinCovDate) END
        ,drvChCvgTermDate3 = CASE WHEN HOSPBdmRelationship_CH IS NOT NULL THEN HOSPBdmBenStopDate END
        ,drvCiSpInd3 = ''
    ...
    JOIN (
            SELECT Distinct  BdmEEID, BdmCOID               
                ,MAX(CASE WHEN bdmDedCode IN ('ACCID') THEN bdmDedCode END) AS ACCIDBdmDedCode 
                ,MAX(CASE WHEN bdmDedCode IN ('ACCID') THEN BdmBenStartDate END ) AS  ACCIDBdmBenStartDate
                ,MAX(CASE WHEN bdmDedCode IN ('ACCID') THEN BdmBenStopDate END ) AS ACCIDBdmBenStopDate
                ,MAX(CASE WHEN bdmDedCode IN ('ACCID') THEN BdmEEAmt END ) AS ACCIDBdmEEAmt
                ,MAX(CASE WHEN bdmDedCode IN ('ACCID') and BdmRelationship IN ('SPS','DP') THEN BdmRelationship END ) AS ACCIDBdmRelationship_SP
                ,MAX(CASE WHEN bdmDedCode IN ('ACCID') and BdmChangeReason IN  ('103','105', '201', '202', '204', '300', '302', '303', '401', '402', 'LEVNT2', 'LEVNT3', 'LEVNT4', 'LEVNT5') THEN BdmChangeReason END ) AS ACCIDChangeReason
                ,MAX(CASE WHEN bdmDedCode IN ('ACCID') and BdmRelationship IN  ('CHL', 'DC', 'DPC', 'STC') THEN BdmRelationship END ) AS ACCIDBdmRelationship_CH
        
                ,MAX(CASE WHEN bdmDedCode IN ('HOSP1','HOSP2') THEN bdmDedCode END) AS HOSPBdmDedCode
                ,MAX(CASE WHEN bdmDedCode IN ('HOSP1') THEN bdmDedCode END) AS HOSPBdmDedCode_1
                ,MAX(CASE WHEN bdmDedCode IN ('HOSP2') THEN bdmDedCode END) AS HOSPBdmDedCode_2
                ,MAX(CASE WHEN bdmDedCode IN ('HOSP1','HOSP2') THEN bdmBenStartDate END) AS HOSPBdmBenStartDate
                ,MAX(CASE WHEN bdmDedCode IN ('HOSP1','HOSP2') THEN bdmBenStopDate END) AS HOSPBdmBenStopDate
                ,MAX(CASE WHEN bdmDedCode IN ('HOSP1','HOSP2') and BdmRelationship IN ('SPS','DP') THEN BdmRelationship END ) AS HOSPBdmRelationship_SP
                ,MAX(CASE WHEN bdmDedCode IN ('HOSP1','HOSP2') and BdmChangeReason IN  ('103','105', '201', '202', '204', '300', '302', '303', '401', '402', 'LEVNT2', 'LEVNT3', 'LEVNT4', 'LEVNT5') THEN BdmChangeReason END ) AS HOSPChangeReason
                ,MAX(CASE WHEN bdmDedCode IN ('HOSP1','HOSP2') and BdmRelationship IN  ('CHL', 'DC', 'DPC', 'STC') THEN BdmRelationship END ) AS HOSPBdmRelationship_CH
                
                ,MAX(CASE WHEN bdmDedCode IN ('CRILL','CISP') THEN bdmDedCode END) AS CRITBdmDedCode
                ,MAX(CASE WHEN bdmDedCode IN ('CRILL','CISP') THEN bdmBenStartDate END) AS CRITBdmBenStartDate
                ,MAX(CASE WHEN bdmDedCode IN ('CRILL','CISP') THEN bdmBenStopDate END) AS CRITBdmBenStopDate
                ,MAX(CASE WHEN bdmDedCode IN ('CRILL','CISP')  THEN BdmEEAmt END ) AS CRITBdmBenAmt
                ,MAX(CASE WHEN bdmDedCode IN ('CISP') and BdmRelationship IN ('SPS','DP') THEN BdmRelationship END ) AS CRITBdmRelationship_SP
                ,MAX(CASE WHEN bdmDedCode IN ('CRILL','CISP') and BdmChangeReason IN  ('103','105', '201', '202', '204', '300', '302', '303', '401', '402', 'LEVNT2', 'LEVNT3', 'LEVNT4', 'LEVNT5') THEN BdmChangeReason END ) AS CRITChangeReason
                ,MAX(CASE WHEN bdmDedCode IN ('CRILL') and BdmRelationship IN ('CHL', 'DC', 'DPC', 'STC') THEN BdmRelationship END ) AS CRITBdmRelationship_CH
